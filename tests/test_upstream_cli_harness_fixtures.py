...
def test_upstream_cli_harness_fixtures_match() -> None:
    native = FIXTURE_DIR / "harness_cli_native_to_chatgpt.json"
    shim = FIXTURE_DIR / "harness_cli_shim_to_chatgpt.json"
