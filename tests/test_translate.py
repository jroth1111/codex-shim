...
# --- normalize_web_search_action edge cases (audit F-002 regression guard) ---
...
# --- KNOWN_RESPONSE_INPUT_TYPES completeness guard (audit §6 backlog) ---
...
# --- build_streaming_tool_output_types coverage (audit §6 backlog) ---
