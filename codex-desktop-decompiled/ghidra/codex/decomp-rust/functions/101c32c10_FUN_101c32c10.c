...
/* WARNING: Removing unreachable block (ram,0x000101c32f0c) */
/* WARNING: Removing unreachable block (ram,0x000101c32f14) */

void FUN_101c32c10(void)

{
  ...
  *unaff_x19 = 0x12;
  ...
  if (unaff_x21 != 0) {
    _free();
    unaff_x22 = *(long *)(unaff_x29 + -0xb0);
  }
  if ((unaff_x22 != -0x8000000000000000) && ((unaff_x23 & 1) != 0)) {
