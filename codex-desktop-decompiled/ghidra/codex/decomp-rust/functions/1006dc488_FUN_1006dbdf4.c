...

{
  ...
  puStack0000000000000158 = &stack0x000004b0;
  pcStack0000000000000150 = s_Failed_to_refresh_token____108ac383c;
  FUN_1006df624(&stack0x000003a0);
  if (*(short *)(unaff_x19 + 0x69) == 0x191) {
    ...
    *puVar3 = 1;
    puVar3[1] = &stack0x000002d0;
    puVar3[2] = 1;
    in_stack_00000358 = func_0x000106029c30(0x28,puVar3,&UNK_10b209118);
    if (pcStack0000000000000150 != (char *)0x0) {
      _free(puStack0000000000000158);
    }
