...
void FUN_100f1d684(undefined2 *param_1,ulong *param_2)

{
  ...
  *param_2 = 0x8000000000000005;
  ...
  if (uVar3 == 3) {
    ...
    func_0x000100b1da80(&cStack_130,&uStack_b0);
  }
  else if (uVar3 == 5) {
...
LAB_100f1d7b4:
          ...
          if (uStack_b0 == 0x8000000000000000) goto LAB_100f1d7b4;
