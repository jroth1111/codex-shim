...
void FUN_100620610(ulong *param_1,ulong *param_2)

{
  ...
  *param_2 = 0x8000000000000001;
  if (uVar14 != 0x8000000000000001) {
    ...
    uStack_c0 = uVar7;
    uStack_b8 = uVar3;
    FUN_10061a998(&uStack_a8,&uStack_110);
    if (uStack_a8 == 2) {
      param_1[2] = uStack_98;
      param_1[1] = uStack_a0;
      param_1[3] = uStack_90;
        ...
        if (uVar14 == 0x8000000000000000) {
          if (uVar12 == 0) {
            ...
            if (uVar7 == 0) {
              ...
              pcVar5 = (code *)SoftwareBreakpoint(1,0x100620784);
              (*pcVar5)();
            }
          }
...
LAB_100620aac:
                    /* WARNING: Does not return */
    pcVar5 = (code *)SoftwareBreakpoint(1,0x100620ab0);
    (*pcVar5)();
  }
  ...
  uStack_190 = uVar7;
  uStack_188 = uVar3;
  func_0x00010159a414(puVar9,&uStack_210,&uStack_1e0);
  if (*puVar9 == 2) {
    if ((uVar14 & 0x7fffffffffffffff) != 0) {
      _free(uVar2);
    }
