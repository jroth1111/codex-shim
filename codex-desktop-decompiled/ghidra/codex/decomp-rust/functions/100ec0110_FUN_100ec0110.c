...
LAB_100ec08b0:
      if (lVar16 == 2) {
        ...
        func_0x00010135bc4c(&uStack_190,pcVar13 + 0x40);
        puVar7 = puStack_188;
...
LAB_100ec0638:
    ...
    do {
      ...
      if (bVar9 != 0xd) {
        if (bVar9 == 0xe) {
          func_0x0001009e9948(&uStack_190,*(undefined8 *)(lVar22 + lVar17 + 0x10),
...
joined_r0x000100ec031c:
          ...
          if (bVar9 == 0xf) {
            func_0x0001009e9948(&uStack_190,*(undefined8 *)(lVar22 + lVar17 + 8),
...
LAB_100ec0920:
      ...
      func_0x00010135bc4c(&uStack_190,pbVar18);
      if (uStack_190 == (undefined ***)0x8000000000000000) {
        puStack_108 = puStack_1b0;
        *param_1 = 0x8000000000000000;
        param_1[1] = (ulong)puStack_188;
