...
void FUN_10122de2c(ulong *param_1,byte *param_2)
...
LAB_10122e29c:
      ...
      if (*pbVar19 == 0x16) goto LAB_10122e29c;
...
LAB_10122e2b4:
  ...
  if (bVar3 != 0x15) {
    uVar9 = FUN_108855b04(param_2,&puStack_78,&UNK_10b20b980);
    *param_1 = 1;
    param_1[1] = uVar9;
    return;
  }
...
LAB_10122e5d0:
            lStack_a0 = lVar16 + 1;
            pbStack_b8 = pbVar18;
            uVar9 = FUN_108855b04(&bStack_98,&puStack_78,&UNK_10b20e5e0);
            goto LAB_10122e3f0;
          }
          iVar11 = 1;
          if (piVar4 != (int *)0x1) {
...
LAB_10122e17c:
        ...
        if (bVar2 == 0xd) {
          if (piVar5 == (int *)0x3) {
            ...
            if (piVar5 != (int *)0x5) goto LAB_10122e14c;
            iVar10 = 2;
        ...
        if (bVar2 != 0xe) {
          if (bVar2 != 0xf) goto LAB_10122e5d0;
          if (piVar5 == (int *)0x3) {
            if ((((char)*piVar4 != 'e') || (*(char *)((long)piVar4 + 1) != 'n')) ||
               (*(char *)((long)piVar4 + 2) != 'd')) goto LAB_10122e14c;
            iVar10 = 1;
          }
...
LAB_10122e14c:
        ...
        if (lStack_80 == 3) {
          if ((((char)*piVar5 != 'e') || (*(char *)((long)piVar5 + 1) != 'n')) ||
             (*(char *)((long)piVar5 + 2) != 'd')) goto LAB_10122e0e4;
          iVar10 = 1;
        }
...
joined_r0x00010122e118:
      ...
      if (iVar10 == 0) {
        ...
        pbStack_e0 = (byte *)CONCAT71(pbStack_e0._1_7_,0x16);
        if (bVar2 == 0x16) goto LAB_10122e50c;
        uVar20 = *puVar13;
        puVar15[1] = puVar13[1];
        *puVar15 = uVar20;
...
LAB_10122e4a0:
        ...
        *(undefined8 *)((long)puVar15 + 0xf) = uVar20;
        ...
        auVar21 = FUN_100617a90(&bStack_98);
        uVar9 = auVar21._8_8_;
        if ((auVar21._0_8_ & 1) != 0) goto LAB_10122e4a0;
        bVar7 = true;
        unaff_x22 = uVar9;
      }
      else {
...
LAB_10122e50c:
          ...
          pcVar8 = (code *)SoftwareBreakpoint(1,0x10122e538);
          (*pcVar8)();
        }
        uVar20 = *puVar13;
        puVar15[1] = puVar13[1];
