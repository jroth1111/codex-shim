...
undefined8 FUN_108997cdc(undefined8 param_1,ulong param_2)
  ...
  if ((param_2 & 1) == 0) {
    ...
    if (param_2 < 2) {
      ...
      if (lVar6 == 0) {
        ...
        puStack_d0 = &UNK_10b303ad0;
        if (plVar3[3] == 0) {
          iVar1 = func_0x000105dc8000(plVar3,&puStack_d8);
          if (iVar1 != 0) goto LAB_108997e4c;
        }
        else {
          plStack_a0 = plVar3 + 4;
          ...
          uVar5 = __ZN4core3fmt5write17h64810b21425781ecE
                            (&plStack_f0,&UNK_10b303ad0,s_at_line_column_108b2e1dd,&plStack_c0);
          if ((uVar5 & 1) != 0) {
LAB_108997e4c:
            func_0x000108a07a3c(&UNK_108df5bcb,0x37,&plStack_c0,&UNK_10b316788,&UNK_10b316480);
                    /* WARNING: Does not return */
            pcVar4 = (code *)SoftwareBreakpoint(1,0x108997e74);
            (*pcVar4)();
          }
        }
        uStack_b8 = uStack_e8;
        ...
        if (*plVar3 == 1) {
          uVar5 = plVar3[1];
          if ((uVar5 & 3) != 1) goto LAB_108997e84;
          ...
          if ((*plVar3 != 0) || (plVar3[2] == 0)) goto LAB_108997e84;
