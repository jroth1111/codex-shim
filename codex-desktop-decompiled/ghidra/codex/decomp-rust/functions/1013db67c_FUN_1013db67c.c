...
LAB_1013db8a0:
          ...
          if (bVar6 == 0xe) {
            func_0x0001009e903c(&bStack_88,*(undefined8 *)(lVar9 + lVar18 + 0x10),
                                *(undefined8 *)(lVar9 + lVar18 + 0x18));
          }
          else {
            if (bVar6 != 0xf) goto LAB_1013db9b8;
            func_0x0001009e903c(&bStack_88,*(undefined8 *)(lVar9 + lVar18 + 8),
...
LAB_1013db8b4:
        if (bStack_87 < 2) {
          ...
          if (bVar6 != 0x10) {
            ...
            func_0x00010140d1b0(&bStack_88,pbVar15);
            iVar12 = iStack_84;
...
LAB_1013dbbe0:
    ...
    func_0x00010140d1b0(&bStack_88,lVar16);
    if ((bStack_88 & 1) == 0) {
