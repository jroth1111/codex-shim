...
undefined1  [16] FUN_100fbf5b4(long *param_1,undefined8 *param_2)
...
LAB_100fbf9fc:
  ...
  pcVar6 = (code *)SoftwareBreakpoint(1,0x100fbfa00);
  (*pcVar6)();
}
