...
void FUN_103e5d760(ulong *param_1)
...
LAB_103e5d8dc:
      uVar5 = uStack_88;
      if (iVar1 == 0) {
        FUN_103dbc954(param_1 + 7);
      }
    }
    _memcpy(puVar9,auStack_b80,0xaf8);
...
LAB_103e5d928:
    puStack_70 = param_1;
    lVar3 = func_0x000106110c98(param_1 + 4,&puStack_70);
    uStack_80 = 1;
    if (lVar3 != 0) {
      uStack_80 = 2;
    }
    ...
    *param_1 = uStack_78 + uStack_80 * -0x40;
    ...
    if ((uVar7 >> 1 & 1) != 0) goto LAB_103e5d890;
    if ((uVar7 >> 3 & 1) == 0) {
      auStack_b80[0] = 2;
      unaff_x21 = param_1[5];
      unaff_x20 = (*
      ...
      if (*(char *)(unaff_x20 + 0x48) == '\x01') goto LAB_103e5d8c0;
      if (*(char *)(unaff_x20 + 0x48) != '\x02') goto LAB_103e5d8a8;
      uStack_88 = 0;
      puVar9 = param_1 + 6;
      iVar1 = (int)*puVar9;
      if (iVar1 != 1) goto LAB_103e5d8dc;
      goto LAB_103e5d7e4;
    }
    if ((uVar7 >> 4 & 1) == 0) goto LAB_103e5d928;
    if (param_1[0x167] != 0) {
      (**(code **)(param_1[0x167] + 0x10))(param_1[0x168]);
      LOAcquire();
      uVar2 = *param_1;
      *param_1 = uVar2 & 0xffffffffffffffef;
      ...
      if ((uVar7 >> 1 & 1) == 0) {
        ...
        if ((uVar7 >> 4 & 1) != 0) {
          if ((uVar7 >> 3 & 1) == 0) {
            if (param_1[0x167] != 0) {
              (**(code **)(param_1[0x167] + 0x18))(param_1[0x168]);
            }
            param_1[0x167] = 0;
          }
          goto LAB_103e5d928;
...
LAB_103e5da10:
  ...
  pcVar8 = (code *)SoftwareBreakpoint(1,0x103e5da14);
  (*pcVar8)();
}
