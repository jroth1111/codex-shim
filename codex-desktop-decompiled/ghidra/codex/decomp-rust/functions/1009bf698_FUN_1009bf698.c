...
undefined8 FUN_1009bf698(undefined8 param_1)

{
  ...
  if ((*(byte *)(unaff_x28 + 0x60) & 1) == 0) {
    ...
    *(undefined8 *)(unaff_x19 + 0x13d8) = *(undefined8 *)(unaff_x19 + 0x12e8);
    uVar19 = *(undefined8 *)(unaff_x19 + 0x12a0);
    uVar21 = *(undefined8 *)(unaff_x19 + 0x1298);
    ...
    *(undefined8 *)(unaff_x19 + 0x1420) = uVar19;
    *puStack0000000000000090 = uVar21;
    ...
    *(long *)(unaff_x19 + 0x1450) = in_stack_00000398;
    *(undefined8 *)(unaff_x19 + 0x1448) = in_stack_00000390;
    *(long *)(unaff_x19 + 0x1458) = in_stack_000003a0;
...
LAB_1009bfd80:
        *(undefined1 *)(unaff_x27 + 0x582) = 0;
        lVar14 = *(long *)(unaff_x19 + 0x1448);
        uVar21 = *(undefined8 *)(unaff_x19 + 0x1450);
        uVar19 = *(undefined8 *)(unaff_x19 + 0x1458);
        if ((lRam000000010b62d4b0 != -0x8000000000000000) && (lRam000000010b62d4b0 != 0)) {
          _free(uRam000000010b62d4b8);
        }
        lRam000000010b62d4b0 = lVar14;
        uRam000000010b62d4b8 = uVar21;
        uRam000000010b62d4c0 = uVar19;
        if (((uVar6 & 1) != 0) ||
    ...
    *(undefined8 *)(unaff_x19 + 0x14d8) = 0x8000000000000000;
    ...
    if (*plVar13 != -0x7ffffffffffffffb) {
      ...
      *(undefined8 *)(unaff_x19 + 0x1500) = *(undefined8 *)(unaff_x19 + 0x1598);
      uVar19 = *(undefined8 *)(unaff_x19 + 0x15c0);
      uVar21 = *(undefined8 *)(unaff_x19 + 0x15b8);
      *(undefined8 *)(unaff_x19 + 0x1518) = *(undefined8 *)(unaff_x19 + 0x15b0);
      *(undefined8 *)(unaff_x19 + 0x1510) = *(undefined8 *)(unaff_x19 + 0x15a8);
      *in_stack_00000068 = 1;
      *(undefined8 *)(unaff_x19 + 0x1528) = uVar19;
      *(undefined8 *)(unaff_x19 + 0x1520) = uVar21;
      ...
      if (-1 < *(long *)(unaff_x19 + 0x14f0)) {
        ...
        *puVar7 = 0x6567615f72657375;
        ...
        if (in_stack_000006a0 == 0) {
          ...
          in_stack_000003a0 = __RNvCshXwFllX56pT_7___rustc12___rust_alloc(in_stack_000006a0,1);
          if (in_stack_000003a0 == 0) {
            func_0x0001087c9084(1,in_stack_000006a0);
            goto LAB_1009c2600;
          }
        }
        _memcpy(in_stack_000003a0,&UNK_10b208fd0,in_stack_000006a0);
        ...
        in_stack_00000398 = in_stack_000006a0;
        in_stack_000003a8 = in_stack_000006a0;
        if (&stack0x00000000 != (undefined1 *)0xfffffffffffff8f0) {
          _free(&UNK_10b208fd0);
        }
      }
      lVar14 = *(long *)(unaff_x19 + 0x1378);
      lVar17 = *(long *)(unaff_x19 + 0x1380);
      if (*(long *)(unaff_x19 + 0x1370) != -0x8000000000000000) {
        if (lVar17 == 0) {
          lVar18 = 1;
        }
        else {
          lVar18 = __RNvCshXwFllX56pT_7___rustc12___rust_alloc(lVar17,1);
          if (lVar18 == 0) {
            func_0x0001087c9084(1,lVar17);
            goto LAB_1009c2600;
          }
        }
        _memcpy(lVar18,lVar14,lVar17);
        lVar14 = lVar18;
      }
...
LAB_1009c18b8:
            ...
            if (*(long *)(unaff_x29 + -0xb0) == -0x7ffffffffffffffb) {
              lVar18 = *(long *)(unaff_x29 + -0xa8);
              _free(puVar10);
              if (lVar18 == 0) goto LAB_1009c2250;
              goto LAB_1009c1b54;
            }
            FUN_101497a9c(&stack0x00000390,&stack0x00000600,&stack0x00000920,unaff_x29 + -0xb0);
            *(long *)(unaff_x29 + -0xf8) = in_stack_000003a0;
            *(long *)(unaff_x29 + -0x100) = in_stack_00000398;
...
LAB_1009c2250:
            ...
            *puVar10 = 0x6e49726576726573;
            ...
            if (lVar14 == -0x7ffffffffffffffb) goto LAB_1009c1b50;
            FUN_101497a9c(&stack0x00000390,&stack0x00000600,&stack0x000008c0,&stack0x00000710);
            if (in_stack_00000398 != -0x7ffffffffffffffb) {
              FUN_100de6690(&stack0x00000690);
            }
...
LAB_1009c1b54:
          ...
          if (*plVar1 != -0x7ffffffffffffffb) {
            ...
            *(undefined1 *)(unaff_x28 + 0x60) = 1;
            ...
            uVar21 = *(undefined8 *)(unaff_x19 + 0x1590);
            lVar17 = *plVar13;
            ...
            *(undefined8 *)(unaff_x19 + 0x15d8) = uVar21;
            ...
            *(undefined1 *)(unaff_x27 + 0x582) = 0;
            ...
            if (lVar14 != -0x8000000000000000) {
              ...
              if (lVar18 != 0) {
                lVar20 = 0;
                do {
                  plVar13 = (long *)(lVar17 + lVar20 * 0x48);
                  if (*plVar13 != 0) {
                    _free(plVar13[1]);
                  }
