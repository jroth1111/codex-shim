...
long FUN_100fde260(undefined8 param_1)

{
  ...
  if ((char)puVar6[9] == '\x01') goto LAB_100fde370;
  if ((char)puVar6[9] != '\x02') goto LAB_100fde358;
  ...
  while( true ) {
    ...
    __ZN4core9panicking9panic_fmt17h6f8816b337451651E(s__108b1bd74,&puStack_6900,&UNK_10b22a330);
LAB_100fde358:
...
LAB_100fde774:
  ...
  pcVar2 = (code *)SoftwareBreakpoint(1,0x100fde778);
  (*pcVar2)();
}
