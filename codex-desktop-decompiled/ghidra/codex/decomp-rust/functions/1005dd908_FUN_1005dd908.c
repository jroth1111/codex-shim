...
undefined1  [16] FUN_1005dd908(void)

{
  ...
  *(ulong *)(unaff_x23 + 0x15c) = CONCAT44(0xb208fd0,(int)((ulong)&stack0x00000f40 >> 0x20));
  *(ulong *)(unaff_x23 + 0x154) = CONCAT44((int)&stack0x00000f40,1);
  *(undefined8 *)(unaff_x23 + 0x168) = in_stack_000014a0;
  *(undefined **)(unaff_x23 + 0x160) = &UNK_10b208fd0;
