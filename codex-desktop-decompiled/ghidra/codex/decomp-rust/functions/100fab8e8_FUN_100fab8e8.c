...
/* WARNING: Removing unreachable block (ram,0x000100fa59a0) */

undefined1  [16] FUN_100fab8e8(void)

{
  ...
  uVar3 = FUN_108858fa8(s_plugin_____in_marketplace______m_108ad407f,&stack0x00005f80);
  FUN_100e76650(&stack0x0000dfc0);
  if (unaff_x26 != 0) {
    puVar6 = (undefined8 *)(in_stack_00000048 + 0x20);
    do {
      if (puVar6[-4] != 0) {
        _free(puVar6[-3]);
      }
  ...
  *(undefined1 *)(in_stack_000000f8 + 0x7c4) = 0;
  if (*(long *)(in_stack_000000f8 + 0x7f8) != 0) {
    _free(*(undefined8 *)(in_stack_000000f8 + 0x800));
  }
  if (((*(byte *)(in_stack_000000f8 + 0x7c1) & 1) != 0) &&
     (*(long *)(in_stack_000000f8 + 0x7e0) != 0)) {
    _free(*(undefined8 *)(in_stack_000000f8 + 0x7e8));
  }
  *(undefined1 *)(in_stack_000000f8 + 0x7c1) = 0;
  FUN_100e1955c(in_stack_000000f8 + 0x1f58);
  FUN_100e05b5c(in_stack_000000f8 + 0x15d8);
  if (*(long *)(in_stack_000000f8 + 0x1f38) != 0) {
    _free(*(undefined8 *)(in_stack_000000f8 + 8000));
  }
  if (*(long *)(in_stack_000000f8 + 0x7c8) != 0) {
    _free(*(undefined8 *)(in_stack_000000f8 + 2000));
  }
  if (((*(byte *)(in_stack_000000f8 + 0x7c3) & 1) != 0) &&
     (*(long *)(in_stack_000000f8 + 0x790) != 0)) {
    _free(*(undefined8 *)(in_stack_000000f8 + 0x798));
  }
  if ((((*(byte *)(in_stack_000000f8 + 0x7c2) & 1) != 0) &&
      (*(long *)(in_stack_000000f8 + 0x7a8) != -0x8000000000000000)) &&
     (*(long *)(in_stack_000000f8 + 0x7a8) != 0)) {
    _free(*(undefined8 *)(in_stack_000000f8 + 0x7b0));
  }
  *(undefined2 *)(in_stack_000000f8 + 0x7c2) = 0;
  *in_stack_00000080 = 1;
  FUN_100e4ecf4(in_stack_000000e8);
  if (uVar3 == 0) {
    *(undefined1 *)(in_stack_000000f8 + 0x73c) = 0;
    *(undefined1 *)(in_stack_000000f8 + 0x70b) = 0;
    *(undefined4 *)(in_stack_000000d8 + 0x50d) = 0;
  ...
  *(undefined1 *)(in_stack_000000f8 + 0x73c) = 0;
  if ((*(byte *)(in_stack_000000f8 + 0x70b) & 1) != 0) {
    FUN_100caa578(&stack0x00012e50);
  }
  *(undefined1 *)(in_stack_000000f8 + 0x70b) = 0;
  *(undefined4 *)(in_stack_000000d8 + 0x50d) = 0;
  if ((*(byte *)(in_stack_000000f8 + 0x6f1) & 1) != 0) {
  ...
  *(undefined1 *)(in_stack_000000f8 + 0x6f1) = 0;
  if ((*(byte *)(in_stack_000000f8 + 0x70d) & 1) != 0) {
    FUN_100e21d54(in_stack_000000f8 + 0x3d8);
  }
  if ((*(byte *)(in_stack_000000f8 + 0x70c) & 1) == 0) {
    *(undefined2 *)(in_stack_000000f8 + 0x70c) = 0;
  }
  else {
    FUN_100dfefd8(in_stack_000000f8 + 0x3f0);
    *(undefined2 *)(in_stack_000000f8 + 0x70c) = 0;
  }
  if ((*(long *)(in_stack_000000f8 + 0x3c0) != -0x8000000000000000) &&
     (*(long *)(in_stack_000000f8 + 0x3c0) != 0)) {
