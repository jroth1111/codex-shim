...
/* WARNING: Removing unreachable block (ram,0x0001013a83e8) */

void FUN_1013a7e30(ulong *param_1,char *param_2)
...
LAB_1013a8730:
        ...
        pcVar8 = (code *)SoftwareBreakpoint(1,0x1013a8734);
        (*pcVar8)();
      }
      uStack_118 = 0;
      uStack_128 = uVar21;
                  ...
                  if (bVar4 != 1) {
                    ...
                    if (bVar4 == 0xc) {
                      if (lStack_70 == 4) {
                        ...
                        if (iVar3 == 0x656d616e) goto LAB_1013a8174;
                      }
...
LAB_1013a84ac:
                    ...
                    pbStack_c8 = pbVar27;
                    pbVar12 = (byte *)FUN_108855b04(&uStack_88,&puStack_a0,&UNK_10b20fd00);
                    puVar26 = (undefined *)((ulong)puVar26 & 0x7fffffffffffffff);
                    goto joined_r0x0001013a84d8;
                  }
...
LAB_1013a8104:
                  ...
                  if (bVar4 != 0xe) {
                    if (bVar4 != 0xf) goto LAB_1013a84ac;
                    if ((((piStack_78 != (int *)0x4) || ((char)*piStack_80 != 'n')) ||
                        (*(char *)((long)piStack_80 + 1) != 'a')) ||
                       (*(char *)((long)piStack_80 + 2) != 'm')) goto LAB_1013a8104;
                  ...
                  if (piStack_80 == (int *)0x0) goto LAB_1013a8110;
                  _free();
                  if (bVar9) goto LAB_1013a8114;
LAB_1013a8174:
...
LAB_1013a835c:
          ...
          pcStack_148 = pcVar24;
          pbStack_130 = pbVar20;
          uVar21 = FUN_108855b04(acStack_110,&puStack_a0,&UNK_10b20b420);
          *param_1 = 0x8000000000000000;
          param_1[1] = uVar21;
          uVar14 = uStack_120;
          uVar21 = uStack_118;
joined_r0x0001013a8540:
          uStack_120 = uVar14;
          uStack_118 = uVar21;
          if (uVar21 != 0) {
...
LAB_1013a8214:
          pbStack_e8 = pbVar31;
          pbVar11 = (byte *)FUN_1087e422c(0,&UNK_10b230888,&UNK_10b20a590);
LAB_1013a8230:
...
LAB_1013a8260:
          ...
          bVar4 = *pbStack_100;
          if (bVar4 == 0x16) goto LAB_1013a8214;
          ...
          *(undefined8 *)((long)puVar22 + 0xf) = uVar32;
          ...
          puVar26 = puStack_a0;
          pbVar11 = pbStack_98;
          if (puStack_a0 == (undefined *)0x8000000000000000) goto LAB_1013a8230;
...
LAB_1013a83f0:
        ...
        *puVar15 = puVar26;
        ...
        if (pcVar24 != pcVar25) goto code_r0x0001013a8440;
        goto LAB_1013a8580;
      }
      pcVar16 = pcVar17 + 0x20;
      pbVar1 = (byte *)0x0;
...
LAB_1013a85a4:
    ...
    uVar21 = FUN_108855b04(param_2,&puStack_a0,&UNK_10b209d40);
    *param_1 = 0x8000000000000000;
    param_1[1] = uVar21;
  }
  return;
code_r0x0001013a8440:
  pcVar16 = pcVar24 + 0x20;
  pcVar23 = pcVar24;
  unaff_x24 = pbVar27;
  pbVar1 = pbVar20;
  cVar7 = *pcVar24;
  if (*pcVar24 == '\x16') goto LAB_1013a8580;
  goto LAB_1013a7f18;
}
