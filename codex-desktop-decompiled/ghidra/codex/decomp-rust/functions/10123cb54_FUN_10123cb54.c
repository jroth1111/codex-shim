...
void FUN_10123cb54(undefined8 *param_1,byte *param_2)
...
LAB_10123cf74:
      pbStack_e8 = pbVar15;
      pbVar8 = (byte *)FUN_1087e422c(0,&UNK_10b2322b0,&UNK_10b20a590);
    }
    else {
      pbVar15 = unaff_x21 + 0x20;
      if (*unaff_x21 == 0x16) goto LAB_10123cf74;
      ...
      if (puStack_a0 != (undefined *)0x8000000000000000) {
        *param_1 = puStack_a0;
        ...
        if (lVar11 == 0) goto LAB_10123d0ec;
        *param_1 = 0x8000000000000000;
        param_1[1] = lVar11;
        unaff_x21 = pbVar8;
        puVar14 = puVar5;
        goto joined_r0x00010123d02c;
      }
    }
    *param_1 = 0x8000000000000000;
    param_1[1] = pbVar8;
...
joined_r0x00010123d02c:
    ...
    if (bVar2 != 0x15) {
      uVar10 = FUN_108855b04(param_2,&puStack_a0,&UNK_10b20c2a0);
      *param_1 = 0x8000000000000000;
      param_1[1] = uVar10;
      return;
    }
          ...
          if (bVar1 != 1) {
            ...
            if (bVar1 == 0xc) {
              if (lStack_70 == 0xe) {
                ...
                if (plVar3 == (long *)0x0) goto LAB_10123ce8c;
                _free();
                if ((uVar12 ^ 0x6c5065746f6d6572) == 0 && uVar13 == 0) goto LAB_10123ced4;
              }
...
LAB_10123d208:
            lStack_b0 = lVar18 + 1;
            pbStack_c8 = pbVar20;
            uVar10 = FUN_108855b04(&bStack_88,&puStack_a0,&UNK_10b210180);
            *param_1 = 0x8000000000000000;
            param_1[1] = uVar10;
...
LAB_10123ce80:
          ...
          if (bVar1 != 0xe) {
            if (bVar1 != 0xf) goto LAB_10123d208;
...
LAB_10123d204:
            ...
            pcVar6 = (code *)SoftwareBreakpoint(1,0x10123d208);
            (*pcVar6)();
          }
          uVar10 = *puVar17;
          puVar16[1] = puVar17[1];
      ...
      if (puVar14 != (undefined *)0x8000000000000000) {
        *param_1 = puVar14;
        ...
        if (pbVar9 == pbVar8) goto LAB_10123d0ec;
