...
void FUN_1017b4060(ulong *param_1)
...
LAB_1017b4184:
    ...
    if ((uVar7 >> 1 & 1) != 0) goto LAB_1017b416c;
    if ((uVar7 >> 3 & 1) == 0) {
      auStack_cf8[0] = 2;
      FUN_1017b3894(param_1 + 4,auStack_cf8);
LAB_1017b40f0:
      puStack_60 = param_1;
    ...
    if ((uVar7 >> 4 & 1) == 0) goto LAB_1017b40f0;
    if (param_1[0x199] != 0) {
      (**(code **)(param_1[0x199] + 0x10))(param_1[0x19a]);
      LOAcquire();
      uVar2 = *param_1;
      *param_1 = uVar2 & 0xffffffffffffffef;
      ...
      if ((uVar7 >> 1 & 1) == 0) {
        ...
        if ((uVar7 >> 4 & 1) != 0) {
          if ((uVar7 >> 3 & 1) == 0) {
            if (param_1[0x199] != 0) {
              (**(code **)(param_1[0x199] + 0x18))(param_1[0x19a]);
            }
            param_1[0x199] = 0;
          }
          goto LAB_1017b40f0;
...
LAB_1017b4204:
  ...
  pcVar1 = (code *)SoftwareBreakpoint(1,0x1017b4208);
  (*pcVar1)();
}
