...
undefined8 FUN_1008989a4(undefined8 param_1)
...
LAB_100898ff4:
    ...
    pcVar9 = (code *)SoftwareBreakpoint(1,0x100898ff8);
    (*pcVar9)();
  }
  plVar13[1] = 1;
  *plVar13 = 1;
  ...
  *(undefined1 *)(plVar13 + 7) = 0;
  lVar10 = *plVar13;
  *plVar13 = lVar10 + 1;
  if (lVar10 < 0) goto LAB_100898ff4;
      ...
      if ((___ZN12tracing_core8metadata9MAX_LEVEL17h02c7742de62f64c3E < 4) &&
        ...
        if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
          ...
          *(undefined8 *)(unaff_x29 + -0xd8) = uVar7;
          ...
          if (iVar12 != 0) {
            lVar10 = *(long *)(lVar18 + 0x60);
            uVar7 = *(undefined8 *)(lVar18 + 0x68);
            lVar6 = *(long *)(lVar18 + 0x50);
            uVar8 = *(undefined8 *)(lVar18 + 0x58);
            uVar15 = 1;
            if (lVar6 == 0) {
              uVar15 = 2;
            }
        ...
        if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
          ...
          *(undefined8 *)(unaff_x29 + -0xf0) = uVar7;
          ...
          if (iVar12 != 0) {
            lVar10 = ___ZN16codex_app_server16outgoing_message21OutgoingMessageSender47send_server_notification_to_connection_and_wait28__u7b__u7b_closure_u7d__u7d_10__CALLSITE17h1fd5be597309d3aaE
                     + 0x30;
