...
/* WARNING: Removing unreachable block (ram,0x00010140d940) */
/* WARNING: Type propagation algorithm not settling */

void FUN_10140d2fc(undefined1 *param_1,char *param_2)
...
LAB_10140d974:
              ...
              pcStack_138 = (char *)__ZN66__LT_serde_json__error__Error_u20_as_u20_serde_core__de__Error_GT_13invalid_value17h60b1f9f2e2975d54E
                                              (&cStack_a0,&UNK_10b22e148,&UNK_10b20a590);
              goto LAB_10140d998;
            }
LAB_10140d574:
            uVar9 = 2;
...
LAB_10140d724:
        ...
        else if (uStack_e0._1_1_ == 4) {
LAB_10140d710:
          uVar9 = 4;
        }
        else {
          if (uStack_e0._1_1_ != 5) goto LAB_10140d974;
LAB_10140d6a0:
          uVar9 = 5;
        }
        uVar8 = 0;
...
LAB_10140d730:
      ...
      if ((byte)uStack_e0 == 4) {
        if (lStack_118 < 3) {
          if (lStack_118 == 0) goto LAB_10140d71c;
          if (lStack_118 == 1) goto LAB_10140d704;
          if (lStack_118 == 2) goto LAB_10140d574;
        }
        else {
          if (lStack_118 == 3) goto LAB_10140d724;
          if (lStack_118 == 4) goto LAB_10140d710;
          if (lStack_118 == 5) goto LAB_10140d6a0;
        }
...
LAB_10140d998:
      ...
      if ((byte)uStack_e0 == 0xc) {
        FUN_100b1f2e0(&uStack_140,pcStack_110,lStack_108);
        goto LAB_10140d4b0;
      }
LAB_10140d914:
      pcStack_138 = (char *)FUN_108855b04(&uStack_e0,&uStack_51,&UNK_10b20e500);
...
LAB_10140d748:
      ...
      if ((byte)uStack_e0 == 0xd) {
        FUN_100b1f2e0(&uStack_140,lStack_118,pcStack_110);
LAB_10140d734:
...
LAB_10140d73c:
        ...
        if ((byte)uStack_e0 != 0xe) {
          if ((byte)uStack_e0 != 0xf) goto LAB_10140d914;
          FUN_100b1ef70(&uStack_140,lStack_118,pcStack_110);
          goto LAB_10140d734;
        }
        FUN_100b1ef70(&uStack_140,pcStack_110,lStack_108);
LAB_10140d4b0:
        pcVar10 = pcVar7;
        unaff_x25 = lVar11;
        if (lVar11 == 0) goto LAB_10140d73c;
        _free(pcVar7);
        pcVar10 = uStack_140;
        lVar6 = lStack_88;
        lStack_88 = lStack_68;
      ...
      if (uStack_140._1_1_ < 3) {
        if (uStack_140._1_1_ == 0) {
          if (uVar1 == 0x16) {
            ...
            goto joined_r0x00010140d640;
          }
          if ((uVar1 == 0x12) || ((uVar1 == 0x15 && (lStack_88 == 0)))) goto LAB_10140d8bc;
...
LAB_10140d590:
      ...
      cVar2 = *uStack_140;
      pcStack_138 = pcVar10;
      if (cVar2 == '\x16') goto LAB_10140d590;
...
LAB_10140d3b4:
      ...
      if ((byte)uStack_e0 == '\x16') goto LAB_10140d3b4;
      FUN_100e077ec(&uStack_e0);
