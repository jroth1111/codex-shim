...

{
  ...
  lVar1 = thunk_FUN_108856088(s_duplicate_field_____108ac2973,&stack0x00000020);
  *unaff_x19 = -0x7fffffffffffffff;
  ...
  if (*unaff_x19 != -0x7fffffffffffffff) {
    ...
    if (unaff_x22 - in_stack_00000008 == 0) {
      ...
      *unaff_x19 = in_stack_00000020;
      ...
      lVar1 = thunk_FUN_1087e422c(unaff_x25 + ((ulong)(unaff_x22 - in_stack_00000008) >> 6),
