...
LAB_101621d1c:
    ...
    *(undefined1 *)((long)param_2 + 0x2c95) = 0;
    __ZN9codex_api8endpoint19responses_websocket28ResponsesWebsocketConnection3new17h2790581a3980c500E
              (&lStack_120,&lStack_1b0,uVar12,uVar1,bVar20 & 1,&lStack_298,&uStack_280,param_2[0x1a]
               ,param_2[0x1b]);
    lVar17 = lStack_d0;
    bVar20 = bStack_ee;
    uVar3 = uStack_f0;
