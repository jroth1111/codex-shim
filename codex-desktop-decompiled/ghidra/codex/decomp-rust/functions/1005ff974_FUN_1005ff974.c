...
undefined1  [16] FUN_1005ff974(void)

{
  ...
  __ZN5alloc3fmt6format12format_inner17h63985d1d6aa0fe33E
            (&stack0x00001b00,s_>dynamic_tool_calls_are_not_supp_108ac24f3,&stack0x00002110);
  ...
  *in_stack_00000068 = '\0';
  ...
  if (in_stack_00001b00 != (char *)0x8000000000000001) {
    ...
    FUN_100e65854(unaff_x19 + 0x5f68);
...
LAB_100600dac:
    ...
    uVar15 = (uint)uVar14;
    uVar11 = (uint)(uVar14 >> 0x10) & 0xffff ^ uVar11 >> 7 ^ uVar15 ^ uVar11;
    *(undefined4 *)(lVar13 + 0x38) = 1;
    *(uint *)(lVar13 + 0x3c) = uVar15;
...
LAB_1005fe738:
      ...
      *(undefined1 *)(unaff_x19 + 0x5990) = uVar16;
...
LAB_1005fcc6c:
        ...
        *(undefined1 *)(unaff_x27 + 0xb7c) = 0;
        ...
        if (uVar14 != 0) {
          ...
          if ((uVar14 & 3) == 1) {
            uVar24 = *(undefined8 *)(uVar14 - 1);
            puVar18 = *(undefined8 **)(uVar14 + 7);
            pcVar8 = (code *)*puVar18;
            if (pcVar8 != (code *)0x0) {
              (*pcVar8)(uVar24);
            }
...
LAB_100601058:
      ...
      if (lVar22 == 2) {
        ...
        *(undefined1 *)(unaff_x27 + 0xb16) = 1;
        ...
        uVar14 = uVar23 ^ 0x8000000000000000;
        if (-1 < (long)uVar23) {
          uVar14 = 1;
        }
        if (uVar14 == 0) {
...
LAB_100600540:
        ...
        *(long *)(unaff_x19 + 0x6260) = lVar22;
        plVar17 = (long *)(unaff_x19 + 0x4f58);
        *(long **)(unaff_x19 + 0x6268) = plVar17;
...
LAB_1006007e0:
        ...
        if ((uVar14 & 1) != 0) {
          ...
          *(undefined1 *)(unaff_x27 + 0xb16) = 0;
          ...
          uVar14 = (**(code **)(unaff_x22 + 0x20))(uVar24,&stack0x00001b00);
          if ((uVar14 & 1) != 0) {
...
LAB_1005fea88:
  ...
  *(undefined1 *)(unaff_x27 + 0xe99) = 7;
  uVar16 = 0xd;
LAB_1006004cc:
  *(undefined1 *)(unaff_x27 + 0xb09) = uVar16;
  uVar24 = 1;
LAB_1006004d4:
