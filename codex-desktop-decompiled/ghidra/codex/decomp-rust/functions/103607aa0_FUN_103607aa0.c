...
undefined8 * FUN_103607aa0(long *param_1,long *param_2)
                                ...
                                if (pbVar18 == (byte *)0x0) {
                                  ...
                                  if ((byte *)0x7 < pbVar18) {
                                    ...
                                    if (pbVar16 != (byte *)0x8) {
                                      ...
                                      uVar15 = uVar15 + (-(-0x41 < (char)((ulong)uVar11 >> 0x30)) &
                                                        1);
                                      uVar21 = uVar21 + (-(-0x41 < (char)((ulong)uVar11 >> 0x38)) &
                                                        1);
                                      uVar23 = uVar23 + (-(-0x41 < (char)((ulong)uVar11 >> 0x20)) &
                                                        1);
                                      uVar24 = uVar24 + (-(-0x41 < (char)((ulong)uVar11 >> 0x28)) &
                                                        1);
                                      uVar25 = uVar25 + (-(-0x41 < (char)((ulong)uVar11 >> 0x10)) &
                                                        1);
                                      uVar26 = uVar26 + (-(-0x41 < (char)((ulong)uVar11 >> 0x18)) &
                                                        1);
...
LAB_1055b9000:
                    ...
                    /* WARNING: Treating indirect jump as call */
                          puVar10 = (undefined8 *)
                                    (**(code **)(puVar10[1] + 0x18))(*puVar10,pbVar5,pbVar18);
                          return puVar10;
                        }
                        ...
                        *plVar12 = 0;
                        ...
                        puVar10 = (undefined8 *)FUN_1035cfdb4(plVar12,plVar14 + 3);
                        if (*plVar12 == 2) {
                          if (lVar4 != 0) goto code_r0x000108aa97c4;
                        }
                        else {
                          plStack_388 = (long *)plVar12[7];
                          lStack_390 = plVar12[6];
                          lStack_378 = plVar12[9];
                          lVar22 = plVar12[8];
                          lStack_3a8 = plVar12[3];
                          lStack_3b0 = plVar12[2];
                          lStack_398 = plVar12[5];
                          lStack_3a0 = plVar12[4];
                          lStack_370 = plVar12[10];
                          lStack_3b8 = plVar12[1];
                          lStack_3c0 = *plVar12;
                          lStack_380 = lVar22;
                          if (lVar22 == lStack_390) {
                            puVar10 = (undefined8 *)
                          ...
                          if (lVar22 != 0) {
                            puVar10 = (undefined8 *)
                                      _memmove(plStack_388 + 3,plStack_388,lVar22 * 0x18);
                          }
                          *plVar14 = lVar4;
                          plVar14[1] = lVar13;
                          plVar14[2] = lVar19;
                          plVar12[5] = lStack_398;
                          plVar12[4] = lStack_3a0;
                          plVar12[7] = (long)plStack_388;
                          plVar12[6] = lStack_390;
                          plVar12[10] = lStack_370;
                          plVar12[1] = lStack_3b8;
                          *plVar12 = lStack_3c0;
                          plVar12[3] = lStack_3a8;
                          plVar12[2] = lStack_3b0;
                          plVar12[9] = lStack_378;
                          plVar12[8] = lVar22 + 1;
                        }
                      }
                      return puVar10;
                    ...
                    *plVar12 = 0;
                    ...
                    puVar10 = (undefined8 *)FUN_1035bae04(plVar12,plVar14 + 3);
                    if (*plVar12 == 2) {
                      if (lVar4 != 0) goto code_r0x000108aa97c4;
                    }
                    else {
                      plStack_2e8 = (long *)plVar12[7];
                      lStack_2f0 = plVar12[6];
                      lStack_2d8 = plVar12[9];
                      lVar22 = plVar12[8];
                      lStack_308 = plVar12[3];
                      lStack_310 = plVar12[2];
                      lStack_2f8 = plVar12[5];
                      lStack_300 = plVar12[4];
                      lStack_2d0 = plVar12[10];
                      lStack_318 = plVar12[1];
                      lStack_320 = *plVar12;
                      lStack_2e0 = lVar22;
                      if (lVar22 == lStack_2f0) {
                        puVar10 = (undefined8 *)
                                  __ZN5alloc7raw_vec19RawVec_LT_T_C_A_GT_8grow_one17h04f561b8f2dea13fE
                                            (&lStack_2f0);
                      }
                      plVar14 = plStack_2e8;
                      if (lVar22 != 0) {
                        puVar10 = (undefined8 *)_memmove(plStack_2e8 + 3,plStack_2e8,lVar22 * 0x18);
                      }
                      *plVar14 = lVar4;
                      plVar14[1] = lVar13;
                      plVar14[2] = lVar19;
                      plVar12[5] = lStack_2f8;
                      plVar12[4] = lStack_300;
                      plVar12[7] = (long)plStack_2e8;
                      plVar12[6] = lStack_2f0;
                      plVar12[10] = lStack_2d0;
                      plVar12[1] = lStack_318;
                      *plVar12 = lStack_320;
                      plVar12[3] = lStack_308;
                      plVar12[2] = lStack_310;
                      plVar12[9] = lStack_2d8;
                      plVar12[8] = lVar22 + 1;
                    }
                  }
                  return puVar10;
                ...
                *plVar12 = 0;
                ...
                puVar10 = (undefined8 *)FUN_102f530b0(plVar12,plVar14 + 3);
                if (*plVar12 == 2) {
                  if (lVar4 != 0) goto code_r0x000108aa97c4;
                }
                else {
            ...
            *plVar12 = 0;
            ...
            puVar10 = (undefined8 *)FUN_1035d4ab0(plVar12,plVar14 + 3);
            if (*plVar12 == 2) {
              if (lVar4 != 0) goto code_r0x000108aa97c4;
            }
            else {
        ...
        *plVar12 = 0;
        ...
        puVar10 = (undefined8 *)func_0x000102f4eccc(plVar12,plVar14 + 3);
        if (*plVar12 == 2) {
          if (lVar4 != 0) goto code_r0x000108aa97c4;
        }
        else {
    ...
    *param_1 = 0;
    ...
    puVar10 = (undefined8 *)FUN_1035dd020(param_1,param_2 + 3);
    if (*param_1 == 2) {
      if (lVar4 != 0) {
