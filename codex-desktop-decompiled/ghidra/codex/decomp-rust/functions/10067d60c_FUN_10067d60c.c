...

{
  ...
  *in_stack_00000180 = -0x8000000000000000;
  ...
  FUN_100ca086c(unaff_x29 + -0xd0);
  FUN_100e1ad68(unaff_x29 + -0xf0);
  if (in_stack_00000488 != 0) {
    _free(in_stack_00000490);
  }
  FUN_100c99aa0(&stack0x00000470);
  ...
  if (unaff_x24 != 0x8000000000000001) {
    iVar2 = in_stack_000000e0;
  }
  if ((iVar2 == 1) && ((unaff_x24 & 0x7fffffffffffffff) != 0)) {
    _free(in_stack_00000058);
  }
  if ((in_stack_000003f8 != -0x8000000000000000) && ((unaff_x20 & 1) != 0)) {
  ...
  if ((in_stack_000003e0 != -0x8000000000000000 & in_stack_00000138) != 0) {
  ...
  if (((in_stack_00000168 & 0x7fffffffffffffff) != 0 & in_stack_000000f8) != 0) {
