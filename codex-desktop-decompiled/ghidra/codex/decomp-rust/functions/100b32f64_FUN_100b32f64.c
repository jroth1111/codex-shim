...
void FUN_100b32f64(undefined2 *param_1,long *param_2,long param_3)

{
  ...
  if (param_3 < 7) {
    ...
    if (*param_2 == 0x6c69665f7473696c && (short)param_2[1] == 0x7365) {
  ...
  uVar1 = FUN_1087e4494(param_2,param_3,&UNK_10b22e7e8,4);
