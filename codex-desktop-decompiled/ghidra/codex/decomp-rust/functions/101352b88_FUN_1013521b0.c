...
/* WARNING: Removing unreachable block (ram,0x000101352a58) */

void FUN_1013521b0(ulong *param_1,char *param_2)
...
LAB_101352ea0:
        ...
        pcVar7 = (code *)SoftwareBreakpoint(1,0x101352ea4);
        (*pcVar7)();
      }
      lVar28 = 0;
                  ...
                  if (bVar4 == 1) {
                    ...
                    if (bVar4 != 4) {
                      if (bVar4 == 0xc) {
                        if (lStack_70 == 9) {
                          iVar14 = 1;
                          if (*plStack_78 != 0x496e75526b6f6f68 || (char)plStack_78[1] != 'd') {
                            iVar14 = 2;
                          }
                        }
                        else if (lStack_70 == 4) {
                          iVar14 = 2;
                          if ((int)*plStack_78 == 0x74786574) {
                            iVar14 = 0;
                          }
                        }
                        else {
                        ...
                        goto joined_r0x000101352584;
                      }
LAB_101352bf8:
                      ppuStack_b0 = (undefined **)((long)ppuVar29 + 1);
                      pbStack_c8 = pbVar26;
                      pbVar9 = (byte *)FUN_108855b04(&uStack_88,&puStack_a0,&UNK_10b20f120);
                      goto joined_r0x000101352a1c;
                    }
                    iVar15 = 1;
...
LAB_10135263c:
                  ...
                  if (bVar4 == 0xd) {
                    if (plStack_78 == (long *)0x9) {
                      iVar14 = 1;
                      if (*plStack_80 != 0x496e75526b6f6f68 || (char)plStack_80[1] != 'd') {
                        iVar14 = 2;
                      }
                    }
                    else {
                      if (plStack_78 != (long *)0x4) goto LAB_101352600;
                      iVar14 = 2;
                      if ((int)*plStack_80 == 0x74786574) {
                        iVar14 = 0;
                      }
                    }
                    goto LAB_10135263c;
                  ...
                  if (bVar4 != 0xe) {
                    if (bVar4 != 0xf) goto LAB_101352bf8;
                    if (plStack_78 == (long *)0x9) {
                      if (((((((char)*plStack_80 != 'h') || (*(char *)((long)plStack_80 + 1) != 'o')
                             ) || (*(char *)((long)plStack_80 + 2) != 'o')) ||
                           ((*(char *)((long)plStack_80 + 3) != 'k' ||
                            (*(char *)((long)plStack_80 + 4) != 'R')))) ||
                          (*(char *)((long)plStack_80 + 5) != 'u')) ||
                         (((*(char *)((long)plStack_80 + 6) != 'n' ||
                           (*(char *)((long)plStack_80 + 7) != 'I')) || ((char)plStack_80[1] != 'd')
                          ))) goto LAB_101352600;
                      iVar14 = 1;
                    }
                    else if ((((plStack_78 == (long *)0x4) && ((char)*plStack_80 == 't')) &&
                             (*(char *)((long)plStack_80 + 1) == 'e')) &&
                            ((*(char *)((long)plStack_80 + 2) == 'x' &&
                             (*(char *)((long)plStack_80 + 3) == 't')))) {
                      iVar14 = 0;
                    }
                    else {
LAB_101352600:
                  ...
                  if (lStack_70 == 9) {
                    if (((((char)*plStack_78 != 'h') || (*(char *)((long)plStack_78 + 1) != 'o')) ||
                        ((*(char *)((long)plStack_78 + 2) != 'o' ||
                         (((*(char *)((long)plStack_78 + 3) != 'k' ||
                           (*(char *)((long)plStack_78 + 4) != 'R')) ||
                          (*(char *)((long)plStack_78 + 5) != 'u')))))) ||
                       (((*(char *)((long)plStack_78 + 6) != 'n' ||
                         (*(char *)((long)plStack_78 + 7) != 'I')) || ((char)plStack_78[1] != 'd')))
                       ) goto LAB_101352544;
                    iVar14 = 1;
                  }
                  else if (((lStack_70 == 4) && ((char)*plStack_78 == 't')) &&
                          ((*(char *)((long)plStack_78 + 1) == 'e' &&
                           ((*(char *)((long)plStack_78 + 2) == 'x' &&
                            (*(char *)((long)plStack_78 + 3) == 't')))))) {
                    iVar14 = 0;
                  }
                  else {
LAB_101352544:
...
joined_r0x000101352584:
                ...
                if (iVar14 == 0) {
                  ...
                  *(undefined8 *)((long)puVar19 + 0xf) = uVar33;
                  ...
                  if (puVar32 != (undefined *)0x8000000000000000) {
                    ppuStack_b0 = (undefined **)((long)ppuVar29 + 1);
                    puStack_a0 = &UNK_108cae1a7;
                    pbStack_98 = (byte *)0x9;
                    uStack_88 = &puStack_a0;
                    plStack_80 = (long *)&DAT_100c7b3a0;
                    pbStack_c8 = pbVar26;
                    pbVar9 = (byte *)FUN_108856088(s_duplicate_field_____108ac2973,&uStack_88);
                    goto joined_r0x000101352ba4;
                  }
                  pbStack_f0 = (byte *)CONCAT71(pbStack_f0._1_7_,0x16);
                  if (cVar3 == '\x16') {
                    ppuStack_b0 = (undefined **)((long)ppuVar29 + 1);
              ...
              if (puVar25 == (undefined *)0x8000000000000000) goto LAB_1013528e8;
              if (puVar32 == (undefined *)0x8000000000000000) {
                puStack_a0 = &UNK_108cae1a7;
                pbStack_98 = (byte *)0x9;
                uStack_88 = &puStack_a0;
          ...
          pbVar9 = (byte *)FUN_108855b04(acStack_110,&puStack_a0,&UNK_10b20bbc0);
LAB_101352db8:
          uVar18 = uStack_180;
...
LAB_101352798:
          pbStack_e8 = pbVar30;
          pbVar8 = (byte *)FUN_1087e422c(0,&UNK_10b22cb30,&UNK_10b20a590);
LAB_1013527b4:
          puStack_140 = (undefined *)0x8000000000000000;
          pbStack_138 = pbVar8;
LAB_1013527c0:
          ...
          bVar4 = *pbStack_100;
          if (bVar4 == 0x16) goto LAB_101352798;
          ...
          *(undefined8 *)((long)puVar19 + 0xf) = uVar33;
          ...
          puVar25 = puStack_a0;
          pbVar8 = pbStack_98;
          if (puStack_a0 == (undefined *)0x8000000000000000) goto LAB_1013527b4;
          if (lVar17 == 1) {
LAB_10135288c:
...
LAB_1013528a8:
          ...
          bVar4 = pbVar1[0x20];
          pbStack_e8 = pbVar30;
          if (bVar4 == 0x16) goto LAB_10135288c;
          ...
          *(undefined8 *)((long)puVar19 + 0xf) = uVar33;
          ...
          puVar32 = puStack_a0;
          pbVar8 = pbStack_98;
          if (puStack_a0 == (undefined *)0x8000000000000000) goto LAB_1013528a8;
          puStack_140 = puVar25;
          pbStack_138 = pbVar9;
          pbStack_130 = pbVar5;
          ...
          if (pbVar8 == (byte *)0x0) goto LAB_101352a60;
          puStack_140 = (undefined *)0x8000000000000000;
          pbStack_138 = pbVar8;
          if (puVar25 != (undefined *)0x0) {
            _free(pbVar9);
...
LAB_101352a60:
        uVar18 = uStack_178;
        if (puVar25 == (undefined *)0x8000000000000000) goto LAB_101352db8;
        ...
        if (uStack_178 == uStack_188) {
          func_0x0001089bea98(&uStack_188);
        }
...
LAB_101352e14:
    ...
    uVar18 = FUN_108855b04(param_2,&puStack_a0,&UNK_10b20a0c0);
    *param_1 = 0x8000000000000000;
    param_1[1] = uVar18;
  }
  return;
