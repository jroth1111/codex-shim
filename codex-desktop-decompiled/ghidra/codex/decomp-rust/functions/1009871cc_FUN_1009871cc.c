...
undefined8 FUN_1009871cc(long param_1)

{
  ...
  lStack00000000000001c8 = param_1 + 0x30;
  *(char **)(unaff_x29 + -0x90) = s_request_failed__108ac9ce2;
  *(long *)(unaff_x29 + -0x88) = unaff_x29 + -0xd0;
  *(undefined8 *)(unaff_x29 + -0x70) = in_x9;
  *(undefined **)(unaff_x29 + -0x68) = &UNK_10b208fd0;
  lStack00000000000001b8 = unaff_x29 + -0x70;
  lStack00000000000001b0 = 1;
  uStack00000000000001c0 = 1;
  *(undefined8 *)(unaff_x28 + 0x88) = in_stack_00000120;
  *(undefined8 *)(unaff_x28 + 0x80) = in_stack_00000118;
  uStack0000000000000140 = in_stack_00000128;
  ...
  *(undefined1 *)(unaff_x19 + 0xed8) = 0;
  ...
  uVar15 = *(undefined8 *)(unaff_x27 + 0x60);
  uVar11 = *(undefined8 *)(unaff_x27 + 0x58);
  uVar22 = *(undefined8 *)(unaff_x27 + 0x70);
  uVar19 = *(undefined8 *)(unaff_x27 + 0x68);
  uVar16 = *(undefined8 *)(unaff_x27 + 0x80);
  uVar12 = *(undefined8 *)(unaff_x27 + 0x78);
  uVar23 = *(undefined8 *)(unaff_x27 + 0x90);
  uVar20 = *(undefined8 *)(unaff_x27 + 0x88);
  uVar17 = *(undefined8 *)(unaff_x27 + 0x20);
  uVar13 = *(undefined8 *)(unaff_x27 + 0x18);
  uVar24 = *(undefined8 *)(unaff_x27 + 0x30);
  uStack0000000000000140 = *(undefined8 *)(unaff_x27 + 0x28);
  uVar18 = *(undefined8 *)(unaff_x27 + 0x40);
  uVar14 = *(undefined8 *)(unaff_x27 + 0x38);
  uVar25 = *(undefined8 *)(unaff_x27 + 0x50);
  uVar21 = *(undefined8 *)(unaff_x27 + 0x48);
...
LAB_100987710:
  ...
  if (lVar1 == unaff_x26 + 0x1b) {
    ...
    *(undefined8 *)(unaff_x27 + 0x60) = uVar15;
    *(undefined8 *)(unaff_x27 + 0x58) = uVar11;
    *(undefined8 *)(unaff_x27 + 0x70) = uVar22;
    *(undefined8 *)(unaff_x27 + 0x68) = uVar19;
    *(undefined8 *)(unaff_x27 + 0x80) = uVar16;
    *(undefined8 *)(unaff_x27 + 0x78) = uVar12;
    *(undefined8 *)(unaff_x27 + 0x90) = uVar23;
    *(undefined8 *)(unaff_x27 + 0x88) = uVar20;
    *(undefined8 *)(unaff_x27 + 0x20) = uVar17;
    *(undefined8 *)(unaff_x27 + 0x18) = uVar13;
    *(undefined8 *)(unaff_x27 + 0x30) = uVar24;
    *(undefined8 *)(unaff_x27 + 0x28) = uStack0000000000000140;
    *(undefined8 *)(unaff_x27 + 0x40) = uVar18;
    *(undefined8 *)(unaff_x27 + 0x38) = uVar14;
    *(undefined8 *)(unaff_x27 + 0x50) = uVar25;
    *(undefined8 *)(unaff_x27 + 0x48) = uVar21;
    lStack00000000000001b0 = lVar1;
    lStack00000000000001b8 = lVar4;
