...
bool FUN_1002c6624(long *param_1,undefined8 param_2,long *param_3,long *param_4)

{
  ...
  if (*param_1 != 1) {
    ...
    if (uVar17 == 0) {
      *(undefined2 *)(param_1 + 0xb) = 7;
      ...
      if (uVar16 >> 0xf == 0) {
        ...
        puVar7[1] = uStack_f0;
        *puVar7 = 0;
        puVar7[0xc] = CONCAT62(uStack_96,(short)((unkuint10)Var29 >> 0x40));
        puVar7[9] = lVar23;
        puVar7[8] = lVar21;
        puVar7[0xb] = lVar27;
        puVar7[10] = lVar25;
    ...
    uVar16 = FUN_1002c6c9c(param_1,uVar16 << 1);
joined_r0x0001002c66fc:
    if ((uVar16 & 1) == 0) {
      return false;
    }
    return true;
  ...
  if (pauVar6[1][0] == '\x01') {
    ...
    *(long *)(*pauVar6 + 8) = auVar30._8_8_;
    pauVar6[1][0] = 1;
  }
  *(long *)*pauVar6 = auVar30._0_8_ + 1;
  *param_1 = 2;
  *(undefined1 (*) [16])(param_1 + 1) = auVar30;
  puVar15 = (undefined4 *)param_1[9];
  if (uVar16 == 0) goto LAB_1002c6814;
  uVar12 = uVar16 * 4 - 4;
  puVar10 = puVar15;
  if (0xb < uVar12) {
    uVar9 = (uVar12 >> 2) + 1;
    if (uVar12 < 0x7c) {
      ...
      if (uVar9 == uVar13) goto LAB_1002c6814;
      if ((uVar9 & 0x1c) == 0) {
    ...
    if (uVar9 == uVar12) goto LAB_1002c6814;
  }
LAB_1002c6800:
  do {
    puVar11 = puVar10 + 1;
...
LAB_1002c6814:
  ...
  do {
    lVar21 = lVar14 + 0x68;
    uVar5 = FUN_1002c5bd0(param_1,lVar14 + 0x40);
    uVar12 = 0;
