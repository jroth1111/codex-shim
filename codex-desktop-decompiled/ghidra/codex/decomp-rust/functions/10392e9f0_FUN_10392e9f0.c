...
void FUN_10392e9f0(long *param_1)
  ...
  if (lVar2 != 0) {
    ...
    if (lVar3 != 0) {
      ...
      do {
        ...
        if (plVar4[uVar1 * -2 + -0x10] != 0) {
          _free(plVar4[uVar1 * -2 + -0xf]);
        }
        uVar6 = uVar6 - 1 & uVar6;
        lVar3 = lVar3 + -1;
        FUN_10393ce9c(plVar4 + uVar1 * -2 + -0xd);
      } while (lVar3 != 0);
    }
    if (lVar2 * 0x81 != -0x89) {
                    /* WARNING: Could not recover jumptable at 0x000108aa97cc. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      (*(code *)PTR__free_10b61b0a8)(*param_1 + lVar2 * -0x80 + -0x80);
      return;
    }
  }
  return;
