...
void FUN_103e584e0(long param_1,undefined8 param_2)
...
joined_r0x000103e585ac:
  if (iVar1 == 1) {
    ...
    func_0x000103daa834(param_1 + 0x18);
  }
  _memcpy(param_1 + 0x10,param_2,0x1568);
  if (*(char *)(lVar2 + 0x48) != '\x01') {
    if (*(char *)(lVar2 + 0x48) == '\x02') {
      return;
    }
