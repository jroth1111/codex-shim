...
void __ZN5alloc7raw_vec19RawVec_LT_T_C_A_GT_8grow_one17h1c99c75495cd9934E(long *param_1)

{
  ...
  lVar6 = 8;
  uVar7 = 0;
  if ((SUB168(ZEXT816(0x98) * auVar3,8) == 0) && (uVar5 = uVar5 * 0x98, uVar5 < 0x7ffffffffffffff9))
  {
    if (lVar1 == 0) {
      if (uVar5 != 0) {
        if (uVar5 < 8) {
      ...
      if (iVar4 == 0 && lStack_88 != 0) {
        _memcpy(lStack_88,lVar2,lVar1 * 0x98);
        _free(lVar2);
      }
    }
    else {
