...

{
  ...
  uVar3 = thunk_FUN_108856088(s_missing_field_____108ac28f7,&stack0x00000520);
  *unaff_x25 = 0x8000000000000000;
  ...
  if (in_stack_00000440 != unaff_x28 + 8) {
    lVar4 = unaff_x28 + in_stack_00000440 + -0xb;
    ...
    else if ((lVar4 == 4) && (in_stack_00000448 != 0)) {
  ...
  if (*in_stack_00000150 == -0x8000000000000000) {
    ...
    if (in_stack_00000220 != in_stack_00000210) {
      lVar4 = thunk_FUN_1087e422c(in_stack_000000e0,&UNK_10b21cb90,&UNK_10b20a590);
      *in_stack_00000150 = -0x8000000000000000;
      in_stack_00000150[1] = lVar4;
