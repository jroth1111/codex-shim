...
LAB_1013321a0:
          ...
          if (bVar5 == 0xe) {
            FUN_100bb1914(&bStack_b0,plVar10);
joined_r0x00010133244c:
            if (plVar3 != (long *)0x0) {
              _free(plVar10);
            }
          ...
          FUN_100bb1914(&bStack_b0,plVar3,plVar10);
LAB_1013321ac:
...
LAB_101332404:
            ...
            if (bVar5 != 0x11) {
              ...
              FUN_10140d2fc(&uStack_c0,&bStack_b0);
              goto LAB_101332404;
            }
            ...
            FUN_10140d2fc(&uStack_c0,&bStack_90);
            _free(puVar7);
            uVar14 = uStack_c0;
          }
...
LAB_1013328a4:
      ...
      lVar17 = FUN_10140d2fc(&uStack_c0,&bStack_b0);
    }
