...

{
  ...
  lVar2 = thunk_FUN_108856088(s_missing_field_____108ac28f7,unaff_x29 + -0xf0);
  *unaff_x20 = -0x8000000000000000;
  ...
  if (in_stack_00000278 != -0x8000000000000000) {
    if (in_stack_00000288 != 0) {
      puVar4 = (undefined8 *)(in_stack_00000280 + 0x10);
      do {
        if (puVar4[-1] != 0) {
          _free(*puVar4);
        }
  ...
  if (*unaff_x20 == -0x8000000000000000) {
    ...
    lVar7 = unaff_x20[0x19];
    lVar5 = unaff_x20[0x18];
    lVar10 = unaff_x20[0x1b];
    lVar9 = unaff_x20[0x1a];
    lVar8 = unaff_x20[0x1d];
    lVar6 = unaff_x20[0x1c];
    ...
    if (unaff_x28 == unaff_x21) {
      ...
      *(long *)(unaff_x29 + -0xf0) = unaff_x27;
      lVar3 = thunk_FUN_1087e422c(((ulong)(unaff_x28 - unaff_x21) >> 6) + unaff_x27,
    ...
    if (lVar3 == 0) {
      ...
      unaff_x20[0x18] = lVar5;
      unaff_x20[0x1b] = lVar10;
      unaff_x20[0x1a] = lVar9;
      unaff_x20[0x1d] = lVar8;
      unaff_x20[0x1c] = lVar6;
      unaff_x20[0x1e] = lVar2;
