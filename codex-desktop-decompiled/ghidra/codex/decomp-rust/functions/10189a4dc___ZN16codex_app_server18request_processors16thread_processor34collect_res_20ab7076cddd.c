...
LAB_10189a000:
      ...
      uVar12 = FUN_1019a7450(&uStack_f0,&ppplStack_b0);
      if ((uVar12 & 1) == 0) {
...
LAB_10189a2b4:
              ...
              ppplStack_a0 = (long ***)CONCAT71(ppplStack_a0._1_7_,6);
              uStack_78 = 0x201;
              uVar8 = FUN_1019a7450(&uStack_f0,&ppplStack_b0);
...
LAB_10189a52c:
    ...
    if (*(char *)(param_2 + 0x13b) != '\x03') {
      ...
      __ZN10codex_core12codex_thread20ThreadConfigSnapshot14sandbox_policy17h0b4046ceb6115857E
                (&uStack_f0,param_3);
