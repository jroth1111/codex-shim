...

{
  ...
  __ZN5alloc3fmt6format12format_inner17h63985d1d6aa0fe33E
            (&stack0x00000050,s__Failed_to_read_project_hooks_co_108ac5cbf,unaff_x29 + -0xd0);
  in_stack_00000198 = in_stack_00000058;
  in_stack_00000190 = in_stack_00000050;
  in_stack_000001a0 = in_stack_00000060;
  uVar1 = __ZN3std2io5error5Error3new17h002dced88496ea8bE(unaff_w21,&stack0x00000190);
  if ((in_stack_000000d0 & 3) == 1) {
    puVar3 = (undefined8 *)(in_stack_000000d0 - 1);
    uVar4 = *puVar3;
    puVar5 = *(undefined8 **)(in_stack_000000d0 + 7);
    pcVar2 = (code *)*puVar5;
    if (pcVar2 != (code *)0x0) {
      (*pcVar2)(uVar4);
    }
