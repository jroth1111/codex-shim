...
void FUN_1012b1988(undefined8 *param_1,byte *param_2)
...
LAB_1012b1e3c:
      pbStack_e8 = pbVar14;
      pbVar17 = (byte *)FUN_1087e422c(0,&UNK_10b2328d0,&UNK_10b20a590);
LAB_1012b1e58:
...
LAB_1012b1e60:
      ...
      if (*pbVar18 == 0x16) goto LAB_1012b1e3c;
      ...
      pbVar17 = pbStack_98;
      puVar15 = puStack_a0;
      if (puStack_a0 == (undefined *)0x8000000000000000) goto LAB_1012b1e58;
      if (lVar12 == 1) {
LAB_1012b1f00:
        pbVar8 = (byte *)FUN_1087e422c(1,&UNK_10b2328d0,&UNK_10b20a590);
LAB_1012b1f18:
        *param_1 = 0x8000000000000000;
        param_1[1] = pbVar8;
      ...
      pbStack_e8 = pbVar14;
      if (pbVar18[0x20] == 0x16) goto LAB_1012b1f00;
      ...
      pbVar8 = pbStack_98;
      puVar6 = puStack_a0;
      if (puStack_a0 == (undefined *)0x8000000000000000) goto LAB_1012b1f18;
      *param_1 = puVar15;
      param_1[1] = pbVar17;
      param_1[2] = uVar9;
      ...
      if (lVar12 == 0) goto LAB_1012b20fc;
      *param_1 = 0x8000000000000000;
      param_1[1] = lVar12;
      if (puVar15 != (undefined *)0x0) {
        _free(pbVar17);
  ...
  if (bVar3 != 0x15) {
    uVar9 = FUN_108855b04(param_2,&puStack_a0,&UNK_10b20ab40);
    *param_1 = 0x8000000000000000;
    param_1[1] = uVar9;
    return;
  }
        ...
        if (bVar2 == 1) {
          ...
          if (bVar2 != 4) {
            if (bVar2 == 0xc) {
              ...
              goto joined_r0x0001012b1ca0;
            }
LAB_1012b22ec:
            lStack_b0 = lVar20 + 1;
            pbStack_c8 = pbVar17;
            uVar9 = FUN_108855b04(&bStack_88,&puStack_a0,&UNK_10b210760);
            goto LAB_1012b1f90;
          }
          iVar11 = 1;
          if (plVar4 != (long *)0x1) {
...
LAB_1012b1d00:
        ...
        if (bVar2 == 0xd) {
          if (plVar5 == (long *)0x4) {
            iVar10 = 1;
            if ((int)*plVar4 != 0x74786574) {
              iVar10 = 2;
            }
          }
          else {
            if (plVar5 != (long *)0x8) goto LAB_1012b1ce0;
            iVar10 = 2;
        ...
        if (bVar2 != 0xe) {
          if (bVar2 != 0xf) goto LAB_1012b22ec;
          if (plVar5 == (long *)0x4) {
            if (((((char)*plVar4 != 't') || (*(char *)((long)plVar4 + 1) != 'e')) ||
                (*(char *)((long)plVar4 + 2) != 'x')) || (*(char *)((long)plVar4 + 3) != 't'))
            goto LAB_1012b1ce0;
            iVar10 = 1;
          }
...
LAB_1012b1ce0:
        ...
        if (lStack_70 == 4) {
          if ((((char)*plVar5 != 't') || (*(char *)((long)plVar5 + 1) != 'e')) ||
             ((*(char *)((long)plVar5 + 2) != 'x' || (*(char *)((long)plVar5 + 3) != 't'))))
          goto LAB_1012b1c7c;
          iVar10 = 1;
        }
...
LAB_1012b22e8:
          ...
          pcVar7 = (code *)SoftwareBreakpoint(1,0x1012b22ec);
          (*pcVar7)();
        }
        uVar9 = *puVar13;
        puVar16[1] = puVar13[1];
    ...
    pbStack_c8 = pbVar18;
    lStack_b0 = lVar21;
    if (puVar15 == (undefined *)0x8000000000000000) goto LAB_1012b1f5c;
    if (puVar19 != (undefined *)0x8000000000000000) {
      *param_1 = puVar15;
