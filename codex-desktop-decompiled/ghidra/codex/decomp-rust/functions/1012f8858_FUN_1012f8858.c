...
/* WARNING: Removing unreachable block (ram,0x0001012f8ea8) */

void FUN_1012f8858(undefined1 *param_1,char *param_2)
...
LAB_1012f8dcc:
    ...
    if ((byte)uStack_e0 == 4) {
      if (plStack_118 != (long *)0x0) {
        if (plStack_118 == (long *)0x1) goto LAB_1012f8b04;
        if (plStack_118 == (long *)0x2) goto LAB_1012f8cac;
    ...
    if ((byte)uStack_e0 == 0xc) {
      if (lStack_108 == 9) {
        if (*plStack_110 != 0x6574656c706d6f63 || (char)plStack_110[1] != 'd') goto LAB_1012f8bc8;
        uStack_140 = (char *)((ulong)uStack_140._2_6_ << 0x10);
      }
      else if (lStack_108 == 0xb) {
        if (*plStack_110 != 0x72676f72705f6e69 ||
            *(long *)((long)plStack_110 + 3) != 0x73736572676f7270) goto LAB_1012f8bc8;
...
LAB_1012f8bc8:
        pcStack_138 = (char *)FUN_1087e4494(plStack_110,lStack_108,&UNK_10b222618,3);
        uStack_140 = (char *)CONCAT71(uStack_140._1_7_,1);
      }
joined_r0x0001012f8cc8:
      if (plVar5 == (long *)0x0) goto LAB_1012f8dd8;
      _free(plVar6);
      pcVar9 = uStack_140;
      lVar10 = lStack_88;
      lStack_88 = lStack_68;
      goto joined_r0x0001012f8de0;
    }
LAB_1012f8e7c:
    pcStack_138 = (char *)FUN_108855b04(&uStack_e0,&uStack_51,&UNK_10b20f840);
    uStack_140 = (char *)CONCAT71(uStack_140._1_7_,1);
    lVar10 = lStack_88;
LAB_1012f8de4:
    lStack_88 = lVar10;
    ...
    if ((byte)uStack_e0 == 0xd) {
      if (plStack_110 == (long *)0x9) {
        if (*plStack_118 == 0x6574656c706d6f63 && (char)plStack_118[1] == 'd') goto LAB_1012f8dc8;
      }
      else if (plStack_110 == (long *)0xb) {
        if (*plStack_118 == 0x72676f72705f6e69 &&
            *(long *)((long)plStack_118 + 3) == 0x73736572676f7270) goto LAB_1012f8b04;
      }
      else if ((plStack_110 == (long *)0xa) &&
              (*plStack_118 == 0x656c706d6f636e69 && (short)plStack_118[1] == 0x6574))
      goto LAB_1012f8cac;
      pcStack_138 = (char *)FUN_1087e4494(plStack_118,plStack_110,&UNK_10b222618,3);
LAB_1012f8c28:
      uVar8 = 1;
      goto LAB_1012f8dcc;
    }
    if ((byte)uStack_e0 == 0xe) {
      func_0x000100ae2970(&uStack_140,plStack_110,lStack_108);
      goto joined_r0x0001012f8cc8;
    }
    if ((byte)uStack_e0 != 0xf) goto LAB_1012f8e7c;
    func_0x000100ae2970(&uStack_140,plStack_118,plStack_110);
LAB_1012f8dd0:
    FUN_100e077ec(&uStack_e0);
LAB_1012f8dd8:
    pcVar9 = uStack_140;
    lVar10 = lStack_88;
    lStack_88 = lStack_68;
joined_r0x0001012f8de0:
    bVar4 = (char)uStack_140 == '\x01';
    uStack_140 = pcVar9;
    lStack_68 = lStack_88;
    if (bVar4) goto LAB_1012f8de4;
...
LAB_1012f8d9c:
        ...
        if ((uVar1 == 0x12) || ((uVar1 == 0x15 && (lStack_88 == 0)))) goto LAB_1012f8d9c;
        pcVar9 = (char *)FUN_108855b04(&cStack_a0,&uStack_51,&UNK_10b20a5c0);
        goto LAB_1012f8dfc;
      }
LAB_1012f8da4:
    ...
    if (uVar1 == 0x16) goto LAB_1012f8da4;
    if ((uVar1 == 0x12) || ((uVar1 == 0x15 && (lStack_88 == 0)))) goto LAB_1012f8d9c;
    pcVar9 = (char *)FUN_108855b04(&cStack_a0,&uStack_51,&UNK_10b20a5c0);
  }
LAB_1012f8dfc:
