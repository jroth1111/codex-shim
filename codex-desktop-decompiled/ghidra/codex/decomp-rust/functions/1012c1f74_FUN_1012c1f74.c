...
void FUN_1012c1f74(undefined8 *param_1,byte *param_2)
...
LAB_1012c2430:
      pbStack_e8 = pbVar14;
      pbVar17 = (byte *)FUN_1087e422c(0,&UNK_10b22fc38,&UNK_10b20a590);
LAB_1012c244c:
...
LAB_1012c2454:
      ...
      if (*pbVar18 == 0x16) goto LAB_1012c2430;
      ...
      pbVar17 = pbStack_98;
      puVar15 = puStack_a0;
      if (puStack_a0 == (undefined *)0x8000000000000000) goto LAB_1012c244c;
      if (lVar12 == 1) {
LAB_1012c24f4:
        pbVar8 = (byte *)FUN_1087e422c(1,&UNK_10b22fc38,&UNK_10b20a590);
LAB_1012c250c:
        *param_1 = 0x8000000000000000;
        param_1[1] = pbVar8;
      ...
      pbStack_e8 = pbVar14;
      if (pbVar18[0x20] == 0x16) goto LAB_1012c24f4;
      ...
      pbVar8 = pbStack_98;
      puVar6 = puStack_a0;
      if (puStack_a0 == (undefined *)0x8000000000000000) goto LAB_1012c250c;
      *param_1 = puVar15;
      param_1[1] = pbVar17;
      param_1[2] = uVar9;
      ...
      if (lVar12 == 0) goto LAB_1012c26f0;
      *param_1 = 0x8000000000000000;
      param_1[1] = lVar12;
      if (puVar15 != (undefined *)0x0) {
        _free(pbVar17);
  ...
  if (bVar3 != 0x15) {
    uVar9 = FUN_108855b04(param_2,&puStack_a0,&UNK_10b20a820);
    *param_1 = 0x8000000000000000;
    param_1[1] = uVar9;
    return;
  }
          ...
          if (bVar2 != 4) {
            if (bVar2 == 0xc) {
              if (lStack_70 == 4) {
                ...
                iVar10 = 2;
                if (*piVar5 == 0x63746177 && *(int *)((long)piVar5 + 3) == 0x64496863) {
                  iVar10 = 0;
                }
              }
              else {
              ...
              goto joined_r0x0001012c2294;
            }
LAB_1012c28e0:
            lStack_b0 = lVar20 + 1;
            pbStack_c8 = pbVar17;
            uVar9 = FUN_108855b04(&bStack_88,&puStack_a0,&UNK_10b20d2e0);
            goto LAB_1012c2584;
          }
          iVar11 = 1;
          if (piVar4 != (int *)0x1) {
...
LAB_1012c22f4:
        ...
        if (bVar2 == 0xd) {
          if (piVar5 == (int *)0x4) {
            iVar10 = 1;
            if (*piVar4 != 0x68746170) {
              iVar10 = 2;
            }
          }
          else {
            if (piVar5 != (int *)0x7) goto LAB_1012c22d4;
            iVar10 = 2;
            if (*piVar4 == 0x63746177 && *(int *)((long)piVar4 + 3) == 0x64496863) {
              iVar10 = 0;
            }
          }
          goto LAB_1012c22f4;
        ...
        if (bVar2 != 0xe) {
          if (bVar2 != 0xf) goto LAB_1012c28e0;
          if (piVar5 == (int *)0x4) {
            if (((((char)*piVar4 != 'p') || (*(char *)((long)piVar4 + 1) != 'a')) ||
                (*(char *)((long)piVar4 + 2) != 't')) || (*(char *)((long)piVar4 + 3) != 'h'))
            goto LAB_1012c22d4;
            iVar10 = 1;
          }
          else if ((((piVar5 == (int *)0x7) && ((char)*piVar4 == 'w')) &&
                   ((*(char *)((long)piVar4 + 1) == 'a' &&
                    ((*(char *)((long)piVar4 + 2) == 't' && (*(char *)((long)piVar4 + 3) == 'c')))))
                   ) && (((char)piVar4[1] == 'h' &&
                         ((*(char *)((long)piVar4 + 5) == 'I' &&
                          (*(char *)((long)piVar4 + 6) == 'd')))))) {
            iVar10 = 0;
          }
          else {
LAB_1012c22d4:
        ...
        if (lStack_70 == 4) {
          if (((((char)*piVar5 != 'p') || (*(char *)((long)piVar5 + 1) != 'a')) ||
              (*(char *)((long)piVar5 + 2) != 't')) || (*(char *)((long)piVar5 + 3) != 'h'))
          goto LAB_1012c2270;
          iVar10 = 1;
        }
        else if (((((lStack_70 == 7) && ((char)*piVar5 == 'w')) &&
                  ((*(char *)((long)piVar5 + 1) == 'a' &&
                   ((*(char *)((long)piVar5 + 2) == 't' && (*(char *)((long)piVar5 + 3) == 'c'))))))
                 && ((char)piVar5[1] == 'h')) &&
                ((*(char *)((long)piVar5 + 5) == 'I' && (*(char *)((long)piVar5 + 6) == 'd')))) {
          iVar10 = 0;
        }
        else {
LAB_1012c2270:
...
LAB_1012c28dc:
          ...
          pcVar7 = (code *)SoftwareBreakpoint(1,0x1012c28e0);
          (*pcVar7)();
        }
        uVar9 = *puVar13;
        puVar16[1] = puVar13[1];
    ...
    pbStack_c8 = pbVar18;
    lStack_b0 = lVar21;
    if (puVar15 == (undefined *)0x8000000000000000) goto LAB_1012c2550;
    if (puVar19 != (undefined *)0x8000000000000000) {
      *param_1 = puVar15;
