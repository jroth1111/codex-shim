...
/* WARNING: Removing unreachable block (ram,0x000100919c44) */
...
/* WARNING: Removing unreachable block (ram,0x000100919650) */

void FUN_10091959c(void)

{
  ...
  plVar1 = (long *)FUN_108856088(s_missing_field_____108ac28f7,&stack0x00000670);
