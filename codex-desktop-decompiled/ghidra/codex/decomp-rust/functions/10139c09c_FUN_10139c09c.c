...
void FUN_10139c09c(ulong *param_1,char *param_2)
...
LAB_10139cbc8:
        ...
        pcVar9 = (code *)SoftwareBreakpoint(1,0x10139cbcc);
        (*pcVar9)();
      }
      uStack_118 = 0;
      bVar2 = *pbVar1;
                ...
                *puVar21 = uVar33;
                ...
                if (0xc < bVar3) {
                  if (bVar3 == 0xd) {
                    ...
                    else if (plStack_80 == (long *)0xa) {
                      uVar14 = 2;
                      if (*plStack_88 == 0x6e61725f65747962 && (short)plStack_88[1] == 0x6567) {
                        uVar14 = 0;
                      }
                    }
                    else {
                  ...
                  if (bVar3 == 0xe) {
                    func_0x000100b1c12c(&uStack_a8,plStack_80);
joined_r0x00010139c2b8:
                    if (plVar7 != (long *)0x0) {
                      _free(plVar8);
                    }
                    goto joined_r0x00010139c42c;
                  }
                  if (bVar3 == 0xf) {
                    func_0x000100b1c12c(&uStack_a8,plStack_88,plStack_80);
                    goto LAB_10139c440;
                  }
LAB_10139c564:
                  pbStack_a0 = (byte *)FUN_108855b04(&uStack_90,auStack_69,&UNK_10b20cfc0);
...
LAB_10139c58c:
                ...
                if (bVar3 == 1) {
                  ...
                  if (bVar3 != 4) {
                    if (bVar3 != 0xc) goto LAB_10139c564;
                    if (lStack_78 == 0xb) {
                      uVar13 = 1;
                      ...
                      uVar13 = 2;
                      if (*plStack_80 == 0x6e61725f65747962 && (short)plStack_80[1] == 0x6567) {
                        uVar13 = 0;
                      }
                      uStack_a8 = (undefined *)((ulong)CONCAT61(uStack_a8._2_6_,uVar13) << 8);
                    }
...
joined_r0x00010139c42c:
                if (((ulong)uStack_a8 & 1) != 0) goto LAB_10139c58c;
                ...
                if (uStack_a8._1_1_ == '\0') {
                  ...
                  pbStack_f0 = (byte *)CONCAT71(pbStack_f0._1_7_,0x16);
                  if (cVar5 == '\x16') goto LAB_10139cae0;
                  uVar33 = *puVar18;
                  puVar21[1] = puVar18[1];
                  *puVar21 = uVar33;
                  ...
                  *(undefined8 *)((long)puVar21 + 0xf) = uVar33;
                  ...
                  func_0x00010122de2c(&uStack_a8,&uStack_90);
                  if ((int)uStack_a8 == 1) goto LAB_10139c58c;
...
joined_r0x00010139c5b0:
            if (-0x7fffffffffffffff < (long)puVar24) {
joined_r0x00010139c960:
...
LAB_10139c7a8:
          ...
          pbStack_148 = pbVar22;
          lStack_130 = lVar28;
          uVar20 = FUN_108855b04(abStack_110,auStack_69,&UNK_10b20b200);
          *param_1 = 0x8000000000000000;
          param_1[1] = uVar20;
          uVar15 = uStack_120;
          uVar20 = uStack_118;
joined_r0x00010139c9bc:
          uStack_120 = uVar15;
          uStack_118 = uVar20;
          if (uVar20 != 0) {
...
LAB_10139c644:
          ...
          bVar3 = *pbStack_100;
          if (bVar3 == 0x16) goto LAB_10139c5f0;
          ...
          *(undefined8 *)((long)puVar21 + 0xf) = uVar33;
          ...
          pbVar27 = pbStack_a0;
          pbVar29 = pbStack_a0;
          if ((int)uStack_a8 == 1) goto LAB_10139c610;
          if (lVar25 == 1) {
LAB_10139c778:
          ...
          bVar3 = pbVar16[0x20];
          pbStack_e8 = pbVar32;
          if (bVar3 == 0x16) goto LAB_10139c778;
          uStack_168 = uStack_98;
          ...
          *(undefined8 *)((long)puVar21 + 0xf) = uVar33;
          ...
          puVar26 = uStack_a8;
          pbVar29 = pbStack_a0;
          if (uStack_a8 == (undefined *)0x8000000000000001) goto LAB_10139c610;
          uStack_170 = uStack_98;
...
LAB_10139c7cc:
        ...
        if (puVar26 + 0x7fffffffffffffff < (undefined *)0x2) {
          *param_1 = 0x8000000000000000;
          ...
          pbStack_148 = pbVar22;
          uVar15 = uStack_120;
          goto joined_r0x00010139c9bc;
        }
        if (uStack_118 == uStack_128) {
          func_0x0001089a4d30(&uStack_128);
        }
        ...
        *puVar30 = puVar26;
        ...
        if (pbVar22 != pbVar23) goto code_r0x00010139c838;
        goto LAB_10139ca00;
      }
      pbVar16 = pbVar1 + 0x20;
      lVar19 = 0;
...
LAB_10139ca24:
    ...
    uVar20 = FUN_108855b04(param_2,auStack_69,&UNK_10b20a160);
    *param_1 = 0x8000000000000000;
    param_1[1] = uVar20;
  }
  return;
code_r0x00010139c838:
  bVar2 = *pbVar22;
  pbVar16 = pbVar22 + 0x20;
  pbVar32 = pbVar22;
  lVar19 = lVar28;
  if (bVar2 == 0x16) goto LAB_10139ca00;
  goto LAB_10139c184;
}
