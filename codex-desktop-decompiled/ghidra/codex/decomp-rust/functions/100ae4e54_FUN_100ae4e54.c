...
void FUN_100ae4e54(undefined2 *param_1,long *param_2,long param_3)

{
  ...
  if (param_3 == 6) {
    ...
    if ((int)*param_2 == 0x636f6c62 && *(int *)((long)param_2 + 3) == 0x64656b63) {
      *(undefined1 *)((long)param_1 + 1) = 3;
      *(undefined1 *)param_1 = 0;
      return;
    }
    if ((int)*param_2 == 0x706f7473 && *(int *)((long)param_2 + 3) == 0x64657070) {
      *(undefined1 *)((long)param_1 + 1) = 4;
      *(undefined1 *)param_1 = 0;
      return;
    }
  }
  uVar1 = FUN_1087e4494(param_2,param_3,&UNK_10b222b58,5);
