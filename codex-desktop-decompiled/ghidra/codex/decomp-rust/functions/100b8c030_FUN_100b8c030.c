...

{
  ...
  *puVar3 = in_stack_0000dc20;
  ...
  uVar7 = *unaff_x26;
  if (uVar7 != 7) {
    if ((uVar7 != 6) && ((*(byte *)(unaff_x19 + 0x703) & 1) != 0)) {
      if ((((*(byte *)(unaff_x19 + 0x704) & 1) != 0) && ((uVar7 & 3) != 0)) &&
         ((uVar7 != 4 || (*(short *)(unaff_x19 + 0x6d0) != 0x12)))) {
