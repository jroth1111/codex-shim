...
undefined1  [16] FUN_100fbf014(undefined8 *param_1,undefined8 *param_2)
...
LAB_100fbf0e4:
      ...
      ;
      plVar14 = auStack_190._8_8_;
      do {
        unaff_x21 = ___ZN5tokio7runtime4task2id2Id4next7NEXT_ID17h2bddb4a9c434075aE;
        puVar9 = ___ZN5tokio7runtime4task2id2Id4next7NEXT_ID17h2bddb4a9c434075aE + 1;
        bVar1 = ___ZN5tokio7runtime4task2id2Id4next7NEXT_ID17h2bddb4a9c434075aE == (undefined *)0x0;
        ___ZN5tokio7runtime4task2id2Id4next7NEXT_ID17h2bddb4a9c434075aE = puVar9;
      } while (bVar1);
      lVar2 = 0x220;
      if ((auStack_190 & 1) == 0) {
        lVar2 = 0x300;
      ...
      if ((auStack_190 & 1) == 0) {
        plVar13 = plVar14 + 0x4c;
        if ((char)*plVar13 == '\0') {
          *(char *)plVar13 = '\x01';
        }
        else {
          __ZN11parking_lot9raw_mutex8RawMutex9lock_slow17ha3330f5b4a61e218E
                    (plVar13,plVar14,1000000000);
        }
        ...
        if ((char)*plVar13 == '\x01') {
          *(char *)plVar13 = in_wzr;
          ...
          __ZN11parking_lot9raw_mutex8RawMutex11unlock_slow17h37f4fcce25a32539E(plVar13,0);
        }
        lVar7 = *plVar14;
        *plVar14 = lVar7 + 1;
        lVar8 = lStack_160;
        plVar13 = plStack_150;
        plVar5 = plStack_148;
        if (lVar7 < 0) goto LAB_100fbf458;
        plVar16 = (long *)plVar14[0x5e];
        lStack_160 = 0;
        plStack_148 = plVar14 + 0x5c;
      }
      else {
        lVar7 = *plVar14;
        *plVar14 = lVar7 + 1;
        ...
        plVar5 = plStack_148;
        if (lVar7 < 0) goto LAB_100fbf458;
        plVar16 = (long *)plVar14[0x4a];
        lStack_160 = 1;
        plStack_148 = plVar14 + 0x48;
      }
      ...
      if ((iVar10 == 0) && (plStack_68 != (long *)0x0)) {
        ...
        *plStack_68 = (long)pplStack_180;
        ...
        auVar19 = __ZN5tokio7runtime8blocking4pool7Spawner10spawn_task17h940099594ef92638E
                            ((long)plVar14 + lVar2,plStack_68,1,auStack_190);
        if (((auVar19._0_8_ & 1) == 0) || (auVar19._8_8_ == (long *)0x0)) {
          ...
          param_1[7] = plVar13;
LAB_100fbf2dc:
          FUN_10151ba30(&pplStack_180,plVar13,*param_2);
          puVar4 = puStack_168;
          puVar9 = puStack_170;
          pcVar6 = pcStack_178;
    ...
    func_0x000108a07af4(&UNK_10b23a280);
LAB_100fbf430:
    func_0x000108a07b10(&UNK_10b23a280);
  }
  else {
    if (bVar3 != 3) goto LAB_100fbf430;
...
LAB_100fbf458:
  ...
  pcVar6 = (code *)SoftwareBreakpoint(1,0x100fbf45c);
  (*pcVar6)();
}
