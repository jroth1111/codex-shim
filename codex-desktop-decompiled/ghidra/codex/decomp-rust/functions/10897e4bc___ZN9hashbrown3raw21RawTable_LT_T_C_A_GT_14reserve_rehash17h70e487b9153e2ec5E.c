...
ulong __ZN9hashbrown3raw21RawTable_LT_T_C_A_GT_14reserve_rehash17h70e487b9153e2ec5E
...

{
  ...
  if (CARRY8(uVar15,param_2)) {
    ...
    if (uStack_88 >> 1 < uVar16) {
      ...
      FUN_103edfa34(&plStack_80,0x20,uVar16);
      if (plStack_80 != (long *)0x0) {
        ...
        if (uVar15 != 0) {
          ...
          do {
            ...
            uVar9 = FUN_103dc2338(uVar4,uVar5,plVar11[uVar10 * -4 + -3],plVar11[uVar10 * -4 + -2]);
...
LAB_10897e6b0:
  ...
  do {
    ...
    if (*(char *)((long)unaff_x21 + uVar15) == -0x80) {
      ...
      while( true ) {
        uVar10 = FUN_103dc2338(uVar4,uVar5,unaff_x21[uVar15 * -4 + -3],unaff_x21[uVar15 * -4 + -2]);
...
LAB_10897e7c4:
    param_1 = plStack_a8;
    if (unaff_x20 <= uVar13) goto LAB_10897e860;
    uVar16 = uVar13 + 1;
    uVar15 = uVar13;
  } while( true );
}
