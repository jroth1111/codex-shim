...

{
  ...
  long in_stack_00000d90;
  long in_stack_00000d98;
  long in_stack_00000da0;
  
  puVar4 = (undefined8 *)
           FUN_108858fa8(s_tool_____is_disabled_for_MCP_ser_108ad9e4b,&stack0x00000d90);
  ...
  *unaff_x25 = 1;
  FUN_100ccba6c(in_stack_00000058);
  ...
  *unaff_x20 = lVar8;
  unaff_x20[7] = in_stack_00000da0;
  unaff_x20[6] = in_stack_00000d98;
  unaff_x20[9] = in_stack_00000088;
  unaff_x20[8] = -0x7ffffffffffffffb;
  unaff_x20[3] = lVar10;
  unaff_x20[2] = lVar9;
  unaff_x20[5] = in_stack_00000d90;
  ...
  *(undefined1 *)(unaff_x19 + 0x50) = 0;
  ...
  if (unaff_x19[0x3a] == -0x8000000000000000) {
    ...
    *(undefined1 *)(unaff_x19 + 0x68) = 0;
    iVar3 = FUN_1008927b8(unaff_x19 + 0x51,in_stack_00000050);
    if (iVar3 == 0) {
...
LAB_1008ba258:
    ...
    *(undefined1 *)(unaff_x19 + 0xfa) = 0;
    iVar3 = FUN_100892e70(unaff_x19 + 0x6c,in_stack_00000050);
    if (iVar3 == 0) {
