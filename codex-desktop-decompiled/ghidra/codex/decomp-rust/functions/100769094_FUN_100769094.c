...
/* WARNING: Heritage AFTER dead removal. Example location: s0x000002b0 : 0x00010076a470 */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* WARNING: Restarted to delay deadcode elimination for space: stack */

void FUN_100769094(undefined *param_1)

{
  ...
  puVar14 = &stack0x000002b0;
  FUN_10076c6a0(&stack0x00000570);
  lVar12 = unaff_x19[0x12];
  *(undefined1 *)((long)unaff_x19 + 0xea) = 0;
  uVar17 = unaff_x19[0x19];
  lVar24 = unaff_x19[0x18];
  uVar15 = unaff_x19[0x1a];
  if ((lVar12 != -0x8000000000000000) && (lVar12 != 0)) {
    _free(unaff_x19[0x13]);
  }
  *(undefined1 *)((long)unaff_x19 + 0xed) = 1;
  unaff_x19[0x13] = uVar17;
  unaff_x19[0x12] = lVar24;
  unaff_x19[0x14] = uVar15;
  if ((in_stack_00000548 & 3) == 1) {
    uVar15 = *(undefined8 *)(in_stack_00000548 - 1);
  ...
  *(undefined1 *)((long)unaff_x19 + 0xec) = 1;
  ...
  if ((uVar22 == 0) || (*pcVar27 != '/')) {
    if (bVar7) {
      ...
      lVar24 = unaff_x19[0x21];
      *(undefined1 *)(lVar12 + lVar24) = 0x2f;
      uVar23 = lVar24 + 1;
      unaff_x19[0x21] = uVar23;
      uVar6 = unaff_x19[0x1f] - uVar23;
      goto joined_r0x00010076a1c8;
    }
    if (uVar22 != 0) goto LAB_10076ad50;
  }
  else {
    unaff_x19[0x21] = 0;
    uVar23 = 0;
...
joined_r0x00010076a1c8:
    ...
    if (uVar6 < uVar22) {
LAB_10076ad50:
      thunk_FUN_108a85fec(unaff_x19 + 0x1f,uVar21,uVar22,1,1);
      lVar12 = unaff_x19[0x20];
      uVar21 = unaff_x19[0x21];
    }
  }
  _memcpy(lVar12 + uVar21,pcVar27,uVar22);
  ...
  if (uVar21 < 0x180) {
    ...
    iVar9 = _stat(&stack0x00000750,&stack0x00000310);
    if (iVar9 == -1) {
      puVar10 = (uint *)___error();
      puVar14 = (undefined1 *)((ulong)*puVar10 << 0x20 | 2);
      goto LAB_10076a248;
    }
...
LAB_10076b9c8:
    ...
    *(undefined1 *)(unaff_x19 + 0x1e) = 0;
    __ZN17codex_file_search3run17h729d2a977a77ec0aE
              (&stack0x00000570,uVar15,uVar17,&stack0x00000310,&stack0x00000750,0);
    unaff_x19[0x25] = 1;
    unaff_x19[0x26] = puVar14;
    unaff_x19[0x28] = param_1;
    unaff_x19[0x27] = 1;
    *(undefined1 *)((long)unaff_x19 + 0xef) = 0;
    puVar20 = puVar14 + unaff_x19[0x27] * 0x50;
    puVar18 = puVar14;
    puVar3 = (undefined *)0x1;
    puVar4 = (undefined *)0x0;
    if (unaff_x19[0x27] == 0) {
LAB_10076a5d0:
      in_stack_000002c0 = puVar4;
      in_stack_000002b8 = param_1;
      in_stack_000002b0 = puVar3;
      unaff_x19[0x22] = 0x8000000000000000;
    }
    else {
      puVar18 = &stack0x00000300;
      puVar3 = in_stack_000002b0;
      param_1 = in_stack_000002b8;
      puVar4 = in_stack_000002c0;
      if (in_stack_000002b0 == (undefined *)0x8000000000000000) goto LAB_10076a5d0;
      __ZN3std4path4Path5_join17ha8f408dfc5576c3eE
                (&stack0x00000310,in_stack_000002d0,in_stack_000002d8,in_stack_000002b8,
                 in_stack_000002c0);
      if (in_stack_000002b0 != (undefined *)0x0) {
        _free(in_stack_000002b8);
      }
      if (in_stack_000002c8 != 0) {
        _free(in_stack_000002d0);
      }
      if ((in_stack_000002e0 & 0x7fffffffffffffff) != 0) {
        _free(in_stack_000002e8);
      }
    ...
    *(undefined1 *)((long)unaff_x19 + 0xee) = 1;
    if ((long)puVar20 - (long)puVar18 != 0) {
      uVar21 = (ulong)((long)puVar20 - (long)puVar18) / 0x50;
      puVar19 = (undefined8 *)(puVar18 + 0x20);
      do {
        if (puVar19[-4] != 0) {
          _free(puVar19[-3]);
        }
        ...
        if ((puVar19[2] & 0x7fffffffffffffff) != 0) {
          _free(puVar19[3]);
        }
        puVar19 = puVar19 + 10;
        uVar21 = uVar21 - 1;
    ...
    if (unaff_x19[0x22] != -0x8000000000000000) {
      if (((___ZN12tracing_core8metadata9MAX_LEVEL17h02c7742de62f64c3E < 2) &&
        ...
        in_stack_000002b8 = &stack0x00000930;
        in_stack_000002b0 = (undefined *)0x1;
        in_stack_000002c0 = (undefined *)0x1;
        ...
        if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
          ...
          iVar9 = (**(code **)(puVar3 + 0x18))(puVar4,&stack0x000002e0);
          if (iVar9 != 0) {
            *(undefined1 **)(unaff_x29 + -0x80) = &stack0x00000930;
            *(undefined **)(unaff_x29 + -0x78) = &UNK_10b208fd0;
            in_stack_000002b8 = (undefined *)(unaff_x29 + -0x80);
            in_stack_000002b0 = (undefined *)0x1;
            in_stack_000002c0 = (undefined *)0x1;
            __ZN7tracing15__macro_support13__tracing_log17h72768b16bee39960E
                      (uVar15,puVar4,puVar3,&stack0x00000570,&stack0x00000750);
      ...
      if ((___ZN12tracing_core8metadata9MAX_LEVEL17h02c7742de62f64c3E < 4) &&
        ...
        in_stack_000002b8 = &stack0x00000310;
        in_stack_000002b0 = (undefined *)0x1;
        in_stack_000002c0 = (undefined *)0x1;
        ...
        if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
          ...
          iVar9 = (**(code **)(puVar3 + 0x18))(puVar4,&stack0x000002f8);
          if (iVar9 != 0) {
            pcVar27 = 
      ...
      if (unaff_x19[6] != 0) {
        in_stack_000002b0 = &UNK_108ed3a13;
        in_stack_000002b8 = (undefined *)0x6;
        in_stack_000002c0 = &UNK_108cdcb10;
...
LAB_10076b42c:
            ...
            if (((___ZN12tracing_core8metadata9MAX_LEVEL17h02c7742de62f64c3E < 4) &&
              ...
              *(undefined **)(unaff_x29 + -0x78) = &UNK_10b208fd0;
              ...
              if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
                ...
                iVar9 = (**(code **)(puVar3 + 0x18))(puVar4,&stack0x00000548);
                if (iVar9 != 0) {
                  *(undefined **)(unaff_x29 + -0x80) = &UNK_108cad392;
                  *(undefined8 *)(unaff_x29 + -0x78) = 0x9f;
                  in_stack_000002b8 = &stack0x00000560;
                  in_stack_000002b0 = (undefined *)0x1;
                  __ZN7tracing15__macro_support13__tracing_log17h72768b16bee39960E
                            (uVar15,puVar4,puVar3,&stack0x00000570,&stack0x00000750);
                }
          ...
          *(undefined1 *)(unaff_x19 + 0x94) = 0;
          ...
          if (in_stack_000002b0 == (undefined *)0x8000000000000001) {
            uVar11 = 5;
          }
          else {
            ...
            if (in_stack_000002b0 == (undefined *)0x8000000000000000) {
              if (((ulong)in_stack_000002b8 & 3) == 1) {
                uVar15 = *(undefined8 *)(in_stack_000002b8 + -1);
                puVar19 = *(undefined8 **)(in_stack_000002b8 + 7);
                pcVar13 = (code *)*puVar19;
                if (pcVar13 != (code *)0x0) {
                  (*pcVar13)(uVar15);
                }
          ...
          if (pcVar27 != (char *)0x8000000000000002) {
            ...
            if (-0x7fffffffffffffff < lVar12) {
              ...
              *(undefined1 *)((long)unaff_x19 + 0x351) = 1;
              ...
              unaff_x19[0xa9] = in_stack_000002b8;
              *plVar1 = (long)in_stack_000002b0;
              unaff_x19[0xaa] = in_stack_000002c0;
              ...
              unaff_x19[0xb2] = in_stack_000002b8;
              unaff_x19[0xb1] = in_stack_000002b0;
              unaff_x19[0xb3] = in_stack_000002c0;
              ...
              if ((unaff_x19[0xdd] == unaff_x19[0xa2]) &&
                ...
                in_stack_000002b0 = (undefined *)unaff_x19[0x6e];
                in_stack_000002b8 = (undefined *)unaff_x19[0x6f];
                if (unaff_x19[0xaa] == 0) {
                ...
                if ((___ZN12tracing_core8metadata9MAX_LEVEL17h02c7742de62f64c3E < 4) &&
                  ...
                  *(undefined **)(unaff_x29 + -0x78) = &UNK_10b208fd0;
                  ...
                  if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
                    ...
                    iVar9 = (**(code **)(puVar3 + 0x18))(puVar4,&stack0x000004f0);
                    if (iVar9 != 0) {
                  ...
                  if (((___ZN12tracing_core8metadata9MAX_LEVEL17h02c7742de62f64c3E < 4) &&
                    ...
                    *(undefined8 *)(unaff_x29 + -0x78) = uVar15;
                    ...
                    if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
                      ...
                      iVar9 = (**(code **)(puVar3 + 0x18))(puVar4,&stack0x00000510);
                      if (iVar9 != 0) {
                        puVar20 = (undefined1 *)
                                  (
                                  ___ZN13codex_rollout8state_db24read_repair_rollout_path28__u7b__u7b_closure_u7d__u7d_10__CALLSITE17ha51ab27f47b0ab0bE
                                  + 0x30);
                        in_stack_000002b0 = &stack0x00000560;
                        in_stack_000002b8 =
                             &
                             __ZN57__LT_std__path__Display_u20_as_u20_core__fmt__Display_GT_3fmt17hd3197a5a14e07c8dE
                        ;
                        ...
                        *(undefined8 *)(unaff_x29 + -0x70) = uVar17;
                        __ZN7tracing15__macro_support13__tracing_log17h72768b16bee39960E
                                  (lVar12,puVar4,puVar3,unaff_x29 + -0x80,&stack0x00000570);
                      }
                    }
                  }
                  (**(code **)*auVar26._8_8_)();
...
LAB_10076a248:
    if (((ulong)puVar14 & 3) == 1) {
      uVar15 = *(undefined8 *)(puVar14 + -1);
      puVar19 = *(undefined8 **)(puVar14 + 7);
      pcVar13 = (code *)*puVar19;
      if (pcVar13 != (code *)0x0) {
        (*pcVar13)(uVar15);
      }
