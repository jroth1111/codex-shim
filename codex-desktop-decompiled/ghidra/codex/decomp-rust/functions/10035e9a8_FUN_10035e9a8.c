...
void FUN_10035e9a8(ulong *param_1,uint *param_2,ulong param_3)

{
  ...
  if (uVar3 == 0) {
    ...
    if (param_3 != 0) goto LAB_10035eae0;
LAB_10035ea04:
    if (uVar3 < 4) goto LAB_10035eb38;
LAB_10035ea0c:
    uVar5 = (ulong)*(uint *)((long)param_2 + uVar2);
    uVar4 = 4;
    if (uVar3 < 6) goto LAB_10035eb64;
  }
  else {
    uVar2 = 8 - uVar3;
    uVar5 = uVar2;
...
LAB_10035ea38:
    ...
    *param_1 = uVar3 ^ uVar5;
    ...
    if (param_3 <= uVar2) goto LAB_10035ea04;
LAB_10035eae0:
    uVar7 = param_1[2];
    uVar4 = param_1[3];
    uVar5 = *param_1;
    ...
    *param_1 = uVar5;
    param_1[1] = uVar6;
    if (3 < uVar3) goto LAB_10035ea0c;
LAB_10035eb38:
    uVar4 = 0;
    uVar5 = 0;
    if (uVar3 < 2) goto LAB_10035eb64;
  }
