...

{
  ...
  in_stack_00000118 = FUN_108856088(s_missing_field_____108ac28f7,&stack0x00000130);
  in_stack_00000110 = -0x7ffffffffffffff9;
  FUN_100de8910(unaff_x23 + 0x48);
  if (in_stack_000001b0 != unaff_x27) {
    FUN_100de6690(&stack0x000001b0);
  }
  if (((long)in_stack_00000018 < 0) && ((in_stack_00000018 & 0xfffffffffffffffe) != unaff_x27 - 1U))
  {
  ...
  if (in_stack_00000110 == -0x7ffffffffffffff9) {
    *(undefined8 *)(unaff_x29 + -0xd0) = in_stack_00000118;
    if ((___ZN12tracing_core8metadata9MAX_LEVEL17h02c7742de62f64c3E < 5) &&
      ...
      *(undefined **)(unaff_x29 + -0xb8) = &UNK_10b208fd0;
      ...
      in_stack_000001b0 = 1;
      in_stack_000001c0 = 1;
      __ZN12tracing_core5event5Event8dispatch17h50a390618bcffa4fE(lVar8,&stack0x000001b0);
      lVar8 = 
      ___ZN16codex_mcp_server13exec_approval25on_exec_approval_response28__u7b__u7b_closure_u7d__u7d_28__u7b__u7b_closure_u7d__u7d_10__CALLSITE17h3d3dc144e2abf8d0E
      ;
      if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
        ...
        if (iVar6 != 0) {
          __ZN7tracing15__macro_support13__tracing_log17h72768b16bee39960E
                    (lVar8,puVar3,puVar2,&stack0x00000130,&stack0x000001b0);
        }
      }
    }
    else {
    ...
    *(ulong *)(unaff_x19 + 0xd0) = unaff_x27 - 1U;
    plVar13 = *(long **)(unaff_x29 + -0xd0);
    if (*plVar13 == 1) {
      uVar7 = plVar13[1];
      if ((uVar7 & 3) == 1) {
        puVar14 = (undefined8 *)(uVar7 - 1);
        uVar10 = *puVar14;
...
LAB_1009b4634:
  ...
  *(long *)(unaff_x19 + 0xf8) = unaff_x27 + 5;
  ...
  *(long *)(unaff_x19 + 0x2e0) = lVar8 + 0x10;
  *(undefined1 *)(unaff_x19 + 0xdd0) = 0;
  lVar8 = unaff_x19 + 0xf8;
  FUN_1004f3438(&stack0x000001b0,lVar8,in_stack_00000020);
  uVar10 = in_stack_000001c0;
  lVar4 = in_stack_000001b8;
  lVar1 = in_stack_000001b0;
  if (in_stack_000001b0 == unaff_x27 + 0x1c) {
    *unaff_x26 = 4;
    uVar11 = 3;
    uVar10 = 1;
    goto LAB_1009b4a10;
...
LAB_1009b4748:
    ...
    if (*(char *)(unaff_x19 + 0xdc8) == '\x03') {
      ...
      lVar8 = unaff_x19 + 0x2e8;
      goto LAB_1009b4748;
    }
  }
  if (lVar1 == unaff_x27 + 0x1b) {
    if (lVar4 != 0) {
      _free(uVar10);
    }
  }
    ...
    if (((___ZN12tracing_core8metadata9MAX_LEVEL17h02c7742de62f64c3E < 5) &&
      ...
      *(long *)(unaff_x29 + -0x68) = lVar1;
      __ZN12tracing_core5event5Event8dispatch17h50a390618bcffa4fE(lVar8,unaff_x29 + -0x80);
      lVar8 = 
      ___ZN16codex_mcp_server13exec_approval25on_exec_approval_response28__u7b__u7b_closure_u7d__u7d_10__CALLSITE17h2522edf8a3659a44E
      ;
      if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
        ...
        *(undefined8 *)(unaff_x29 + -0x90) = uVar15;
        ...
        if (iVar6 != 0) {
          __ZN7tracing15__macro_support13__tracing_log17h72768b16bee39960E
                    (lVar8,puVar3,puVar2,unaff_x29 + -0xa0,unaff_x29 + -0x80);
        }
      }
    }
    else {
      ...
      if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
        ...
        *(undefined8 *)(unaff_x29 + -0xe8) = uVar15;
        ...
        if (iVar6 != 0) {
          ...
          *(long *)(unaff_x29 + -0x68) = lVar1;
          __ZN7tracing15__macro_support13__tracing_log17h72768b16bee39960E
                    (lVar8,puVar3,puVar2,unaff_x29 + -0xf8,unaff_x29 + -0x80);
        }
      }
    }
