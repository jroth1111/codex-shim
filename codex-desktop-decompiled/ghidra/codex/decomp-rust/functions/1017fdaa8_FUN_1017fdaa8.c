...

{
  ...
  while (FUN_101990a78(&stack0x00000350,&stack0x000002b0), in_stack_000002b0 != 0) {
    lVar2 = in_stack_000002b0 + in_stack_000002c0 * 0x18;
    if (*(long *)(lVar2 + 8) != 0) {
      _free(*(undefined8 *)(lVar2 + 0x10));
    }
    FUN_101951d58(in_stack_000002b0 + in_stack_000002c0 * 0x48 + 0x110);
  }
  *unaff_x26 = 1;
  FUN_101937450();
