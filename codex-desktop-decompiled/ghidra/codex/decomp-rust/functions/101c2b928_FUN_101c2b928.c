...

{
  ...
  lVar2 = FUN_1088dc508(s_duplicate_field_____108ac2973,unaff_x29 + -0xe0);
  *unaff_x19 = 0x12;
  unaff_x19[1] = lVar2;
  ...
  if (lVar3 == 0x12) {
    ...
    if (lVar1 == lVar2) {
      ...
      *(long *)(unaff_x29 + -0xe0) = in_stack_00000110;
      lVar2 = FUN_1088c7110(in_stack_00000110 + ((ulong)(lVar1 - lVar2) >> 6),unaff_x29 + -0xe0,
                            &UNK_10b276c98);
    }
    if (in_stack_000000d0 != '\x16') {
      FUN_1020378e0(&stack0x000000d0);
