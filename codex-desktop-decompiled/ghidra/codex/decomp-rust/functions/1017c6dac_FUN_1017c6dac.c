...
/* WARNING: Removing unreachable block (ram,0x0001017c72f4) */
/* WARNING: Type propagation algorithm not settling */

void FUN_1017c6dac(undefined1 *param_1,char *param_2)
...
LAB_1017c720c:
      ...
      if ((byte)uStack_e0 == 4) {
        if (plStack_118 != (long *)0x0) {
          if (plStack_118 == (long *)0x1) goto LAB_1017c70ac;
      ...
      if ((byte)uStack_e0 == 0xc) {
        if (lStack_108 == 4) {
          if ((int)*plStack_110 != 0x68676968) goto LAB_1017c6f0c;
          uStack_140 = (long *)((ulong)uStack_140._2_6_ << 0x10);
        }
        else if ((lStack_108 == 8) && (*plStack_110 == 0x6c616e696769726f)) {
          uStack_140 = (long *)CONCAT62(uStack_140._2_6_,0x100);
        }
        else {
LAB_1017c6f0c:
          plStack_138 = (long *)FUN_108878f8c(plStack_110,lStack_108,&UNK_10b259710,2);
          uStack_140 = (long *)CONCAT71(uStack_140._1_7_,1);
        }
joined_r0x0001017c7120:
        plVar10 = plVar7;
        if (plVar5 == (long *)0x0) goto LAB_1017c7218;
        _free(plVar7);
        plVar10 = uStack_140;
        lVar9 = lStack_88;
        lStack_88 = lStack_68;
        goto joined_r0x0001017c7220;
      }
LAB_1017c72c8:
      plStack_138 = (long *)FUN_10888066c(&uStack_e0,&uStack_51,&UNK_10b258cf0);
      uStack_140 = (long *)CONCAT71(uStack_140._1_7_,1);
      lVar9 = lStack_88;
LAB_1017c7224:
      lStack_88 = lVar9;
...
joined_r0x0001017c7338:
      bVar4 = true;
    }
    else {
      if ((byte)uStack_e0 == 0xd) {
        if (plStack_110 == (long *)0x4) {
          if ((int)*plStack_118 == 0x68676968) goto LAB_1017c7208;
        }
        else if ((plStack_110 == (long *)0x8) && (*plStack_118 == 0x6c616e696769726f))
        goto LAB_1017c70ac;
        plStack_138 = (long *)FUN_108878f8c(plStack_118,plStack_110,&UNK_10b259710,2);
LAB_1017c7018:
        uVar8 = 1;
        goto LAB_1017c720c;
      }
      if ((byte)uStack_e0 == 0xe) {
        func_0x000101794c50(&uStack_140,plStack_110,lStack_108);
        goto joined_r0x0001017c7120;
      }
      if ((byte)uStack_e0 != 0xf) goto LAB_1017c72c8;
      func_0x000101794c50(&uStack_140,plStack_118,plStack_110);
LAB_1017c7210:
...
LAB_1017c7218:
      ...
      lVar9 = lStack_88;
      lStack_88 = lStack_68;
joined_r0x0001017c7220:
      bVar4 = (char)uStack_140 == '\x01';
      uStack_140 = plVar10;
      lStack_68 = lStack_88;
      if (bVar4) goto LAB_1017c7224;
      ...
      if (uStack_140._1_1_ == '\x01') {
        if (uVar1 == 0x16) {
          ...
          goto joined_r0x0001017c71a0;
        }
        if ((uVar1 == 0x12) || ((uVar1 == 0x15 && (lStack_88 == 0)))) {
          uVar12 = 1;
          goto LAB_1017c71e4;
        }
        plVar7 = (long *)FUN_10888066c(&cStack_a0,&uStack_51,&UNK_10b258970);
LAB_1017c7324:
        uVar8 = bVar11 ^ 1;
        if (cVar3 == '\x15') {
          uVar8 = true;
        }
        goto joined_r0x0001017c7338;
      }
      if (uVar1 == 0x16) {
        uVar12 = 0;
        bVar4 = false;
...
LAB_1017c7024:
      ...
      plStack_138 = plVar10;
      if (cVar2 == '\x16') goto LAB_1017c7024;
...
LAB_1017c6e64:
      ...
      if ((byte)uStack_e0 == '\x16') goto LAB_1017c6e64;
      func_0x0001017a6a48(&uStack_e0);
    ...
    plVar7 = (long *)func_0x000108a4a50c(&uStack_e0,&UNK_10b258960,&UNK_10b258940);
    func_0x0001017a6a48(param_2);
  }
