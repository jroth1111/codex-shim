...
void FUN_1005f7ebc(undefined8 param_1)

{
  ...
  undefined8 *puStack0000000000000080;
  ...
  puStack0000000000000080 = (undefined8 *)&stack0x00000090;
  pcStack0000000000000078 = s_invalid_project_root_markers__108ac2229;
  pcStack0000000000000060 = (char *)&stack0x00000078;
  puStack0000000000000068 = (undefined8 *)&UNK_10b208fd0;
  puStack00000000000000d8 = &stack0x00000060;
  pcStack00000000000000d0 = (char *)0x1;
  uStack00000000000000e0 = 1;
  uStack00000000000000e8 = param_1;
  FUN_1005f9018(&stack0x000000d0);
          ...
          if (lVar8 != lVar6) {
            do {
              ...
              __ZN25codex_utils_absolute_path10absolutize15absolutize_from17h7c78eeaa90c9e1dfE
                        (&stack0x000000d0,in_stack_00000098,
                         CONCAT71(uStack00000000000000a1,uStack00000000000000a0),uVar12,uVar17);
              uVar12 = *unaff_x27;
...
LAB_1005f8680:
      ...
      if (lVar8 == -0x8000000000000000) {
        ...
        *(undefined1 *)((long)unaff_x19 + 0xc9) = 0;
        ...
        puStack0000000000000080 = (undefined8 *)0x8;
...
LAB_1005f8734:
        ...
        if (in_stack_00000088 == pcStack0000000000000078) {
          __ZN5alloc7raw_vec19RawVec_LT_T_C_A_GT_8grow_one17h0fc00cbe580b1e89E(&stack0x00000078);
        }
        puVar11 = puStack0000000000000080 + (long)pcVar5 * 3;
        *puVar11 = puVar10;
        puVar11[1] = lVar6;
        puVar11[2] = puVar10;
...
LAB_1005f8898:
        if ((char *)0x1 < in_stack_00000088) {
          ...
          puVar3 = puStack0000000000000080 + 2;
          puVar11 = puStack0000000000000080 + (long)in_stack_00000088 * 3 + -1;
          do {
            uVar17 = puVar3[-1];
            uVar12 = puVar3[-2];
            uVar14 = puVar11[-2];
        ...
        *(undefined1 *)((long)unaff_x19 + 0xcc) = 1;
        puStack0000000000000068 = puStack0000000000000080;
        pcStack0000000000000060 = pcStack0000000000000078;
