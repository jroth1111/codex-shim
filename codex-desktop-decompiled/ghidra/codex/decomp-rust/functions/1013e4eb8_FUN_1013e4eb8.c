...
/* WARNING: Removing unreachable block (ram,0x0001013e53ec) */

void FUN_1013e4eb8(undefined1 *param_1,char *param_2)
...
LAB_1013e5310:
    ...
    if ((byte)uStack_e0 == 4) {
      if (piStack_118 != (int *)0x0) {
        if (piStack_118 == (int *)0x1) goto LAB_1013e51c8;
    ...
    if ((byte)uStack_e0 == 0xc) {
      if (lStack_108 == 4) {
        if (*piStack_110 != 0x74786574) goto LAB_1013e5018;
        uStack_140 = (char *)((ulong)uStack_140._2_6_ << 0x10);
      }
      else if ((lStack_108 == 5) && (*piStack_110 == 0x69647561 && (char)piStack_110[1] == 'o')) {
        uStack_140 = (char *)CONCAT62(uStack_140._2_6_,0x100);
      }
      else {
LAB_1013e5018:
        pcStack_138 = (char *)FUN_1087e4494(piStack_110,lStack_108,&UNK_10b222898,2);
        uStack_140 = (char *)CONCAT71(uStack_140._1_7_,1);
      }
joined_r0x0001013e5198:
      if (piVar5 == (int *)0x0) goto LAB_1013e531c;
      _free(piVar6);
      pcVar8 = uStack_140;
      lVar9 = lStack_88;
      lStack_88 = lStack_68;
      goto joined_r0x0001013e5258;
    }
LAB_1013e53c0:
    pcStack_138 = (char *)FUN_108855b04(&uStack_e0,&uStack_51,&UNK_10b20e020);
    uStack_140 = (char *)CONCAT71(uStack_140._1_7_,1);
    lVar9 = lStack_88;
LAB_1013e5328:
    lStack_88 = lVar9;
    ...
    if ((byte)uStack_e0 == 0xd) {
      if (piStack_110 == (int *)0x4) {
        if (*piStack_118 == 0x74786574) goto LAB_1013e530c;
      }
      else if ((piStack_110 == (int *)0x5) &&
              (*piStack_118 == 0x69647561 && (char)piStack_118[1] == 'o')) goto LAB_1013e51c8;
      pcStack_138 = (char *)FUN_1087e4494(piStack_118,piStack_110,&UNK_10b222898,2);
LAB_1013e5124:
      uVar10 = 1;
      goto LAB_1013e5310;
    }
    if ((byte)uStack_e0 == 0xe) {
      func_0x000100b2fb20(&uStack_140,piStack_110,lStack_108);
      goto joined_r0x0001013e5198;
    }
    if ((byte)uStack_e0 != 0xf) goto LAB_1013e53c0;
    func_0x000100b2fb20(&uStack_140,piStack_118,piStack_110);
LAB_1013e5314:
    FUN_100e077ec(&uStack_e0);
LAB_1013e531c:
    pcVar8 = uStack_140;
    lVar9 = lStack_88;
    lStack_88 = lStack_68;
joined_r0x0001013e5258:
    bVar4 = (char)uStack_140 == '\x01';
    uStack_140 = pcVar8;
    lStack_68 = lStack_88;
    if (bVar4) goto LAB_1013e5328;
