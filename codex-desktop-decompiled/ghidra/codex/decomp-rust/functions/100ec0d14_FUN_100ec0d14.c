...
LAB_100ec0eac:
          ...
          if (bVar5 == 0x10) {
            ...
            if (bVar5 == 0x11) {
              func_0x000100ec7314(&ppuStack_f8,*(undefined8 *)(lVar16 + lVar17 + 0x28));
              ...
              func_0x000100ec7314(&ppuStack_f8);
              ppuVar18 = ppuStack_f8;
              in_x10 = puStack_f0;
              puStack_200 = puStack_e8;
              uStack_1f8 = uStack_e0;
...
LAB_100ec0d90:
  ...
  if (cVar6 != '\x10') {
    if (cVar6 == '\x11') {
      func_0x000100ec7314(&ppuStack_f8,*(undefined8 *)(*(char **)(param_2 + 0x10) + 8));
      ppuVar19 = ppuStack_f8;
      puVar13 = puStack_f0;
