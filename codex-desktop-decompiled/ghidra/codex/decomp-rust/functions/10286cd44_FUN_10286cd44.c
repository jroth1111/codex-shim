...
undefined1  [16] FUN_10286cd44(byte *param_1,long param_2)
  ...
  if (param_2 != 0) {
    do {
      ...
      if ((4 < uVar10 - 9) && (uVar10 != 0x20)) {
        if (uVar10 < 0x80) goto joined_r0x00010286ce7c;
        uVar4 = uVar10 >> 8;
        if (uVar4 < 0x20) {
          if (uVar4 == 0) {
            bVar1 = (&
...
joined_r0x00010286ce54:
            if ((bVar1 & 1) == 0) goto joined_r0x00010286ce7c;
          }
          else if ((uVar4 != 0x16) || (uVar10 != 0x1680)) goto joined_r0x00010286ce7c;
        }
        else {
          if (uVar4 == 0x20) {
            bVar1 = (byte)(&
            ...
            goto joined_r0x00010286ce54;
          }
          if ((uVar4 != 0x30) || (uVar10 != 0x3000)) goto joined_r0x00010286ce7c;
        }
      }
      pbVar6 = pbVar7;
      pbVar8 = pbVar9;
...
LAB_10286ce64:
  ...
  pbVar7 = param_1;
  pbVar8 = (byte *)0x0;
joined_r0x00010286ce7c:
  do {
    do {
      pbVar6 = pbVar5;
      if (pbVar7 == pbVar6) goto LAB_10286ce64;
      pbVar5 = pbVar6 + -1;
      bVar1 = *pbVar5;
...
LAB_10286cf74:
      ...
      else if ((uVar4 != 0x16) || (uVar10 != 0x1680)) goto LAB_10286cf74;
      goto joined_r0x00010286ce7c;
    }
    if (uVar4 == 0x20) {
      bVar1 = (byte)(&
                    __ZN4core7unicode12unicode_data11white_space14WHITESPACE_MAP17h395e3fa068a5bcc2E
                    )[uVar11 & 0xff] >> 1;
      goto joined_r0x00010286cf70;
    }
    if ((uVar4 != 0x30) || (uVar10 != 0x3000)) goto LAB_10286cf74;
  } while( true );
}
