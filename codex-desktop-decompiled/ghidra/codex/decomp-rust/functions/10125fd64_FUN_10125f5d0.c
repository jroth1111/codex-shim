...
void FUN_10125f5d0(undefined8 *param_1,char *param_2)

{
  ...
  if (*param_2 != '\x15') {
    uVar15 = FUN_108855c40(param_2,&ppppppiStack_98,&UNK_10b213348);
    ...
    if ((byte)uStack_2f0 == '\x16') {
      ...
      if (cVar3 != '\x10') {
        if (cVar3 == '\x11') {
          ...
          if (cVar3 == '\x12') goto LAB_10125f7cc;
...
LAB_1012600fc:
        ...
        pcVar7 = (code *)SoftwareBreakpoint(1,0x101260100);
        (*pcVar7)();
      }
      ...
      if (bVar6 < 0xd) {
        ...
        if (bVar6 == 0xc) {
          if (piStack_2d8 == (int *)0x3) {
            ...
            if (piStack_2d8 != (int *)0x5) goto LAB_10125fafc;
            iVar10 = 2;
          ...
          goto joined_r0x00010125fa68;
        }
LAB_101260204:
        piStack_d8 = piStack_330;
        pppppppiStack_e0 = pppppppiVar17;
        piVar9 = (int *)FUN_108855b04(&uStack_2f0,&ppppppiStack_98,&UNK_10b2113a0);
LAB_101260040:
...
LAB_101260068:
        ...
        if (bVar6 == 0xd) {
          if (pppppppiStack_2e0 == (int *******)0x3) {
            ...
            if (pppppppiStack_2e0 != (int *******)0x5) goto LAB_10125fb68;
            iVar10 = 2;
...
LAB_10125fb98:
          ...
          if (bVar6 != 0xe) {
            if (bVar6 != 0xf) goto LAB_101260204;
            if (pppppppiStack_2e0 == (int *******)0x3) {
              if ((((char)*piStack_2e8 != 'u') || (*(char *)((long)piStack_2e8 + 1) != 'r')) ||
                 (*(char *)((long)piStack_2e8 + 2) != 'i')) goto LAB_10125fb68;
              iVar10 = 1;
            }
...
LAB_10125fb68:
          ...
          if (piStack_2d8 == (int *)0x3) {
            if (((*(char *)pppppppiStack_2e0 != 'u') ||
               ...
               (*(char *)((long)pppppppiStack_2e0 + 2) != 'i')) goto LAB_10125fafc;
            iVar10 = 1;
          }
...
LAB_10125fca4:
        ...
        pppppppiStack_e0 = pppppppiVar17;
        piVar9 = (int *)FUN_108856088(s_duplicate_field_____108ac2973,&uStack_2f0);
        if (ppppppiVar18 == (int ******)0x0) goto LAB_10125fdbc;
      }
      _free(piStack_338);
      uVar15 = 1;
...
LAB_10125fd28:
    ...
    pppppppiVar17 = (int *******)0x8000000000000001;
    uVar15 = 1;
    if (ppppppiVar18 == (int ******)0x8000000000000000) goto LAB_10125fd44;
LAB_10125fcf0:
    ...
    piStack_158 = piStack_2d8;
    pppppppiStack_160 = pppppppiStack_2e0;
    if ((char)pppppppiStack_120 == '\x16') goto LAB_10125ff08;
LAB_10125fe30:
    FUN_100e077ec(&pppppppiStack_120);
    piVar9 = piStack_338;
    if (ppppppiVar18 != (int ******)0x8000000000000000) {
LAB_10125ff08:
    ...
    if (ppppppiVar18 != (int ******)0x8000000000000000) goto LAB_10125fcf0;
LAB_10125fd44:
