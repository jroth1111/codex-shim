...
void FUN_101355464(undefined8 *param_1,byte *param_2)
...
LAB_101355998:
      pbStack_e8 = pbVar14;
      pbVar17 = (byte *)FUN_1087e422c(0,&UNK_10b232320,&UNK_10b20a590);
LAB_1013559b4:
...
LAB_1013559bc:
      ...
      if (*pbVar18 == 0x16) goto LAB_101355998;
      ...
      pbVar17 = pbStack_98;
      puVar15 = puStack_a0;
      if (puStack_a0 == (undefined *)0x8000000000000000) goto LAB_1013559b4;
      if (lVar12 == 1) {
LAB_101355a5c:
        pbVar8 = (byte *)FUN_1087e422c(1,&UNK_10b232320,&UNK_10b20a590);
LAB_101355a74:
        *param_1 = 0x8000000000000000;
        param_1[1] = pbVar8;
      ...
      pbStack_e8 = pbVar14;
      if (pbVar18[0x20] == 0x16) goto LAB_101355a5c;
      ...
      pbVar8 = pbStack_98;
      puVar6 = puStack_a0;
      if (puStack_a0 == (undefined *)0x8000000000000000) goto LAB_101355a74;
      *param_1 = puVar15;
      param_1[1] = pbVar17;
      param_1[2] = uVar9;
      ...
      if (lVar12 == 0) goto LAB_101355c58;
      *param_1 = 0x8000000000000000;
      param_1[1] = lVar12;
      if (puVar15 != (undefined *)0x0) {
        _free(pbVar17);
  ...
  if (bVar3 != 0x15) {
    uVar9 = FUN_108855b04(param_2,&puStack_a0,&UNK_10b20bee0);
    *param_1 = 0x8000000000000000;
    param_1[1] = uVar9;
    return;
  }
        ...
        if (bVar2 == 1) {
          ...
          if (bVar2 != 4) {
            if (bVar2 == 0xc) {
              if (lStack_70 == 5) {
                iVar10 = 1;
                if ((int)*plVar5 != 0x72657571 || *(char *)((long)plVar5 + 4) != 'y') {
                  iVar10 = 2;
                }
              }
              else if (lStack_70 == 9) {
              ...
              goto joined_r0x0001013557dc;
            }
LAB_101355e48:
            lStack_b0 = lVar20 + 1;
            pbStack_c8 = pbVar17;
            uVar9 = FUN_108855b04(&bStack_88,&puStack_a0,&UNK_10b211c60);
            goto LAB_101355aec;
          }
          iVar11 = 1;
          if (plVar4 != (long *)0x1) {
...
LAB_10135585c:
        ...
        if (bVar2 == 0xd) {
          if (plVar5 == (long *)0x5) {
            iVar10 = 1;
            if ((int)*plVar4 != 0x72657571 || *(char *)((long)plVar4 + 4) != 'y') {
              iVar10 = 2;
            }
          }
          else {
            if (plVar5 != (long *)0x9) goto LAB_101355828;
            iVar10 = 2;
        ...
        if (bVar2 != 0xe) {
          if (bVar2 != 0xf) goto LAB_101355e48;
          if (plVar5 == (long *)0x5) {
            if (((((char)*plVar4 != 'q') || (*(char *)((long)plVar4 + 1) != 'u')) ||
                (*(char *)((long)plVar4 + 2) != 'e')) ||
               ((*(char *)((long)plVar4 + 3) != 'r' || (*(char *)((long)plVar4 + 4) != 'y'))))
            goto LAB_101355828;
            iVar10 = 1;
          }
...
LAB_101355828:
        ...
        if (lStack_70 == 5) {
          if ((((char)*plVar5 != 'q') || (*(char *)((long)plVar5 + 1) != 'u')) ||
             ((*(char *)((long)plVar5 + 2) != 'e' ||
              ((*(char *)((long)plVar5 + 3) != 'r' || (*(char *)((long)plVar5 + 4) != 'y'))))))
          goto LAB_1013557a4;
          iVar10 = 1;
        }
        else if (((((lStack_70 == 9) && ((char)*plVar5 == 's')) &&
...
LAB_101355e44:
          ...
          pcVar7 = (code *)SoftwareBreakpoint(1,0x101355e48);
          (*pcVar7)();
        }
        uVar9 = *puVar13;
        puVar16[1] = puVar13[1];
    ...
    pbStack_c8 = pbVar18;
    lStack_b0 = lVar21;
    if (puVar15 == (undefined *)0x8000000000000000) goto LAB_101355ab8;
    if (puVar19 != (undefined *)0x8000000000000000) {
      *param_1 = puVar15;
