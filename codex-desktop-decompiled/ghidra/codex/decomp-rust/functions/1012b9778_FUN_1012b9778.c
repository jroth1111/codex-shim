...
/* WARNING: Removing unreachable block (ram,0x0001012b9e58) */

void FUN_1012b9778(undefined1 *param_1,char *param_2)
...
LAB_1012b9e78:
            ...
            pcStack_138 = (char *)__ZN66__LT_serde_json__error__Error_u20_as_u20_serde_core__de__Error_GT_13invalid_value17h60b1f9f2e2975d54E
                                            (&cStack_a0,&UNK_10b2329f0,&UNK_10b20a590);
            goto LAB_1012b9e9c;
          }
LAB_1012b9b30:
          uVar11 = 1;
...
LAB_1012b9d4c:
          ...
          if (uStack_e0._1_1_ != 3) goto LAB_1012b9e78;
LAB_1012b9ce4:
          uVar11 = 3;
        }
      }
      else if (uStack_e0._1_1_ < 6) {
        if (uStack_e0._1_1_ == 4) {
LAB_1012b9d58:
          uVar11 = 4;
        }
        else {
          if (uStack_e0._1_1_ != 5) goto LAB_1012b9e78;
LAB_1012b9d38:
          uVar11 = 5;
        }
      }
...
LAB_1012b9d70:
      ...
      else if (uStack_e0._1_1_ == 7) {
LAB_1012b9d64:
        uVar11 = 7;
      }
      else {
        if (uStack_e0._1_1_ != 8) goto LAB_1012b9e78;
LAB_1012b9a38:
        uVar11 = 8;
      }
      uVar8 = 0;
...
LAB_1012b9d7c:
    ...
    if ((byte)uStack_e0 == 4) {
      if (lStack_118 < 4) {
        if (lStack_118 < 2) {
          if (lStack_118 == 0) goto LAB_1012b9d44;
          if (lStack_118 == 1) goto LAB_1012b9b30;
        }
        else {
          if (lStack_118 == 2) goto LAB_1012b9d4c;
          if (lStack_118 == 3) goto LAB_1012b9ce4;
        }
      }
      else if (lStack_118 < 6) {
        if (lStack_118 == 4) goto LAB_1012b9d58;
        if (lStack_118 == 5) goto LAB_1012b9d38;
      }
      else {
        if (lStack_118 == 6) goto LAB_1012b9d70;
        if (lStack_118 == 7) goto LAB_1012b9d64;
        if (lStack_118 == 8) goto LAB_1012b9a38;
      }
...
LAB_1012b9e9c:
    ...
    if ((byte)uStack_e0 == 0xc) {
      FUN_100be0044(&uStack_140,uStack_110,lStack_108);
      goto LAB_1012b9938;
    }
LAB_1012b9e2c:
    pcStack_138 = (char *)FUN_108855b04(&uStack_e0,&uStack_51,&UNK_10b20f4e0);
...
LAB_1012b9d94:
    ...
    if ((byte)uStack_e0 == 0xd) {
      FUN_100be0044(&uStack_140,lStack_118,uStack_110);
LAB_1012b9d80:
      FUN_100e077ec(&uStack_e0);
LAB_1012b9d88:
      pcVar9 = uStack_140;
      ...
      if ((byte)uStack_e0 != 0xe) {
        if ((byte)uStack_e0 != 0xf) goto LAB_1012b9e2c;
        FUN_100bdfbb8(&uStack_140,lStack_118,uStack_110);
        goto LAB_1012b9d80;
      }
      FUN_100bdfbb8(&uStack_140,uStack_110,lStack_108);
LAB_1012b9938:
      if (lVar10 == 0) goto LAB_1012b9d88;
      _free(uVar7);
      pcVar9 = uStack_140;
      lVar10 = lStack_88;
      lStack_88 = lStack_68;
    ...
    if (3 < uStack_140._1_1_) {
      if (uStack_140._1_1_ < 6) {
        if (uStack_140._1_1_ == 4) {
          if (uVar1 == 0x16) goto LAB_1012b9ca0;
          if ((uVar1 == 0x12) || ((uVar1 == 0x15 && (lStack_88 == 0)))) goto LAB_1012b9c98;
      ...
      else if (uStack_140._1_1_ == 6) {
        if (uVar1 == 0x16) goto LAB_1012b9ca0;
        if ((uVar1 == 0x12) || ((uVar1 == 0x15 && (lStack_88 == 0)))) goto LAB_1012b9c98;
        pcVar9 = (char *)FUN_108855b04(&cStack_a0,&uStack_51,&UNK_10b20a5c0);
      }
      else if (uStack_140._1_1_ == 7) {
        if (uVar1 == 0x16) goto LAB_1012b9ca0;
        if ((uVar1 == 0x12) || ((uVar1 == 0x15 && (lStack_88 == 0)))) goto LAB_1012b9c98;
        pcVar9 = (char *)FUN_108855b04(&cStack_a0,&uStack_51,&UNK_10b20a5c0);
      }
