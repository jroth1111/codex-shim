...

{
  ...
  uVar1 = thunk_FUN_108856088(s_missing_field_____108ac28f7,&stack0x00000410);
  *in_stack_00000180 = unaff_x28;
  in_stack_00000180[1] = uVar1;
  ...
  if (*in_stack_00000180 == 0x8000000000000000) {
    ...
    if (in_stack_00000188 != unaff_x20) {
      uVar1 = thunk_FUN_1087e422c(in_stack_000000b8,&UNK_10b21cb90,&UNK_10b20a590);
