...
void FUN_1012232c8(ulong *param_1,char *param_2)
...
LAB_101223bc8:
        ...
        pcVar8 = (code *)SoftwareBreakpoint(1,0x101223bcc);
        (*pcVar8)();
      }
      uStack_118 = 0;
      uStack_128 = uVar21;
                  ...
                  if (bVar4 != 1) {
                    ...
                    if (bVar4 == 0xc) {
                      if (lStack_70 == 4) {
                        ...
                        if (iVar3 == 0x656d616e) goto LAB_10122360c;
                      }
...
LAB_101223944:
                    ...
                    pbStack_c8 = pbVar27;
                    pbVar12 = (byte *)FUN_108855b04(&uStack_88,&puStack_a0,&UNK_10b211ba0);
...
LAB_10122359c:
                  ...
                  if (bVar4 != 0xe) {
                    if (bVar4 != 0xf) goto LAB_101223944;
                    if ((((piStack_78 != (int *)0x4) || ((char)*piStack_80 != 'n')) ||
                        (*(char *)((long)piStack_80 + 1) != 'a')) ||
                       (*(char *)((long)piStack_80 + 2) != 'm')) goto LAB_10122359c;
                  ...
                  if (piStack_80 == (int *)0x0) goto LAB_1012235a8;
                  _free();
                  if (bVar9) goto LAB_1012235ac;
LAB_10122360c:
...
LAB_1012237f4:
          ...
          pcStack_148 = pcVar24;
          pbStack_130 = pbVar20;
          uVar21 = FUN_108855b04(acStack_110,&puStack_a0,&UNK_10b20b280);
...
LAB_1012236ac:
          pbStack_e8 = pbVar31;
          pbVar11 = (byte *)FUN_1087e422c(0,&UNK_10b231788,&UNK_10b20a590);
LAB_1012236c8:
...
LAB_1012236f8:
          ...
          bVar4 = *pbStack_100;
          if (bVar4 == 0x16) goto LAB_1012236ac;
          ...
          *(undefined8 *)((long)puVar22 + 0xf) = uVar32;
          ...
          puVar26 = puStack_a0;
          pbVar11 = pbStack_98;
          if (puStack_a0 == (undefined *)0x8000000000000000) goto LAB_1012236c8;
...
LAB_101223888:
        ...
        *puVar15 = puVar26;
        ...
        if (pcVar24 != pcVar25) goto code_r0x0001012238d8;
        goto LAB_101223a18;
      }
      pcVar16 = pcVar17 + 0x20;
      pbVar1 = (byte *)0x0;
...
LAB_101223a3c:
    ...
    uVar21 = FUN_108855b04(param_2,&puStack_a0,&UNK_10b20a380);
    *param_1 = 0x8000000000000000;
    param_1[1] = uVar21;
  }
  return;
code_r0x0001012238d8:
  pcVar16 = pcVar24 + 0x20;
  pcVar23 = pcVar24;
  unaff_x24 = pbVar27;
  pbVar1 = pbVar20;
  cVar7 = *pcVar24;
  if (*pcVar24 == '\x16') goto LAB_101223a18;
  goto LAB_1012233b0;
}
