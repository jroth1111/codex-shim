...
void FUN_1012d3404(undefined8 *param_1,ulong *param_2)

{
  ...
  uVar12 = uVar15;
  if (uVar6 == 0) {
    func_0x0001016184d8(&uStack_2d8,param_2 + 1);
...
LAB_1012d3958:
            ...
            pcVar3 = (code *)SoftwareBreakpoint(1,0x1012d395c);
            (*pcVar3)();
          }
          ...
          *(undefined8 *)((long)puVar4 + 0x2e) = 0x656c626174207974;
          ...
          if (*plVar18 == -0x7fffffffffffffff) goto LAB_1012d35c4;
          uVar5 = plVar18[3];
          uVar1 = plVar18[4];
          lStack_e0 = plVar18[1];
          lStack_d8 = plVar18[2];
          ...
          uStack_f0 = uVar1;
          lStack_e8 = *plVar18;
          func_0x0001016184d8(&uStack_158,&lStack_e8);
          ...
          if (uStack_158 == 2) {
            ...
            if (lVar2 == -0x7ffffffffffffffa) {
              if (uVar17 == 2) goto LAB_1012d34dc;
              uVar5 = uVar13 >> 8;
            }
            else {
              lStack_220 = lVar2;
...
LAB_1012d393c:
        ...
        *(undefined8 *)((long)puVar4 + 0x1a) = 0x203020646e756f66;
        ...
        if (puVar4 == (undefined8 *)0x0) goto LAB_1012d393c;
        puVar4[1] = 0x3120796c74636178;
        *puVar4 = 0x65206465746e6177;
