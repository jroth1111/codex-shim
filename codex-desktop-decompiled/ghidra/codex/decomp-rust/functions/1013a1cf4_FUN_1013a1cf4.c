...
void FUN_1013a1cf4(undefined8 *param_1,byte *param_2)

{
  ...
  if (bVar4 != 0x14) {
    if (bVar4 != 0x15) {
      uVar10 = FUN_108855b04(param_2,auStack_69,&UNK_10b20bf80);
...
LAB_1013a1fc4:
                bStack_8f = 3;
                goto joined_r0x0001013a21dc;
              }
              bStack_8f = 0;
              bStack_90 = 0;
            }
joined_r0x0001013a1f94:
            if (pbVar19 != (byte *)0x0) {
              _free(plVar6);
            }
          }
...
LAB_1013a21ec:
            uVar10 = FUN_108855b04(&uStack_b0,auStack_69,&UNK_10b210700);
          ...
          if (bVar3 == 0xd) {
            if (plStack_a0 == (long *)0xa) {
              ...
              if ((*(long *)pbStack_a8 != 0x614d65746f6d6572 ||
                  ...
                  *(long *)(pbStack_a8 + 0xd) != 0x656d614e6563616c) goto LAB_1013a2058;
              bStack_8f = 1;
            }
...
LAB_1013a2058:
          ...
          if (bVar3 == 0xe) {
            func_0x000100baaca0(&bStack_90,plStack_a0);
            goto joined_r0x0001013a1f94;
          }
          if (bVar3 != 0xf) goto LAB_1013a21ec;
          func_0x000100baaca0(&bStack_90,pbStack_a8,plStack_a0);
LAB_1013a2064:
...
joined_r0x0001013a2480:
          if (puVar13 != (undefined *)0x0) {
            _free(pbStack_128);
          }
          bVar8 = true;
          if (puVar17 == (undefined *)0x8000000000000001) goto LAB_1013a24dc;
LAB_1013a24d4:
          bVar8 = true;
          if (((ulong)puVar17 & 0x7fffffffffffffff) == 0) goto LAB_1013a24dc;
          _free(pbStack_138);
          bVar5 = uStack_108 != 0x8000000000000001;
          goto joined_r0x0001013a251c;
        }
        ...
        if (bStack_8f == 2) {
          ...
          *param_1 = 0x8000000000000000;
          ...
          bVar8 = true;
          if (puVar17 != (undefined *)0x8000000000000001) goto LAB_1013a24d4;
          goto LAB_1013a24dc;
        }
        pbStack_100 = (byte *)CONCAT71(pbStack_100._1_7_,0x16);
        if (bVar3 == 0x16) {
...
LAB_1013a2808:
          ...
          pcVar7 = (code *)SoftwareBreakpoint(1,0x1013a280c);
          (*pcVar7)();
        }
        uVar10 = *puVar14;
        puVar12[1] = puVar14[1];
...
LAB_1013a232c:
    ...
    if (uVar1 == 0x8000000000000001) {
      uVar10 = FUN_1087e422c(0,&UNK_10b231be8,&UNK_10b20a590);
      goto LAB_1013a2248;
    }
    pbVar15 = pbStack_f8;
...
LAB_1013a22f8:
      pbStack_f8 = pbVar15;
      pbVar15 = pbStack_f8;
      pbVar9 = (byte *)FUN_1087e422c(1,&UNK_10b231be8,&UNK_10b20a590);
LAB_1013a2314:
      *param_1 = 0x8000000000000000;
      param_1[1] = pbVar9;
LAB_1013a231c:
    ...
    bVar3 = *pbStack_f8;
    if (bVar3 == 0x16) goto LAB_1013a22f8;
    ...
    pbVar9 = pbStack_a8;
    puVar13 = uStack_b0;
    if (uStack_b0 == (undefined *)0x8000000000000001) goto LAB_1013a2314;
    if (pbVar15 == pbVar20) {
LAB_1013a2560:
      pbVar11 = (byte *)FUN_1087e422c(2,&UNK_10b231be8,&UNK_10b20a590);
LAB_1013a2578:
      *param_1 = 0x8000000000000000;
      param_1[1] = pbVar11;
    ...
    pbStack_f8 = pbVar15;
    if (pbVar11[0x20] == 0x16) goto LAB_1013a2560;
    ...
    pbVar11 = pbStack_a8;
    puVar17 = uStack_b0;
    if (uStack_b0 == (undefined *)0x8000000000000000) goto LAB_1013a2578;
    *param_1 = uStack_b0;
    param_1[1] = pbStack_a8;
    ...
    if (lVar18 == 0) goto LAB_1013a25bc;
    *param_1 = 0x8000000000000000;
    param_1[1] = lVar18;
    if ((uVar1 & 0x7fffffffffffffff) != 0) {
      _free(uVar10);
