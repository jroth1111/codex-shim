...
void FUN_100325cec(undefined8 param_1,undefined8 param_2)

{
  ...
  *(undefined8 *)(unaff_x29 + -0xa8) = param_1;
  ...
  if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
    ...
    lVar8 = *(long *)(unaff_x23 + 0x708);
    in_stack_000000e0 = *(undefined8 *)(lVar8 + 0x20);
    in_stack_000000e8 = *(undefined8 *)(lVar8 + 0x28);
    in_stack_000000d8 = (undefined *)0x5;
    ...
    iVar6 = (**(code **)(puVar2 + 0x18))(puVar3,&stack0x000000d8);
    if (iVar6 != 0) {
      __ZN7tracing15__macro_support13__tracing_log17h72768b16bee39960E
                (lVar8,puVar3,puVar2,&stack0x000000d8,unaff_x29 + -0xc0);
    }
  }
  ...
  if (*unaff_x20 == 0) {
    ...
    uVar7 = (**(code **)(unaff_x20[3] + lVar8))(unaff_x20[2]);
    if ((uVar7 & 1) == 0) goto LAB_100325f70;
  }
  if ((*unaff_x26 == 0) &&
    ...
    lVar8 = ___ZN18aws_smithy_runtime6client4http4body18minimum_throughput15http_body_0_4_x136__LT_impl_u20_http_body__Body_u20_for_u20_aws_smithy_runtime__client__http__body__minimum_throughput__ThroughputReadingBody_LT_B_GT__GT_9poll_data10__CALLSITE17hcb2bed1c14e717dcE
            + 0x30;
    ...
    *(long *)(unaff_x29 + -0xa8) = lVar8;
    ...
    if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
      ...
      iVar6 = (**(code **)(puVar2 + 0x18))(puVar3,&stack0x00000048);
      if (iVar6 != 0) {
        ...
        *(long *)(unaff_x29 + -0xa8) = lVar1;
        __ZN7tracing15__macro_support13__tracing_log17h72768b16bee39960E
                  (lVar8,puVar3,puVar2,&stack0x00000048,unaff_x29 + -0xc0);
      }
    }
  }
