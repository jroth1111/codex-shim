...
void FUN_100eaa368(undefined8 *param_1,char *param_2)
...
LAB_100eaa3d4:
      do {
        while( true ) {
          ...
          puVar5 = puStack_118;
          if ((char)uStack_120 == '\x01') goto joined_r0x000100eaa4c4;
...
LAB_100eaa948:
            ...
            pcVar3 = (code *)SoftwareBreakpoint(1,0x100eaa968);
            (*pcVar3)();
          }
        }
        if (uStack_120._1_1_ != '\0') {
          if (uStack_120._1_1_ != '\x01') {
            if (bVar1) {
              ...
              if (lStack_1e0 - lStack_1e8 == 0) goto LAB_100eaa650;
          ...
          FUN_101292628(&uStack_120);
          puVar5 = puStack_118;
          if (uStack_120 == (undefined **)0x8000000000000000) goto LAB_100eaa74c;
        ...
        lStack_1d8 = 0;
        if (lVar6 == 0) goto LAB_100eaa948;
        puVar5 = (undefined *)FUN_10136bab8();
        bVar1 = true;
      } while (puVar5 == (undefined *)0x0);
joined_r0x000100eaa4c4:
      if (ppuVar7 != (undefined **)0x8000000000000000) {
joined_r0x000100eaaa04:
      ...
      puVar5 = (undefined *)FUN_108855c40(param_2,&uStack_61,&UNK_10b213948);
    }
    goto LAB_100eaa74c;
  }
  ...
  if (pppuVar8 == (undefined ***)0x0) {
    ...
    puVar5 = (undefined *)FUN_10136bab8(lVar6);
    if (puVar5 != (undefined *)0x0) goto LAB_100eaa74c;
    if (pppuVar8 != (undefined ***)0x1) {
      FUN_101292628(&uStack_120,lVar6 + 0x20);
      puVar5 = puStack_118;
...
LAB_100eaa650:
        ...
        if (ppuStack_280 == (undefined **)0x8000000000000000) {
          ...
          if (ppuStack_1c8 == (undefined **)0x8000000000000000) goto LAB_100eaa89c;
        }
        else {
