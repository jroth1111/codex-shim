...
void FUN_103e5d3c8(ulong *param_1)
...
LAB_103e5d544:
      uVar5 = uStack_88;
      if (iVar1 == 0) {
        FUN_103dbcaf0(param_1 + 7);
      }
    }
    _memcpy(puVar9,auStack_b68,0xae0);
...
LAB_103e5d590:
    ...
    *param_1 = uStack_78 + uStack_80 * -0x40;
    ...
    if ((uVar7 >> 1 & 1) != 0) goto LAB_103e5d4f8;
    if ((uVar7 >> 3 & 1) == 0) {
      auStack_b68[0] = 2;
      unaff_x21 = param_1[5];
      unaff_x20 = (*
      ...
      if (*(char *)(unaff_x20 + 0x48) == '\x01') goto LAB_103e5d528;
      if (*(char *)(unaff_x20 + 0x48) != '\x02') goto LAB_103e5d510;
      uStack_88 = 0;
      puVar9 = param_1 + 6;
      iVar1 = (int)*puVar9;
      if (iVar1 != 1) goto LAB_103e5d544;
      goto LAB_103e5d44c;
    }
    if ((uVar7 >> 4 & 1) == 0) goto LAB_103e5d590;
    if (param_1[0x164] != 0) {
      (**(code **)(param_1[0x164] + 0x10))(param_1[0x165]);
      LOAcquire();
      uVar2 = *param_1;
      *param_1 = uVar2 & 0xffffffffffffffef;
      ...
      if ((uVar7 >> 1 & 1) == 0) {
        ...
        if ((uVar7 >> 4 & 1) != 0) {
          if ((uVar7 >> 3 & 1) == 0) {
            if (param_1[0x164] != 0) {
              (**(code **)(param_1[0x164] + 0x18))(param_1[0x165]);
            }
            param_1[0x164] = 0;
          }
          goto LAB_103e5d590;
...
LAB_103e5d678:
  ...
  pcVar8 = (code *)SoftwareBreakpoint(1,0x103e5d67c);
  (*pcVar8)();
}
