  ...
  if (*param_2 != '\x14') {
    ...
    if (lVar12 == 0) {
      ...
      do {
        ...
        if (bVar9 != 0xd) {
          if (bVar9 == 0xe) {
            func_0x0001009e9818(&uStack_d0,*(undefined8 *)(lVar14 + lVar11 + 0x10),
...
joined_r0x000100ebf9c4:
            ...
            if (bVar9 == 0xf) {
              func_0x0001009e9818(&uStack_d0,*(undefined8 *)(lVar14 + lVar11 + 8),
...
LAB_100ebfaa0:
        if (uStack_d0._1_1_ < 2) {
          if (uStack_d0._1_1_ == 0) {
            ...
            func_0x00010133a4e4(&uStack_d0,pbVar13);
          ...
          if (bVar9 != 0x10) {
            ...
            func_0x000101438f4c(&uStack_d0,pbVar13);
            ppuVar17 = uStack_d0;
...
LAB_100ebfc70:
  ...
  func_0x00010133a4e4(&uStack_d0,lVar12);
...
LAB_100ebfeec:
      ...
      func_0x000101438f4c(&uStack_d0,pcVar7);
