...
undefined8 FUN_1014e4034(undefined8 param_1)

{
  ...
  pcStack0000000000000100 = s_________abort_spawned_attempt_to_108ad8806;
  puStack0000000000000050 = (undefined1 *)&stack0x00000100;
  puStack0000000000000058 = &UNK_10b208fd0;
  puStack00000000000000a8 = (undefined1 *)&stack0x00000050;
  uStack00000000000000a0 = 1;
  uStack00000000000000b0 = 1;
  uStack00000000000000b8 = param_1;
  FUN_1014a159c(&stack0x000000a0);
  uVar6 = unaff_x19[0xe];
  if ((int)uVar6 != 0) {
    pcVar5 = (char *)unaff_x19[0xd];
    if (*pcVar5 == '\0') {
      *pcVar5 = '\x01';
    }
    else {
    ...
    FUN_1060fa678(pcVar5,(int)uVar6,pcVar5);
  }
  ...
  *(undefined1 *)((long)unaff_x19 + 0xb1) = 1;
  ...
  if ((*unaff_x24 == '\0') && (uVar6 = unaff_x19[4], uVar6 != 0)) {
    uStack00000000000000a0 = *(undefined8 *)(uVar6 + 0x10);
    puStack00000000000000a8 = *(undefined1 **)(uVar6 + 0x18);
