...
void FUN_103e5dd30(ulong *param_1)
...
LAB_103e5df0c:
    ...
    *param_1 = uStack_68 + uStack_70 * -0x40;
    ...
    if ((uVar6 >> 1 & 1) != 0) goto LAB_103e5de58;
    if ((uVar6 >> 3 & 1) == 0) {
      uStack_e8 = 2;
      unaff_x21 = param_1[5];
      unaff_x20 = (*
      ...
      if (*(char *)(unaff_x20 + 0x48) == '\x01') goto LAB_103e5de88;
      if (*(char *)(unaff_x20 + 0x48) != '\x02') goto LAB_103e5de70;
      uVar9 = 0;
      puVar8 = param_1 + 6;
      iVar1 = (int)*puVar8;
      if (iVar1 != 1) goto LAB_103e5dea4;
      goto LAB_103e5ddac;
    }
    if ((uVar6 >> 4 & 1) == 0) goto LAB_103e5df0c;
    if (param_1[0x16] != 0) {
...
LAB_103e5dff0:
  ...
  pcVar7 = (code *)SoftwareBreakpoint(1,0x103e5dff4);
  (*pcVar7)();
}
