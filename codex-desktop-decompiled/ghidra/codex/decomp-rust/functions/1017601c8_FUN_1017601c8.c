...
void FUN_1017601c8(undefined8 param_1,ulong param_2)

{
  ...
  pcVar9 = s__external_auth_refresh_returned_w_108ac3627;
  if ((param_2 & 1) == 0) {
    uVar8 = 0x29;
    bVar3 = 0;
    uVar6 = 0;
...
LAB_100024148:
  ...
  iVar5 = __ZN4core3fmt5write17h64810b21425781ecE
                    (&uStack_20,&UNK_10b1d24a0,s__external_auth_refresh_returned_w_108ac3627,param_2
                    );
  if (iVar5 == 0) {
