...
LAB_101308a90:
        ...
        if (bVar11 != 0xe) {
          ...
          func_0x000100b667a8(&bStack_100,plStack_98,plStack_90);
          goto LAB_101308688;
        }
        func_0x000100b667a8(&bStack_100,plStack_90);
...
LAB_101308708:
            ...
            if (cVar3 == '\x11') {
              ...
              func_0x00010145ac5c(&bStack_100,&uStack_a0);
              _free(puVar4);
              ...
              cStack_c0 = cVar3;
              func_0x00010145ac5c(&bStack_100,&cStack_c0);
              lVar12 = CONCAT62(uStack_fe,CONCAT11(bStack_ff,bStack_100));
            }
            if (lVar12 == -0x7fffffffffffffff) {
              pcStack_160 = pcVar17 + 1;
...
LAB_101308770:
          ...
          lStack_88 = puVar4[3];
          plStack_90 = (long *)puVar4[2];
          func_0x00010140ec48(&bStack_100,&uStack_a0);
          _free(puVar4);
        }
        else {
          if (cVar3 == '\x12') goto LAB_101308770;
          func_0x00010140ec48(&bStack_100,&cStack_c0);
        }
