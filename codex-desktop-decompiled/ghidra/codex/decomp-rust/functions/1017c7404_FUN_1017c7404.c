...
/* WARNING: Removing unreachable block (ram,0x0001017c7994) */
/* WARNING: Type propagation algorithm not settling */

void FUN_1017c7404(undefined1 *param_1,char *param_2)
        ...
        if (uStack_e0._1_1_ != '\0') {
          if (uStack_e0._1_1_ != '\x01') {
            ...
            plStack_138 = (long *)__ZN66__LT_serde_json__error__Error_u20_as_u20_serde_core__de__Error_GT_13invalid_value17h60b1f9f2e2975d54E
                                            (&cStack_a0,&UNK_10b259a40,&UNK_10b258940);
            goto LAB_1017c7698;
          }
LAB_1017c774c:
...
LAB_1017c78ac:
      ...
      if ((byte)uStack_e0 == 4) {
        if (plStack_118 != (long *)0x0) {
          if (plStack_118 == (long *)0x1) goto LAB_1017c774c;
      ...
      if ((byte)uStack_e0 == 0xc) {
        if (lStack_108 == 10) {
          if (*plStack_110 == 0x61746e656d6d6f63 && (short)plStack_110[1] == 0x7972) {
            uStack_140 = (long *)((ulong)uStack_140._2_6_ << 0x10);
          }
          else {
LAB_1017c7578:
            plStack_138 = (long *)FUN_108878f8c(plStack_110,lStack_108,&UNK_10b259730,2);
            uStack_140 = (long *)CONCAT71(uStack_140._1_7_,1);
          }
        }
        else {
          if ((lStack_108 != 0xc) ||
             (*plStack_110 != 0x6e615f6c616e6966 || (int)plStack_110[1] != 0x72657773))
          goto LAB_1017c7578;
          uStack_140 = (long *)CONCAT62(uStack_140._2_6_,0x100);
        }
joined_r0x0001017c77c0:
        plVar10 = plVar6;
        if (plVar5 == (long *)0x0) goto LAB_1017c78b8;
        _free(plVar6);
        plVar5 = uStack_140;
        lVar9 = lStack_88;
        lStack_88 = lStack_68;
        goto joined_r0x0001017c77d4;
      }
LAB_1017c7968:
      plStack_138 = (long *)FUN_10888066c(&uStack_e0,&uStack_51,&UNK_10b258c50);
      uStack_140 = (long *)CONCAT71(uStack_140._1_7_,1);
      lVar9 = lStack_88;
LAB_1017c78c4:
      lStack_88 = lVar9;
...
joined_r0x0001017c79d8:
      bVar4 = true;
    }
    else {
      if ((byte)uStack_e0 == 0xd) {
        if (plStack_110 == (long *)0xa) {
          if (*plStack_118 == 0x61746e656d6d6f63 && (short)plStack_118[1] == 0x7972)
          goto LAB_1017c78a8;
        }
        else if ((plStack_110 == (long *)0xc) &&
                (*plStack_118 == 0x6e615f6c616e6966 && (int)plStack_118[1] == 0x72657773))
        goto LAB_1017c774c;
        plStack_138 = (long *)FUN_108878f8c(plStack_118,plStack_110,&UNK_10b259730,2);
LAB_1017c7698:
        uVar8 = 1;
        goto LAB_1017c78ac;
      }
      if ((byte)uStack_e0 == 0xe) {
        func_0x000101794d94(&uStack_140,plStack_110,lStack_108);
        goto joined_r0x0001017c77c0;
      }
      if ((byte)uStack_e0 != 0xf) goto LAB_1017c7968;
      func_0x000101794d94(&uStack_140,plStack_118,plStack_110);
LAB_1017c78b0:
...
LAB_1017c78b8:
      ...
      lVar9 = lStack_88;
      lStack_88 = lStack_68;
joined_r0x0001017c77d4:
      bVar4 = (char)uStack_140 == '\x01';
      uStack_140 = plVar5;
      lStack_68 = lStack_88;
      if (bVar4) goto LAB_1017c78c4;
      ...
      if (uStack_140._1_1_ == '\x01') {
        if (uVar1 == 0x16) {
          ...
          goto joined_r0x0001017c7840;
        }
        if ((uVar1 == 0x12) || ((uVar1 == 0x15 && (lStack_88 == 0)))) {
          uVar12 = 1;
          goto LAB_1017c7884;
        }
        plVar10 = (long *)FUN_10888066c(&cStack_a0,&uStack_51,&UNK_10b258970);
LAB_1017c79c4:
        uVar8 = bVar11 ^ 1;
        if (cVar3 == '\x15') {
          uVar8 = true;
        }
        goto joined_r0x0001017c79d8;
      }
      if (uVar1 == 0x16) {
        uVar12 = 0;
        bVar4 = false;
...
LAB_1017c76a4:
      ...
      plStack_138 = plVar10;
      if (cVar2 == '\x16') goto LAB_1017c76a4;
...
LAB_1017c74bc:
      ...
      if ((byte)uStack_e0 == '\x16') goto LAB_1017c74bc;
      func_0x0001017a6a48(&uStack_e0);
    ...
    plVar10 = (long *)func_0x000108a4a50c(&uStack_e0,&UNK_10b258960,&UNK_10b258940);
    func_0x0001017a6a48(param_2);
  }
