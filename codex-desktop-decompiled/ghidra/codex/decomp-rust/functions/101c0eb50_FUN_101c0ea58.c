...

{
  ...
  __ZN5alloc3fmt6format12format_inner17h63985d1d6aa0fe33E
            (unaff_x29 + -0x68,s_Array<_>_108ae5df7,&stack0x00000020);
  if (in_stack_00000048 != (undefined8 *)0x0) {
    _free(in_stack_00000050);
  }
  in_stack_00000048 = (undefined8 *)(unaff_x29 + -0x50);
  __ZN5alloc3fmt6format12format_inner17h63985d1d6aa0fe33E
            (&stack0x00000020,s_data_____108adff4d,&stack0x00000048);
  if (*(long *)(unaff_x29 + -0x68) != 0) {
    _free(*(undefined8 *)(unaff_x29 + -0x60));
  }
  lVar1 = (long)in_stack_00000020;
  __ZN5ts_rs11format_docs17hb661cfc57512c688E(&stack0x00000048,&UNK_10b26c0b0,2);
  ...
  if (puVar4 != (undefined4 *)0x0) {
    ...
    *(undefined8 *)(unaff_x29 + -0x48) = unaff_x22;
    ...
    __ZN5alloc3fmt6format12format_inner17h63985d1d6aa0fe33E
              (&stack0x00000008,s_nextCursor_____108ae01e6,&stack0x00000048);
    if (*(long *)(unaff_x29 + -0x68) != 0) {
      _free(*(undefined8 *)(unaff_x29 + -0x60));
    }
  ...
  pcVar3 = (code *)SoftwareBreakpoint(1,0x101c0ecbc);
  (*pcVar3)();
}
