...
long * FUN_10081be68(long param_1)

{
  ...
  if (uVar10 < 0x8000000000000003) {
    ...
    if ((uVar3 & 0x7fffffffffffffff) == 0) {
      ...
      uStack_98 = 5;
      FUN_100813d9c(param_1 + 0x10,&uStack_a8);
      uVar10 = *(ulong *)(param_1 + 0x148);
    }
    else if (((uVar3 & 0x7fffffffffffffff) == 1) && (lVar9 = *(long *)(param_1 + 0x150), lVar9 != 0)
            ) {
      *(undefined8 *)(param_1 + 0x148) = 0x8000000000000006;
      ...
      pcVar5 = (code *)SoftwareBreakpoint(1,0x10081c014);
      (*pcVar5)();
    }
    uVar3 = uVar10;
    if (uVar10 < 0x8000000000000001) {
