...
void FUN_10127e25c(undefined8 param_1,long param_2)
...
LAB_10127e484:
      ...
      *in_stack_00000010 = in_stack_00000088;
      ...
      if (lVar13 == -0x8000000000000000) goto LAB_10127e4b4;
      ...
      *in_stack_00000010 = -0x8000000000000000;
      ...
      goto joined_r0x00010127e540;
    }
    unaff_x21 = pcVar15 + 0x20;
    cVar6 = *pcVar15;
    pbVar10 = unaff_x19;
    if (cVar6 == '\x16') goto LAB_10127e484;
    ...
    *in_stack_00000040 = uVar21;
    ...
    if (cVar6 != '\x14') {
      if (cVar6 != '\x15') {
        in_stack_00000068 = unaff_x21;
        in_stack_00000080 = unaff_x19;
        lVar13 = FUN_108855b04(&stack0x000000a0,unaff_x29 + -0x90,&UNK_10b20c620);
        *in_stack_00000010 = -0x8000000000000000;
            ...
            if (bVar5 != 1) {
              ...
              if (bVar5 == 0xc) {
                if (*(long *)(unaff_x29 + -0x60) == 4) {
                  ...
                  if (iVar4 == 0x656d616e) goto LAB_10127e084;
                }
...
LAB_10127e3bc:
              ...
              pbVar10 = (byte *)FUN_108855b04(unaff_x29 + -0x78,unaff_x29 + -0x90,&UNK_10b20fec0);
...
LAB_10127e014:
            ...
            if (bVar5 != 0xe) {
              if (bVar5 != 0xf) goto LAB_10127e3bc;
            ...
            if (piVar2 == (int *)0x0) goto LAB_10127e020;
            _free();
            if (bVar8) goto LAB_10127e024;
LAB_10127e084:
...
LAB_10127e640:
              ...
              pcVar7 = (code *)SoftwareBreakpoint(1,0x10127e644);
              (*pcVar7)();
            }
            uVar21 = *unaff_x25;
            unaff_x20[1] = unaff_x25[1];
...
LAB_10127e124:
      ...
      pbVar9 = (byte *)FUN_1087e422c(0,&UNK_10b231a38,&UNK_10b20a590);
LAB_10127e140:
      ...
      unaff_x25 = in_stack_00000038;
      pbVar10 = pbVar19;
      if (pbVar18 != (byte *)0x0) goto LAB_10127e170;
      uVar17 = 0x8000000000000000;
      unaff_x24 = pbVar18;
      pbVar10 = pbVar9;
    }
      ...
      if (bVar5 == 0x16) goto LAB_10127e124;
      ...
      *(byte *)(unaff_x29 + -0x78) = bVar5;
      ...
      pbVar10 = *(byte **)(unaff_x29 + -0x88);
      pbVar9 = pbVar10;
      if (uVar17 == 0x8000000000000000) goto LAB_10127e140;
