...
ulong FUN_104ada38c(ulong param_1,ulong param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  uStack_40 = param_1;
  uStack_38 = param_2;
  func_0x000104b1a3a0(&uStack_60,param_3,param_4);
  uStack_11 = 0xff;
  func_0x000104b1a3a0(&uStack_60,&uStack_11,1);
