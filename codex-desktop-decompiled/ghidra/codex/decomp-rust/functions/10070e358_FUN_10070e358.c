...

{
  ...
  *(undefined **)(unaff_x29 + -0xa8) = &UNK_10b208fd0;
  FUN_10070f640(&stack0x000004e8);
  *(long *)(unaff_x20 + 0xd0) = *(long *)(unaff_x20 + 0xd0) + 1;
  auVar12 = (**(code **)(*(long *)(unaff_x20 + 0x160) + 0x20))
                      (*(long *)(unaff_x20 + 0x158) +
                       (*(long *)(*(long *)(unaff_x20 + 0x160) + 0x10) - 1U & 0xfffffffffffffff0) +
                       0x10);
  if (auVar12._8_4_ == 1000000000) {
    ...
    *unaff_x19 = 0x15;
    ...
    uVar3 = *(uint *)(unaff_x20 + 0x150);
    if (uVar3 == 1000000000) {
      auVar4._8_4_ = 1000000000;
      auVar4._0_8_ = extraout_x10;
    }
    else {
      uVar8 = *(ulong *)(unaff_x20 + 0x148);
      auVar4._8_4_ = uVar3;
      auVar4._0_8_ = uVar8;
    ...
    uVar9 = *(undefined8 *)(unaff_x20 + 0xd0);
    FUN_100d66e74(&stack0x000000c8);
    FUN_100e0af0c();
    *(undefined8 *)(unaff_x20 + 0xf0) = in_stack_00000498;
    *(undefined8 *)(unaff_x20 + 0xe8) = in_stack_00000490;
    *(undefined8 *)(unaff_x20 + 0x100) = in_stack_000004a8;
    *(undefined8 *)(unaff_x20 + 0xf8) = in_stack_000004a0;
    *(undefined8 *)(unaff_x20 + 0xb8) = in_stack_00000460;
    *(undefined8 *)(unaff_x20 + 0xc0) = in_stack_00000468;
    *(undefined8 *)(unaff_x20 + 200) = in_stack_00000470;
    *(undefined8 *)(unaff_x20 + 0xd0) = in_stack_00000478;
    *(undefined8 *)(unaff_x20 + 0xe0) = in_stack_00000488;
    *(undefined8 *)(unaff_x20 + 0xd8) = in_stack_00000480;
    *(undefined8 *)(unaff_x20 + 0x110) = in_stack_000004b8;
    *(undefined8 *)(unaff_x20 + 0x108) = in_stack_000004b0;
    *(undefined8 *)(unaff_x20 + 0x120) = in_stack_000004c8;
    *(undefined8 *)(unaff_x20 + 0x118) = in_stack_000004c0;
    *(undefined8 *)(unaff_x20 + 0x128) = uVar9;
    FUN_10070e11c();
  }
  return;
}
