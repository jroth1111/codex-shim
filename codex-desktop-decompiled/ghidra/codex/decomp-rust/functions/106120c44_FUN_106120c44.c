...
ulong FUN_106120c44(ulong param_1,ulong param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  uStack_40 = param_1;
  uStack_38 = param_2;
  FUN_106127cfc(&uStack_60,param_3,param_4);
  uStack_11 = 0xff;
  FUN_106127cfc(&uStack_60,&uStack_11,1);
