...
undefined1  [16]
FUN_100c25cd0(long param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  auVar7 = __ZN2h25proto7streams10prioritize10Prioritize25recv_stream_window_update17h0e261f4f62839167E
  ...
  if (___ZN12tracing_core8metadata9MAX_LEVEL17h02c7742de62f64c3E < 2) {
    bVar4 = bRam000000010b632648;
    if (1 < bRam000000010b632648 - 1) {
      if (bRam000000010b632648 != 0) {
        bVar4 = __ZN12tracing_core8callsite15DefaultCallsite8register17hd8a0d35d4a8f8e8bE
                          (&
                           __ZN2h25proto7streams4send4Send25recv_stream_window_update10__CALLSITE17h5f9312c2dcd6341aE
                          );
        if (bVar4 != 0) goto LAB_100c25d50;
      }
      goto LAB_100c25e5c;
    }
LAB_100c25d50:
    iVar5 = __ZN7tracing15__macro_support12__is_enabled17h508af3f20e7344eeE
                      (___ZN2h25proto7streams4send4Send25recv_stream_window_update10__CALLSITE17h5f9312c2dcd6341aE
                       ,bVar4);
    if (iVar5 == 0) goto LAB_100c25e5c;
    lStack_d0 = ___ZN2h25proto7streams4send4Send25recv_stream_window_update10__CALLSITE17h5f9312c2dcd6341aE
                + 0x30;
...
LAB_100c25e5c:
    ...
    if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
      ...
      if (iVar5 != 0) {
        lStack_120 = ___ZN2h25proto7streams4send4Send25recv_stream_window_update10__CALLSITE17h5f9312c2dcd6341aE
                     + 0x30;
  ...
  FUN_100c24b74(param_1,3,1,param_3,param_4,param_5,param_6);
