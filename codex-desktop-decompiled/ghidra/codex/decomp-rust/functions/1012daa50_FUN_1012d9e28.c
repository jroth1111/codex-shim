...
void FUN_1012d9e28(undefined8 *param_1,char *param_2)

{
  ...
  if (*param_2 != '\x15') {
    uVar15 = FUN_108855c40(param_2,&ppppppiStack_98,&UNK_10b2131a8);
    ...
    if ((byte)uStack_2f0 == '\x16') {
      ...
      if (cVar3 != '\x10') {
        if (cVar3 == '\x11') {
          ...
          if (cVar3 == '\x12') goto LAB_1012da024;
...
LAB_1012da9a4:
        ...
        pcVar7 = (code *)SoftwareBreakpoint(1,0x1012da9a8);
        (*pcVar7)();
      }
...
LAB_1012da128:
    ...
    if ((byte)uStack_2f0 != 0x16) {
      ...
      if (bVar6 < 0xd) {
        ...
        if (bVar6 == 0xc) {
          if (piStack_2d8 == (int *)0x6) {
            iVar10 = 1;
            if (*(int *)pppppppiStack_2e0 != 0x6b736174 ||
                *(short *)((long)pppppppiStack_2e0 + 4) != 0x6449) {
              iVar10 = 2;
            }
          }
          else {
            if (piStack_2d8 != (int *)0x5) goto LAB_1012da378;
            iVar10 = 2;
          ...
          goto joined_r0x0001012da370;
        }
LAB_1012daaac:
        piStack_d8 = piStack_330;
        pppppppiStack_e0 = pppppppiVar17;
        piVar9 = (int *)FUN_108855b04(&uStack_2f0,&ppppppiStack_98,&UNK_10b20ed60);
LAB_1012da8e8:
...
LAB_1012da910:
        ...
        if (bVar6 == 0xd) {
          if (pppppppiStack_2e0 == (int *******)0x6) {
            iVar10 = 1;
            if (*piStack_2e8 != 0x6b736174 || (short)piStack_2e8[1] != 0x6449) {
              iVar10 = 2;
            }
          }
          else {
            if (pppppppiStack_2e0 != (int *******)0x5) goto LAB_1012da40c;
            iVar10 = 2;
...
LAB_1012da440:
          ...
          if (bVar6 != 0xe) {
            if (bVar6 != 0xf) goto LAB_1012daaac;
            if (pppppppiStack_2e0 == (int *******)0x6) {
              if (((((char)*piStack_2e8 != 't') || (*(char *)((long)piStack_2e8 + 1) != 'a')) ||
                  (*(char *)((long)piStack_2e8 + 2) != 's')) ||
                 (((*(char *)((long)piStack_2e8 + 3) != 'k' || ((char)piStack_2e8[1] != 'I')) ||
                  (*(char *)((long)piStack_2e8 + 5) != 'd')))) goto LAB_1012da40c;
              iVar10 = 1;
            }
            else if (((pppppppiStack_2e0 == (int *******)0x5) && ((char)*piStack_2e8 == '_')) &&
                    ((*(char *)((long)piStack_2e8 + 1) == 'm' &&
                     (((*(char *)((long)piStack_2e8 + 2) == 'e' &&
                       (*(char *)((long)piStack_2e8 + 3) == 't')) && ((char)piStack_2e8[1] == 'a')))
                     ))) {
              iVar10 = 0;
            }
            else {
LAB_1012da40c:
          ...
          if (piStack_2d8 == (int *)0x6) {
            if (((*(char *)pppppppiStack_2e0 != 't') ||
                (*(char *)((long)pppppppiStack_2e0 + 1) != 'a')) ||
               (((*(char *)((long)pppppppiStack_2e0 + 2) != 's' ||
                 ((*(char *)((long)pppppppiStack_2e0 + 3) != 'k' ||
                  (*(char *)((long)pppppppiStack_2e0 + 4) != 'I')))) ||
                (*(char *)((long)pppppppiStack_2e0 + 5) != 'd')))) goto LAB_1012da378;
            iVar10 = 1;
          }
...
LAB_1012da54c:
        ...
        piStack_d8 = piStack_330;
        ppppppiStack_98 = (int ******)&UNK_108cb4aeb;
        piStack_90 = (int *)0x6;
        uStack_2f0 = &ppppppiStack_98;
        piStack_2e8 = (int *)&DAT_100c7b3a0;
        uVar15 = 1;
        pppppppiStack_e0 = pppppppiVar17;
        piVar9 = (int *)FUN_108856088(s_duplicate_field_____108ac2973,&uStack_2f0);
        if (ppppppiVar18 == (int ******)0x0) goto LAB_1012da664;
      }
      _free(piStack_338);
      uVar15 = 1;
...
LAB_1012da5d0:
    ...
    pppppppiVar17 = (int *******)0x8000000000000001;
    uVar15 = 1;
    if (ppppppiVar18 == (int ******)0x8000000000000000) goto LAB_1012da5ec;
LAB_1012da598:
    ...
    piStack_158 = piStack_2d8;
    pppppppiStack_160 = pppppppiStack_2e0;
    if ((char)pppppppiStack_120 == '\x16') goto LAB_1012da7b0;
LAB_1012da6d8:
    FUN_100e077ec(&pppppppiStack_120);
    piVar9 = piStack_338;
    if (ppppppiVar18 != (int ******)0x8000000000000000) {
LAB_1012da7b0:
    ...
    if (ppppppiVar18 != (int ******)0x8000000000000000) goto LAB_1012da598;
LAB_1012da5ec:
    pppppiStack_80 = (int *****)&UNK_108cb4aeb;
    uStack_78 = 6;
