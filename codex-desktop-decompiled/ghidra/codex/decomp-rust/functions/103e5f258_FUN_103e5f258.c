...
void FUN_103e5f258(ulong *param_1)
...
LAB_103e5f360:
    uStack_78 = uVar7;
    FUN_103dac1cc(param_1 + 6);
    _memcpy(param_1 + 6,auStack_a38,0x9c0);
...
LAB_103e5f3ac:
    ...
    *param_1 = uStack_68 + uStack_70 * -0x40;
    ...
    if ((uVar6 >> 1 & 1) != 0) goto LAB_103e5f328;
    if ((uVar6 >> 3 & 1) == 0) {
      auStack_a38[0] = 2;
      unaff_x22 = param_1[5];
      unaff_x20 = (*
      ...
      if (*(char *)(unaff_x20 + 0x48) == '\x01') goto LAB_103e5f358;
      if (*(char *)(unaff_x20 + 0x48) != '\x02') goto LAB_103e5f340;
      uVar7 = 0;
      goto LAB_103e5f360;
    }
    if ((uVar6 >> 4 & 1) == 0) goto LAB_103e5f3ac;
    if (param_1[0x140] != 0) {
      (**(code **)(param_1[0x140] + 0x10))(param_1[0x141]);
      LOAcquire();
      uVar2 = *param_1;
      *param_1 = uVar2 & 0xffffffffffffffef;
      ...
      if ((uVar6 >> 1 & 1) == 0) {
        ...
        if ((uVar6 >> 4 & 1) != 0) {
          if ((uVar6 >> 3 & 1) == 0) {
            if (param_1[0x140] != 0) {
              (**(code **)(param_1[0x140] + 0x18))(param_1[0x141]);
            }
            param_1[0x140] = 0;
          }
          goto LAB_103e5f3ac;
...
LAB_103e5f490:
  ...
  pcVar1 = (code *)SoftwareBreakpoint(1,0x103e5f494);
  (*pcVar1)();
}
