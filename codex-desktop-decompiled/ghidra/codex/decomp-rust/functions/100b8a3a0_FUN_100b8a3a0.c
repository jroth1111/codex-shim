...
LAB_100b8a918:
    *(undefined1 *)(unaff_x19 + 0xf53) = 0;
    ...
    if (lVar8 == 6) goto LAB_100b8a918;
    if (lVar8 != 7) goto LAB_100b8a8fc;
  }
  ...
  *(undefined1 *)(unaff_x19 + 0xf58) = 1;
  ...
  if (lVar5 == 0) {
    uVar11 = *(undefined8 *)(unaff_x19 + 0xe28);
    ...
    *unaff_x20 = '\0';
    lVar8 = unaff_x19 + 0xe88;
    auVar14 = FUN_100b8de90(lVar8,in_stack_00000088);
    lVar5 = auVar14._8_8_;
    if ((auVar14._0_8_ & 1) == 0) {
      if (*unaff_x20 == '\x03') {
        ...
        unaff_x20[1] = '\0';
        lVar8 = unaff_x19 + 0xf48;
LAB_100b8aaac:
        FUN_100e3d46c(lVar8);
      }
      else if (*unaff_x20 == '\0') goto LAB_100b8aaac;
      if (lVar5 != 0) goto LAB_100b8aab8;
      lVar8 = *(long *)(unaff_x19 + 0xe68);
      lVar5 = *(long *)(unaff_x19 + 0xe70);
...
LAB_100b8aab8:
  uVar11 = *(undefined8 *)(unaff_x19 + 0xe70);
  FUN_100e28b64(uVar11,*(undefined8 *)(unaff_x19 + 0xe78));
...
LAB_100b8ab04:
    *(undefined1 *)(unaff_x19 + 0xe81) = 0;
    *(undefined1 *)(unaff_x19 + 0xe80) = 1;
    if (lVar8 == -0x7fffffffffffffff) goto LAB_100b87f58;
  }
  FUN_100d243e4();
