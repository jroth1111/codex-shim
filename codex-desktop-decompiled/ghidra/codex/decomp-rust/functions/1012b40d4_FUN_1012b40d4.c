...
void FUN_1012b40d4(undefined8 *param_1,byte *param_2)
...
LAB_1012b4458:
      pbStack_e8 = pbVar13;
      pbVar8 = (byte *)FUN_1087e422c(0,&UNK_10b2323e0,&UNK_10b20a590);
    }
    else {
      pbVar13 = unaff_x21 + 0x20;
      if (*unaff_x21 == 0x16) goto LAB_1012b4458;
      ...
      if (puStack_a0 != (undefined *)0x8000000000000000) {
        *param_1 = puStack_a0;
        ...
        if (lVar11 == 0) goto LAB_1012b45c0;
        *param_1 = 0x8000000000000000;
        param_1[1] = lVar11;
        unaff_x21 = pbVar8;
        puVar12 = puVar5;
        goto joined_r0x0001012b4510;
      }
    }
    *param_1 = 0x8000000000000000;
    param_1[1] = pbVar8;
...
joined_r0x0001012b4510:
    ...
    if (bVar2 != 0x15) {
      uVar10 = FUN_108855b04(param_2,&puStack_a0,&UNK_10b20b680);
      *param_1 = 0x8000000000000000;
      param_1[1] = uVar10;
      return;
    }
...
LAB_1012b4348:
          ...
          if (bVar1 != 0xc) goto LAB_1012b46c8;
          if (lStack_70 == 8) {
            lVar18 = *plVar4;
            if (plVar3 != (long *)0x0) {
              _free();
            }
            if (lVar18 != 0x6449646165726874) goto LAB_1012b4360;
            goto LAB_1012b43c4;
          }
          if (plVar3 != (long *)0x0) {
            _free();
...
LAB_1012b46c4:
            ...
            pcVar6 = (code *)SoftwareBreakpoint(1,0x1012b46c8);
            (*pcVar6)();
          }
          uVar10 = *puVar15;
          puVar14[1] = puVar15[1];
...
LAB_1012b46c8:
            lStack_b0 = lVar16 + 1;
            pbStack_c8 = pbVar17;
            uVar10 = FUN_108855b04(&bStack_88,&puStack_a0,&UNK_10b20ec80);
            *param_1 = 0x8000000000000000;
            param_1[1] = uVar10;
            puVar12 = (undefined *)((ulong)puVar12 & 0x7fffffffffffffff);
joined_r0x0001012b4700:
            if (puVar12 != (undefined *)0x0) {
              _free(unaff_x21);
            }
            goto LAB_1012b4580;
...
LAB_1012b4354:
          FUN_100e077ec(&bStack_88);
joined_r0x0001012b43a0:
          if (bVar7) goto LAB_1012b4360;
LAB_1012b43c4:
      ...
      if (puVar12 != (undefined *)0x8000000000000000) {
        *param_1 = puVar12;
        ...
        if (pbVar9 == pbVar8) goto LAB_1012b45c0;
