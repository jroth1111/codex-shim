...
/* WARNING: Removing unreachable block (ram,0x0001012db134) */

void FUN_1012dac48(undefined1 *param_1,char *param_2)
...
LAB_1012dafec:
        ...
        if (uStack_e0._1_1_ != 3) goto LAB_1012db154;
LAB_1012dafd8:
        uVar11 = 3;
      }
      uVar8 = 0;
...
LAB_1012daff8:
    ...
    if ((byte)uStack_e0 == 4) {
      if (lStack_118 < 2) {
        if (lStack_118 == 0) goto LAB_1012dafe4;
        if (lStack_118 == 1) goto LAB_1012daec8;
      }
      else {
        if (lStack_118 == 2) goto LAB_1012dafec;
        if (lStack_118 == 3) goto LAB_1012dafd8;
      }
...
LAB_1012db178:
    ...
    if ((byte)uStack_e0 == 0xc) {
      func_0x000100b213c4(&uStack_140,uStack_110,lStack_108);
      goto LAB_1012dadf4;
    }
LAB_1012db108:
    pcStack_138 = (char *)FUN_108855b04(&uStack_e0,&uStack_51,&UNK_10b211500);
...
LAB_1012db010:
    ...
    if ((byte)uStack_e0 == 0xd) {
      func_0x000100b213c4(&uStack_140,lStack_118,uStack_110);
LAB_1012daffc:
      FUN_100e077ec(&uStack_e0);
LAB_1012db004:
      pcVar9 = uStack_140;
      ...
      if ((byte)uStack_e0 != 0xe) {
        if ((byte)uStack_e0 != 0xf) goto LAB_1012db108;
        func_0x000100b21024(&uStack_140,lStack_118,uStack_110);
        goto LAB_1012daffc;
      }
      func_0x000100b21024(&uStack_140,uStack_110,lStack_108);
LAB_1012dadf4:
      if (lVar10 == 0) goto LAB_1012db004;
      _free(uVar7);
      pcVar9 = uStack_140;
      lVar10 = lStack_88;
      lStack_88 = lStack_68;
...
LAB_1012daf68:
        ...
        if ((uVar1 == 0x12) || ((uVar1 == 0x15 && (lStack_88 == 0)))) goto LAB_1012daf68;
        pcVar9 = (char *)FUN_108855b04(&cStack_a0,&uStack_51,&UNK_10b20a5c0);
        goto LAB_1012db028;
      }
LAB_1012daf70:
    ...
    if (uStack_140._1_1_ == 0) {
      if (uVar1 == 0x16) goto LAB_1012daf70;
      if ((uVar1 == 0x12) || ((uVar1 == 0x15 && (lStack_88 == 0)))) goto LAB_1012daf68;
      pcVar9 = (char *)FUN_108855b04(&cStack_a0,&uStack_51,&UNK_10b20a5c0);
    }
    else {
