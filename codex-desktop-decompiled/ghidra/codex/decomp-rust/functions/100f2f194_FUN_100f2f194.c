...
void FUN_100f2f194(long *param_1,long param_2)
...
LAB_100f2f1c8:
  ...
  *(char **)(param_2 + 8) = pcVar2 + 0x20;
  if (cStack_60 == '\x16') goto LAB_100f2f1c8;
...
LAB_100f2f20c:
    ...
    if (cStack_60 == '\x11') {
      ...
      uStack_28 = puVar1[3];
      uStack_30 = puVar1[2];
      func_0x00010141824c(&lStack_78,&uStack_40);
      _free(puVar1);
    }
    else {
      if (cStack_60 == '\x12') goto LAB_100f2f20c;
      func_0x00010141824c(&lStack_78,&cStack_60);
    }
