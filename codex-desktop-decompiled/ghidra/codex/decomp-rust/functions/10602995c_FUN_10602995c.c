...
ulong FUN_10602995c(undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  uStack_38 = 0;
  uStack_40 = param_1;
  iVar2 = __ZN4core3fmt5write17h64810b21425781ecE(&uStack_40,&UNK_10b4ad7a0,param_2,param_3);
  if (iVar2 == 0) {
    if ((uStack_38 & 3) == 1) {
