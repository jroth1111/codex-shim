...
void FUN_1013467dc(undefined8 *param_1,byte *param_2)
...
LAB_101346cdc:
      pbStack_e8 = pbVar11;
      pbVar10 = (byte *)FUN_1087e422c(0,&UNK_10b2328c0,&UNK_10b20a590);
LAB_101346cf8:
      *param_1 = 0x8000000000000000;
      ...
      if (*pbStack_108 == 0x16) goto LAB_101346cdc;
      ...
      pbVar10 = pbStack_a0;
      puVar17 = uStack_a8;
      if (uStack_a8 == (undefined *)0x8000000000000000) goto LAB_101346cf8;
      if (lVar13 == 1) {
LAB_101346ef8:
        pbStack_f8 = (byte *)FUN_1087e422c(1,&UNK_10b2328c0,&UNK_10b20a590);
LAB_101346f14:
        *param_1 = 0x8000000000000000;
        ...
        pbStack_e8 = pbVar11;
        if (pbStack_108[0x20] == 0x16) goto LAB_101346ef8;
        ...
        if (uStack_a8 == (undefined *)0x8000000000000001) goto LAB_101346f14;
        if (lVar13 == 2) {
LAB_101346fd8:
          bVar14 = 0;
LAB_10134701c:
          ...
          *(byte *)(param_1 + 6) = bVar14;
          ...
          if (lVar13 == 0) goto LAB_101346ea4;
          *param_1 = 0x8000000000000000;
          param_1[1] = lVar13;
          ...
          pbStack_108 = pbVar16;
          goto joined_r0x000101347058;
        }
        pbVar11 = pbStack_108 + 0x60;
        bVar5 = pbStack_108[0x40];
        pbStack_e8 = pbVar11;
        if (bVar5 == 0x16) goto LAB_101346fd8;
...
joined_r0x000101347058:
    ...
    if (bVar4 != 0x15) {
      uVar12 = FUN_108855b04(param_2,auStack_69,&UNK_10b20bea0);
      *param_1 = 0x8000000000000000;
      param_1[1] = uVar12;
      return;
    }
...
LAB_101346af4:
          ...
          if (bVar14 == 0xc) {
            if (lStack_78 == 0xb) {
              ...
              if (*plVar7 != 0x64745365736f6c63 || (short)plVar7[1] != 0x6e69) goto LAB_101346a6c;
              uStack_a8 = (undefined *)CONCAT62(uStack_a8._2_6_,0x200);
            }
            else if ((lStack_78 == 9) && (*plVar7 == 0x49737365636f7270 && (char)plVar7[1] == 'd'))
            {
...
LAB_101346c84:
            pbStack_a0 = (byte *)FUN_108855b04(&bStack_90,auStack_69,&UNK_10b20f700);
          ...
          if (bVar14 == 0xd) {
            ...
            else if (plVar7 == (long *)0xa) {
              if (*plVar2 != 0x64745365736f6c63 || (short)plVar2[1] != 0x6e69) goto LAB_101346aec;
              bVar14 = 2;
            }
            else if ((plVar7 == (long *)0x9) &&
                    (*plVar2 == 0x49737365636f7270 && (char)plVar2[1] == 'd')) {
              bVar14 = 0;
            }
            else {
LAB_101346aec:
          ...
          if (bVar14 == 0xe) {
            func_0x000100bdee7c(&uStack_a8,plVar7);
            goto joined_r0x000101346a30;
          }
          if (bVar14 != 0xf) goto LAB_101346c84;
          func_0x000100bdee7c(&uStack_a8,plVar2,plVar7);
LAB_101346af8:
          FUN_100e077ec(&bStack_90);
        }
        bVar14 = bStack_8f;
...
LAB_101346d94:
        ...
        if (uStack_a8._1_1_ < 2) {
          ...
          pbStack_f0 = (byte *)CONCAT71(pbStack_f0._1_7_,0x16);
          if (bVar8 == 0x16) goto LAB_101347064;
          uVar12 = *puVar15;
          puVar18[1] = puVar15[1];
          *puVar18 = uVar12;
          uVar12 = *(undefined8 *)((long)puVar15 + 0xf);
...
LAB_101347210:
            ...
            pcVar9 = (code *)SoftwareBreakpoint(1,0x101347214);
            (*pcVar9)();
          }
          uVar12 = *puVar15;
          puVar18[1] = puVar15[1];
      ...
      if (puVar19 != (undefined *)0x8000000000000000) {
        ...
        *(byte *)(param_1 + 6) = bVar5 & 1;
        ...
        if (pbVar11 == pbVar10) goto LAB_101346ea4;
