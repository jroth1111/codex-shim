...
undefined8 FUN_10028a0ec(undefined8 param_1)
  ...
  *(undefined8 *)(unaff_x29 + -200) = param_1;
  ...
  if ((ulong)(*(long *)(unaff_x20 + 0x110) - lVar8) < 3) {
    ...
    *(long *)(unaff_x20 + 0x108) = lVar8;
    if (*(long *)(unaff_x20 + 0x110) != lVar8) goto LAB_10028ac2c;
LAB_10028ab80:
    __ZN5bytes9bytes_mut8BytesMut13reserve_inner17h27c45947f3de9d03E();
    lVar8 = *(long *)(unaff_x20 + 0x108);
    lVar10 = *(long *)(unaff_x20 + 0x110);
    *(undefined1 *)(*(long *)(unaff_x20 + 0x100) + lVar8) = 8;
    if (lVar10 == lVar8) goto LAB_10028b3f8;
    lVar8 = lVar8 + 1;
    *(long *)(unaff_x20 + 0x108) = lVar8;
    if (*(long *)(unaff_x20 + 0x110) == lVar8) goto LAB_10028abcc;
LAB_10028ac4c:
    ...
    *(undefined2 *)(lVar10 + lVar8) = 0;
    lVar8 = lVar8 + 3;
    *(long *)(unaff_x20 + 0x108) = lVar8;
    if (*(long *)(unaff_x20 + 0x110) == lVar8) goto LAB_10028ab80;
LAB_10028ac2c:
    *(undefined1 *)(*unaff_x21 + lVar8) = 8;
    lVar8 = lVar8 + 1;
    *(long *)(unaff_x20 + 0x108) = lVar8;
    if (*(long *)(unaff_x20 + 0x110) != lVar8) goto LAB_10028ac4c;
LAB_10028abcc:
    __ZN5bytes9bytes_mut8BytesMut13reserve_inner17h27c45947f3de9d03E();
    lVar8 = *(long *)(unaff_x20 + 0x108);
    lVar10 = *(long *)(unaff_x20 + 0x110);
        ...
        if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
          ...
          if (iVar7 != 0) {
            ...
            *(undefined **)(unaff_x29 + -200) = &UNK_10b1f48a8;
            ...
            in_stack_00000060 = 2;
            __ZN7tracing15__macro_support13__tracing_log17h72768b16bee39960E
                      (lVar8,puVar3,puVar2,&stack0x00000328,&stack0x00000050);
          }
        }
      }
