...
/* WARNING: Removing unreachable block (ram,0x0001013d2338) */

void FUN_1013d1dec(undefined1 *param_1,char *param_2)
...
LAB_1013d225c:
    ...
    if ((byte)uStack_e0 == 4) {
      if (plStack_118 != (long *)0x0) {
        if (plStack_118 == (long *)0x1) goto LAB_1013d2114;
    ...
    if ((byte)uStack_e0 == 0xc) {
      if (lStack_108 == 7) {
        if ((int)*plStack_110 == 0x62616e65 && *(int *)((long)plStack_110 + 3) == 0x64656c62) {
          uStack_140 = (char *)((ulong)uStack_140._2_6_ << 0x10);
        }
        else {
LAB_1013d1f5c:
          pcStack_138 = (char *)FUN_1087e4494(plStack_110,lStack_108,&UNK_10b231ef8,2);
          uStack_140 = (char *)CONCAT71(uStack_140._1_7_,1);
        }
      }
      else {
        if ((lStack_108 != 8) || (*plStack_110 != 0x64656c6261736964)) goto LAB_1013d1f5c;
        uStack_140 = (char *)CONCAT62(uStack_140._2_6_,0x100);
      }
joined_r0x0001013d20e8:
      if (plVar5 == (long *)0x0) goto LAB_1013d2268;
      _free(plVar6);
      pcVar8 = uStack_140;
      lVar9 = lStack_88;
      lStack_88 = lStack_68;
      goto joined_r0x0001013d2270;
    }
LAB_1013d230c:
    pcStack_138 = (char *)FUN_108855b04(&uStack_e0,&uStack_51,&UNK_10b20f340);
    uStack_140 = (char *)CONCAT71(uStack_140._1_7_,1);
    lVar9 = lStack_88;
LAB_1013d2274:
    lStack_88 = lVar9;
    ...
    if ((byte)uStack_e0 == 0xd) {
      if (plStack_110 == (long *)0x7) {
        if ((int)*plStack_118 == 0x62616e65 && *(int *)((long)plStack_118 + 3) == 0x64656c62)
        goto LAB_1013d2258;
      }
      else if ((plStack_110 == (long *)0x8) && (*plStack_118 == 0x64656c6261736964))
      goto LAB_1013d2114;
      pcStack_138 = (char *)FUN_1087e4494(plStack_118,plStack_110,&UNK_10b231ef8,2);
LAB_1013d2078:
      uVar10 = 1;
      goto LAB_1013d225c;
    }
    if ((byte)uStack_e0 == 0xe) {
      func_0x000100bac93c(&uStack_140,plStack_110,lStack_108);
      goto joined_r0x0001013d20e8;
    }
    if ((byte)uStack_e0 != 0xf) goto LAB_1013d230c;
    func_0x000100bac93c(&uStack_140,plStack_118,plStack_110);
LAB_1013d2260:
    FUN_100e077ec(&uStack_e0);
LAB_1013d2268:
    pcVar8 = uStack_140;
    lVar9 = lStack_88;
    lStack_88 = lStack_68;
joined_r0x0001013d2270:
    bVar4 = (char)uStack_140 == '\x01';
    uStack_140 = pcVar8;
    lStack_68 = lStack_88;
    if (bVar4) goto LAB_1013d2274;
