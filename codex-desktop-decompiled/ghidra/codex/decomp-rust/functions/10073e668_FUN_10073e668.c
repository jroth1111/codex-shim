...

{
  ...
  __ZN5alloc3fmt6format12format_inner17h63985d1d6aa0fe33E
            (&stack0x00000360,s_Config_file_has_no_parent_direct_108ac5a11,&stack0x000002a0);
  uVar1 = __ZN3std2io5error5Error3new17h002dced88496ea8bE(0x15,&stack0x00000360);
  if (unaff_x28 != 0) {
    _free();
  }
