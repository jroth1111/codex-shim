...

{
  ...
  if (puVar3 == (undefined4 *)0x0) {
    ...
    *(undefined2 *)(puVar3 + 1) = 0x676e;
    ...
    __ZN5alloc3fmt6format12format_inner17h63985d1d6aa0fe33E(unaff_x29 + -0x78,s_Array<_>_108ae5df7);
    if (in_stack_00000058 != (undefined8 *)0x0) {
      _free(puVar3);
    }
    in_stack_00000058 = &stack0x00000030;
    __ZN5alloc3fmt6format12format_inner17h63985d1d6aa0fe33E(s_data_____108ae0ae5,&stack0x00000058);
    ...
    __ZN5ts_rs11format_docs17hb661cfc57512c688E(&stack0x00000058,&UNK_10b26c120,2);
    ...
    if (puVar3 != (undefined4 *)0x0) {
      ...
      *(undefined2 *)(puVar3 + 1) = 0x676e;
      ...
      in_stack_00000058 = &stack0x00000030;
      __ZN5alloc3fmt6format12format_inner17h63985d1d6aa0fe33E
                (&stack0x00000018,s_nextCursor_____108ae01e6,&stack0x00000058);
      if (*(long *)(unaff_x29 + -0x78) != 0) {
        _free(*(undefined8 *)(unaff_x29 + -0x70));
      }
      if (in_stack_00000030 != (undefined8 *)0x0) {
  ...
  pcVar2 = (code *)SoftwareBreakpoint(1,0x101c11c78);
  (*pcVar2)();
}
