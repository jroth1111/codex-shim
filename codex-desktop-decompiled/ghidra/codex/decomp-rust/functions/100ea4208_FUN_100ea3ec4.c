...
/* WARNING: Removing unreachable block (ram,0x000100ea424c) */
/* WARNING: Type propagation algorithm not settling */

void FUN_100ea3ec4(undefined8 *param_1,char *param_2)
...
LAB_100ea3f3c:
      do {
        while( true ) {
          ...
          if ((char)uStack_1e0 == '\x01') goto joined_r0x000100ea4054;
...
LAB_100ea44e8:
            ...
            pcVar3 = (code *)SoftwareBreakpoint(1,0x100ea4508);
            (*pcVar3)();
          }
        }
          ...
          if (uStack_1e0._1_1_ == '\x01') {
            ...
            if (pcVar6 != (char *)0x0) {
              ...
              if (cVar1 == '\x10' || cVar1 == '\x12') {
                ...
                ppuVar5 = ppuStack_1d8;
                ppuVar10 = uStack_1e0;
                if (uStack_1e0 == (undefined **)0x8000000000000003) goto LAB_100ea42fc;
              }
            ...
            if (uVar7 == 0) goto joined_r0x000100ea4140;
          }
...
LAB_100ea4218:
        ...
        pcStack_2a0 = (char *)0x0;
        if (pcVar6 == (char *)0x0) goto LAB_100ea44e8;
        ppuVar5 = (undefined **)FUN_10128aa94();
        bVar2 = true;
      } while (ppuVar5 == (undefined **)0x0);
joined_r0x000100ea4054:
      ppuVar10 = (undefined **)((ulong)ppuVar10 & 0xfffffffffffffffe);
joined_r0x000100ea45b0:
      ...
      ppuVar5 = (undefined **)FUN_108855c40(param_2,auStack_71,&UNK_10b214168);
    }
    goto LAB_100ea42fc;
  }
...
LAB_100ea42fc:
  ...
  ppuVar5 = (undefined **)FUN_10128aa94(lVar8);
  if (ppuVar5 != (undefined **)0x0) goto LAB_100ea42fc;
  if (lVar11 == 1) {
    uVar4 = 1;
    goto LAB_100ea42e4;
  }
  ...
  if (cVar1 == '\x10' || cVar1 == '\x12') {
    ...
    unaff_x20 = ppuStack_1d8;
    if (uStack_1e0 == (undefined **)0x8000000000000004) goto LAB_100ea42fc;
  }
...
joined_r0x000100ea4140:
  ppuVar5 = unaff_x20;
  if (ppuStack_3d0 == (undefined **)0x8000000000000003) goto LAB_100ea42fc;
...
LAB_100ea43f4:
    ...
    puStack_3c8 = (undefined *)unaff_x20;
    if (ppuStack_3d0 != (undefined **)0x8000000000000001) goto LAB_100ea43f4;
