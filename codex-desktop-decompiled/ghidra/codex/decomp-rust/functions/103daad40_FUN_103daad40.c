...
void FUN_103daad40(ulong *param_1)

{
  ...
  if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
    ...
    uStack_80 = *(undefined8 *)(uVar5 + 0x10);
    uStack_78 = *(undefined8 *)(uVar5 + 0x18);
  ...
  cVar2 = *(char *)((long)param_1 + 0x1b2);
  if (cVar2 == '\0') {
    func_0x000103d9f4c4(param_1 + 0x2c);
    ...
    *(long *)param_1[0x29] = lVar4 + -1;
    ...
    if (uVar5 != 0) {
      ...
      if (uVar5 * 0x19 != -0x21) {
        _free(param_1[0x15] + uVar5 * -0x18 + -0x18);
      }
    }
    uVar5 = param_1[0x1c];
    if (uVar5 != 0) {
      ...
      if (uVar5 * 0x19 != -0x21) {
        _free(param_1[0x1b] + uVar5 * -0x18 + -0x18);
      }
    }
    ...
    *plVar9 = lVar4 + -1;
    ...
    if (cVar2 == '\x03') {
      puStack_70 = (undefined1 *)param_1[0x44];
      puStack_68 = param_1 + 0x4b;
      puStack_60 = param_1 + 0x45;
      puStack_58 = param_1 + 0x46;
      ...
      if (cVar2 != '\x04') goto LAB_103dab2e4;
      if (((((char)param_1[0x47] == '\x03') && ((char)param_1[0x46] == '\x03')) &&
          ((char)param_1[0x45] == '\x03')) && ((char)param_1[0x3c] == '\x04')) {
        __ZN79__LT_tokio__sync__batch_semaphore__Acquire_u20_as_u20_core__ops__drop__Drop_GT_4drop17h3c921db99f3540f0E
                  (param_1 + 0x3d);
        if (param_1[0x3e] != 0) {
          (**(code **)(param_1[0x3e] + 0x18))(param_1[0x3f]);
        }
      }
      if ((1 < param_1[0x48]) && (uVar5 = param_1[0x4a], uVar5 != 0)) {
        puVar8 = (undefined8 *)param_1[0x4b];
        pcVar6 = (code *)*puVar8;
        if (pcVar6 != (code *)0x0) {
          (*pcVar6)(uVar5);
        }
    ...
    *(undefined1 *)((long)param_1 + 0x1b1) = 0;
    func_0x000103d953c0(param_1 + 0x13);
    func_0x000103d9b75c(param_1 + 5);
    func_0x000103d9f4c4(param_1 + 9);
    func_0x000103d9afd4(param_1 + 0x27);
    func_0x000103d96a34(param_1 + 0x28);
    __ZN97__LT_tokio_util__sync__cancellation_token__CancellationToken_u20_as_u20_core__ops__drop__Drop_GT_4drop17h41b2bd289c4eedfeE
              (param_1 + 0x29);
  ...
  func_0x000103dbd204(param_1 + 0x21);
LAB_103dab2e4:
  if (*param_1 != 2) {
    uVar5 = param_1[1];
    if ((*param_1 & 1) != 0) {
