...
void FUN_102c58470(undefined8 *param_1,long *param_2,long *param_3,undefined8 param_4)

{
  ...
  long lStack_2f8;
  long lStack_2f0;
  undefined1 auStack_2e8 [632];
  
  lVar7 = param_3[1];
  lVar11 = param_3[2];
  uVar6 = FUN_102c48024(param_2[4],param_2[5],lVar7,lVar11);
  if (param_2[2] == 0) {
    func_0x000108920574(param_2,1,param_2 + 4,1);
  }
  bVar4 = false;
  lVar9 = 0;
  plVar1 = (long *)*param_2;
  ...
  do {
    for (; uVar13 != 0; uVar13 = uVar13 - 1 & uVar13) {
      ...
      if ((lVar11 == plVar1[uVar8 * -0x51 + -0x4f]) &&
         (iVar5 = _memcmp(lVar7,plVar1[uVar8 * -0x51 + -0x50],lVar11), iVar5 == 0)) {
        _memcpy(param_1,plVar1 + uVar8 * -0x51 + -0x4e,0x270);
        _memcpy(plVar1 + uVar8 * -0x51 + -0x4e,param_4,0x270);
        if (*param_3 == 0) {
          return;
        }
...
LAB_102c5859c:
      bVar12 = NEON_umaxv(CONCAT17(-((char)((ulong)lVar14 >> 0x38) == -1),
                                   CONCAT16(-(cVar20 == -1),
                                            CONCAT15(-(cVar19 == -1),
                                                  ...
                                                  char)lVar14 == -1)))))))),1);
      if ((bVar12 & 1) != 0) {
        uVar6 = (ulong)*(char *)((long)plVar1 + uStack_328);
        if (-1 < *(char *)((long)plVar1 + uStack_328)) {
          lVar7 = *plVar1;
          ...
          uStack_328 = (ulong)LZCOUNT(uVar6 >> 0x20 | uVar6 << 0x20) >> 3;
          uVar6 = (ulong)*(byte *)((long)plVar1 + uStack_328);
        }
        lStack_2f8 = param_3[1];
        lStack_300 = *param_3;
        lStack_2f0 = param_3[2];
        _memcpy(auStack_2e8,param_4,0x270);
        bVar3 = bVar3 >> 1;
        *(byte *)((long)plVar1 + uStack_328) = bVar3;
        *(byte *)((long)plVar1 + (uStack_328 - 8 & uVar2) + 8) = bVar3;
        param_2[3] = param_2[3] + 1;
        param_2[2] = param_2[2] - (uVar6 & 1);
        _memcpy(plVar1 + uStack_328 * -0x51 + -0x51,&lStack_300,0x288);
      ...
      if (uVar13 != 0) {
        ...
        uStack_328 = uVar6 + ((ulong)LZCOUNT(uVar13 >> 0x20 | uVar13 << 0x20) >> 3) & uVar2;
        goto LAB_102c5859c;
      }
      bVar4 = false;
    }
