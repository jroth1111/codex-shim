...

{
  ...
  lVar2 = thunk_FUN_108856088(s_duplicate_field_____108ac2973,&stack0x00000430);
  *unaff_x20 = -0x8000000000000000;
  ...
  if (((in_stack_000000b8 & 1) != 0) && (in_stack_00000060 != 0)) {
  ...
  if ((in_stack_000000a8._4_4_ & 0x1e) != 0x14) {
    FUN_100e077ec();
  }
  return;
}
