...

{
  ...
  uVar5 = FUN_108856088(s_missing_field_____108ac28f7,&stack0x000004d0);
  FUN_100cfb250(unaff_x29 + -0xb0);
  FUN_100e69084(&stack0x000004a0);
  FUN_100cd9984(&stack0x000006c0);
  if ((in_stack_00000020 & 0x7fffffffffffffff) != 0) {
  ...
  if (-0x7fffffffffffffff < in_stack_00000100) {
    lVar3 = *(long *)(unaff_x29 + -0xf8);
    lVar7 = *(long *)(unaff_x29 + -0xf0) + 1;
    lVar6 = lVar3;
    while (lVar7 = lVar7 + -1, lVar7 != 0) {
      func_0x000100dfc74c(lVar6);
      lVar6 = lVar6 + 0x1d8;
    }
  ...
  if ((uVar1 & 1) != 0) {
    bVar4 = in_stack_00000440 != 0x8000000000000000;
    if (in_stack_00000440 < 0x8000000000000001) {
      in_stack_00000440 = 0;
    }
    if ((bVar4) && ((in_stack_00000440 & 0x7fffffffffffffff) == 0)) {
      FUN_100e79780(&stack0x00000440);
    }
  }
  uVar1 = 0;
  if (in_stack_00000420 != -0x7ffffffffffffffc) {
    uVar1 = unaff_w27;
  }
  if ((((uVar1 & 1) != 0) && (in_stack_00000420 != -0x7ffffffffffffffd)) &&
     (-0x7ffffffffffffffe < in_stack_00000420)) {
    if (in_stack_00000430 != 0) {
      puVar8 = (undefined8 *)(in_stack_00000428 + 8);
      do {
        if (puVar8[-1] != 0) {
          _free(*puVar8);
        }
  ...
  if ((iVar2 == 1) && ((unaff_x22 & 0x7fffffffffffffff) != 0)) {
    _free(in_stack_000000a0);
    uVar1 = 0;
    if ((in_stack_00000120 & 0x7fffffffffffffff) != 0) {
      uVar1 = uStack00000000000000d0;
    }
  }
  else {
    uVar1 = 0;
  ...
  if ((iVar2 == 1) && ((in_stack_00000108 & 0x7fffffffffffffff) != 0)) {
    _free(in_stack_00000140);
  }
