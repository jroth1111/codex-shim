...
void FUN_101861610(long param_1,long param_2)
...
code_r0x000101861610:
  ...
  puStack0000000000000060 = &UNK_10b25d1e8;
...
LAB_101861c8c:
  if (((ulong)in_stack_00000018 & 3) != 1) goto LAB_101861e4c;
...
LAB_101861e4c:
    do {
      ...
      *(undefined1 *)(unaff_x19 + 0xc0) = 0;
      FUN_10199560c(unaff_x29 + -0xe0,unaff_x19 + 0x88,in_stack_00000010);
...
LAB_101861d2c:
          ...
          if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
            ...
            if (iVar12 != 0) {
              ...
              *(undefined8 *)(unaff_x29 + -0x78) = uVar21;
              ...
              puStack0000000000000088 = (undefined8 *)&UNK_10b25d1e8;
      ...
      *(undefined2 *)(unaff_x29 + -0xa8) = 0x201;
      ...
      if ((bStack0000000000000108 - 7 < 3) &&
        ...
        FUN_10184fd88(&stack0x000000a0,*(undefined8 *)(unaff_x19 + 0x78),
...
LAB_1018617f0:
          ...
          if (cVar11 != '\x01') {
            if (cVar11 == '\x02') goto LAB_1018617f0;
            __ZN3std3sys12thread_local11destructors4list8register17ha25af605773d94bcE
                      (plVar15,&DAT_1055621b8);
            *(undefined1 *)(plVar15 + 4) = 1;
          }
...
LAB_1018614ec:
            ...
            *unaff_x21 = lVar20;
            ...
            lVar20 = *unaff_x21;
            *unaff_x26 = 1;
            if (lVar20 == -0x7fffffffffffffff) goto LAB_10186151c;
            ...
            uVar16 = 1;
            *unaff_x25 = 1;
            if (lVar20 != -0x7fffffffffffffff) goto LAB_101861d2c;
            goto LAB_101861d20;
          }
        }
...
LAB_10186142c:
        ...
        pcVar9 = (code *)SoftwareBreakpoint(1,0x101861430);
        (*pcVar9)();
      }
      if (((___ZN12tracing_core8metadata9MAX_LEVEL17h02c7742de62f64c3E < 2) &&
