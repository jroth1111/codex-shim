...
void FUN_10138f0dc(undefined1 *param_1,char *param_2)
...
LAB_10138f534:
    ...
    if ((byte)uStack_e0 == 4) {
      if (piStack_118 != (int *)0x0) {
        if (piStack_118 == (int *)0x1) goto LAB_10138f3ec;
    ...
    if ((byte)uStack_e0 == 0xc) {
      if (lStack_108 == 5) {
        if (*piStack_110 == 0x6f6c6c61 && (char)piStack_110[1] == 'w') {
          uStack_140 = (char *)((ulong)uStack_140._2_6_ << 0x10);
        }
        else {
LAB_10138f248:
          pcStack_138 = (char *)FUN_1087e4494(piStack_110,lStack_108,&UNK_10b2204a0,2);
          uStack_140 = (char *)CONCAT71(uStack_140._1_7_,1);
        }
      }
      else {
        if ((lStack_108 != 4) || (*piStack_110 != 0x796e6564)) goto LAB_10138f248;
        uStack_140 = (char *)CONCAT62(uStack_140._2_6_,0x100);
      }
joined_r0x00010138f3c8:
      if (piVar5 == (int *)0x0) goto LAB_10138f540;
      _free(piVar6);
      pcVar8 = uStack_140;
      lVar9 = lStack_88;
      lStack_88 = lStack_68;
...
LAB_10138f5e4:
    pcStack_138 = (char *)FUN_108855b04(&uStack_e0,&uStack_51,&UNK_10b20f6e0);
    uStack_140 = (char *)CONCAT71(uStack_140._1_7_,1);
    lVar9 = lStack_88;
LAB_10138f54c:
    lStack_88 = lVar9;
    ...
    if ((byte)uStack_e0 == 0xd) {
      if (piStack_110 == (int *)0x5) {
        if (*piStack_118 == 0x6f6c6c61 && (char)piStack_118[1] == 'w') goto LAB_10138f530;
      }
      else if ((piStack_110 == (int *)0x4) && (*piStack_118 == 0x796e6564)) goto LAB_10138f3ec;
      pcStack_138 = (char *)FUN_1087e4494(piStack_118,piStack_110,&UNK_10b2204a0,2);
LAB_10138f360:
      uVar10 = 1;
      goto LAB_10138f534;
    }
    if ((byte)uStack_e0 == 0xe) {
      func_0x000100b3dcdc(&uStack_140,piStack_110,lStack_108);
      goto joined_r0x00010138f3c8;
    }
    if ((byte)uStack_e0 != 0xf) goto LAB_10138f5e4;
    func_0x000100b3dcdc(&uStack_140,piStack_118,piStack_110);
LAB_10138f538:
    FUN_100e077ec(&uStack_e0);
LAB_10138f540:
    pcVar8 = uStack_140;
