...
void FUN_10128c568(ulong *param_1,char *param_2)

{
  ...
  if (*param_2 != '\x14') {
    uVar13 = FUN_108855b04(param_2,&puStack_108,&UNK_10b20a120);
  ...
  if (uVar9 == 0) {
    ...
    if (puStack_d8 == (ulong *)0x0) {
      ...
      pcVar6 = (code *)SoftwareBreakpoint(1,0x10128c884);
      (*pcVar6)();
    }
    uStack_d0 = 0;
    cVar5 = (char)*puVar4;
    ...
    if (cVar5 == '\x16') {
      ...
      do {
        ...
        *(ulong *)((long)puVar14 + 0xf) = uVar10;
        acStack_88[0] = cVar5;
        func_0x00010079dc10(&uStack_a8,acStack_88);
        uVar10 = uStack_d0;
        puVar7 = puStack_d8;
  ...
  *param_1 = uStack_e0;
  ...
  if (uVar13 != 0x8000000000000000) {
    ...
    uVar3 = param_1[2];
    uVar9 = FUN_100fbc738(&puStack_108);
    if (uVar9 == 0) {
      return;
    }
    *param_1 = 0x8000000000000000;
...
joined_r0x00010128c7b0:
  if (uVar13 != 0) {
    _free(puVar4);
  }
  return;
joined_r0x00010128c6e4:
  if (uVar13 == 0) goto LAB_10128c73c;
  uVar10 = *puVar1;
  uVar9 = uVar10 ^ 0x8000000000000000;
  if (-1 < (long)uVar10) {
    uVar9 = 1;
