...

{
  ...
  uVar1 = FUN_108856088(s_missing_field_____108ac28f7,&stack0x00000090);
  in_stack_00000058 = in_stack_00000058 + '\x01';
  plVar2 = (long *)FUN_100654604(&stack0x00000010);
  if (plVar2 != (long *)0x0) {
    if (*plVar2 == 1) {
  ...
  uVar1 = FUN_108832da4(uVar1,&stack0x00000010);
  ...
  uVar1 = FUN_108857ac8(&stack0x00000010,&stack0x00000090);
  if (unaff_x26 != 0) {
    _free();
  }
  *unaff_x21 = 1;
