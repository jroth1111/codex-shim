...
undefined8 FUN_1014e3f80(undefined1 *param_1)

{
  ...
  *(undefined1 *)(unaff_x19 + 0x31) = 0;
  ...
  unaff_x19[0x10] = (ulong)puStack0000000000000020;
  unaff_x19[0xf] = (ulong)puStack0000000000000018;
...
LAB_1014e431c:
    ...
    *(undefined1 *)((long)unaff_x19 + 0xb2) = 1;
    ...
    pcStack0000000000000050 = (char *)unaff_x19[0xf];
    ...
    *(ulong *)(unaff_x25 + 0x48) = uVar8;
    ...
    unaff_x19[0x17] = (ulong)pcStack0000000000000050;
    ...
    *(undefined1 *)(unaff_x19 + 0x3e) = 0;
    ...
    puStack0000000000000110 = *(ulong **)(unaff_x25 + 0x18);
    ...
    if (puVar16 != (ulong *)0x2) {
      ...
      *(ulong **)(unaff_x25 + 0x18) = puStack0000000000000110;
