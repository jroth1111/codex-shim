...
void FUN_100ae99dc(undefined8 *param_1,long *param_2,long param_3)

{
  ...
  if (param_3 < 9) {
    if (param_3 == 8) {
      if (*param_2 == 0x72616c756e617267) {
        *(undefined1 *)(param_1 + 1) = 3;
        *param_1 = 2;
        return;
      }
    }
    else if ((param_3 == 5) && ((int)*param_2 == 0x6576656e && *(char *)((long)param_2 + 4) == 'r'))
    {
    ...
    if (*param_2 == 0x756c6961662d6e6f && (short)param_2[1] == 0x6572) {
      *(undefined1 *)(param_1 + 1) = 1;
      *param_1 = 2;
      return;
    }
    if (*param_2 == 0x65757165722d6e6f && (short)param_2[1] == 0x7473) {
      *(undefined1 *)(param_1 + 1) = 2;
      *param_1 = 2;
      return;
    }
  }
  else if ((param_3 == 9) && (*param_2 == 0x6574737572746e75 && (char)param_2[1] == 'd')) {
    *(undefined1 *)(param_1 + 1) = 0;
    *param_1 = 2;
    return;
  }
  puStack_78 = &UNK_10b222dc8;
  uStack_70 = 5;
