...

{
  ...
  uVar5 = thunk_FUN_108856088(s_missing_field_____108ac28f7,unaff_x29 + -0x100);
  *unaff_x23 = 0x1d;
  unaff_x23[1] = uVar5;
  uVar6 = in_stack_00000078 ^ 0x8000000000000000;
  if (-1 < (long)in_stack_00000078) {
    uVar6 = 3;
  }
  puVar3 = in_stack_00000060;
  lVar4 = in_stack_00000040;
  if (uVar6 < 0xb) {
    if (uVar6 == 3) {
      puVar3 = in_stack_00000038;
      lVar4 = in_stack_00000238;
      if (in_stack_00000078 != 0) {
        _free(in_stack_00000040);
      }
      goto joined_r0x000100465024;
    }
  }
  else {
joined_r0x000100465024:
    if (lVar4 != 0) {
      _free(*puVar3);
    }
  }
  ...
  if ((uVar1 & 1) != 0) {
    uVar6 = in_stack_00000220 ^ 0x8000000000000000;
    if (-1 < (long)in_stack_00000220) {
      uVar6 = 3;
    }
    lVar4 = in_stack_00000228;
    if (uVar6 < 0xb) {
      if (uVar6 != 3) goto LAB_100464808;
