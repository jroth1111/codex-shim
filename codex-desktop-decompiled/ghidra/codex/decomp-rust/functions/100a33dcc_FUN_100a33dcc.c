...
void FUN_100a33dcc(long *param_1,undefined8 *param_2,undefined8 *param_3)
      ...
      *plVar27 = lVar17 + 1;
      if (-1 < lVar17) {
        ...
        *(int *)(param_2 + 0x10) = iVar30;
        ...
        param_2[0x12] = uVar18;
        puVar23 = &UNK_10b22acf0;
        param_2[0x13] = uVar16;
        param_2[0x14] = &UNK_10b22acf0;
...
LAB_100a34920:
            ...
            if (iVar22 + iVar30 == 0) {
              if ((*pbVar28 & 1) == 0) {
                ...
                if (plStack_100 != (long *)0x8000000000000001) goto LAB_100a34a5c;
                bVar13 = true;
              }
            }
              ...
              if ((*pbVar28 >> 1 & 1) == 0) {
                ...
                bVar13 = true;
                if ((uVar18 & 1) == 0) goto LAB_100a34968;
              }
            }
              ...
              bVar24 = 4;
              bVar13 = true;
              if (uVar15 != 2) goto LAB_100a34ae0;
            }
            iVar22 = 2;
            ...
            if (iVar22 + iVar30 == 0) {
              if ((*pbVar28 & 1) != 0) goto LAB_100a34af0;
              (**(code **)((*(undefined8 **)plVar27[0xe])[1] + 0x18))
                        (&plStack_100,**(undefined8 **)plVar27[0xe],param_3);
              if (plStack_100 != (long *)0x8000000000000001) goto LAB_100a34a5c;
            }
              ...
              if ((*pbVar28 >> 1 & 1) == 0) {
                ...
                if ((uVar18 & 1) == 0) goto LAB_100a34ae0;
              }
              else {
LAB_100a34af0:
                plVar25 = (long *)0x8000000000000003;
                uVar15 = (uint)puStack_428;
                if (!bVar13) goto LAB_100a34afc;
              }
            }
            else {
              if ((*pbVar28 >> 2 & 1) != 0) goto LAB_100a34af0;
              uVar15 = FUN_100fd4ba0(plVar27 + 0xf,param_3);
              uVar15 = uVar15 & 0xff;
              plVar25 = (long *)0x8000000000000002;
              bVar24 = 4;
...
LAB_100a34cd0:
          ...
          bVar24 = 4;
          bVar13 = true;
          if (uVar15 == 2) goto LAB_100a34920;
LAB_100a34ae0:
          *pbVar28 = *pbVar28 | bVar24;
          ...
          if (iVar30 == 1) {
            bVar13 = false;
            if ((*pbVar28 >> 1 & 1) != 0) goto LAB_100a34920;
            uVar18 = func_0x000106114748(plVar27,param_3);
            bVar13 = true;
            if ((uVar18 & 1) != 0) goto LAB_100a34920;
LAB_100a34968:
            bVar24 = 2;
            plVar25 = (long *)0x8000000000000001;
            uVar15 = (uint)puStack_428;
          ...
          bVar13 = false;
          if ((*pbVar28 & 1) != 0) goto LAB_100a34920;
          (**(code **)((*(undefined8 **)plVar27[0xe])[1] + 0x18))
                    (&plStack_100,**(undefined8 **)plVar27[0xe],param_3);
          if (plStack_100 == (long *)0x8000000000000001) {
            bVar13 = true;
...
LAB_100a34a5c:
          ...
          *pbVar28 = *pbVar28 | 1;
          plVar25 = plStack_100;
          if (plStack_100 == (long *)0x8000000000000004) goto LAB_100a34cd0;
        }
LAB_100a34afc:
          ...
          *(ulong *)(lVar17 + 0x130) = uVar18 - 0x10;
          ...
          if ((*(byte *)(lVar17 + 0x138) & 1) == 0) {
            ...
            if (uVar18 < uVar20) {
              ...
              if (uVar14 < uVar15) {
                uVar19 = 1000000000;
                if (lVar17 == 0) goto LAB_100a34c90;
                lVar17 = lVar17 + -1;
...
LAB_100a34380:
                if ((bVar24 & 1) == 0) {
                  ...
                  if (plStack_100 != (long *)0x8000000000000001) goto LAB_100a34438;
                  goto LAB_100a345b4;
                }
LAB_100a34424:
                plVar27 = (long *)0x8000000000000002;
                uVar14 = (uint)lStack_430;
                if (bVar5 == 0) goto LAB_100a345b4;
              }
            }
            else {
              bVar5 = bVar24 & 1;
              if ((bVar24 & 1) != 0) {
LAB_100a343f0:
                if ((bVar24 >> 1 & 1) != 0) goto LAB_100a34424;
                uVar14 = FUN_100fd4ba0(puVar31 + 1,param_3);
                uVar14 = uVar14 & 0xff;
                uVar20 = extraout_x1_03;
                if (uVar14 != 2) goto LAB_100a3440c;
                goto LAB_100a345b4;
              }
              (**(code **)((*(undefined8 **)*puVar31)[1] + 0x18))
                        (&plStack_100,**(undefined8 **)*puVar31,param_3);
...
LAB_100a34438:
              ...
              *pbVar28 = *pbVar28 | 1;
              ...
              if (plStack_100 == (long *)0x8000000000000003) goto LAB_100a345b4;
            }
...
LAB_100a34ed8:
        ...
        if (plVar27 == (long *)0x8000000000000001) goto LAB_100a34eec;
        uVar16 = param_2[0x19];
        puVar4 = (undefined8 *)param_2[0x1a];
        pcVar12 = (code *)*puVar4;
      ...
      if ((uVar18 & 1) == 0) goto LAB_100a34ed8;
      uVar21 = 6;
LAB_100a34e84:
...
joined_r0x000100a34604:
    ...
    *(undefined1 *)puStack_420 = 1;
    if (plVar27 == (long *)0x8000000000000002) goto LAB_100a34fe8;
...
LAB_100a35198:
        ...
        pcVar12 = (code *)SoftwareBreakpoint(1,0x100a3519c);
        (*pcVar12)();
      }
    }
