...
void FUN_100af73a8(undefined8 param_1)

{
  ...
  unaff_x27[1] = in_stack_00000110;
  *unaff_x27 = in_stack_00000108;
  ...
  __ZN19codex_network_proxy10http_proxy25blocked_text_with_details17h8b5be3d460a58e69E
            (&stack0x00000240,*(undefined8 *)(unaff_x19 + 0x330),*(undefined8 *)(unaff_x19 + 0x338),
             unaff_x19 + 0x340);
  ...
  *(undefined4 *)(unaff_x29 + -0x80) = *(undefined4 *)(unaff_x28 + 0x73);
  ...
  if (*(long *)(unaff_x19 + 0x328) != 0) {
    _free(*(undefined8 *)(unaff_x19 + 0x330));
  }
  if (*(long *)(unaff_x19 + 0x2f8) != -0x7fffffffffffffff) {
