...
/* WARNING: Removing unreachable block (ram,0x0001007ebf50) */
/* WARNING: Removing unreachable block (ram,0x0001007ec068) */
/* WARNING: Removing unreachable block (ram,0x0001007ebf58) */

void FUN_1007eb2bc(void)
  ...
  if (*unaff_x24 == -0x8000000000000000) {
    ...
    if (in_stack_000000e0 == unaff_x27) {
      ...
      *(long *)(unaff_x29 + -0xf0) = in_stack_00000118;
      lVar2 = FUN_1087e422c(((ulong)(in_stack_000000e0 - unaff_x27) >> 6) + in_stack_00000118,
