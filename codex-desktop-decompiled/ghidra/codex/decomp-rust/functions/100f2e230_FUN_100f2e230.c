...
void FUN_100f2e230(long *param_1,long param_2)
...
LAB_100f2e264:
  ...
  *(char **)(param_2 + 8) = pcVar2 + 0x20;
  if (cStack_60 == '\x16') goto LAB_100f2e264;
...
LAB_100f2e2a8:
    ...
    if (cStack_60 == '\x11') {
      ...
      uStack_28 = puVar1[3];
      uStack_30 = puVar1[2];
      func_0x00010140ce34(&lStack_78,&uStack_40);
      _free(puVar1);
    }
    else {
      if (cStack_60 == '\x12') goto LAB_100f2e2a8;
      func_0x00010140ce34(&lStack_78,&cStack_60);
    }
