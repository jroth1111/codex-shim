...
void FUN_100f25d10(long *param_1,long param_2)
...
LAB_100f25d44:
  ...
  *(char **)(param_2 + 8) = pcVar2 + 0x20;
  if (cStack_60 == '\x16') goto LAB_100f25d44;
...
LAB_100f25d8c:
    ...
    if (cStack_60 == '\x11') {
      ...
      uStack_28 = puVar1[3];
      uStack_30 = puVar1[2];
      FUN_1014130a0(&lStack_80,&uStack_40);
      _free(puVar1);
    }
    else {
      if (cStack_60 == '\x12') goto LAB_100f25d8c;
      FUN_1014130a0(&lStack_80,&cStack_60);
    }
    if (lStack_80 == -0x7ffffffffffffffc) {
