...
void FUN_100f29fd8(long *param_1,long param_2)
...
LAB_100f2a00c:
  ...
  *(char **)(param_2 + 8) = pcVar2 + 0x20;
  if (cStack_60 == '\x16') goto LAB_100f2a00c;
...
LAB_100f2a050:
    ...
    if (cStack_60 == '\x11') {
      ...
      uStack_28 = puVar1[3];
      uStack_30 = puVar1[2];
      func_0x00010145ae18(&lStack_78,&uStack_40);
      _free(puVar1);
    }
    else {
      if (cStack_60 == '\x12') goto LAB_100f2a050;
      func_0x00010145ae18(&lStack_78,&cStack_60);
    }
