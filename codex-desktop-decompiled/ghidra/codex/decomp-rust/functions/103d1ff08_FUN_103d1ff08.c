...
void FUN_103d1ff08(long *param_1,char *param_2)

{
  ...
  if (*param_2 == '\x15') {
    ...
    *(long *)*pauVar2 = auStack_188._0_8_ + 1;
    ...
    lStack_1b0 = 0;
    while( true ) {
      func_0x000103ec89f8(&lStack_178,acStack_258);
      lVar1 = lStack_220;
      lVar3 = lStack_230;
      ...
      if (lStack_178 == -0x7fffffffffffffff) {
        *param_1 = -0x8000000000000000;
        ...
        func_0x000103dc1800(&lStack_1c0);
        goto LAB_103d20084;
      }
      lStack_118 = lStack_178;
      uStack_108 = uStack_168;
      lStack_110 = lStack_170;
      FUN_103ebe164(auStack_b8,&lStack_1c0,&lStack_118,auStack_160);
      uStack_f8 = uStack_a8;
      ...
      if (lStack_b0 != -0x7ffffffffffffffb) {
        func_0x000103daac44(&lStack_100);
      }
    }
...
LAB_103d20084:
      func_0x000103d988cc(&lStack_238);
      if (acStack_258[0] != '\x16') {
        func_0x000103db23f4(acStack_258);
      }
    }
    else {
      ...
      if (lVar1 == lVar3) {
        ...
        lVar3 = func_0x000108978e3c(lStack_218 + ((ulong)(lVar1 - lVar3) >> 6),&lStack_178,
                                    &UNK_10b2fb940);
      }
      if (acStack_258[0] != '\x16') {
        func_0x000103db23f4(acStack_258);
      ...
      if (lVar3 != 0) {
        *param_1 = -0x8000000000000000;
        param_1[1] = lVar3;
        func_0x000103dc1800(&lStack_210);
      }
    }
  }
  else {
    lVar3 = func_0x00010897c8c4(param_2,&uStack_61,&UNK_10b2f71e8);
    *param_1 = -0x8000000000000000;
    param_1[1] = lVar3;
  }
  return;
