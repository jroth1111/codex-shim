...
void FUN_101495ce4(undefined8 *param_1,long *param_2,undefined8 param_3,undefined8 param_4,
                  undefined8 param_5)
      ...
      if (puVar13 == (ulong *)0x0) {
        ...
        *plStack_98 = lVar4 + -1;
        ...
        if (lVar4 == 1) {
          ...
          __ZN5alloc4sync16Arc_LT_T_C_A_GT_9drop_slow17hab837701f6c89e90E(&plStack_98);
        }
        return;
      }
      LOAcquire();
...
LAB_101495f60:
        ...
        if (uVar5 != 2) goto LAB_101495f60;
        if (puVar13[10] == uVar15) {
          puStack_78 = (ulong *)*puVar12;
          auVar17 = FUN_1014971a8(&puStack_78);
          ...
          if (plVar9 != (long *)0x0) {
            uVar5 = *puStack_78;
            *puStack_78 = uVar5 + 1;
            if ((long)uVar5 < 0) goto LAB_101495fac;
            if ((ulong *)*plVar9 == puStack_78 + 2) {
              ...
              *puStack_78 = uVar5 - 1;
              ...
              if (uVar5 == 1) {
                DataMemoryBarrier(2,1);
                __ZN5alloc4sync16Arc_LT_T_C_A_GT_9drop_slow17hab837701f6c89e90E(&puStack_68);
              }
            }
          }
          ...
          *puStack_78 = uVar6 - 1;
          ...
          if (uVar6 == 1) {
            DataMemoryBarrier(2,1);
            uStack_90 = uVar5;
            __ZN5alloc4sync16Arc_LT_T_C_A_GT_9drop_slow17hab837701f6c89e90E(&puStack_88);
            uVar5 = uStack_90;
          }
          goto LAB_101495d80;
        }
...
LAB_101495e98:
      while( true ) {
        puVar10 = puVar11;
        puVar7 = puVar8;
        if ((puVar10 != (ulong *)0x0) && (puVar10 != puVar1)) goto code_r0x000101495ea4;
...
LAB_101495fac:
  ...
  pcVar3 = (code *)SoftwareBreakpoint(1,0x101495fb0);
  (*pcVar3)();
code_r0x000101495ea4:
  puVar11 = puVar10 + 1;
  puVar8 = puVar7;
  if (*puVar10 == *puVar14) {
    *puVar10 = 3;
LAB_101495ee8:
    lVar16 = *plStack_98;
    *plStack_98 = lVar16 + 1;
    if (lVar16 < 0) goto LAB_101495fac;
  }
  goto LAB_101495e98;
}
