...

{
  ...
  puVar9 = (undefined *)FUN_108856088(s_duplicate_field_____108ac2973,unaff_x29 + -0x100);
...
LAB_1014071e8:
  if (puVar17 != (undefined8 *)0x8000000000000001) {
    ...
    *in_stack_00000020 = uVar7;
    in_stack_00000020[3] = uVar21;
    in_stack_00000020[2] = uVar16;
