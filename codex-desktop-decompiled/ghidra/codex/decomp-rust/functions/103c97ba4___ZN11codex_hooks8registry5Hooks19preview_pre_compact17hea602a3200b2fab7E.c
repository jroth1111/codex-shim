...
void __ZN11codex_hooks8registry5Hooks19preview_pre_compact17hea602a3200b2fab7E
  ...
  if (puVar7 != (undefined8 *)0x0) {
    *puVar7 = uVar2;
    ...
    __ZN11codex_hooks6engine10dispatcher34select_handlers_for_matcher_inputs17h1c684c5df70e7282E
              (&uStack_270,lVar13,uVar3,3,puVar7,1);
    _free(puVar7);
    puVar9 = puStack_268;
    uVar5 = uStack_270;
    ...
    if ((uVar5 != 0) && (lVar13 = (uVar10 / 0x98) * 0x98, uVar10 % 0x98 != 0)) {
      if (uVar10 < 0x98) {
        ...
        if (puVar9 == (undefined8 *)0x0) goto LAB_103c97e1c;
      }
    }
    *param_1 = uVar10 / 0x98;
...
LAB_103c97e1c:
  ...
  pcVar6 = (code *)SoftwareBreakpoint(1,0x103c97e2c);
  (*pcVar6)();
}
