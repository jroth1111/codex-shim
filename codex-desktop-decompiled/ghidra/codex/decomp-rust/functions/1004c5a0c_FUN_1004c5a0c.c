...

{
  ...
  lVar2 = thunk_FUN_108856088(s_missing_field_____108ac28f7,unaff_x29 + -0x88);
  *in_stack_000000c8 = 7;
...
LAB_1004c5da0:
  ...
  iVar1 = 0;
  if (in_stack_000000b0 != 0x8000000000000001) {
    iVar1 = unaff_w22;
  }
  if ((iVar1 == 1) && ((in_stack_000000b0 & 0x7fffffffffffffff) != 0)) {
    _free(in_stack_00000038);
    iVar1 = 0;
  ...
  if ((iVar1 == 1) && ((in_stack_000000b8 & 0x7fffffffffffffff) != 0)) {
    _free(in_stack_00000040);
  }
  if (*in_stack_000000c8 == 7) {
    ...
    if (unaff_x20 == unaff_x21) {
      ...
      *(long *)(unaff_x29 + -0x88) = unaff_x26;
      lVar2 = thunk_FUN_1087e422c(((ulong)(unaff_x20 - unaff_x21) >> 6) + unaff_x26,
  ...
  if ((in_stack_000000a0 & 0x1e) != 0x14) {
    FUN_100e077ec(in_stack_00000070);
  }
  return;
}
