...
void FUN_100f25bc4(long *param_1,long param_2)
...
LAB_100f25c00:
  ...
  *(char **)(param_2 + 8) = pcVar2 + 0x20;
  if (cStack_a0 == '\x16') goto LAB_100f25c00;
...
LAB_100f25c44:
    ...
    if (cStack_a0 == '\x11') {
      ...
      lStack_68 = plVar1[3];
      lStack_70 = plVar1[2];
      FUN_1014a868c(&lStack_58,&lStack_80);
      if (lStack_58 < -0x7ffffffffffffffe) {
        lStack_58 = -0x7fffffffffffffff;
      }
      _free(plVar1);
      lStack_80 = lStack_58;
      unaff_x21 = lStack_50;
      ...
      if (cStack_a0 == '\x12') goto LAB_100f25c44;
      FUN_1014a868c(&lStack_80,&cStack_a0);
      unaff_x21 = lStack_78;
      unaff_x22 = lStack_70;
