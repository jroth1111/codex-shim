...

{
  ...
  __ZN5alloc3fmt6format12format_inner17h63985d1d6aa0fe33E
            (&stack0x00000050,s_agents____config_file_must_point_108ac0f69,&stack0x000000e8);
  uVar1 = __ZN3std2io5error5Error3new17h002dced88496ea8bE(0x14,&stack0x00000050);
