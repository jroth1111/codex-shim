...
void FUN_1012d5c64(ulong *param_1,ulong *param_2)

{
  ...
  if (uVar9 == 0) {
    func_0x00010061ebb8(&uStack_1f8,param_2 + 1);
    uStack_c0 = unaff_x25;
    uStack_d0 = unaff_x27;
    uStack_b0 = unaff_x28;
...
LAB_1012d6120:
            ...
            pcVar8 = (code *)SoftwareBreakpoint(1,0x1012d6124);
            (*pcVar8)();
          }
          uVar12 = 0;
...
LAB_1012d5d6c:
          ...
          if (*puVar2 == 0x8000000000000000) goto LAB_1012d5d20;
          uStack_80 = puVar2[2];
          uStack_88 = puVar2[1];
          uStack_128 = puVar2[6];
          uStack_130 = puVar2[5];
          ...
          uStack_90 = *puVar2;
          func_0x00010061ebb8(&uStack_e8,&uStack_90);
          cVar7 = cStack_e0;
          uVar6 = uStack_f8;
          param_2 = puStack_110;
          uVar5 = uStack_118;
          ...
          if (cVar7 == '\0') {
            ...
            if (uStack_1f8 != 2) goto LAB_1012d6054;
            cStack_e0 = '\0';
            uStack_c0 = unaff_x25;
            uStack_d0 = unaff_x27;
            uStack_b0 = unaff_x28;
...
LAB_1012d5de4:
        ...
        uVar12 = uStack_c0;
        puStack_1c8 = param_2;
        goto joined_r0x0001012d60fc;
      }
      uVar13 = 0x2d;
      unaff_x20 = (undefined8 *)_malloc(0x2d);
      if (unaff_x20 == (undefined8 *)0x0) goto LAB_1012d6104;
      unaff_x20[1] = 0x3120796c74636178;
      *unaff_x20 = 0x65206465746e6177;
...
joined_r0x0001012d60fc:
    if (uStack_1f8 == 2) goto LAB_1012d5e1c;
  }
