...

{
  ...
  in_stack_000000f0 = FUN_108856088(s_missing_field_____108ac28f7,&stack0x000002b0);
  ...
  if (in_stack_000000e8 == -0x7ffffffffffffff9) {
    *in_stack_00000090 = 2;
    ...
    in_stack_00000090[0x1a] = *(undefined8 *)(unaff_x19 + 0x78);
    in_stack_00000090[0x19] = uVar3;
    uVar3 = *(undefined8 *)(unaff_x19 + 0x80);
    uVar7 = *(undefined8 *)(unaff_x19 + 0x98);
    uVar6 = *(undefined8 *)(unaff_x19 + 0x90);
    in_stack_00000090[0x1c] = *(undefined8 *)(unaff_x19 + 0x88);
    in_stack_00000090[0x1b] = uVar3;
    in_stack_00000090[0x1e] = uVar7;
    in_stack_00000090[0x1d] = uVar6;
    ...
    in_stack_00000090[0x18] = uVar5;
    in_stack_00000090[0x17] = uVar4;
