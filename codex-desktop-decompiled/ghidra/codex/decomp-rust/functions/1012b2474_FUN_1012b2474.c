...
/* WARNING: Removing unreachable block (ram,0x0001012b29bc) */

void FUN_1012b2474(undefined1 *param_1,char *param_2)
...
LAB_1012b2874:
        ...
        if (uStack_e0._1_1_ != 4) goto LAB_1012b29dc;
LAB_1012b2714:
        uVar8 = 4;
      }
      uVar11 = 0;
...
LAB_1012b2880:
    ...
    if ((byte)uStack_e0 == 4) {
      if (lStack_118 < 2) {
        if (lStack_118 == 0) goto LAB_1012b2860;
        if (lStack_118 == 1) goto LAB_1012b2854;
      }
      else {
        if (lStack_118 == 2) goto LAB_1012b2868;
        if (lStack_118 == 3) goto LAB_1012b2874;
        if (lStack_118 == 4) goto LAB_1012b2714;
      }
...
LAB_1012b2a00:
    ...
    if ((byte)uStack_e0 == 0xc) {
      func_0x000100ae4e54(&uStack_140,uStack_110,lStack_108);
      goto LAB_1012b262c;
    }
LAB_1012b2990:
    pcStack_138 = (char *)FUN_108855b04(&uStack_e0,&uStack_51,&UNK_10b211320);
...
LAB_1012b2898:
    ...
    if ((byte)uStack_e0 == 0xd) {
      func_0x000100ae4e54(&uStack_140,lStack_118,uStack_110);
LAB_1012b2884:
      FUN_100e077ec(&uStack_e0);
LAB_1012b288c:
      pcVar9 = uStack_140;
      ...
      if ((byte)uStack_e0 != 0xe) {
        if ((byte)uStack_e0 != 0xf) goto LAB_1012b2990;
        func_0x000100ae4bd8(&uStack_140,lStack_118,uStack_110);
        goto LAB_1012b2884;
      }
      func_0x000100ae4bd8(&uStack_140,uStack_110,lStack_108);
LAB_1012b262c:
      if (lVar10 == 0) goto LAB_1012b288c;
      _free(uVar7);
      pcVar9 = uStack_140;
      lVar10 = lStack_88;
      lStack_88 = lStack_68;
...
LAB_1012b27ec:
        ...
        if ((uVar1 == 0x12) || ((uVar1 == 0x15 && (lStack_88 == 0)))) goto LAB_1012b27ec;
        pcVar9 = (char *)FUN_108855b04(&cStack_a0,&uStack_51,&UNK_10b20a5c0);
        goto LAB_1012b28b0;
      }
LAB_1012b27f4:
    ...
    if (uStack_140._1_1_ == 3) {
      if (uVar1 == 0x16) goto LAB_1012b27f4;
      if ((uVar1 == 0x12) || ((uVar1 == 0x15 && (lStack_88 == 0)))) goto LAB_1012b27ec;
      pcVar9 = (char *)FUN_108855b04(&cStack_a0,&uStack_51,&UNK_10b20a5c0);
    }
    else {
