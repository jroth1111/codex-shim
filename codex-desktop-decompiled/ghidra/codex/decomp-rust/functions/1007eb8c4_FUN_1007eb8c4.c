...

{
  ...
  uStack00000000000000a0 = unaff_w21;
  uStack00000000000000a8 = unaff_w20;
  lVar4 = thunk_FUN_108856088(s_missing_field_____108ac28f7,unaff_x29 + -0x70);
  *unaff_x24 = -0x8000000000000000;
  unaff_x24[1] = lVar4;
  FUN_100ccc28c(unaff_x29 + -0xa0);
  if (*(long *)(unaff_x29 + -0xf0) < -0x7ffffffffffffffe) {
    FUN_100cebd88(unaff_x29 + -0xc0);
    FUN_100e7b7b0(&stack0x00000390);
  }
  else {
    FUN_100e79780(unaff_x29 + -0xf0);
    FUN_100cebd88(unaff_x29 + -0xc0);
    FUN_100e7b7b0(&stack0x00000390);
  }
  ...
  if (((unaff_w25 != 0) && (in_stack_00000330 != -0x7fffffffffffffff)) &&
     (in_stack_00000330 != -0x8000000000000000)) {
...
LAB_1007ebcc8:
  ...
  uVar2 = 0;
  if (in_stack_000002f0 != -0x7fffffffffffffff) {
    uVar2 = in_stack_00000048;
  }
  if (((uVar2 & 1) != 0) && (in_stack_000002f0 != -0x8000000000000000)) {
  ...
  uVar2 = 0;
  if (in_stack_000002d8 != -0x7fffffffffffffff) {
    uVar2 = uStack00000000000000a8;
  }
  if (((uVar2 & 1) != 0) && (in_stack_000002d8 != -0x8000000000000000)) {
  ...
  if (((uVar2 & 1) != 0) && ((in_stack_000000e8 & 0x7fffffffffffffff) != 0)) {
    _free(in_stack_00000040);
  }
  iVar3 = 0;
  if (in_stack_000000f0 != 0x8000000000000001) {
    iVar3 = in_stack_000000d8;
  }
  if ((iVar3 == 1) && ((in_stack_000000f0 & 0x7fffffffffffffff) != 0)) {
    _free(in_stack_00000038);
    uVar2 = 0;
