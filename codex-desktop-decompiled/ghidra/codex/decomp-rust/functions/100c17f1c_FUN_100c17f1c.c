...
/* WARNING: Removing unreachable block (ram,0x000100c18908) */
/* WARNING: Removing unreachable block (ram,0x000100c18b00) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_100c17f1c(undefined8 param_1)

{
  ...
  FUN_100c2a51c(&stack0x00000a80);
  if (in_stack_00000830 >> 0x1f != 0) {
    __ZN4core9panicking5panic17h30f5ec71e3af4326E(&UNK_108cc3a4d,0x37,&UNK_10b233cb0);
                    /* WARNING: Does not return */
    pcVar1 = (code *)SoftwareBreakpoint(1,0x100c194d0);
    (*pcVar1)();
  }
  ...
  *(undefined1 **)(in_stack_00000038 + 4) = &stack0x00000960;
