...
/* WARNING: Removing unreachable block (ram,0x00010064fcf0) */
...

{
  ...
  auVar10 = thunk_FUN_108856088(s_missing_field_____108ac28f7,&stack0x00000128);
  uVar6 = auVar10._0_8_;
  uVar5 = extraout_x17_05;
  if (in_stack_00000098 != 0) {
    auVar10 = _free(in_stack_00000068);
    uVar5 = extraout_x17_06;
  }
  if (in_stack_00000080 != 0) {
    auVar10 = _free(in_stack_000000a8);
    uVar5 = extraout_x17_02;
  }
  if (in_stack_00000088 != 0) {
    auVar10 = _free(in_stack_000000a0);
    uVar5 = extraout_x17_03;
  }
  if (in_stack_00000078 != 0) {
    auVar10 = _free(in_stack_00000038);
    uVar5 = extraout_x17_04;
  }
  lVar3 = in_stack_00000070;
  if ((in_stack_00000070 != -0x8000000000000000) && (in_stack_00000070 != 0)) {
    auVar10 = _free(in_stack_00000090);
    lVar3 = extraout_x9;
    uVar5 = extraout_x17;
  }
  uVar8 = 0;
  ...
  while( true ) {
    ...
    if ((bStack0000000000000100 & 1) == 0) {
      *(undefined1 *)(unaff_x29 + -0x80) = 0;
      while( true ) {
        uStack00000000000001a8 = auVar10._8_4_;
        in_stack_00000198 = auVar10._0_8_;
        lVar3 = _read(uVar1,unaff_x29 + -0x80,1);
        auVar10._8_4_ = uStack00000000000001a8;
        auVar10._0_8_ = in_stack_00000198;
        if (lVar3 != -1) break;
        piVar4 = (int *)___error();
        auVar10._8_4_ = uStack00000000000001a8;
        auVar10._0_8_ = in_stack_00000198;
        if (*piVar4 != 4) {
          plVar7 = (long *)func_0x000107c05db8((long)*piVar4 << 0x20 | 2);
          auVar10._8_4_ = uStack00000000000001a8;
          auVar10._0_8_ = in_stack_00000198;
          goto LAB_10064fecc;
        }
    ...
    uStack00000000000001a8 = auVar10._8_4_;
    in_stack_00000198 = auVar10._0_8_;
    uVar9 = (uint)bStack0000000000000101;
    if (0x2c < uVar9) goto LAB_10065049c;
    if ((1L << ((ulong)uVar9 & 0x3f) & 0x100002600U) == 0) break;
    ...
    if (in_stack_000000c8 != -0x8000000000000000) {
      ...
      *(byte *)(in_stack_000000d0 + lVar3) = bVar2;
      in_stack_000000d8 = lVar3 + 1;
    }
  }
  if ((ulong)uVar9 == 0x2c) {
...
LAB_10065049c:
    if (uVar9 == 0x7d) {
      ...
      if (in_stack_000000c8 == -0x8000000000000000) {
        ...
        plVar7 = (long *)0x0;
        *(undefined1 *)(in_stack_000000d0 + lVar3) = 0x7d;
        in_stack_000000d8 = lVar3 + 1;
      }
    }
    else {
...
LAB_10064fecc:
  uStack00000000000001a8 = auVar10._8_4_;
  in_stack_00000198 = auVar10._0_8_;
  *(undefined8 *)(unaff_x29 + -0x78) = in_stack_000001a0;
  *(undefined8 *)(unaff_x29 + -0x80) = in_stack_00000198;
  *(ulong *)(unaff_x29 + -0x70) = CONCAT44(uStack00000000000001ac,uStack00000000000001a8);
  if (plVar7 != (long *)0x0) {
    if (*plVar7 == 1) {
  ...
  uStack00000000000001a8 = auVar10._8_4_;
  in_stack_00000198 = auVar10._0_8_;
  uVar5 = thunk_FUN_108832e54(uVar6,in_stack_000000e0,in_stack_000000e8);
