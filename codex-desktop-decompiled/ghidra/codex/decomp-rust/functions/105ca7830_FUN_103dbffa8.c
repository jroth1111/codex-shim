...
void FUN_103dbffa8(long *param_1)

{
  ...
  if (*param_1 == 0x14) {
    func_0x000103daf478(param_1 + 1);
    plVar4 = (long *)param_1[0xe];
    if (plVar4 != (long *)0x0) {
      uVar5 = plVar4[6];
      do {
        uVar3 = uVar5;
        if (((uint)uVar3 >> 2 & 1) != 0) goto LAB_103dbfff8;
        uVar5 = plVar4[6];
      } while (uVar5 != uVar3);
      plVar4[6] = uVar3 | 2;
LAB_103dbfff8:
...
_free:
    ...
    if (plVar4 != (long *)0x0) {
      ...
      do {
        uVar3 = uVar5;
        if (((uint)uVar3 >> 2 & 1) != 0) goto LAB_103dc0090;
        uVar5 = plVar4[0x66];
      } while (uVar5 != uVar3);
      plVar4[0x66] = uVar3 | 2;
LAB_103dc0090:
