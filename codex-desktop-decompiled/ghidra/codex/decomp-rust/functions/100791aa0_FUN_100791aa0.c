...
void FUN_100791aa0(undefined1 *param_1,ulong *param_2)

{
  ...
  if (uVar5 == 3) {
    ...
    func_0x000100b2b2e0(param_1,&uStack_a0);
    return;
  }
  if (uVar5 != 5) {
    func_0x000107c05dc0(&uStack_a0,param_2);
    uVar2 = FUN_107c05dcc(&uStack_a0,&UNK_10b20a5b0,&UNK_10b20a590);
