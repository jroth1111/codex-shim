...

{
  ...
  __ZN5alloc3fmt6format12format_inner17h63985d1d6aa0fe33E
            (&stack0x00000350,s_failed_to_inspect_stderr_log_108ad1a20,&stack0x00000180);
  ...
  puVar2 = (undefined8 *)FUN_108857510(&stack0x00000180,&stack0x000000e0);
  ...
  *unaff_x21 = 1;
  ...
  lVar1 = plVar3[2];
  if ((ulong)(*plVar3 - lVar1) < in_stack_00000190) {
    FUN_108855060(plVar3,lVar1,in_stack_00000190,1,1);
    lVar1 = plVar3[2];
  }
  _memcpy(plVar3[1] + lVar1,in_stack_00000188,in_stack_00000190);
  plVar3[2] = lVar1 + in_stack_00000190;
