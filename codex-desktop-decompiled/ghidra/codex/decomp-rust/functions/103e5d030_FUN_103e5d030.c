...
void FUN_103e5d030(ulong *param_1)
...
LAB_103e5d1f8:
    ...
    *param_1 = uStack_78 + uStack_80 * -0x40;
    ...
    if ((uVar7 >> 1 & 1) != 0) goto LAB_103e5d160;
    if ((uVar7 >> 3 & 1) == 0) {
      auStack_798[0] = 2;
      unaff_x21 = param_1[5];
      unaff_x20 = (*
      ...
      if (*(char *)(unaff_x20 + 0x48) == '\x01') goto LAB_103e5d190;
      if (*(char *)(unaff_x20 + 0x48) != '\x02') goto LAB_103e5d178;
      uStack_88 = 0;
      puVar9 = param_1 + 6;
      iVar1 = (int)*puVar9;
      if (iVar1 != 1) goto LAB_103e5d1ac;
      goto LAB_103e5d0b4;
    }
    if ((uVar7 >> 4 & 1) == 0) goto LAB_103e5d1f8;
    if (param_1[0xea] != 0) {
...
LAB_103e5d2e0:
  ...
  pcVar8 = (code *)SoftwareBreakpoint(1,0x103e5d2e4);
  (*pcVar8)();
}
