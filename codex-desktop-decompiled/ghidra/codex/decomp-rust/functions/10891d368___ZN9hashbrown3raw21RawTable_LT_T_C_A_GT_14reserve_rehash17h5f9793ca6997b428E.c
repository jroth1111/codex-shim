...
ulong __ZN9hashbrown3raw21RawTable_LT_T_C_A_GT_14reserve_rehash17h5f9793ca6997b428E
...

{
  ...
  if (CARRY8(uVar15,param_2)) {
    ...
    if (uStack_88 >> 1 < uVar16) {
      ...
      FUN_102c3bb9c(&plStack_80,0x20,uVar16);
      if (plStack_80 != (long *)0x0) {
        ...
        if (uVar15 != 0) {
          ...
          do {
            ...
            uVar9 = FUN_102a2408c(uVar4,uVar5,plVar11[uVar10 * -4 + -3],plVar11[uVar10 * -4 + -2]);
...
LAB_10891d55c:
  ...
  do {
    ...
    if (*(char *)((long)unaff_x21 + uVar15) == -0x80) {
      ...
      while( true ) {
        uVar10 = FUN_102a2408c(uVar4,uVar5,unaff_x21[uVar15 * -4 + -3],unaff_x21[uVar15 * -4 + -2]);
...
LAB_10891d670:
    param_1 = plStack_a8;
    if (unaff_x20 <= uVar13) goto LAB_10891d70c;
    uVar16 = uVar13 + 1;
    uVar15 = uVar13;
  } while( true );
}
