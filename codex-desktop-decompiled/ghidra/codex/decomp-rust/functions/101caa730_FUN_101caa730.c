...
/* WARNING: Removing unreachable block (ram,0x000101caa63c) */

void FUN_101caa730(void)

{
  ...
  *unaff_x21 = 0x8000000000000000;
  ...
  if (((in_stack_00000048 & 0x7fffffffffffffff) != 0) && ((unaff_x19 & 1) != 0)) {
    _free(in_stack_00000028);
  }
  if (((unaff_x27 & 0x7fffffffffffffff) != 0) && ((unaff_x22 & 1) != 0)) {
    _free(in_stack_00000030);
  }
