...
void __ZN5hyper4body8incoming6Sender17try_send_trailers17h177370b47eea51a3E
...

{
  ...
  *param_2 = 0;
  ...
  if (*(char *)(lVar4 + 0xa8) == '\0') {
    ...
    *(char *)(lVar4 + 0x70) = '\x01';
    LORelease();
    if (cVar1 != '\0') goto LAB_1057abe78;
    if (*(long *)(lVar4 + 0x10) != 3) {
      __ZN4core9panicking5panic17h30f5ec71e3af4326E(&UNK_109aa025e,0x20,&UNK_10b3b4208);
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(1,0x1057abfd4);
      (*pcVar2)();
    }
    lVar5 = param_3[4];
    lVar6 = param_3[7];
    ...
    *(undefined1 *)(lVar4 + 0x70) = in_wzr;
    if (*(char *)(lVar4 + 0xa8) == '\0') {
LAB_1057abf34:
      FUN_1057a6350(&stack0xffffffffffffffc8);
      lVar5 = 4;
      goto LAB_1057abfa0;
    }
    LOAcquire();
