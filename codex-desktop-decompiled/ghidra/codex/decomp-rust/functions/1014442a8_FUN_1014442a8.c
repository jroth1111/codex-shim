...
/* WARNING: Removing unreachable block (ram,0x0001014447f4) */
/* WARNING: Type propagation algorithm not settling */

void FUN_1014442a8(undefined1 *param_1,char *param_2)
...
LAB_1014445e4:
          ...
          if (uStack_e0._1_1_ != 3) goto LAB_101444828;
LAB_1014445d0:
          uVar9 = 3;
        }
        uVar8 = 0;
...
LAB_1014445f0:
      ...
      if ((byte)uStack_e0 == 4) {
        if (lStack_118 < 2) {
          if (lStack_118 == 0) goto LAB_1014445dc;
          if (lStack_118 == 1) goto LAB_101444500;
        }
        else {
          if (lStack_118 == 2) goto LAB_1014445e4;
          if (lStack_118 == 3) goto LAB_1014445d0;
        }
...
LAB_10144484c:
      ...
      if ((byte)uStack_e0 == 0xc) {
        func_0x000100b250bc(&uStack_140,pcStack_110,lStack_108);
        goto LAB_101444454;
      }
LAB_1014447c8:
      pcStack_138 = (char *)FUN_108855b04(&uStack_e0,&uStack_51,&UNK_10b20e8a0);
...
LAB_101444608:
      ...
      if ((byte)uStack_e0 == 0xd) {
        func_0x000100b250bc(&uStack_140,lStack_118,pcStack_110);
LAB_1014445f4:
...
LAB_1014445fc:
        ...
        if ((byte)uStack_e0 != 0xe) {
          if ((byte)uStack_e0 != 0xf) goto LAB_1014447c8;
          func_0x000100b24ee4(&uStack_140,lStack_118,pcStack_110);
          goto LAB_1014445f4;
        }
        func_0x000100b24ee4(&uStack_140,pcStack_110,lStack_108);
LAB_101444454:
        pcVar10 = pcVar7;
        unaff_x25 = lVar11;
        if (lVar11 == 0) goto LAB_1014445fc;
        _free(pcVar7);
        pcVar10 = uStack_140;
        lVar6 = lStack_88;
        lStack_88 = lStack_68;
      ...
      if (uStack_140._1_1_ < 2) {
        if (uStack_140._1_1_ == 0) {
          if (uVar1 != 0x16) {
            if ((uVar1 == 0x12) || ((uVar1 == 0x15 && (lStack_88 == 0)))) goto LAB_101444770;
...
LAB_10144451c:
      ...
      cVar2 = *uStack_140;
      pcStack_138 = pcVar10;
      if (cVar2 == '\x16') goto LAB_10144451c;
...
LAB_101444360:
      ...
      if ((byte)uStack_e0 == '\x16') goto LAB_101444360;
      FUN_100e077ec(&uStack_e0);
