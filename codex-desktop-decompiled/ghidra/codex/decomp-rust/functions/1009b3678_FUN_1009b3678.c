...

{
  ...
  *(char **)(unaff_x29 + -0x70) = s__disconnecting_slow_connection_a_108accb8e;
  *(undefined1 **)(unaff_x29 + -0x68) = &stack0x00000660;
  FUN_1009b3aec(&stack0x000008a8);
