...
void FUN_103db3894(long param_1)

{
  ...
  **(long **)(param_1 + 0x20) = lVar2 + -1;
  ...
  FUN_103dafa60(param_1 + 0x30);
  if (*(long *)(param_1 + 0x910) != 0) {
    (**(code **)(*(long *)(param_1 + 0x910) + 0x18))(*(undefined8 *)(param_1 + 0x918));
  }
  plVar4 = *(long **)(param_1 + 0x920);
  if (plVar4 != (long *)0x0) {
    lVar2 = *plVar4;
    *plVar4 = lVar2 + -1;
    LORelease();
    if (lVar2 == 1) {
      DataMemoryBarrier(2,1);
      lVar2 = *(long *)(param_1 + 0x920);
      puVar1 = *(undefined8 **)(param_1 + 0x928);
      uVar5 = puVar1[2];
