...
void FUN_100ea9310(undefined8 *param_1,char *param_2)
...
LAB_100ea937c:
      do {
        while( true ) {
          ...
          puVar5 = puStack_118;
          if ((char)uStack_120 == '\x01') goto joined_r0x000100ea946c;
...
LAB_100ea98f0:
            ...
            pcVar3 = (code *)SoftwareBreakpoint(1,0x100ea9910);
            (*pcVar3)();
          }
        }
        if (uStack_120._1_1_ != '\0') {
          if (uStack_120._1_1_ != '\x01') {
            if (bVar1) {
              ...
              if (lStack_1e0 - lStack_1e8 == 0) goto LAB_100ea95f8;
          ...
          FUN_1012d9e28(&uStack_120);
          puVar5 = puStack_118;
          if (uStack_120 == (undefined **)0x8000000000000000) goto LAB_100ea96f4;
        ...
        lStack_1d8 = 0;
        if (lVar6 == 0) goto LAB_100ea98f0;
        puVar5 = (undefined *)FUN_1013d0b48();
        bVar1 = true;
      } while (puVar5 == (undefined *)0x0);
joined_r0x000100ea946c:
      if (ppuVar7 != (undefined **)0x8000000000000000) {
joined_r0x000100ea99ac:
      ...
      puVar5 = (undefined *)FUN_108855c40(param_2,&uStack_61,&UNK_10b214468);
    }
    goto LAB_100ea96f4;
  }
  ...
  if (pppuVar8 == (undefined ***)0x0) {
    ...
    puVar5 = (undefined *)FUN_1013d0b48(lVar6);
    if (puVar5 != (undefined *)0x0) goto LAB_100ea96f4;
    if (pppuVar8 != (undefined ***)0x1) {
      FUN_1012d9e28(&uStack_120,lVar6 + 0x20);
      puVar5 = puStack_118;
...
LAB_100ea95f8:
        ...
        if (ppuStack_280 == (undefined **)0x8000000000000000) {
          ...
          if (ppuStack_1c8 == (undefined **)0x8000000000000000) goto LAB_100ea9844;
        }
        else {
