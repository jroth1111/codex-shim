...
undefined1  [16] FUN_100fbd64c(undefined8 *param_1,undefined8 param_2)
...
LAB_100fbda90:
  ...
  pcVar6 = (code *)SoftwareBreakpoint(1,0x100fbda94);
  (*pcVar6)();
}
