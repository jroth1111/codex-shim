...
void FUN_103db48fc(long param_1)

{
  ...
  **(long **)(param_1 + 0x20) = lVar2 + -1;
  ...
  func_0x000103db0f60(param_1 + 0x30);
  if (*(long *)(param_1 + 0xa10) != 0) {
    (**(code **)(*(long *)(param_1 + 0xa10) + 0x18))(*(undefined8 *)(param_1 + 0xa18));
  }
  ...
  if (plVar4 != (long *)0x0) {
    ...
    *plVar4 = lVar2 + -1;
    ...
    if (lVar2 == 1) {
      DataMemoryBarrier(2,1);
      lVar2 = *(long *)(param_1 + 0xa20);
      puVar1 = *(undefined8 **)(param_1 + 0xa28);
      uVar5 = puVar1[2];
