...
long __ZN42__LT_str_u20_as_u20_toml__value__Index_GT_5index17hcf8c1d5dac618934E
...

{
  ...
  if (-1 < *param_3) {
    auVar24 = FUN_10612a75c(param_3,param_1,param_2);
    uVar11 = auVar24._8_8_;
    if ((auVar24._0_8_ & 1) != 0) {
      if (uVar11 < (ulong)param_3[2]) {
        return param_3[1] + uVar11 * 0x70 + 0x18;
      }
      auVar24 = func_0x000108a07bdc(uVar11,param_3[2],&UNK_10b4cf778);
