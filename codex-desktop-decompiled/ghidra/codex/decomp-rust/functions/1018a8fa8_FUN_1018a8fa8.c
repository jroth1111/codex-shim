...

{
  ...
  in_stack_000000b8 = (long *)FUN_1088bbbb8(s_duplicate_field_____108ac2973,unaff_x29 + -0xb0);
  in_stack_000000b0 = 0x8000000000000006;
  if (1 < in_stack_00000058 + 0x7ffffffffffffffbU) {
  ...
  if (in_stack_00000048 != -0x7ffffffffffffffa) {
    ...
    in_stack_00000040[1] = in_stack_000000b8;
  ...
  *in_stack_00000040 = 0x8000000000000005;
  in_stack_00000040[9] = 0x8000000000000005;
  if (*plVar4 == 1) {
    uVar9 = plVar4[1];
