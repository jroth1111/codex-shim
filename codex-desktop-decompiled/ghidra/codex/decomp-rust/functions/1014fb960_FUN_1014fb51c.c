...
undefined8 FUN_1014fb51c(undefined1 *param_1)

{
  ...
  *(undefined1 *)(unaff_x19 + 0x22) = 0;
  ...
  unaff_x19[0x12] = in_stack_00000020;
  unaff_x19[0x11] = in_stack_00000018;
...
LAB_1014fb5e4:
    ...
    *(undefined1 *)((long)unaff_x19 + 0xc2) = 1;
    ...
    puStack0000000000000050 = (ulong *)unaff_x19[0x11];
    ...
    *puVar15 = (ulong)puStack0000000000000050;
    ...
    *(undefined1 *)(unaff_x19 + 0x40) = 0;
    ...
    in_stack_00000110 = *(ulong **)(unaff_x26 + 0x18);
    ...
    if (puVar15 != (ulong *)0x2) {
      ...
      *(ulong **)(unaff_x26 + 0x18) = in_stack_00000110;
