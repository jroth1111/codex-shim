...

{
  ...
  __ZN5alloc3fmt6format12format_inner17h63985d1d6aa0fe33E
            (&stack0x00001a00,s_failed_to_run_network_proxy__108ac1035,&stack0x00001358);
  ...
  if (puVar3 == (undefined8 *)0x0) {
    ...
    *puVar3 = in_stack_00001a00;
    ...
    if (plVar4 != (long *)0x0) {
      ...
      *(undefined4 *)(unaff_x20 + 0x42) = *(undefined4 *)(unaff_x27 + 0xb);
