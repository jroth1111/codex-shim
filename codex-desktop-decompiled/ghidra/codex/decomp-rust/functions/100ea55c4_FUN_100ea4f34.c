...
/* WARNING: Removing unreachable block (ram,0x000100ea52bc) */
/* WARNING: Type propagation algorithm not settling */

void FUN_100ea4f34(undefined8 *param_1,char *param_2)
...
LAB_100ea4fac:
      do {
        while( true ) {
          ...
          if ((char)uStack_1e0 == '\x01') goto joined_r0x000100ea50c4;
...
LAB_100ea5558:
            ...
            pcVar3 = (code *)SoftwareBreakpoint(1,0x100ea5578);
            (*pcVar3)();
          }
        }
          ...
          if (uStack_1e0._1_1_ == '\x01') {
            ...
            if (pcVar6 != (char *)0x0) {
              ...
              if (cVar1 == '\x10' || cVar1 == '\x12') {
                ...
                ppuVar5 = ppuStack_1d8;
                ppuVar10 = uStack_1e0;
                if (uStack_1e0 == (undefined **)0x8000000000000003) goto LAB_100ea536c;
              }
            ...
            if (uVar7 == 0) goto joined_r0x000100ea51b0;
          }
...
LAB_100ea5288:
        ...
        pcStack_2a0 = (char *)0x0;
        if (pcVar6 == (char *)0x0) goto LAB_100ea5558;
        ppuVar5 = (undefined **)FUN_10136ee7c();
        bVar2 = true;
      } while (ppuVar5 == (undefined **)0x0);
joined_r0x000100ea50c4:
      ppuVar10 = (undefined **)((ulong)ppuVar10 & 0xfffffffffffffffe);
joined_r0x000100ea5620:
      ...
      ppuVar5 = (undefined **)FUN_108855c40(param_2,auStack_71,&UNK_10b213d08);
    }
    goto LAB_100ea536c;
  }
...
LAB_100ea536c:
  ...
  ppuVar5 = (undefined **)FUN_10136ee7c(lVar8);
  if (ppuVar5 != (undefined **)0x0) goto LAB_100ea536c;
  if (lVar11 == 1) {
    uVar4 = 1;
    goto LAB_100ea5354;
  }
  ...
  if (cVar1 == '\x10' || cVar1 == '\x12') {
    ...
    unaff_x20 = ppuStack_1d8;
    if (uStack_1e0 == (undefined **)0x8000000000000004) goto LAB_100ea536c;
  }
...
joined_r0x000100ea51b0:
  ppuVar5 = unaff_x20;
  if (ppuStack_3d0 == (undefined **)0x8000000000000003) goto LAB_100ea536c;
...
LAB_100ea5464:
    ...
    puStack_3c8 = (undefined *)unaff_x20;
    if (ppuStack_3d0 != (undefined **)0x8000000000000001) goto LAB_100ea5464;
