...

{
  ...
  auVar19._8_8_ = in_stack_00000358;
  auVar19._0_8_ = in_stack_00000350;
  uVar5 = FUN_108856088(s_missing_field_____108ac28f7,&stack0x000001e0);
  ...
  if (unaff_x21 == 0x8000000000000000) {
    lVar6 = FUN_108854818(uVar5,&UNK_108cbf9b6,0x2d);
    *in_stack_00000070 = 1;
LAB_100b91264:
    ...
    *(undefined8 *)(unaff_x29 + -0x70) = in_stack_00000178;
    puVar13 = (undefined8 *)(unaff_x29 - 0x80U | 8);
    ...
    *(ulong *)(unaff_x19 + 0x180) = unaff_x21;
    *(undefined8 *)(unaff_x19 + 0x188) = uVar5;
    *(undefined8 *)(unaff_x19 + 400) = in_stack_00000150;
    *(undefined8 *)(unaff_x19 + 0x1a0) = uVar15;
    *(undefined8 *)(unaff_x19 + 0x198) = uVar14;
    *(undefined8 *)(unaff_x19 + 0x1a8) = uVar8;
    *(undefined1 *)(unaff_x19 + 0x1b0) = 0;
    *(char *)(unaff_x19 + 0x1b1) = in_stack_00000188;
    if (in_stack_00000188 == '\x01') {
      *(undefined1 *)(unaff_x19 + 0x1b9) = 0;
      ...
      uVar15 = *(undefined8 *)(unaff_x19 + 400);
      uVar18 = *(undefined8 *)(unaff_x19 + 0x1a8);
      uVar17 = *(undefined8 *)(unaff_x19 + 0x1a0);
      ...
      *(undefined8 *)(unaff_x19 + 0x208) = uVar5;
      ...
      *(undefined8 *)(unaff_x19 + 0x248) = *(undefined8 *)(unaff_x19 + 0x1f0);
      auVar20 = __ZN5tokio4time7instant7Instant3now17h0933a405225fc2efE();
      lVar6 = auVar20._0_8_ + lVar10;
      if (lVar10 < 0 != SCARRY8(auVar20._0_8_,lVar10)) {
LAB_100b90ad4:
        func_0x000108a079f0(&UNK_109bd7235,0x28,&UNK_10b4aef18);
LAB_100b912c8:
                    /* WARNING: Does not return */
        pcVar3 = (code *)SoftwareBreakpoint(1,0x100b912cc);
        (*pcVar3)();
      }
      uVar9 = auVar20._8_4_ + iVar2;
      if (999999999 < uVar9) {
        bVar4 = SCARRY8(lVar6,1);
        lVar6 = lVar6 + 1;
        if (bVar4) goto LAB_100b90ad4;
        uVar9 = uVar9 + 0xc4653600;
      }
      *(long *)(unaff_x19 + 0x250) = lVar6;
      *(uint *)(unaff_x19 + 600) = uVar9;
      while( true ) {
        auVar19._8_8_ = in_stack_00000358;
        auVar19._0_8_ = in_stack_00000350;
        auVar20 = __ZN5tokio4time7instant7Instant3now17h0933a405225fc2efE();
        bVar4 = auVar20._8_4_ < *(uint *)(unaff_x19 + 600);
        if (auVar20._0_8_ != *(long *)(unaff_x19 + 0x250)) {
          bVar4 = auVar20._0_8_ < *(long *)(unaff_x19 + 0x250);
        }
        if (!bVar4) {
          *(undefined1 *)(unaff_x19 + 0x248) = 1;
          lVar10 = *(long *)(unaff_x19 + 0x218);
        ...
        lVar6 = 0;
        if ((int)in_stack_00000350 == 0) {
          lVar6 = in_stack_00000358;
        }
        lVar10 = auVar20._0_8_ + lVar6;
        if ((lVar6 < 0 != SCARRY8(auVar20._0_8_,lVar6)) ||
           ((uVar9 = auVar20._8_4_ + iVar2, 999999999 < uVar9 &&
            ((bVar4 = SCARRY8(lVar10,1), lVar10 = lVar10 + 1, bVar4 ||
             (uVar9 = uVar9 + 0xc4653600, uVar9 == 1000000000)))))) {
          __ZN5tokio4time5sleep5Sleep10far_future17h6fe06e7f826507d5E(&stack0x00000350,0);
        }
        else {
          auVar19 = __ZN5tokio7runtime9scheduler6Handle7current17hf4db12f69375e750E(&UNK_10b230f70);
          lVar6 = 0x140;
          if ((auVar19._0_8_ & 1) == 0) {
            lVar6 = 0x200;
          }
          if (*(int *)(auVar19._8_8_ + lVar6 + 0xd8) == 1000000000) {
            func_0x000108a079f0(&UNK_109bebb98,0x73,&UNK_10b230f70);
            goto LAB_100b912c8;
          }
          in_stack_00000360 = 0;
          in_stack_000003b8 = 0;
          in_stack_000003a8 = lVar10;
          in_stack_000003b0 = uVar9;
        }
        lVar6 = auVar19._8_8_;
        in_stack_00000350 = auVar19._0_8_;
        ...
        *(undefined1 (*) [16])(unaff_x19 + 0x260) = auVar19;
        ...
        *(undefined8 *)(unaff_x19 + 0x2d0) = uVar5;
...
LAB_100b91000:
      ...
      if (lVar10 == -0x8000000000000000) goto LAB_100b91264;
      *(undefined1 *)(unaff_x19 + 0x1b9) = 1;
      *(long *)(unaff_x19 + 0x180) = lVar10;
...
LAB_100b910fc:
        ...
        (**(code **)(*(long *)(unaff_x19 + lVar12) + 0x20))
                  ((long)plVar1 + lVar10,*(undefined8 *)((long)plVar1 + lVar11),
                   *(undefined8 *)((long)plVar1 + lVar6));
        auVar19 = _in_stack_000000f0;
      }
    }
    ...
    in_stack_000000f0 = auVar19._0_8_;
    bVar4 = in_stack_000000f0 != 0x15;
    _in_stack_000000f0 = auVar19;
    if (bVar4) {
  ...
  *unaff_x26 = uVar5;
  ...
  uVar7 = 1;
LAB_100b91288:
  *(undefined1 *)(unaff_x19 + 0x1b8) = uVar7;
  return;
}
