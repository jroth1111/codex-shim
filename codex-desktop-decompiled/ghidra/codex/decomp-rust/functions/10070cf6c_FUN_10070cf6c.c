...
void FUN_10070cf6c(undefined8 param_1)

{
  ...
  *(char **)(unaff_x29 + -0x70) = s_retry_sse_stream_error__108ac50ab;
  ...
  *(undefined **)(unaff_x29 + -0x90) = &UNK_10b208fd0;
  ...
  if ((*unaff_x25 == '\0') && (3 < ___ZN3log20MAX_LOG_LEVEL_FILTER17h2019f7c33388e688E)) {
    ...
    iVar8 = (**(code **)(puVar1 + 0x18))(puVar2,&stack0x000003f0);
    if (iVar8 != 0) {
      in_stack_000000e8 = *(long *)(lVar10 + 0x60);
      in_stack_000000f0 = *(undefined8 *)(lVar10 + 0x68);
      in_stack_000000d0 = *(long *)(lVar10 + 0x50);
      in_stack_000000d8 = *(undefined8 *)(lVar10 + 0x58);
      in_stack_000000c8 = 1;
      if (in_stack_000000d0 == 0) {
        in_stack_000000c8 = 2;
      }
      uStack0000000000000110 = *(undefined4 *)(lVar10 + 8);
      uStack0000000000000114 = *(undefined4 *)(lVar10 + 0xc);
      *(undefined1 **)(unaff_x29 + -0xb0) = &stack0x000004e0;
      *(undefined1 *)(unaff_x29 + -0xa8) = 1;
      *(long *)(unaff_x29 + -0x88) = unaff_x29 + -0xb0;
      *(undefined **)(unaff_x29 + -0x80) = &DAT_1061c2098;
      ...
      in_stack_000000f8 = 4;
      in_stack_00000120 = unaff_x29 + -0x88;
      in_stack_00000118 = s__108b39f4f;
      in_stack_00000100 = uVar11;
      in_stack_00000108 = uVar3;
      (**(code **)(puVar1 + 0x20))(puVar2,&stack0x000000c8);
    }
  }
  unaff_x20[9] = unaff_x20[9] + 1;
  auVar12 = (**(code **)(unaff_x20[0x1d] + 0x20))
                      (unaff_x20[0x1c] +
  ...
  if (auVar12._8_4_ == 1000000000) {
    if ((*unaff_x26 < 5) &&
      ...
      *(undefined **)(unaff_x29 + -0x80) = &UNK_10b208fd0;
      in_stack_000000d0 = unaff_x29 + -0x88;
      in_stack_000000c8 = 1;
      in_stack_000000d8 = 1;
        ...
        if (iVar8 != 0) {
          ...
          *(undefined **)(unaff_x29 + -0x80) = &UNK_10b208fd0;
          ...
          __ZN7tracing15__macro_support13__tracing_log17h72768b16bee39960E
                    (lVar10,puVar2,puVar1,&stack0x000004c8,&stack0x000000c8);
        }
      }
    }
    FUN_100df2508();
    ...
    *unaff_x19 = 0x15;
    ...
    uVar4 = *(uint *)(unaff_x20 + 0x13);
    if (uVar4 == 1000000000) {
      auVar5._8_4_ = 1000000000;
      auVar5._0_8_ = extraout_x10;
    }
    else {
      uVar9 = unaff_x20[0x12];
      auVar5._8_4_ = uVar4;
      auVar5._0_8_ = uVar9;
      bVar6 = auVar12._8_4_ < uVar4;
      if (auVar12._0_8_ != uVar9) {
        bVar6 = auVar12._0_8_ < uVar9;
      }
      if (!bVar6) {
        auVar5 = auVar12;
      }
    }
    if (auVar5._8_4_ != 1000000000) {
      auVar12 = auVar5;
    }
    __ZN5tokio4time5sleep5sleep17h2755eaf31c7f2ee9E
              (&stack0x00000458,auVar12._0_8_,auVar12._8_4_,&UNK_10b21f158);
    uVar11 = unaff_x20[9];
