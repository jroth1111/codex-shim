...
void FUN_103e6282c(ulong *param_1)
...
LAB_103e62a08:
    ...
    *param_1 = uStack_68 + uStack_70 * -0x40;
    ...
    if ((uVar6 >> 1 & 1) != 0) goto LAB_103e62954;
    if ((uVar6 >> 3 & 1) == 0) {
      uStack_e8 = 2;
      unaff_x21 = param_1[5];
      unaff_x20 = (*
      ...
      if (*(char *)(unaff_x20 + 0x48) == '\x01') goto LAB_103e62984;
      if (*(char *)(unaff_x20 + 0x48) != '\x02') goto LAB_103e6296c;
      uVar9 = 0;
      puVar8 = param_1 + 6;
      iVar1 = (int)*puVar8;
      if (iVar1 != 1) goto LAB_103e629a0;
      goto LAB_103e628a8;
    }
    if ((uVar6 >> 4 & 1) == 0) goto LAB_103e62a08;
    if (param_1[0x16] != 0) {
...
LAB_103e62aec:
  ...
  pcVar7 = (code *)SoftwareBreakpoint(1,0x103e62af0);
  (*pcVar7)();
}
