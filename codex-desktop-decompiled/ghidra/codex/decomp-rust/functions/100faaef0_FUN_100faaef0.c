...
undefined1  [16] FUN_100faaef0(void)

{
  ...
  FUN_100f3f484(&stack0x00000880,s_Remote_control_is_enabled_on_but_108ad46f9,&stack0x00000100);
  uVar3 = FUN_108856624(&stack0x00000880);
