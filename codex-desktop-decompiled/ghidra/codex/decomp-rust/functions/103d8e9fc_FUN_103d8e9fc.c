...
void FUN_103d8e9fc(long param_1)
...
joined_r0x000103d8eae4:
  ...
  if (iVar1 == 1) {
    ...
    func_0x000103dbe4a0(param_1 + 0x18);
  }
  _memcpy(param_1 + 0x10,auStack_758,0x710);
  if (*(char *)(lVar2 + 0x48) != '\x01') {
    if (*(char *)(lVar2 + 0x48) == '\x02') {
      return;
    }
