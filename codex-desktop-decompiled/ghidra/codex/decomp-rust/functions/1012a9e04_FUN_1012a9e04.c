...
undefined8 FUN_1012a9e04(char *param_1)
...
LAB_1012a9fdc:
          lStack_90 = lVar12 + 1;
          pbStack_a8 = pbVar9;
          uVar11 = FUN_108855b04(&lStack_88,&uStack_61,&UNK_10b210fe0);
        ...
        if ((1 << (ulong)(uVar7 & 0x1f) & 0xa012U) == 0) {
          if ((uVar7 != 0xc) && (bVar2 != 0xe)) goto LAB_1012a9fdc;
          if (lStack_80 != 0) {
            _free(uStack_78);
          }
        }
        ...
        if (cVar4 == '\x16') {
          ...
          pcVar6 = (code *)SoftwareBreakpoint(1,0x1012a9fdc);
          (*pcVar6)();
        }
        uVar11 = *puVar14;
        puVar13[1] = puVar14[1];
    ...
    uVar11 = FUN_108855b04(param_1,&uStack_61,&UNK_10b20ad20);
  }
  return uVar11;
}
