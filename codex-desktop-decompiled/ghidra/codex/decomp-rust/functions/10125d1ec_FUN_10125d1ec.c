...
void FUN_10125d1ec(undefined8 *param_1,byte *param_2)
...
LAB_10125d508:
      pbStack_e8 = pbVar14;
      pbVar9 = (byte *)FUN_1087e422c(0,&UNK_10b2305c8,&UNK_10b20a590);
    }
    else {
      pbVar14 = unaff_x21 + 0x20;
      if (*unaff_x21 == 0x16) goto LAB_10125d508;
      ...
      if (puStack_a0 != (undefined *)0x8000000000000000) {
        *param_1 = puStack_a0;
        ...
        if (lVar12 == 0) goto LAB_10125d670;
        *param_1 = 0x8000000000000000;
        param_1[1] = lVar12;
        unaff_x21 = pbVar9;
        puVar13 = puVar6;
        goto joined_r0x00010125d5c0;
      }
    }
    *param_1 = 0x8000000000000000;
    param_1[1] = pbVar9;
...
joined_r0x00010125d5c0:
    ...
    if (bVar3 != 0x15) {
      uVar11 = FUN_108855b04(param_2,&puStack_a0,&UNK_10b20c500);
      *param_1 = 0x8000000000000000;
      param_1[1] = uVar11;
      return;
    }
          ...
          if (bVar2 != 1) {
            ...
            if (bVar2 == 0xc) {
              if (lStack_70 == 4) {
                ...
                if (iVar1 == 0x68746170) goto LAB_10125d474;
              }
...
LAB_10125d778:
            lStack_b0 = lVar17 + 1;
            pbStack_c8 = pbVar19;
            uVar11 = FUN_108855b04(&bStack_88,&puStack_a0,&UNK_10b20d4a0);
            *param_1 = 0x8000000000000000;
            param_1[1] = uVar11;
            puVar13 = (undefined *)((ulong)puVar13 & 0x7fffffffffffffff);
            goto joined_r0x00010125d7b0;
          }
          bVar8 = cStack_87 == '\0';
LAB_10125d3f8:
          bVar8 = !bVar8;
...
LAB_10125d400:
          ...
          if (bVar2 != 0xe) {
            if (bVar2 != 0xf) goto LAB_10125d778;
          ...
          if (piVar4 == (int *)0x0) goto LAB_10125d40c;
          _free();
          if (bVar8) goto LAB_10125d410;
LAB_10125d474:
...
LAB_10125d774:
            ...
            pcVar7 = (code *)SoftwareBreakpoint(1,0x10125d778);
            (*pcVar7)();
          }
          uVar11 = *puVar16;
          puVar15[1] = puVar16[1];
      ...
      if (puVar13 != (undefined *)0x8000000000000000) {
        *param_1 = puVar13;
        ...
        if (pbVar10 == pbVar9) goto LAB_10125d670;
