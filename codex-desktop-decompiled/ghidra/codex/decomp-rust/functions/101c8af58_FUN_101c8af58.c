...

{
  ...
  if (puVar6 != (undefined4 *)0x0) {
    ...
    *(undefined8 *)(unaff_x29 + -0x48) = 6;
    __ZN5alloc3fmt6format12format_inner17h63985d1d6aa0fe33E(&stack0x00000050,s_turnId_____108adeb4b)
    ;
    if (*(long *)(unaff_x29 + -0x58) != 0) {
      _free(*(undefined8 *)(unaff_x29 + -0x50));
    }
  ...
  pcVar5 = (code *)SoftwareBreakpoint(1,0x101c8b0dc);
  (*pcVar5)();
}
