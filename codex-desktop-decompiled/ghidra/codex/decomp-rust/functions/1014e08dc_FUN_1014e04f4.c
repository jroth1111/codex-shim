...
code_r0x000108aa97c4:
  ...
  *puVar19 = 0x8000000000000001;
  ...
  if (uVar24 != 0x8000000000000001) {
    ...
    uStack_110 = uVar4;
    uStack_108 = uVar8;
    uVar14 = func_0x00010060c644(puVar16,&uStack_160);
    if (*puVar16 == 2) {
      uVar18 = uVar7;
  ...
  *puVar19 = 0x8000000000000001;
  ...
  if (uVar17 != 0x8000000000000001) {
    ...
    uStack_1c0 = uVar15;
    uStack_1b8 = uVar6;
    uVar14 = func_0x0001015e67e0(puVar16,&uStack_210);
    if (*puVar16 == 2) {
  ...
  *puVar19 = 0x8000000000000001;
  ...
  if (uVar24 != 0x8000000000000001) {
    ...
    uStack_270 = uVar4;
    uStack_268 = uVar8;
    uVar14 = func_0x0001015cdf0c(puVar16,&uStack_2c0);
    if (*puVar16 == 2) {
      uVar18 = uVar7;
      if ((uVar24 & 0x7fffffffffffffff) != 0) goto code_r0x000108aa97c4;
    }
  ...
  *puVar19 = 0x8000000000000001;
  ...
  if (uVar17 != 0x8000000000000001) {
    ...
    uStack_320 = uVar15;
    uStack_318 = uVar6;
    uVar14 = func_0x00010160334c(puVar16,&uStack_370);
    if (*puVar16 == 2) {
      if ((uVar17 & 0x7fffffffffffffff) != 0) goto code_r0x000108aa97c4;
    }
    else {
...
LAB_1014e143c:
      uVar17 = func_0x00010053cfd0(puVar16 + 0x15,uVar14);
      if ((uVar17 & 1) != 0) {
