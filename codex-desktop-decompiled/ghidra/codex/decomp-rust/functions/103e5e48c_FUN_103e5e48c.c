...
void FUN_103e5e48c(ulong *param_1)
...
LAB_103e5e654:
    ...
    *param_1 = uStack_78 + uStack_80 * -0x40;
    ...
    if ((uVar7 >> 1 & 1) != 0) goto LAB_103e5e5bc;
    if ((uVar7 >> 3 & 1) == 0) {
      auStack_b80[0] = 2;
      unaff_x21 = param_1[5];
      unaff_x20 = (*
      ...
      if (*(char *)(unaff_x20 + 0x48) == '\x01') goto LAB_103e5e5ec;
      if (*(char *)(unaff_x20 + 0x48) != '\x02') goto LAB_103e5e5d4;
      uStack_88 = 0;
      puVar9 = param_1 + 6;
      iVar1 = (int)*puVar9;
      if (iVar1 != 1) goto LAB_103e5e608;
      goto LAB_103e5e510;
    }
    if ((uVar7 >> 4 & 1) == 0) goto LAB_103e5e654;
    if (param_1[0x167] != 0) {
...
LAB_103e5e73c:
  ...
  pcVar8 = (code *)SoftwareBreakpoint(1,0x103e5e740);
  (*pcVar8)();
}
