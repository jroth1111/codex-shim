...
/* WARNING: Removing unreachable block (ram,0x00010128fdb0) */

void FUN_10128f8c4(undefined1 *param_1,char *param_2)
...
LAB_10128fc68:
        ...
        if (uStack_e0._1_1_ != 3) goto LAB_10128fdd0;
LAB_10128fc54:
        uVar11 = 3;
      }
      uVar8 = 0;
...
LAB_10128fc74:
    ...
    if ((byte)uStack_e0 == 4) {
      if (lStack_118 < 2) {
        if (lStack_118 == 0) goto LAB_10128fc60;
        if (lStack_118 == 1) goto LAB_10128fb44;
      }
      else {
        if (lStack_118 == 2) goto LAB_10128fc68;
        if (lStack_118 == 3) goto LAB_10128fc54;
      }
...
LAB_10128fdf4:
    ...
    if ((byte)uStack_e0 == 0xc) {
      func_0x000100b1b190(&uStack_140,uStack_110,lStack_108);
      goto LAB_10128fa70;
    }
LAB_10128fd84:
    pcStack_138 = (char *)FUN_108855b04(&uStack_e0,&uStack_51,&UNK_10b2123a0);
...
LAB_10128fc8c:
    ...
    if ((byte)uStack_e0 == 0xd) {
      func_0x000100b1b190(&uStack_140,lStack_118,uStack_110);
LAB_10128fc78:
      FUN_100e077ec(&uStack_e0);
LAB_10128fc80:
      pcVar9 = uStack_140;
      ...
      if ((byte)uStack_e0 != 0xe) {
        if ((byte)uStack_e0 != 0xf) goto LAB_10128fd84;
        func_0x000100b1ae98(&uStack_140,lStack_118,uStack_110);
        goto LAB_10128fc78;
      }
      func_0x000100b1ae98(&uStack_140,uStack_110,lStack_108);
LAB_10128fa70:
      if (lVar10 == 0) goto LAB_10128fc80;
      _free(uVar7);
      pcVar9 = uStack_140;
      lVar10 = lStack_88;
      lStack_88 = lStack_68;
...
LAB_10128fbe4:
        ...
        if ((uVar1 == 0x12) || ((uVar1 == 0x15 && (lStack_88 == 0)))) goto LAB_10128fbe4;
        pcVar9 = (char *)FUN_108855b04(&cStack_a0,&uStack_51,&UNK_10b20a5c0);
        goto LAB_10128fca4;
      }
LAB_10128fbec:
    ...
    if (uStack_140._1_1_ == 0) {
      if (uVar1 == 0x16) goto LAB_10128fbec;
      if ((uVar1 == 0x12) || ((uVar1 == 0x15 && (lStack_88 == 0)))) goto LAB_10128fbe4;
      pcVar9 = (char *)FUN_108855b04(&cStack_a0,&uStack_51,&UNK_10b20a5c0);
    }
    else {
