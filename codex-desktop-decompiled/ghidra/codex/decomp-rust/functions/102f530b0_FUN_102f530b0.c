...
/* WARNING: Possible PIC construction at 0x000102f53368: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x000102f5336c) */

void FUN_102f530b0(ulong *param_1,ulong *param_2)

{
  ...
  if ((long)uVar3 < 4) {
    if ((long)uVar3 < 3) {
      ...
      FUN_108921f70(param_1,&uStack_158,&uStack_51,&UNK_10b29b4f0);
    }
    else {
    ...
    auStack_70[0] = 10;
    uStack_d0 = uVar8;
    FUN_108921f70(&uStack_158,auStack_70,&uStack_51,&UNK_10b29b4f0);
    if (uStack_158 == 2) {
      if (uVar7 == 0) {
        ...
        *param_1 = 2;
        ...
        FUN_1089223ec(&uStack_158,uVar7,&UNK_10b2b6868,&UNK_10b29b520);
    ...
    if (uVar3 != 6) {
      ...
      func_0x00010329c7b0(&uStack_158,&uStack_d0);
      param_2 = &uStack_158;
      unaff_x30 = 0x102f5336c;
...
SUB_10892ddf4:
      ...
      *(undefined1 *)((long)register0x00000008 + -0x50) = 5;
      FUN_108921f70(param_1,(undefined1 *)((long)register0x00000008 + -0x50),
                    (undefined1 *)((long)register0x00000008 + -0x31),&UNK_10b29b4f0);
      if (*param_2 != 0) {
        _free(uVar3);
      }
      return;
    ...
    uStack_e8 = uVar3;
    uStack_e0 = uVar8;
    FUN_108921f70(&uStack_d0,auStack_70,&uStack_51,&UNK_10b29b4f0);
    if (uStack_d0 == 2) {
      if (uVar7 == 0) {
        ...
        *param_1 = 2;
        ...
        FUN_1089223ec(&uStack_d0,uVar6,&UNK_10b2b6878,&UNK_10b29b520);
