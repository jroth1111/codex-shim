...
void FUN_101615110(undefined8 *param_1,long *param_2)

{
  ...
  if (lVar3 == -0x8000000000000000) {
    if (lStack_80 == 7) {
      if ((int)*plVar1 != 0x73757274 || *(int *)((long)plVar1 + 3) != 0x64657473) {
code_r0x0001087e44e4:
        puStack_78 = &UNK_10b222448;
        uStack_70 = 2;
      ...
      *(undefined1 *)(param_1 + 1) = 0;
      ...
      if ((lStack_80 != 9) || (*plVar1 != 0x6574737572746e75 || (char)plVar1[1] != 'd'))
...
LAB_101615190:
    FUN_1087e44e4(param_1,plVar1,lStack_80,&UNK_10b222448,2);
  }
  else {
    if ((lStack_80 != 9) || (*plVar1 != 0x6574737572746e75 || (char)plVar1[1] != 'd'))
    goto LAB_101615190;
