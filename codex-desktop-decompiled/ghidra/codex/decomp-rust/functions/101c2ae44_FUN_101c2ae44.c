...
/* WARNING: Removing unreachable block (ram,0x000101c2b1fc) */

void FUN_101c2ae44(void)

{
  ...
  lVar3 = FUN_1088dc508(s_missing_field_____108ac28f7,unaff_x29 + -0xe0);
  *unaff_x19 = 0x12;
  unaff_x19[1] = lVar3;
  if (unaff_x27 != 0) {
    _free();
  ...
  if (((in_stack_000000b0 & 1) != 0) && (in_stack_00000090 != 0)) {
    FUN_10203e3c0(in_stack_00000090);
  ...
  if (in_stack_000000b8 != -0x7ffffffffffffffb) {
    func_0x00010203527c(&stack0x00000218);
  }
  ...
  if (*unaff_x19 == 0x12) {
    ...
    if (lVar2 == lVar3) {
      ...
      *(long *)(unaff_x29 + -0xe0) = in_stack_00000110;
      lVar3 = FUN_1088c7110(in_stack_00000110 + ((ulong)(lVar2 - lVar3) >> 6),unaff_x29 + -0xe0,
                            &UNK_10b276c98);
    }
    if (in_stack_000000d0 != '\x16') {
      FUN_1020378e0(&stack0x000000d0);
