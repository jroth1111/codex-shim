...
void __ZN5alloc7raw_vec19RawVec_LT_T_C_A_GT_8grow_one17h0d91c6a94bb3f406E(ulong *param_1)

{
  ...
  FUN_108a93d20(aiStack_38,*param_1,param_1[1],uVar10,8,0x68);
  if (aiStack_38[0] != 1) {
    *param_1 = uVar10;
    param_1[1] = uStack_30;
    return;
  ...
  FUN_108a93d20(aiStack_78,*puVar4,uVar6);
  if (aiStack_78[0] != 1) {
    *puVar4 = uVar11;
    puVar4[1] = uStack_70;
    return;
  ...
  if (auVar14._8_8_ == 0) {
    ...
    if (uVar11 != 0) {
      if (uVar11 < uVar8) {
        ...
        if (iVar3 != 0) goto LAB_108a93e3c;
      }
      else {
        uStack_c8 = _malloc(uVar11);
      }
      goto joined_r0x000108a93e04;
    }
LAB_108a93e24:
    uVar12 = 0;
    puVar5[1] = uStack_c8;
...
joined_r0x000108a93e04:
      if (uStack_c8 != 0) goto LAB_108a93e24;
    }
LAB_108a93e3c:
    puVar5[1] = uVar8;
    uVar12 = 1;
