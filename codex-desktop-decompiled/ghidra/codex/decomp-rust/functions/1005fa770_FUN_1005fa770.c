...
undefined1  [16] FUN_1005fa770(undefined8 param_1)

{
  ...
  undefined7 in_stack_00000fd8;
  undefined4 in_stack_00000fdf;
  undefined5 in_stack_00000fe3;
  uint5 uVar38;
  long in_stack_00000fe8;
  long in_stack_00000ff0;
  undefined7 in_stack_00000ff8;
  undefined1 in_stack_00000fff;
  ...
  pcVar35 = s_Sent_prompt_with_event_ID__108ac22de;
  bVar36 = (byte)&stack0x00002110;
  uVar37 = (undefined7)((ulong)&stack0x00002110 >> 8);
  ...
  *(undefined8 *)(unaff_x19 + 0x5128) = in_stack_00001e40;
  puVar5 = (undefined *)CONCAT53(in_stack_00000fe3,(int3)((uint)in_stack_00000fdf >> 8));
  lVar19 = in_stack_00000fe8 + 1;
  puVar15 = puVar5;
  ...
  if (CONCAT17((char)in_stack_00000fdf,in_stack_00000fd8) != 0) {
    _free(puVar5);
  }
  if (in_stack_00000ff0 != -0x8000000000000000) {
    if (in_stack_00000ff0 != 0) {
      _free(CONCAT17(in_stack_00000fff,in_stack_00000ff8));
    }
    if ((in_stack_00001008 != -0x8000000000000000) && (in_stack_00001008 != 0)) {
      _free(in_stack_00001010);
    }
  }
  *(undefined1 *)(unaff_x27 + 0xb21) = 0;
  *(undefined1 *)(unaff_x27 + 0xb22) = 0;
