...
void FUN_101225620(ushort *param_1,ulong *param_2)

{
  ...
  uVar4 = uVar6 ^ 0x8000000000000000;
  if (-1 < (long)uVar6) {
    uVar4 = 5;
  }
  if (uVar4 == 3) {
    ...
    func_0x000100ba4d40(&sStack_120,&uStack_a0);
    goto joined_r0x0001012257cc;
  }
  if (uVar4 != 5) {
    __ZN10serde_json5value2de42__LT_impl_u20_serde_json__value__Value_GT_10unexpected17he5d1f58814edc489E
              (&uStack_a0,param_2);
    uStack_118 = func_0x000108a4a50c(&uStack_a0,&UNK_10b20a5b0,&UNK_10b20a590);
    sStack_120 = 1;
...
LAB_101225734:
        ...
        if (uStack_a0 == 0x8000000000000000) goto LAB_101225734;
        ...
        uStack_118 = __ZN66__LT_serde_json__error__Error_u20_as_u20_serde_core__de__Error_GT_13invalid_value17h60b1f9f2e2975d54E
  ...
  sStack_120 = 1;
  FUN_100de8910(&puStack_110);
joined_r0x0001012257cc:
  if (sStack_120 == 1) {
    *(undefined8 *)(param_1 + 4) = uStack_118;
  }
  else {
    *(undefined4 *)(param_1 + 1) = uStack_11e;
    param_1[3] = uStack_11a;
  }
  *param_1 = (ushort)(sStack_120 == 1);
  return;
}
