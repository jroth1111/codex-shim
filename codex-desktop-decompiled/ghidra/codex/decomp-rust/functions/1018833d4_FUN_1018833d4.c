...
/* WARNING: Removing unreachable block (ram,0x000101883550) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined8 FUN_1018833d4(undefined8 param_1)

{
  ...
  *(undefined **)(unaff_x29 + -0xe0) = &UNK_10b25d1e8;
  __ZN12tracing_core5event5Event8dispatch17h50a390618bcffa4fE(param_1,&stack0x00000420);
  if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
     (4 < ___ZN3log20MAX_LOG_LEVEL_FILTER17h2019f7c33388e688E)) {
    lVar21 = *(long *)(unaff_x22 + 0x6b0);
    in_stack_00000020 = *(undefined8 *)(lVar21 + 0x20);
    ...
    iVar12 = (**(code **)(puVar3 + 0x18))(puVar4,&stack0x00000018);
    if (iVar12 != 0) {
      __ZN7tracing15__macro_support13__tracing_log17h72768b16bee39960E
                (lVar21,puVar4,puVar3,&stack0x00000018,&stack0x00000420);
    }
  }
...
LAB_1018838cc:
  ...
  *(undefined1 *)(plVar13 + 7) = 0;
  lVar21 = *plVar13;
  *plVar13 = lVar21 + 1;
  if (lVar21 < 0) goto LAB_1018838cc;
  ...
  if ((___ZN12tracing_core8metadata9MAX_LEVEL17h02c7742de62f64c3E < 4) &&
    ...
    if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
      ...
      *(undefined8 *)(unaff_x29 + -0xf0) = uVar8;
      ...
      iVar12 = (**(code **)(puVar3 + 0x18))(puVar4,unaff_x29 + -0x100);
      if (iVar12 != 0) {
        lVar15 = ___ZN16codex_app_server16outgoing_message21OutgoingMessageSender47send_server_notification_to_connection_and_wait28__u7b__u7b_closure_u7d__u7d_10__CALLSITE17h1fd5be597309d3aaE
                 + 0x30;
...
LAB_1018838ec:
    cVar11 = *(char *)(lVar15 + 0x44);
    cVar20 = *(char *)(lVar15 + 0x45);
    cVar17 = cVar20;
    if (cVar11 == '\x01') {
      if (cVar20 != '\0') {
        cVar17 = cVar20 + -1;
...
LAB_101883a0c:
  ...
  if (*(char *)(lVar15 + 0x48) != '\x02') {
    __ZN3std3sys12thread_local11destructors4list8register17ha25af605773d94bcE(lVar15,&DAT_10192b788)
    ;
...
LAB_101883970:
    ...
    *(undefined1 (*) [16])(lVar21 + 0x20) = auVar22;
    LOAcquire();
    uVar14 = *(ulong *)(lVar21 + 0x30);
    *(ulong *)(lVar21 + 0x30) = uVar14 | 1;
    LORelease();
    if (((uint)uVar14 >> 1 & 1) != 0) goto LAB_101883a08;
  }
    ...
    LOAcquire();
    uVar14 = *puVar1;
    *puVar1 = uVar14 & 0xfffffffffffffffe;
    LORelease();
  ...
  if (cVar11 != '\0') {
    if (*(char *)(lVar15 + 0x48) != '\x01') {
      if (*(char *)(lVar15 + 0x48) == '\x02') goto LAB_1018839f4;
      __ZN3std3sys12thread_local11destructors4list8register17ha25af605773d94bcE
                (lVar15,&DAT_1060edbcc);
      *(undefined1 *)(lVar15 + 0x48) = 1;
    }
    *(undefined1 *)(lVar15 + 0x44) = 1;
    *(char *)(lVar15 + 0x45) = cVar20;
  }
LAB_1018839f4:
  uVar18 = 4;
  uVar16 = 1;
