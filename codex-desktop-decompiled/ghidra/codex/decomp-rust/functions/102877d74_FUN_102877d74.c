...
void FUN_102877d74(ulong *param_1,uint *param_2,ulong param_3)

{
  ...
  if (uVar3 == 0) {
    ...
    if (param_3 != 0) goto LAB_102877eac;
LAB_102877dd0:
    if (uVar3 < 4) goto LAB_102877f04;
LAB_102877dd8:
    uVar5 = (ulong)*(uint *)((long)param_2 + uVar2);
    uVar4 = 4;
    if (uVar3 < 6) goto LAB_102877f30;
  }
  else {
    uVar2 = 8 - uVar3;
    uVar5 = uVar2;
...
LAB_102877e04:
    ...
    *param_1 = uVar3 ^ uVar5;
    ...
    if (param_3 <= uVar2) goto LAB_102877dd0;
LAB_102877eac:
    uVar7 = param_1[2];
    uVar4 = param_1[3];
    uVar5 = *param_1;
    ...
    *param_1 = uVar5;
    param_1[1] = uVar6;
    if (3 < uVar3) goto LAB_102877dd8;
LAB_102877f04:
    uVar4 = 0;
    uVar5 = 0;
    if (uVar3 < 2) goto LAB_102877f30;
  }
