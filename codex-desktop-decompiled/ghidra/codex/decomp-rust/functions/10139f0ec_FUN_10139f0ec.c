    ...
    *param_1 = 0x8000000000000000;
    ...
    do {
      ...
      *puVar23 = uVar13;
      ...
      if (0xc < bVar3) {
        if (bVar3 == 0xd) {
          func_0x000100bb6f9c(&bStack_d0,uVar14,uVar13);
          goto LAB_10139f354;
        }
        if (bVar3 != 0xe) {
          if (bVar3 != 0xf) goto LAB_10139f6a8;
          func_0x000100bb6d50(&bStack_d0,uVar14,uVar13);
          goto LAB_10139f354;
        }
        func_0x000100bb6d50(&bStack_d0,uVar13,uStack_98);
...
LAB_10139f6a8:
      ...
      func_0x000100bb6f9c(&bStack_d0,uVar13);
