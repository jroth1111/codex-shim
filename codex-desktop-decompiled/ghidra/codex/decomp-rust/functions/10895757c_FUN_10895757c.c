...
void FUN_10895757c(undefined8 *param_1,long param_2,undefined8 param_3,ulong param_4,ulong param_5,
                  long param_6)
  ...
  if (param_2 == 0) {
    ...
    if (uVar6 != 0) {
      if (uVar6 < param_5) {
        ...
        if (iVar3 != 0) goto LAB_108957698;
      }
      else {
        uStack_48 = _malloc(uVar6);
      }
      goto joined_r0x000108957660;
    }
LAB_108957680:
    uVar4 = 0;
    param_1[1] = uStack_48;
...
joined_r0x000108957660:
      if (uStack_48 != 0) goto LAB_108957680;
    }
LAB_108957698:
    param_1[1] = param_5;
    uVar4 = 1;
