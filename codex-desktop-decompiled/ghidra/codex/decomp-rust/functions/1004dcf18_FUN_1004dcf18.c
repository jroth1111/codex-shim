...

{
  ...
  in_stack_000000e8 = thunk_FUN_108856088(s_missing_field_____108ac28f7,&stack0x00000360);
...
LAB_1004dd500:
            if (in_stack_00000428 == -0x8000000000000000) {
              ...
              *(long *)(unaff_x24 + 0x100) = in_stack_000002d0;
              uVar11 = *(undefined8 *)(in_stack_00000430 + 0x40);
...
LAB_1004dd70c:
              ...
              *(long *)(unaff_x29 + -200) = lVar9;
              uVar12 = *(undefined8 *)(unaff_x24 + 0xf0);
              uVar14 = *(undefined8 *)(unaff_x24 + 0x108);
              uVar13 = *(undefined8 *)(unaff_x24 + 0x100);
              unaff_x23[0x25] = *(undefined8 *)(unaff_x24 + 0xf8);
              unaff_x23[0x24] = uVar12;
              unaff_x23[0x27] = uVar14;
              unaff_x23[0x26] = uVar13;
              ...
              *(undefined8 *)(unaff_x29 + -0x98) = uVar8;
              ...
              uVar11 = unaff_x23[0x21];
              uVar8 = unaff_x23[0x20];
              uVar12 = unaff_x23[0x1b];
              uVar14 = unaff_x23[0x1e];
              uVar13 = unaff_x23[0x1d];
              *(undefined8 *)(unaff_x24 + 0xf8) = unaff_x23[0x1c];
              *(undefined8 *)(unaff_x24 + 0xf0) = uVar12;
              *(undefined8 *)(unaff_x24 + 0x108) = uVar14;
              *(undefined8 *)(unaff_x24 + 0x100) = uVar13;
              lVar9 = in_stack_00000430;
            ...
            *(undefined8 *)(unaff_x24 + 0x40) = uVar11;
          ...
          thunk_FUN_1087e422c((lVar9 + 0x7fffffffffffffeU & 0x7ffffffffffffff) + 2,&stack0x000002b0,
                              &UNK_10b23a1b0);
...
LAB_1004dd014:
      do {
        ...
        in_stack_00000168 = lVar9;
        in_stack_00000160 = uVar8;
        FUN_100f23138(&stack0x000002b0,unaff_x29 + -0x88);
        puVar17 = puVar10;
        if ((char)in_stack_000002b0 == '\x01') {
joined_r0x0001004dd118:
          in_stack_00000158 = unaff_x21;
          _cStack0000000000000150 = puVar17;
          if (puVar10 != (undefined8 *)0x8000000000000000) {
LAB_1004dd1f4:
            FUN_100cbb248(&stack0x00000150);
          }
          goto LAB_1004dd200;
        }
        cVar18 = (char)((ulong)in_stack_000002b0 >> 8);
        if (cVar18 == '\x02') {
          ...
          *(undefined8 *)(unaff_x29 + -0x78) = 0;
          ...
          if (lVar6 == 0) {
LAB_1004ddaa0:
            _cStack0000000000000150 = puVar10;
            in_stack_00000158 = unaff_x21;
...
LAB_1004dd1dc:
            ...
            puVar17 = _cStack0000000000000150;
            unaff_x21 = in_stack_00000158;
            goto joined_r0x0001004dd118;
          }
          lVar9 = *(long *)(unaff_x29 + -0x78);
          *(undefined8 *)(unaff_x29 + -0x78) = 0;
          if (lVar9 == 0) goto LAB_1004ddaa0;
          lVar6 = FUN_1012840c4();
          bVar2 = true;
          uVar8 = in_stack_00000160;
          lVar9 = in_stack_00000168;
          ...
          lVar9 = *(long *)(unaff_x29 + -0x78);
          *(undefined8 *)(unaff_x29 + -0x78) = 0;
          if (lVar9 == 0) goto LAB_1004dd274;
          FUN_10131d9dc(&stack0x000002b0);
          puVar10 = in_stack_000002b0;
          unaff_x21 = in_stack_000002b8;
          uVar8 = in_stack_000002c0;
          lVar9 = in_stack_000002c8;
          lVar7 = in_stack_000002d0;
          uVar11 = in_stack_000002d8;
          lVar3 = in_stack_000002e0;
          uVar12 = in_stack_000002e8;
          uVar13 = in_stack_000002f0;
          uVar14 = in_stack_000002f8;
          uVar15 = in_stack_00000300;
...
LAB_1004dd200:
  ...
  lVar9 = in_stack_000000d8;
  puVar17 = in_stack_000000d0;
  if (unaff_w27 == 0x14) {
    if (in_stack_000000d8 == 0) {
      thunk_FUN_1087e422c(0,&UNK_10b22e858,&UNK_10b20a590);
      puVar17 = in_stack_000002b0;
    }
    else {
      ...
      if (lVar7 == 0) {
        ...
        thunk_FUN_1087e422c((lVar9 - 1U & 0x7ffffffffffffff) + 1,&stack0x000002b0,&UNK_10b23a1b0);
...
LAB_1004ddabc:
  ...
  FUN_100cbb07c(&stack0x00000360);
  auVar16 = FUN_100eac3a4(&stack0x000000c0);
  ...
  if ((auVar16._0_8_ & 1) == 0) {
    ...
    FUN_100cbb07c(&stack0x00000360);
    auVar16 = FUN_100eac1b4(&stack0x000000c0);
    puVar10 = auVar16._8_8_;
    if ((auVar16._0_8_ & 1) == 0) {
      ...
      if (puVar17 == (undefined8 *)0x8000000000000000) {
        FUN_100cbb07c(&stack0x00000360);
      ...
      uVar12 = *(undefined8 *)(unaff_x25 + 0xb8);
      uVar11 = *(undefined8 *)(unaff_x25 + 0xb0);
      ...
      in_stack_00000080 = unaff_x23[6];
      uVar12 = unaff_x23[8];
      uVar11 = unaff_x23[0xb];
      uVar8 = unaff_x23[10];
      uVar14 = unaff_x23[0xd];
      uVar13 = unaff_x23[0xc];
      *(undefined8 *)(unaff_x24 + 0x38) = unaff_x23[9];
      *(undefined8 *)(unaff_x24 + 0x30) = uVar12;
      *(undefined8 *)(unaff_x24 + 0x48) = uVar11;
      *(undefined8 *)(unaff_x24 + 0x40) = uVar8;
      *(undefined8 *)(unaff_x24 + 0x58) = uVar14;
      *(undefined8 *)(unaff_x24 + 0x50) = uVar13;
      in_stack_00000068 = unaff_x23[3];
      in_stack_00000060 = unaff_x23[2];
      in_stack_00000078 = unaff_x23[5];
      in_stack_00000070 = unaff_x23[4];
...
LAB_1004dd930:
  ...
  uVar11 = *(undefined8 *)(unaff_x24 + 0x30);
  uVar14 = *(undefined8 *)(unaff_x24 + 0x48);
  uVar13 = *(undefined8 *)(unaff_x24 + 0x40);
  unaff_x19[7] = in_stack_00000088;
  unaff_x19[6] = in_stack_00000080;
  unaff_x19[9] = uVar12;
  unaff_x19[8] = uVar11;
  uVar12 = *(undefined8 *)(unaff_x24 + 0x58);
  uVar11 = *(undefined8 *)(unaff_x24 + 0x50);
  unaff_x19[0xb] = uVar14;
  unaff_x19[10] = uVar13;
  ...
  *unaff_x19 = uVar8;
  ...
  FUN_100d5c778(&stack0x00000028);
  uVar8 = unaff_x19[8];
  uVar12 = unaff_x19[0xb];
  uVar11 = unaff_x19[10];
  unaff_x23[9] = unaff_x19[9];
  unaff_x23[8] = uVar8;
  unaff_x23[0xb] = uVar12;
  unaff_x23[10] = uVar11;
  uVar8 = unaff_x19[0xc];
