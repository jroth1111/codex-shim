...

{
  ...
  undefined1 *puStack0000000000000130;
  long in_stack_000001b8;
  undefined8 *in_stack_000001c0;
  
  puStack0000000000000130 = &stack0x00000310;
  pcStack0000000000000128 = s_fuzzy_file_search_join_failed__108aca072;
  FUN_10089af28(&stack0x00000200);
  if (in_stack_000001b8 != 0) {
    if ((code *)*in_stack_000001c0 != (code *)0x0) {
      (*(code *)*in_stack_000001c0)(in_stack_000001b8);
    }
    if (in_stack_000001c0[1] != 0) {
