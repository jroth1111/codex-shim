...

{
  ...
  if (puVar6 != (undefined4 *)0x0) {
    ...
    *(undefined8 *)(unaff_x29 + -0x38) = 4;
    __ZN5alloc3fmt6format12format_inner17h63985d1d6aa0fe33E(&stack0x00000050,s_turn_____108adf2cf);
    if (*(long *)(unaff_x29 + -0x48) != 0) {
      _free(*(undefined8 *)(unaff_x29 + -0x40));
    }
  ...
  pcVar5 = (code *)SoftwareBreakpoint(1,0x101c011b0);
  (*pcVar5)();
}
