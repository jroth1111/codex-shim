...
ulong * FUN_101508438(ulong *param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
                     undefined8 param_5)
    ...
    if (*puVar16 == 0) {
      if (*(ulong **)(uVar25 + 0x28) == puVar10) {
        ...
        *(ulong *)(uVar25 + 0x28) = uVar20;
        goto joined_r0x0001015084f0;
      }
LAB_1015085ec:
      func_0x000108a07a20(&UNK_10b24e580);
LAB_1015085f8:
                    /* WARNING: Does not return */
      pcVar8 = (code *)SoftwareBreakpoint(1,0x1015085fc);
      (*pcVar8)();
    }
    uVar20 = param_1[4];
    *(ulong *)(*puVar16 + 0x10) = uVar20;
joined_r0x0001015084f0:
    if (uVar20 == 0) {
      if (*(ulong **)(uVar25 + 0x30) != puVar10) goto LAB_1015085ec;
    ...
    if (puVar16 == puVar10) {
      func_0x00010897c03c(1,uVar25 + 0x18,&stack0xffffffffffffffc8,0,param_5,&UNK_10b23aac0);
      goto LAB_1015085f8;
    }
    param_1[3] = 0;
      ...
      if (*pcVar1 == '\x01') {
        *pcVar1 = in_wzr;
        ...
        __ZN11parking_lot9raw_mutex8RawMutex11unlock_slow17h37f4fcce25a32539E(pcVar1,0);
                    ...
                    /* WARNING: Could not recover jumptable at 0x000101508574. Too many branches */
