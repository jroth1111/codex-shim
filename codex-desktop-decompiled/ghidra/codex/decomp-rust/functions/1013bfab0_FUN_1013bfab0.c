      ...
      do {
        ...
        *(undefined8 *)((long)puVar21 + 0xf) = uVar25;
        ...
        if (0xc < bVar1) {
          ...
          if (bVar1 == 0xe) {
            func_0x000100baab70(&uStack_90,plVar5);
joined_r0x0001013bfdbc:
          ...
          if (bVar1 == 0xf) {
            func_0x000100baab70(&uStack_90,plVar3,plVar5);
            goto LAB_1013bfec8;
          }
LAB_1013c0014:
...
joined_r0x0001013bfed4:
        ...
        if (uStack_90._1_1_ == '\0') {
          if (pbVar22 == (byte *)0x8000000000000001) {
            func_0x000100f20864(&uStack_90,&pbStack_140);
...
LAB_1013bfca0:
          ...
          if (bVar1 == 0x11) {
            ...
            uStack_80 = puVar4[2];
            func_0x0001014553b8(&uStack_d8,&uStack_90);
            _free(puVar4);
            uVar23 = uStack_d8;
          }
          else {
            ...
            bStack_b0 = bVar1;
            func_0x0001014553b8(&uStack_d8,&bStack_b0);
            uVar23 = uStack_d8;
          }
          uStack_d8 = uVar23;
...
LAB_1013bfca8:
  ...
  func_0x000100f27f20(&uStack_90,&pbStack_140);
  uVar23 = uStack_80;
  pbVar22 = pbStack_88;
  pbVar17 = uStack_90;
  pbVar11 = pbStack_128;
