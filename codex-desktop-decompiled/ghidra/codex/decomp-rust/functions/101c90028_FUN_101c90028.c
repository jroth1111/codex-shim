...

{
  ...
  in_stack_00000040 = 1;
  in_stack_00000048 = 0;
  puVar4 = (undefined8 *)_malloc(0x12);
  if (puVar4 != (undefined8 *)0x0) {
    *(undefined2 *)(puVar4 + 2) = 0x7374;
    puVar4[1] = 0x6e656d6572697571;
    *puVar4 = 0x65526769666e6f43;
    *(undefined8 *)(unaff_x29 + -0x60) = 0x12;
    *(undefined8 **)(unaff_x29 + -0x58) = puVar4;
    *(undefined8 *)(unaff_x29 + -0x50) = 0x12;
    ...
    *(undefined8 *)(unaff_x29 + -0x38) = unaff_x20;
    __ZN5alloc3fmt6format12format_inner17h63985d1d6aa0fe33E
              (&stack0x00000008,s_requirements_____108ae2ab1,unaff_x29 + -0x60);
  ...
  pcVar3 = (code *)SoftwareBreakpoint(1,0x101c901e8);
  (*pcVar3)();
}
