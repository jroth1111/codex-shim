...
void FUN_1016170bc(undefined8 *param_1,long *param_2)

{
  ...
  if (lVar3 == -0x8000000000000000) {
    if (lStack_80 == 8) {
      if (*plVar1 != 0x6465746176656c65) {
code_r0x0001087e44e4:
        puStack_78 = &UNK_10b2206c8;
        uStack_70 = 2;
      ...
      *(undefined1 *)(param_1 + 1) = 0;
      ...
      if ((lStack_80 != 10) || (*plVar1 != 0x746176656c656e75 || (short)plVar1[1] != 0x6465))
...
LAB_10161712c:
    FUN_1087e44e4(param_1,plVar1,lStack_80,&UNK_10b2206c8,2);
  }
  else {
    if ((lStack_80 != 10) || (*plVar1 != 0x746176656c656e75 || (short)plVar1[1] != 0x6465))
    goto LAB_10161712c;
