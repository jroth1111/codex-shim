...
void FUN_101452924(undefined8 *param_1,char *param_2)
...
LAB_101452a14:
                    ...
                    if (bVar2 == 0x12) goto LAB_101452a58;
                    FUN_1004de164(&ppppuStack_b8);
                    if (ppppuStack_b8 != (undefined8 ****)0x8000000000000000) goto LAB_101452a14;
LAB_101452c6c:
                    ppppuVar7 = (undefined8 ****)0x8000000000000001;
                  }
                  unaff_x20 = puStack_b0;
                  if (ppppuVar7 == (undefined8 ****)0x8000000000000001) goto LAB_101452d78;
                }
LAB_101452a58:
              ...
              if (*(long *)(lVar8 + lVar9 + 8) == 0) goto LAB_101452c08;
            }
            else {
              if (bVar2 != 0xc) {
LAB_101452dc8:
                ppppuStack_190 = ppppuVar7;
                unaff_x20 = (undefined *)FUN_108855c40(lVar8 + lVar9,&ppppuStack_b8,&UNK_10b210480);
                if (ppppuVar7 != (undefined8 ****)0x8000000000000001) goto LAB_101452df0;
                goto LAB_101452d78;
              }
              if ((*(long *)(lVar8 + lVar9 + 0x18) == 0xd) &&
                 (plVar5 = *(long **)(lVar8 + lVar9 + 0x10),
                 *plVar5 == 0x654d657461657263 && *(long *)((long)plVar5 + 5) == 0x6567617373654d65)
                 ) goto LAB_101452c08;
            }
          }
          else if (bVar2 == 0xd) {
            if ((*(long *)(lVar8 + lVar9 + 0x10) == 0xd) &&
               (plVar5 = *(long **)(lVar8 + lVar9 + 8),
               *plVar5 == 0x654d657461657263 && *(long *)((long)plVar5 + 5) == 0x6567617373654d65))
            goto LAB_101452c08;
          }
          else if (bVar2 == 0xe) {
            if (*(long *)(lVar8 + lVar9 + 0x18) == 0xd) {
              ...
              cVar3 = *pcVar6;
joined_r0x000101452b38:
              if ((((((cVar3 == 'c') && (pcVar6[1] == 'r')) && (pcVar6[2] == 'e')) &&
                   ((pcVar6[3] == 'a' && (pcVar6[4] == 't')))) &&
                  ((pcVar6[5] == 'e' && ((pcVar6[6] == 'M' && (pcVar6[7] == 'e')))))) &&
                 ((pcVar6[8] == 's' &&
                  ((((pcVar6[9] == 's' && (pcVar6[10] == 'a')) && (pcVar6[0xb] == 'g')) &&
                   (pcVar6[0xc] == 'e')))))) goto LAB_101452c08;
            }
          }
          else {
            if (bVar2 != 0xf) goto LAB_101452dc8;
            if (*(long *)(lVar8 + lVar9 + 0x10) == 0xd) {
              pcVar6 = *(char **)(lVar8 + lVar9 + 8);
              cVar3 = *pcVar6;
              goto joined_r0x000101452b38;
            }
          }
          lVar9 = lVar9 + 0x40;
    ...
    unaff_x20 = (undefined *)FUN_108855c40(param_2,&ppppuStack_b8,&UNK_10b20bf60);
    goto LAB_101452d78;
  }
  lVar8 = *(long *)(param_2 + 0x18);
  if (lVar8 == 0) {
    unaff_x20 = (undefined *)FUN_1087e422c(0,&UNK_10b22e4c8,&UNK_10b20a590);
    goto LAB_101452d78;
  }
  ...
  if (cVar3 != '\x10') {
    if (cVar3 == '\x11') {
      ...
      if (cVar3 == '\x12') goto LAB_101452d00;
      FUN_1004de164(&ppppuStack_b8);
      ppppuVar7 = ppppuStack_b8;
      unaff_x20 = puStack_b0;
      ppppuStack_190 = (undefined8 ****)ppppuStack_a8;
    ...
    if ((ppppuVar7 == (undefined8 ****)0x8000000000000000) ||
       (ppppuVar7 == (undefined8 ****)0x8000000000000001)) goto LAB_101452d78;
  }
LAB_101452d00:
...
LAB_101452d24:
  ...
  unaff_x20 = (undefined *)
              FUN_1087e422c((uVar4 & 0x7ffffffffffffff) + 1,&ppppuStack_190,&UNK_10b23a1b0);
  if (ppppuVar7 != (undefined8 ****)0x8000000000000000) {
