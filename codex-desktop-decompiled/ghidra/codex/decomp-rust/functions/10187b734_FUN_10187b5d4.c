...

{
  ...
  plVar8 = (long *)FUN_1088bbbb8(s_missing_field_____108ac28f7,unaff_x29 + -0xa8);
  if (unaff_x23 != 0) {
    puVar10 = (undefined8 *)(in_stack_00000020 + 0x10);
    do {
      if (puVar10[-1] != 0) {
        _free(*puVar10);
      }
  ...
  __ZN16codex_app_server13dynamic_tools17fallback_response17hbc01028dbe995bd1E(&UNK_108ced2c0,0x21);
