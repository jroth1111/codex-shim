...
/* WARNING: Removing unreachable block (ram,0x0001004c4938) */

void FUN_1004c4178(void)

{
  ...
  lVar4 = thunk_FUN_108856088(s_missing_field_____108ac28f7,unaff_x29 + -0x80);
  *in_stack_000000e8 = 7;
  in_stack_000000e8[1] = lVar4;
  if (unaff_x28 != 0) {
  ...
  if (in_stack_000000c8 != 7) {
    if (in_stack_000000c8 == 3) {
      uVar5 = *(ulong *)(unaff_x29 + -0xd8) & 0x7fffffffffffffff;
    }
    else {
      if (in_stack_000000c8 != 4) goto LAB_1004c489c;
      uVar5 = *(ulong *)(unaff_x29 + -0xd8);
    }
    if (uVar5 != 0) {
...
LAB_1004c489c:
  ...
  if ((iVar2 == 1) && ((in_stack_000000d0 & 0x7fffffffffffffff) != 0)) {
    _free(in_stack_00000058);
    iVar2 = 0;
    if (in_stack_000000c0 != 0x8000000000000001) {
      iVar2 = unaff_w21;
    }
  }
  else {
  ...
  if ((iVar2 == 1) && ((in_stack_000000c0 & 0x7fffffffffffffff) != 0)) {
    _free(in_stack_00000060);
  }
  lVar3 = in_stack_00000128;
  ...
  if (*in_stack_000000e8 == 7) {
    ...
    lVar8 = in_stack_000000e8[0x17];
    lVar7 = in_stack_000000e8[0x16];
    lVar6 = in_stack_000000e8[0x18];
    ...
    if (lVar3 == lVar4) {
      ...
      *(long *)(unaff_x29 + -0x80) = in_stack_00000130;
      lVar4 = thunk_FUN_1087e422c(in_stack_00000130 + ((ulong)(lVar3 - lVar4) >> 6),
    ...
    if (lVar4 == 0) {
      ...
      in_stack_000000e8[0x17] = lVar8;
      in_stack_000000e8[0x16] = lVar7;
      in_stack_000000e8[0x18] = lVar6;
