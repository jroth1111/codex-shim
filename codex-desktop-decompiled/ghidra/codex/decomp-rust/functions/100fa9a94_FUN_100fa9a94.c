...
/* WARNING: Removing unreachable block (ram,0x000100f9cd5c) */

undefined1  [16] FUN_100fa9a94(void)

{
  ...
  uVar3 = FUN_108858fa8(s_Unknown_feature_flag__108ad43ae,&stack0x00005f80);
  *unaff_x23 = 1;
  FUN_100e4ccb0();
  if (uVar3 == 0) {
    if (*(long *)(in_stack_000000f8 + 0x748) != 0) {
      _free(*(undefined8 *)(in_stack_000000f8 + 0x750));
    }
