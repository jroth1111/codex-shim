...
/* WARNING: Removing unreachable block (ram,0x0001013a5fec) */

void FUN_1013a5aa0(undefined1 *param_1,char *param_2)
...
LAB_1013a5f10:
    ...
    if ((byte)uStack_e0 == 4) {
      if (plStack_118 != (long *)0x0) {
        if (plStack_118 == (long *)0x1) goto LAB_1013a5dc8;
    ...
    if ((byte)uStack_e0 == 0xc) {
      if (lStack_108 == 8) {
        if (*plStack_110 != 0x44455453494c4e55) goto LAB_1013a5c08;
        uStack_140 = (char *)((ulong)uStack_140._2_6_ << 0x10);
      }
...
LAB_1013a5c08:
        pcStack_138 = (char *)FUN_1087e4494(plStack_110,lStack_108,&UNK_10b2326f0,2);
        uStack_140 = (char *)CONCAT71(uStack_140._1_7_,1);
      }
joined_r0x0001013a5d94:
      if (plVar5 == (long *)0x0) goto LAB_1013a5f1c;
      _free(plVar6);
      pcVar8 = uStack_140;
      lVar9 = lStack_88;
      lStack_88 = lStack_68;
      goto joined_r0x0001013a5e58;
    }
LAB_1013a5fc0:
    pcStack_138 = (char *)FUN_108855b04(&uStack_e0,&uStack_51,&UNK_10b20d7c0);
    uStack_140 = (char *)CONCAT71(uStack_140._1_7_,1);
    lVar9 = lStack_88;
LAB_1013a5f28:
    lStack_88 = lVar9;
    ...
    if ((byte)uStack_e0 == 0xd) {
      if (plStack_110 == (long *)0x8) {
        if (*plStack_118 == 0x44455453494c4e55) goto LAB_1013a5f0c;
      }
      else if ((plStack_110 == (long *)0x7) &&
              ((int)*plStack_118 == 0x56495250 && *(int *)((long)plStack_118 + 3) == 0x45544156))
      goto LAB_1013a5dc8;
      pcStack_138 = (char *)FUN_1087e4494(plStack_118,plStack_110,&UNK_10b2326f0,2);
LAB_1013a5d1c:
      uVar10 = 1;
      goto LAB_1013a5f10;
    }
    if ((byte)uStack_e0 == 0xe) {
      FUN_100bde174(&uStack_140,plStack_110,lStack_108);
      goto joined_r0x0001013a5d94;
    }
    if ((byte)uStack_e0 != 0xf) goto LAB_1013a5fc0;
    FUN_100bde174(&uStack_140,plStack_118,plStack_110);
LAB_1013a5f14:
    FUN_100e077ec(&uStack_e0);
LAB_1013a5f1c:
    pcVar8 = uStack_140;
    lVar9 = lStack_88;
    lStack_88 = lStack_68;
joined_r0x0001013a5e58:
    bVar4 = (char)uStack_140 == '\x01';
    uStack_140 = pcVar8;
    lStack_68 = lStack_88;
    if (bVar4) goto LAB_1013a5f28;
