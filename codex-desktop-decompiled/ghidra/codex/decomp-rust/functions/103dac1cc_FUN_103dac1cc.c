...
void FUN_103dac1cc(int *param_1)

{
  ...
  if (*param_1 == 0) {
    cVar4 = *(char *)((long)param_1 + 0x301);
    if (cVar4 == '\0') {
      func_0x000103d9de74(param_1 + 2);
      lVar14 = *(long *)(param_1 + 0x5c);
      LOAcquire();
      ...
      *(long *)(lVar14 + 0x1f0) = lVar8 + -1;
      ...
      lVar8 = **(long **)(param_1 + 0x5c);
      **(long **)(param_1 + 0x5c) = lVar8 + -1;
      LORelease();
      if (lVar8 == 1) {
        DataMemoryBarrier(2,1);
        __ZN5alloc4sync16Arc_LT_T_C_A_GT_9drop_slow17haf4d1ee58cf8c660E(param_1 + 0x5c);
      }
      ...
      **(long **)(param_1 + 0x5e) = lVar8 + -1;
      ...
      if (cVar4 == '\x03') {
        ...
        piStack_48 = param_1 + 0xd6;
        FUN_1060fb5d4(&uStack_50);
        if (*(long *)(param_1 + 0xd0) != 0) {
          (**(code **)(*(long *)(param_1 + 0xd0) + 0x18))(*(undefined8 *)(param_1 + 0xd2));
        }
      }
      else {
        if (cVar4 != '\x04') {
        ...
        func_0x000103d9d8cc(param_1 + 0xc4);
        *(undefined1 *)((long)param_1 + 0x303) = 0;
      }
      func_0x000103d9de74(param_1 + 0x66);
      __ZN97__LT_tokio_util__sync__cancellation_token__CancellationToken_u20_as_u20_core__ops__drop__Drop_GT_4drop17h41b2bd289c4eedfeE
                (param_1 + 0x62);
      ...
      **(long **)(param_1 + 0x62) = lVar8 + -1;
      ...
      if (lVar8 == 1) {
        DataMemoryBarrier(2,1);
        __ZN5alloc4sync16Arc_LT_T_C_A_GT_9drop_slow17ha29a3ea10b50cafaE(param_1 + 0x62);
      }
