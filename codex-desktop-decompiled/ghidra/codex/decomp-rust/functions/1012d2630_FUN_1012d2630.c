...
/* WARNING: Removing unreachable block (ram,0x0001012d2b94) */

void FUN_1012d2630(undefined1 *param_1,char *param_2)
...
LAB_1012d2ab8:
    ...
    if ((byte)uStack_e0 == 4) {
      if (plStack_118 != (long *)0x0) {
        if (plStack_118 == (long *)0x1) goto LAB_1012d2970;
    ...
    if ((byte)uStack_e0 == 0xc) {
      if (lStack_108 == 10) {
        if (*plStack_110 != 0x7463697274736572 || (short)plStack_110[1] != 0x6465)
        goto LAB_1012d27a4;
        uStack_140 = (char *)((ulong)uStack_140._2_6_ << 0x10);
      }
      else if ((lStack_108 == 7) &&
              ((int)*plStack_110 == 0x62616e65 && *(int *)((long)plStack_110 + 3) == 0x64656c62)) {
        uStack_140 = (char *)CONCAT62(uStack_140._2_6_,0x100);
      }
      else {
LAB_1012d27a4:
        pcStack_138 = (char *)FUN_1087e4494(plStack_110,lStack_108,&UNK_10b222208,2);
        uStack_140 = (char *)CONCAT71(uStack_140._1_7_,1);
      }
joined_r0x0001012d293c:
      if (plVar5 == (long *)0x0) goto LAB_1012d2ac4;
      _free(plVar6);
      pcVar8 = uStack_140;
      lVar9 = lStack_88;
      lStack_88 = lStack_68;
      goto joined_r0x0001012d2a00;
    }
LAB_1012d2b68:
    pcStack_138 = (char *)FUN_108855b04(&uStack_e0,&uStack_51,&UNK_10b20da20);
    uStack_140 = (char *)CONCAT71(uStack_140._1_7_,1);
    lVar9 = lStack_88;
LAB_1012d2ad0:
    lStack_88 = lVar9;
    ...
    if ((byte)uStack_e0 == 0xd) {
      if (plStack_110 == (long *)0xa) {
        if (*plStack_118 == 0x7463697274736572 && (short)plStack_118[1] == 0x6465)
        goto LAB_1012d2ab4;
      }
      else if ((plStack_110 == (long *)0x7) &&
              ((int)*plStack_118 == 0x62616e65 && *(int *)((long)plStack_118 + 3) == 0x64656c62))
      goto LAB_1012d2970;
      pcStack_138 = (char *)FUN_1087e4494(plStack_118,plStack_110,&UNK_10b222208,2);
LAB_1012d28c4:
      uVar10 = 1;
      goto LAB_1012d2ab8;
    }
    if ((byte)uStack_e0 == 0xe) {
      func_0x000100ae50ec(&uStack_140,plStack_110,lStack_108);
      goto joined_r0x0001012d293c;
    }
    if ((byte)uStack_e0 != 0xf) goto LAB_1012d2b68;
    func_0x000100ae50ec(&uStack_140,plStack_118,plStack_110);
LAB_1012d2abc:
    FUN_100e077ec(&uStack_e0);
LAB_1012d2ac4:
    pcVar8 = uStack_140;
    lVar9 = lStack_88;
    lStack_88 = lStack_68;
joined_r0x0001012d2a00:
    bVar4 = (char)uStack_140 == '\x01';
    uStack_140 = pcVar8;
    lStack_68 = lStack_88;
    if (bVar4) goto LAB_1012d2ad0;
