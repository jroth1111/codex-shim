...
/* WARNING: Removing unreachable block (ram,0x0001013a6630) */

void FUN_1013a60e8(undefined1 *param_1,char *param_2)
...
LAB_1013a64e8:
        ...
        if (uStack_e0._1_1_ != 4) goto LAB_1013a6650;
LAB_1013a6388:
        uVar8 = 4;
      }
      uVar11 = 0;
...
LAB_1013a64f4:
    ...
    if ((byte)uStack_e0 == 4) {
      if (lStack_118 < 2) {
        if (lStack_118 == 0) goto LAB_1013a64d4;
        if (lStack_118 == 1) goto LAB_1013a64c8;
      }
      else {
        if (lStack_118 == 2) goto LAB_1013a64dc;
        if (lStack_118 == 3) goto LAB_1013a64e8;
        if (lStack_118 == 4) goto LAB_1013a6388;
      }
...
LAB_1013a6674:
    ...
    if ((byte)uStack_e0 == 0xc) {
      func_0x000100b40728(&uStack_140,uStack_110,lStack_108);
      goto LAB_1013a62a0;
    }
LAB_1013a6604:
    pcStack_138 = (char *)FUN_108855b04(&uStack_e0,&uStack_51,&UNK_10b20e440);
...
LAB_1013a650c:
    ...
    if ((byte)uStack_e0 == 0xd) {
      func_0x000100b40728(&uStack_140,lStack_118,uStack_110);
LAB_1013a64f8:
      FUN_100e077ec(&uStack_e0);
LAB_1013a6500:
      pcVar9 = uStack_140;
      ...
      if ((byte)uStack_e0 != 0xe) {
        if ((byte)uStack_e0 != 0xf) goto LAB_1013a6604;
        func_0x000100b40450(&uStack_140,lStack_118,uStack_110);
        goto LAB_1013a64f8;
      }
      func_0x000100b40450(&uStack_140,uStack_110,lStack_108);
LAB_1013a62a0:
      if (lVar10 == 0) goto LAB_1013a6500;
      _free(uVar7);
      pcVar9 = uStack_140;
      lVar10 = lStack_88;
      lStack_88 = lStack_68;
...
LAB_1013a6460:
        ...
        if ((uVar1 == 0x12) || ((uVar1 == 0x15 && (lStack_88 == 0)))) goto LAB_1013a6460;
        pcVar9 = (char *)FUN_108855b04(&cStack_a0,&uStack_51,&UNK_10b20a5c0);
        goto LAB_1013a6524;
      }
LAB_1013a6468:
    ...
    if (uStack_140._1_1_ == 3) {
      if (uVar1 == 0x16) goto LAB_1013a6468;
      if ((uVar1 == 0x12) || ((uVar1 == 0x15 && (lStack_88 == 0)))) goto LAB_1013a6460;
      pcVar9 = (char *)FUN_108855b04(&cStack_a0,&uStack_51,&UNK_10b20a5c0);
    }
    else {
