...
undefined8 FUN_10028a2ac(undefined8 param_1)

{
  ...
  *(undefined8 *)(unaff_x29 + -0x78) = in_stack_00000360;
  *(undefined8 *)(unaff_x29 + -0x80) = in_stack_00000358;
  *(undefined8 *)(unaff_x29 + -0x70) = in_stack_00000368;
  ...
  lVar13 = *(long *)(unaff_x20 + 0x108);
  uVar5 = (undefined1)(uVar12 >> 8);
  if ((ulong)(*(long *)(unaff_x20 + 0x110) - lVar13) < 3) {
    __ZN5bytes9bytes_mut8BytesMut13reserve_inner17h27c45947f3de9d03E();
    lVar13 = *(long *)(unaff_x20 + 0x108);
    uVar10 = *(long *)(unaff_x20 + 0x110) - lVar13;
    puVar1 = (ushort *)(*(long *)(unaff_x20 + 0x100) + lVar13);
    *puVar1 = uVar6;
    *(undefined1 *)(puVar1 + 1) = uVar5;
    if (uVar10 < 3) {
      ...
      lVar13 = lVar13 + 3;
      *(long *)(unaff_x20 + 0x108) = lVar13;
      if (*(long *)(unaff_x20 + 0x110) != lVar13) goto LAB_10028b048;
LAB_10028af78:
      __ZN5bytes9bytes_mut8BytesMut13reserve_inner17h27c45947f3de9d03E();
      lVar13 = *(long *)(unaff_x20 + 0x108);
      lVar11 = *(long *)(unaff_x20 + 0x110);
      *(undefined1 *)(*(long *)(unaff_x20 + 0x100) + lVar13) = 7;
      if (lVar11 != lVar13) {
        lVar13 = lVar13 + 1;
        *(long *)(unaff_x20 + 0x108) = lVar13;
        if (*(long *)(unaff_x20 + 0x110) != lVar13) goto LAB_10028b068;
LAB_10028afb4:
        __ZN5bytes9bytes_mut8BytesMut13reserve_inner17h27c45947f3de9d03E();
        lVar13 = *(long *)(unaff_x20 + 0x108);
        lVar11 = *(long *)(unaff_x20 + 0x110);
        *(undefined1 *)(*(long *)(unaff_x20 + 0x100) + lVar13) = 0;
        if (lVar11 != lVar13) {
          lVar13 = lVar13 + 1;
          *(long *)(unaff_x20 + 0x108) = lVar13;
          if (3 < (ulong)(*(long *)(unaff_x20 + 0x110) - lVar13)) goto LAB_10028b088;
LAB_10028aff0:
          __ZN5bytes9bytes_mut8BytesMut13reserve_inner17h27c45947f3de9d03E();
          lVar13 = *(long *)(unaff_x20 + 0x108);
          uVar10 = *(long *)(unaff_x20 + 0x110) - lVar13;
          *(undefined4 *)(*(long *)(unaff_x20 + 0x100) + lVar13) = 0;
    ...
    lVar11 = *unaff_x21;
    *(ushort *)(lVar11 + lVar13) = uVar6;
    *(undefined1 *)((ushort *)(lVar11 + lVar13) + 1) = uVar5;
    lVar13 = lVar13 + 3;
    *(long *)(unaff_x20 + 0x108) = lVar13;
    if (*(long *)(unaff_x20 + 0x110) == lVar13) goto LAB_10028af78;
LAB_10028b048:
    *(undefined1 *)(*unaff_x21 + lVar13) = 7;
    lVar13 = lVar13 + 1;
    *(long *)(unaff_x20 + 0x108) = lVar13;
    if (*(long *)(unaff_x20 + 0x110) == lVar13) goto LAB_10028afb4;
LAB_10028b068:
    *(undefined1 *)(*unaff_x21 + lVar13) = 0;
    lVar13 = lVar13 + 1;
    *(long *)(unaff_x20 + 0x108) = lVar13;
    if ((ulong)(*(long *)(unaff_x20 + 0x110) - lVar13) < 4) goto LAB_10028aff0;
LAB_10028b088:
    *(undefined4 *)(*unaff_x21 + lVar13) = 0;
LAB_10028b090:
    lVar13 = lVar13 + 4;
    *(long *)(unaff_x20 + 0x108) = lVar13;
    uVar4 = (uStack0000000000000070 & 0xff00ff00) >> 8 | (uStack0000000000000070 & 0xff00ff) << 8;
    uVar4 = uVar4 >> 0x10 | uVar4 << 0x10;
    if (3 < (ulong)(*(long *)(unaff_x20 + 0x110) - lVar13)) {
      *(uint *)(*unaff_x21 + lVar13) = uVar4;
LAB_10028b0e4:
      lVar11 = lVar13 + 4;
      *(long *)(unaff_x20 + 0x108) = lVar11;
      ...
      if ((ulong)(*(long *)(unaff_x20 + 0x110) - lVar11) < 4) {
        ...
        lVar13 = *(long *)(unaff_x20 + 0x108);
        uVar10 = *(long *)(unaff_x20 + 0x110) - lVar13;
        *(uint *)(*(long *)(unaff_x20 + 0x100) + lVar13) = uVar4;
        if (uVar10 < 4) goto LAB_10028c988;
        *(long *)(unaff_x20 + 0x108) = lVar13 + 4;
        uVar10 = in_stack_00000060;
      }
      else {
        *(uint *)(*unaff_x21 + lVar11) = uVar4;
        *(long *)(unaff_x20 + 0x108) = lVar13 + 8;
        uVar10 = in_stack_00000060;
      }
...
LAB_10028c128:
        if ((___ZN12tracing_core8metadata9MAX_LEVEL17h02c7742de62f64c3E == 0) &&
          ...
          lVar13 = ___ZN2h25codec12framed_write16Encoder_LT_B_GT_6buffer10__CALLSITE17he6570701b9666f35E
                   + 0x30;
          ...
          if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
            ...
            if (iVar9 != 0) {
              ...
              *(undefined8 *)(unaff_x29 + -0xf0) = uVar15;
              __ZN7tracing15__macro_support13__tracing_log17h72768b16bee39960E
                        (lVar13,puVar3,puVar2,unaff_x29 + -0x100,unaff_x29 + -0x80);
            }
          }
        }
        ...
        if (in_stack_00000010 != 2) {
          ...
          (**(code **)(in_stack_00000020 + 0x68))(lVar13,&stack0x00000028);
        }
        if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
           (in_stack_00000030 != 0)) {
        ...
        *(ulong *)(unaff_x29 + -0xf0) = uVar10;
        ...
        if (iVar9 == 0) {
          ...
          *(undefined8 *)(unaff_x29 + -0x70) = uVar16;
          ...
          lVar13 = *(long *)(unaff_x20 + 0x108);
          if ((ulong)-lVar13 < uVar10) {
            __ZN5bytes9bytes_mut8BytesMut13reserve_inner17h27c45947f3de9d03E();
            lVar13 = *(long *)(unaff_x20 + 0x108);
          }
          _memcpy(*(long *)(unaff_x20 + 0x100) + lVar13,uVar14,uVar10);
