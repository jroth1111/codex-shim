...
void FUN_10055c6c4(long param_1,long param_2)

{
  ...
  undefined1 *in_stack_00014e20;
  
code_r0x00010055c6c4:
  *(undefined8 *)(unaff_x22 + 0x70) = 1;
  *(undefined1 **)(unaff_x22 + 0x78) = &stack0x0000fec8;
  *(undefined8 *)(unaff_x22 + 0x80) = 1;
  *(long *)(unaff_x22 + 0x88) = param_1;
  __ZN12tracing_core5event5Event8dispatch17h50a390618bcffa4fE(param_2,&stack0x00014e20);
...
LAB_10055ce90:
  if (((ulong)in_stack_0000fe68 & 3) != 1) goto LAB_10055d004;
...
LAB_10055d004:
    do {
      while( true ) {
        while( true ) {
          ...
          do {
            ...
            if (puVar13 == *(undefined8 **)(unaff_x19 + 0x2988)) {
              ...
              if (*(long *)(unaff_x19 + 0x2980) == 0) goto LAB_10055c250;
              goto LAB_10055c248;
            }
            uVar14 = *puVar13;
          ...
          *(undefined1 *)(unaff_x20 + 0x378) = 0;
          FUN_100fc00fc(&stack0x00009900,unaff_x19 + 0x29a8,in_stack_00000180);
          ...
          cVar5 = FUN_100c355d4(in_stack_0000fe68);
          if (cVar5 != '\0') {
            ...
            if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
              ...
              if (iVar6 != 0) {
                in_stack_00014e20 = &stack0x0000fec8;
        ...
        *(undefined8 *)(unaff_x27 + 0x2568) = uVar11;
        ...
        if ((___ZN12tracing_core8metadata9MAX_LEVEL17h02c7742de62f64c3E < 2) &&
          ...
          if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
             (3 < ___ZN3log20MAX_LOG_LEVEL_FILTER17h2019f7c33388e688E)) {
            in_stack_00014e20 = (undefined1 *)0x4;
            puVar1 = puRam000000010b634c20;
            if (lRam000000010b66fd20 != 2) {
              puVar1 = &UNK_10b3c24c8;
            }
          ...
          if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
            ...
            if (iVar6 != 0) {
              in_stack_00014e20 = (undefined1 *)0x1;
        ...
        if (lVar16 != 0) goto LAB_10055cffc;
      }
      __ZN25codex_utils_absolute_path20AbsolutePathBufGuard3new17h7de3fa69cf09380cE();
      FUN_100734e68(&stack0x000073a0,*(undefined8 *)(unaff_x19 + 0x2998),
      ...
      if (in_stack_000073a0 != -0x8000000000000000) {
        if (cVar5 != '\x01') {
          if (cVar5 == '\x02') goto LAB_10055c890;
...
LAB_10055d024:
          ...
          pcVar3 = (code *)SoftwareBreakpoint(1,0x10055d028);
          (*pcVar3)();
        }
        *plVar9 = -1;
...
LAB_10055c250:
        ...
        *(undefined1 *)(unaff_x20 + 0x24d) = 0;
        ...
        if ((*(byte *)(unaff_x20 + 0x24e) & 1) == 0) goto LAB_10055ca50;
...
LAB_10055c890:
      ...
      if (*plVar9 != 0) goto LAB_10055d018;
      *plVar9 = -1;
      lVar8 = 0;
      if ((plVar9[1] & 0x7fffffffffffffffU) != 0) {
        _free(plVar9[2]);
