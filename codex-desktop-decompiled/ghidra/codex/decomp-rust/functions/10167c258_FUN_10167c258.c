...

{
  ...
  FUN_100f3f484(&stack0x00000140,s__Failed_to_update_skill_config_f_108adac05,&stack0x00003e30);
  __ZN9codex_tui10chatwidget10ChatWidget17add_error_message17hc02ae70319960b9eE();
  (**(code **)*in_stack_00006870)();
  if (((*(byte *)(unaff_x27 + 0xad9) & 1) != 0) && (*(long *)(unaff_x27 + 0xa88) != 0)) {
    _free(*(undefined8 *)(unaff_x27 + 0xa90));
  }
  *(undefined1 *)(unaff_x27 + 0xad9) = 0;
