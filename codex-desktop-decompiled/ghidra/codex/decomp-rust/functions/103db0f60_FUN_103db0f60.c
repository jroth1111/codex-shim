...
void FUN_103db0f60(int *param_1)

{
  ...
  if (*param_1 == 0) {
    cVar4 = *(char *)((long)param_1 + 0x311);
    if (cVar4 == '\0') {
      func_0x000103da0bb4(param_1 + 2);
      lVar14 = *(long *)(param_1 + 0x5e);
      LOAcquire();
      ...
      *(long *)(lVar14 + 0x1f0) = lVar8 + -1;
      ...
      lVar8 = **(long **)(param_1 + 0x5e);
      **(long **)(param_1 + 0x5e) = lVar8 + -1;
      LORelease();
      if (lVar8 == 1) {
        DataMemoryBarrier(2,1);
        __ZN5alloc4sync16Arc_LT_T_C_A_GT_9drop_slow17haf4d1ee58cf8c660E(param_1 + 0x5e);
      }
      ...
      **(long **)(param_1 + 0x60) = lVar8 + -1;
      ...
      if (cVar4 == '\x03') {
        uStack_50 = *(undefined8 *)(param_1 + 0xcc);
        piStack_48 = param_1 + 0xda;
        FUN_1060fb5d4(&uStack_50);
        if (*(long *)(param_1 + 0xd4) != 0) {
          (**(code **)(*(long *)(param_1 + 0xd4) + 0x18))(*(undefined8 *)(param_1 + 0xd6));
        }
      }
      else {
        if (cVar4 != '\x04') {
        ...
        FUN_103d9d8cc(param_1 + 200);
        *(undefined1 *)((long)param_1 + 0x313) = 0;
      }
      func_0x000103da0bb4(param_1 + 0x68);
      __ZN97__LT_tokio_util__sync__cancellation_token__CancellationToken_u20_as_u20_core__ops__drop__Drop_GT_4drop17h41b2bd289c4eedfeE
                (param_1 + 100);
      lVar8 = **(long **)(param_1 + 100);
      **(long **)(param_1 + 100) = lVar8 + -1;
      LORelease();
      if (lVar8 == 1) {
        DataMemoryBarrier(2,1);
        __ZN5alloc4sync16Arc_LT_T_C_A_GT_9drop_slow17ha29a3ea10b50cafaE(param_1 + 100);
      }
      lVar14 = *(long *)(param_1 + 0x62);
      LOAcquire();
      lVar8 = *(long *)(lVar14 + 0x1f0);
      *(long *)(lVar14 + 0x1f0) = lVar8 + -1;
      LORelease();
