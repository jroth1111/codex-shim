...
/* WARNING: Removing unreachable block (ram,0x000100f47258) */

undefined1  [16] FUN_100f4728c(void)

{
  ...
  func_0x00010602ab90(s_Removed_marketplace______108ad43ee,&stack0x00002a70);
  if ((in_stack_00000540 != -0x8000000000000000) &&
     (func_0x00010602ab90(s__Removed_installed_marketplace_r_108ad440a,&stack0x00002a70),
     in_stack_00000540 != 0)) {
