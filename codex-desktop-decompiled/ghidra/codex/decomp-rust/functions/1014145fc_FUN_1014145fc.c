...
void FUN_1014145fc(undefined8 *param_1,char *param_2)
        ...
        if (bVar27 < 0xd) {
          ...
          if (bVar27 == 0xc) {
            ...
            if (lVar30 == 0) {
              ...
              if (lVar13 == 0) goto LAB_101415830;
            }
...
LAB_101414858:
          FUN_108855bf0(&puStack_d0,pbVar15,auStack_71,&UNK_10b2152a8);
...
LAB_1014147c8:
            ...
            if (bVar27 != 0xf) goto LAB_101414858;
            uVar17 = *(undefined8 *)(lVar25 + lVar37 + 8);
            uVar18 = *(undefined8 *)(lVar25 + lVar37 + 0x10);
            bStack_c8 = 0xf;
          }
...
LAB_1014148ec:
    do {
      pcVar14 = pcVar31;
      if (pcVar14 == pcVar2) goto LAB_101415474;
...
LAB_101415614:
        ...
        if (lVar13 != -0x8000000000000000) {
          ...
          if (bVar27 - 0xc < 2) {
            pbVar28 = (byte *)0x0;
joined_r0x0001014149f0:
            if (bVar27 < 0xd) {
              if (bVar27 != 1) {
                if (bVar27 == 4) {
                  lVar16 = *(long *)(pbVar15 + 8);
                  if (lVar16 == 0) goto LAB_101414b88;
                  if (lVar16 == 1) goto LAB_101414c10;
                  ...
                  if (bVar27 == 0xc) {
                    ...
                    if (lVar16 != 5) goto LAB_101414bf4;
                    goto LAB_101414978;
                  }
LAB_101415454:
                  FUN_108855bf0(&puStack_140,pbVar15,auStack_71,&UNK_10b214a68);
                }
                goto LAB_1014149b4;
              }
              bVar27 = pbVar15[1];
...
LAB_101415418:
              ...
              if (bVar27 == 0xd) {
                ...
                if (lVar16 == 5) {
LAB_101414978:
                  if (*piVar19 == 0x6f6c6c61 && (char)piVar19[1] == 'w') goto LAB_101414b88;
                  lVar16 = 5;
                }
                else {
LAB_101414bf4:
                  if (lVar16 == 4) {
                    if (*piVar19 == 0x796e6564) goto LAB_101414c10;
                    lVar16 = 4;
                  }
                }
                FUN_1087e44e4(&puStack_140,piVar19,lVar16,&UNK_10b2204a0,2);
                goto LAB_1014149b4;
              }
              if (bVar27 == 0xe) {
                pcVar14 = *(char **)(pbVar15 + 0x10);
                lVar16 = *(long *)(pbVar15 + 0x18);
                if (lVar16 != 5) goto LAB_101414a24;
LAB_101414ab4:
                if ((((*pcVar14 == 'a') && (pcVar14[1] == 'l')) && (pcVar14[2] == 'l')) &&
                   ((pcVar14[3] == 'o' && (pcVar14[4] == 'w')))) goto LAB_101414b88;
              }
              else {
                if (bVar27 != 0xf) goto LAB_101415454;
                pcVar14 = *(char **)(pbVar15 + 8);
                lVar16 = *(long *)(pbVar15 + 0x10);
                if (lVar16 == 5) goto LAB_101414ab4;
LAB_101414a24:
                if ((((lVar16 == 4) && ((*pcVar14 == 'd' && (pcVar14[1] == 'e')))) &&
                    (pcVar14[2] == 'n')) && (pcVar14[3] == 'y')) goto LAB_101414c10;
              }
              __ZN5alloc6string6String15from_utf8_lossy17hfb27054e23a2c9beE(&uStack_e8);
              uVar17 = uStack_e0;
              uVar29 = uStack_e8;
              FUN_1087e44e4(&puStack_d0,uStack_e0,uStack_d8,&UNK_10b2204a0,2);
              bStack_118 = bStack_a8;
              uStack_117 = uStack_a7;
              bStack_120 = bStack_b0;
              uStack_11f = uStack_af;
...
LAB_1014149b4:
              ...
              if ((uStack_138 & 1) == 0) goto LAB_101414b88;
LAB_101414c10:
              if (((pbVar28 != (byte *)0x0) && (*pbVar28 != 0x12)) &&
                 (FUN_108855bf0(&puStack_d0,pbVar28,auStack_71,&UNK_10b20a5c0),
                 puStack_d0 != (undefined8 *)0x2)) goto LAB_101415418;
              bVar27 = 1;
              uStack_298 = uStack_1f0;
            }
          }
...
LAB_101415560:
              ...
              bStack_b0 = bVar27;
              lStack_240 = lVar25;
              if (puStack_268 != (undefined8 *)0x0) goto LAB_101415500;
              goto LAB_1014155a4;
            }
          ...
          if (puStack_268 != (undefined8 *)0x0) {
            do {
              ...
              do {
                lVar32 = lVar16;
                uVar3 = uVar36;
                if (lVar38 == 0) goto joined_r0x000101414cc4;
                uVar33 = puVar26[2];
                uVar3 = uVar21;
                if (uVar33 <= uVar21) {
                  uVar3 = uVar33;
              ...
              uVar3 = lVar32 - 0x113;
joined_r0x000101414cc4:
              if (uVar29 == 0) goto LAB_101414d04;
  ...
  FUN_108855bf0(&puStack_140,param_2,auStack_71,&UNK_10b213248);
joined_r0x000101415674:
  if (puStack_140 != (undefined8 *)0x2) {
...
LAB_101415878:
      ...
      pcVar11 = (code *)SoftwareBreakpoint(1,0x10141587c);
      (*pcVar11)();
    }
    *puStack_260 = 0;
...
LAB_101415474:
  ...
  if ((uVar21 == 0) ||
     ...
     puStack_d0 == (undefined8 *)0x2)) goto LAB_1014154a0;
  bStack_118 = bStack_a8;
  uStack_117 = uStack_a7;
  bStack_120 = bStack_b0;
  uStack_11f = uStack_af;
