...
/* WARNING: Removing unreachable block (ram,0x00010124fafc) */

void FUN_10124f5b4(undefined1 *param_1,char *param_2)
...
LAB_10124f9b4:
        ...
        if (uStack_e0._1_1_ != 4) goto LAB_10124fb1c;
LAB_10124f854:
        uVar8 = 4;
      }
      uVar11 = 0;
...
LAB_10124f9c0:
    ...
    if ((byte)uStack_e0 == 4) {
      if (lStack_118 < 2) {
        if (lStack_118 == 0) goto LAB_10124f9a0;
        if (lStack_118 == 1) goto LAB_10124f994;
      }
      else {
        if (lStack_118 == 2) goto LAB_10124f9a8;
        if (lStack_118 == 3) goto LAB_10124f9b4;
        if (lStack_118 == 4) goto LAB_10124f854;
      }
...
LAB_10124fb40:
    ...
    if ((byte)uStack_e0 == 0xc) {
      FUN_100b26cd8(&uStack_140,uStack_110,lStack_108);
      goto LAB_10124f76c;
    }
LAB_10124fad0:
    pcStack_138 = (char *)FUN_108855b04(&uStack_e0,&uStack_51,&UNK_10b20d020);
...
LAB_10124f9d8:
    ...
    if ((byte)uStack_e0 == 0xd) {
      FUN_100b26cd8(&uStack_140,lStack_118,uStack_110);
LAB_10124f9c4:
      FUN_100e077ec(&uStack_e0);
LAB_10124f9cc:
      pcVar9 = uStack_140;
      ...
      if ((byte)uStack_e0 != 0xe) {
        if ((byte)uStack_e0 != 0xf) goto LAB_10124fad0;
        FUN_100b26a84(&uStack_140,lStack_118,uStack_110);
        goto LAB_10124f9c4;
      }
      FUN_100b26a84(&uStack_140,uStack_110,lStack_108);
LAB_10124f76c:
      if (lVar10 == 0) goto LAB_10124f9cc;
      _free(uVar7);
      pcVar9 = uStack_140;
      lVar10 = lStack_88;
      lStack_88 = lStack_68;
...
LAB_10124f92c:
        ...
        if ((uVar1 == 0x12) || ((uVar1 == 0x15 && (lStack_88 == 0)))) goto LAB_10124f92c;
        pcVar9 = (char *)FUN_108855b04(&cStack_a0,&uStack_51,&UNK_10b20a5c0);
        goto LAB_10124f9f0;
      }
LAB_10124f934:
    ...
    if (uStack_140._1_1_ == 3) {
      if (uVar1 == 0x16) goto LAB_10124f934;
      if ((uVar1 == 0x12) || ((uVar1 == 0x15 && (lStack_88 == 0)))) goto LAB_10124f92c;
      pcVar9 = (char *)FUN_108855b04(&cStack_a0,&uStack_51,&UNK_10b20a5c0);
    }
    else {
