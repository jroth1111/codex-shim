...
ulong __ZN9hashbrown3raw21RawTable_LT_T_C_A_GT_14reserve_rehash17h9434f095adb7dd6bE
...

{
  ...
  if (CARRY8(uVar15,param_2)) {
    ...
    if (uStack_90 >> 1 < uVar16) {
      ...
      FUN_103878e48(&plStack_80,0x20,uVar16);
      if (plStack_80 != (long *)0x0) {
        ...
        if (uVar15 != 0) {
          ...
          do {
            ...
            uVar9 = FUN_1033f7ffc(uVar4,uVar5,plVar11[uVar10 * -4 + -4]);
...
LAB_108947c30:
  ...
  do {
    ...
    if (*(char *)((long)unaff_x21 + uVar15) == -0x80) {
      ...
      while( true ) {
        uVar10 = FUN_1033f7ffc(uVar4,uVar5,unaff_x21[uVar15 * -4 + -4]);
...
LAB_108947d4c:
    param_1 = plStack_a8;
    if (unaff_x20 <= uVar13) goto LAB_108947dec;
    uVar16 = uVar13 + 1;
    uVar15 = uVar13;
  } while( true );
}
