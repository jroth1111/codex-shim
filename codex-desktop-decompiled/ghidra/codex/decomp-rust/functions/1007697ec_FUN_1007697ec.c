...
void FUN_1007697ec(undefined *param_1)

{
  ...
  *(undefined **)(unaff_x29 + -0x78) = &UNK_10b208fd0;
  ...
  if ((*unaff_x25 < 4) &&
    ...
    puVar27 = &UNK_108cad187;
    FUN_10076c91c(&stack0x00000750);
    puVar19 = (undefined8 *)0x9f;
  }
  else {
    lVar13 = 
    ___ZN13codex_rollout4list36find_thread_path_by_id_str_in_subdir28__u7b__u7b_closure_u7d__u7d_10__CALLSITE17h500da6322e3f85f0E
    ...
    if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
      ...
      iVar11 = (**(code **)(puVar30 + 0x18))(puVar3,&stack0x00000280);
      if (iVar11 != 0) {
        in_stack_00000930 = (int)&stack0x00000310;
        in_stack_00000938 = &UNK_10b208fd0;
        puVar27 = (undefined *)0x2;
        __ZN7tracing15__macro_support13__tracing_log17h72768b16bee39960E
                  (lVar13,puVar3,puVar30,&stack0x00000570,&stack0x00000750);
        puVar19 = puVar23;
        puVar28 = puVar4;
      }
    }
  ...
  if ((lRam000000010b6302b0 == 0) &&
     (lVar13 = lRam000000010b6302a0 +
               (*(long *)(lRam000000010b6302a8 + 0x10) - 1U & 0xfffffffffffffff0) + 0x10,
     lVar13 != 0)) {
    (**(code **)(lRam000000010b6302a8 + 0x18))(lVar13,&UNK_108ed3a1f,0x1b,1,&stack0x00000750,2);
  }
...
LAB_100769d28:
    *(undefined1 *)((long)unaff_x19 + 0xeb) = 0;
    uVar22 = *unaff_x19;
    uVar12 = unaff_x19[1];
    if (uVar12 != 0) goto LAB_100769d38;
LAB_10076a120:
    lVar13 = 1;
  }
  else {
...
LAB_10076a10c:
    ...
    *(undefined1 *)((long)unaff_x19 + 0xeb) = 0;
    uVar22 = *unaff_x19;
    uVar12 = unaff_x19[1];
    if (uVar12 == 0) goto LAB_10076a120;
LAB_100769d38:
    lVar13 = _malloc(uVar12);
    if (lVar13 == 0) {
      FUN_107c03c64(1,uVar12);
      goto LAB_10076b9c8;
    }
  }
  _memcpy(lVar13,uVar22,uVar12);
  bVar9 = false;
  unaff_x19[0x1f] = uVar12;
  unaff_x19[0x20] = lVar13;
  unaff_x19[0x21] = uVar12;
  *(undefined1 *)((long)unaff_x19 + 0xec) = 1;
  pcVar26 = (char *)unaff_x19[2];
  uVar20 = unaff_x19[3];
  if ((uVar12 != 0) && (pcVar17 = (char *)(lVar13 + uVar12 + -1), pcVar17 != (char *)0x0)) {
    bVar9 = *pcVar17 != '/';
  }
  if ((uVar20 == 0) || (*pcVar26 != '/')) {
    if (bVar9) {
      thunk_FUN_108a85fec(unaff_x19 + 0x1f,uVar12,1,1,1);
      lVar13 = unaff_x19[0x20];
      lVar5 = unaff_x19[0x21];
      *(undefined1 *)(lVar13 + lVar5) = 0x2f;
      uVar21 = lVar5 + 1;
...
joined_r0x00010076a1c8:
    ...
    if (uVar7 < uVar20) {
LAB_10076ad50:
      thunk_FUN_108a85fec(unaff_x19 + 0x1f,uVar12,uVar20,1,1);
      lVar13 = unaff_x19[0x20];
      uVar12 = unaff_x19[0x21];
    }
  }
  _memcpy(lVar13 + uVar12,pcVar26,uVar20);
  uVar12 = uVar12 + uVar20;
  unaff_x19[0x21] = uVar12;
  if (uVar12 < 0x180) {
    _memcpy(&stack0x00000750,unaff_x19[0x20],uVar12);
    (&stack0x00000750)[uVar12] = 0;
    __ZN4core3ffi5c_str4CStr19from_bytes_with_nul17h3eb41042a4761af1E
              (&stack0x00000930,&stack0x00000750,uVar12 + 1);
    if (in_stack_00000930 == 1) {
      puVar19 = (undefined8 *)&UNK_10b4add80;
    }
    else {
      iVar11 = _stat(in_stack_00000938,&stack0x00000310);
      if (iVar11 != -1) {
      ...
      puVar15 = (uint *)___error();
      puVar19 = (undefined8 *)((ulong)*puVar15 << 0x20 | 2);
    }
LAB_10076a248:
    if (((ulong)puVar19 & 3) == 1) {
      uVar22 = *(undefined8 *)((long)puVar19 + -1);
      puVar23 = *(undefined8 **)((long)puVar19 + 7);
      pcVar8 = (code *)*puVar23;
      if (pcVar8 != (code *)0x0) {
        (*pcVar8)(uVar22);
      }
...
joined_r0x00010076a424:
    ...
    *(undefined1 *)((long)unaff_x19 + 0xed) = 0;
    ...
    thunk_FUN_108a820a8(&stack0x00000570,unaff_x19[0x20],uVar12,&DAT_10603cc64);
    if (puVar27 != (undefined *)0x0) goto LAB_10076a248;
LAB_10076a2dc:
...
LAB_10076a5d0:
      ...
      puVar14 = puVar19 + 10;
      param_1 = (undefined *)puVar19[1];
      puVar28 = (undefined *)*puVar19;
      lVar13 = puVar19[3];
      puVar30 = (undefined *)puVar19[2];
      uVar22 = puVar19[4];
      uVar18 = puVar19[7];
      uVar12 = puVar19[6];
      if (puVar28 == (undefined *)0x8000000000000000) goto LAB_10076a5d0;
      __ZN3std4path4Path5_join17ha8f408dfc5576c3eE
                (&stack0x00000310,uVar22,puVar19[5],param_1,puVar30);
    ...
    *(undefined1 *)((long)unaff_x19 + 0xee) = 1;
    if ((long)puVar29 - (long)puVar14 != 0) {
      uVar12 = (ulong)((long)puVar29 - (long)puVar14) / 0x50;
      puVar14 = puVar14 + 4;
      do {
        if (puVar14[-4] != 0) {
          _free(puVar14[-3]);
        ...
        if ((puVar14[2] & 0x7fffffffffffffff) != 0) {
          _free(puVar14[3]);
        }
        puVar14 = puVar14 + 10;
        uVar12 = uVar12 - 1;
    ...
    if (unaff_x19[0x22] != -0x8000000000000000) {
      if (((___ZN12tracing_core8metadata9MAX_LEVEL17h02c7742de62f64c3E < 2) &&
        ...
        if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
          ...
          iVar11 = (**(code **)(puVar27 + 0x18))(puVar4,&stack0x000002e0);
          if (iVar11 != 0) {
            ...
            *(undefined **)(unaff_x29 + -0x78) = &UNK_10b208fd0;
            ...
            puVar30 = (undefined *)0x1;
            __ZN7tracing15__macro_support13__tracing_log17h72768b16bee39960E
                      (uVar22,puVar4,puVar27,&stack0x00000570,&stack0x00000750);
      ...
      if (((___ZN12tracing_core8metadata9MAX_LEVEL17h02c7742de62f64c3E < 4) &&
        ...
        if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
          ...
          iVar11 = (**(code **)(puVar27 + 0x18))(puVar4,&stack0x000002f8);
          if (iVar11 != 0) {
            pcVar26 = 
      ...
      if (unaff_x19[6] != 0) {
        ...
        if ((lRam000000010b6302b0 == 0) &&
          ...
          (**(code **)(lRam000000010b6302a8 + 0x18))
                    (lVar13,&UNK_108ed3a1f,0x1b,1,&stack0x00000750,2);
        }
      }
      lVar13 = unaff_x19[0x11];
      unaff_x19[0x2b] = unaff_x19[0x23];
      unaff_x19[0x2c] = unaff_x19[0x24];
      unaff_x19[0x2d] = lVar13;
            ...
            if (((___ZN12tracing_core8metadata9MAX_LEVEL17h02c7742de62f64c3E < 4) &&
              ...
              *(undefined **)(unaff_x29 + -0x78) = &UNK_10b208fd0;
              ...
              if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
                ...
                iVar11 = (**(code **)(puVar27 + 0x18))(puVar30,&stack0x00000548);
                if (iVar11 != 0) {
                  ...
                  *(undefined8 *)(unaff_x29 + -0x78) = 0x9f;
                  ...
                  puVar28 = (undefined *)0x1;
                  __ZN7tracing15__macro_support13__tracing_log17h72768b16bee39960E
                            (uVar22,puVar30,puVar27,&stack0x00000570,&stack0x00000750);
                }
              }
            }
          }
...
LAB_10076b834:
              ...
              lVar13 = in_stack_00000678 + 0x7ffffffffffffffa;
              ...
              else if ((lVar13 == 4) && (in_stack_00000680 != 0)) {
            ...
            *(undefined1 *)((long)unaff_x19 + 0x9b4) = *(undefined1 *)(unaff_x19 + 0x6a);
            uVar12 = FUN_100776744(unaff_x19 + 0x70,unaff_x21);
            if ((uVar12 & 1) == 0) {
          ...
          *(undefined1 *)(unaff_x19 + 0x7c) = 0;
          ...
          if (pcVar26 != (char *)0x8000000000000002) {
            ...
            lVar13 = unaff_x19[0x2f];
            if (-0x7fffffffffffffff < lVar13) {
                ...
                if (((___ZN12tracing_core8metadata9MAX_LEVEL17h02c7742de62f64c3E < 4) &&
                  ...
                  *(undefined **)(unaff_x29 + -0x78) = &UNK_10b208fd0;
                  ...
                  if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
                    ...
                    iVar11 = (**(code **)(puVar27 + 0x18))(puVar30,&stack0x000004f0);
                    if (iVar11 != 0) {
                  ...
                  if ((___ZN12tracing_core8metadata9MAX_LEVEL17h02c7742de62f64c3E < 4) &&
                    ...
                    *(undefined8 *)(unaff_x29 + -0x78) = uVar22;
                    ...
                    if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
                      ...
                      iVar11 = (**(code **)(puVar27 + 0x18))(puVar30,&stack0x00000510);
                      if (iVar11 != 0) {
                        puVar29 = (undefined8 *)
                                  (
                                  ___ZN13codex_rollout8state_db24read_repair_rollout_path28__u7b__u7b_closure_u7d__u7d_10__CALLSITE17ha51ab27f47b0ab0bE
                        ...
                        *(undefined8 *)(unaff_x29 + -0x70) = uVar18;
                        __ZN7tracing15__macro_support13__tracing_log17h72768b16bee39960E
                                  (lVar13,puVar30,puVar27,unaff_x29 + -0x80,&stack0x00000570);
                      }
                    }
                  }
                  (**(code **)*auVar25._8_8_)();
...
LAB_10076b8b0:
        *(undefined1 *)((long)unaff_x19 + 0x352) = uVar16;
...
LAB_10076b8e0:
  ...
  *unaff_x27 = uVar21;
  ...
  unaff_x27[2] = uVar12;
LAB_10076b940:
  *(undefined1 *)((long)unaff_x19 + 0xf1) = uVar16;
  return;
}
