...

{
  ...
  uVar10 = FUN_108856088(s_duplicate_field_____108ac2973,&stack0x00000130);
  ...
  *(undefined8 *)(unaff_x19 + 0x220) = 0x8000000000000004;
...
LAB_100987710:
  ...
  if (lVar1 == -0x7fffffffffffffe0) {
    ...
    if (((___ZN12tracing_core8metadata9MAX_LEVEL17h02c7742de62f64c3E < 5) &&
        ((bRam000000010b628080 - 1 < 2 ||
         ((bRam000000010b628080 != 0 &&
          (cVar7 = __ZN12tracing_core8callsite15DefaultCallsite8register17hd8a0d35d4a8f8e8bE
                             (&
