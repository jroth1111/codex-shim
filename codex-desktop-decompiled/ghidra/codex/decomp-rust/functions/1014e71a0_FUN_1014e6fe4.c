...
undefined8 FUN_1014e6fe4(ulong param_1)

{
  ...
  *(undefined1 *)(unaff_x19 + 0x34) = 0;
  if (puVar8 == (undefined8 *)0x0) {
    ...
    lVar12 = *(long *)unaff_x19[0x33];
    *(long *)unaff_x19[0x33] = lVar12 + -1;
    LORelease();
    if (lVar12 == 1) {
      DataMemoryBarrier(2,1);
  ...
  if (unaff_x19[0x27] == 0x8000000000000000) {
    ...
    if ((___ZN12tracing_core8metadata9MAX_LEVEL17h02c7742de62f64c3E < 5) &&
      ...
      *(undefined **)(unaff_x29 + -0x78) = &UNK_10b208fd0;
      ...
      puStack00000000000000d0 = (undefined8 *)0x1;
      puStack00000000000000e0 = (undefined *)0x1;
      __ZN12tracing_core5event5Event8dispatch17h50a390618bcffa4fE(lVar12,&stack0x000000d0);
      lVar12 = 
      ___ZN173__LT_rama_http_backend__server__layer__upgrade__service__UpgradeService_LT_S_C_O_GT__u20_as_u20_rama_core__service__svc__Service_LT_rama_http_types__request__Request_GT__GT_5serve28__u7b__u7b_closure_u7d__u7d_28__u7b__u7b_closure_u7d__u7d_10__CALLSITE17hb58e39848623b831E
      ;
      if ((*unaff_x27 == '\0') && (___ZN3log20MAX_LOG_LEVEL_FILTER17h2019f7c33388e688E != 0)) {
        ...
        if (iVar6 != 0) {
          __ZN7tracing15__macro_support13__tracing_log17h72768b16bee39960E
                    (lVar12,puVar3,puVar13,&stack0x000000a0,&stack0x000000d0);
        }
      }
    }
    else {
      ...
      if ((*unaff_x27 == '\0') && (___ZN3log20MAX_LOG_LEVEL_FILTER17h2019f7c33388e688E != 0)) {
        ...
        if (iVar6 != 0) {
          ...
          in_stack_000000a0 = 1;
          in_stack_000000b0 = 1;
          in_stack_000000f0 = *(undefined8 **)(lVar12 + 0x60);
          in_stack_000000f8 = *(ulong *)(lVar12 + 0x68);
          puStack00000000000000d8 = *(undefined8 **)(lVar12 + 0x50);
          puStack00000000000000e0 = *(undefined **)(lVar12 + 0x58);
          puStack00000000000000d0 = (undefined8 *)0x1;
          if (puStack00000000000000d8 == (undefined8 *)0x0) {
            puStack00000000000000d0 = (undefined8 *)0x2;
          }
          uStack0000000000000118 = *(undefined4 *)(lVar12 + 8);
          uStack000000000000011c = *(undefined4 *)(lVar12 + 0xc);
...
LAB_1014e78e0:
    ...
    _memcpy(unaff_x19[0x32] + uVar15 * 0x20,lVar7,lVar12);
  ...
  lVar12 = *(long *)unaff_x19[0x25];
  *(long *)unaff_x19[0x25] = lVar12 + -1;
  LORelease();
  if (lVar12 == 1) {
    DataMemoryBarrier(2,1);
