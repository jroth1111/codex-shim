...
void FUN_101324078(long *param_1)

{
  ...
  lStack_a8 = lStack_58;
  lStack_b0 = lStack_60;
  func_0x0001004dc350(&lStack_78,&lStack_c0);
  if (lStack_78 != 2) {
    FUN_100de3b58(&lStack_78);
    func_0x0001004db4ac(&lStack_78,&lStack_c0);
    if (lStack_78 != 2) {
      FUN_100de3b58(&lStack_78);
      ...
      if (puVar2 == (undefined8 *)0x0) {
        ...
        pcVar1 = (code *)SoftwareBreakpoint(1,0x1013241ac);
        (*pcVar1)();
      }
