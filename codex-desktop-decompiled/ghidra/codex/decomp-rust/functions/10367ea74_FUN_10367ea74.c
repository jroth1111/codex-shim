...
/* WARNING: Possible PIC construction at 0x00010367f910: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x00010367f914) */
/* WARNING: Type propagation algorithm not settling */

void FUN_10367ea74(long *param_1,ulong *param_2)
      ...
      if (uStack_380 == 0) {
        ...
        if (uVar24 == 0x8000000000000006) {
          ...
          do {
            ...
            if ((long)uVar17 < 3) {
              if (uVar17 == 0) {
                func_0x00010892fa6c(&pppppppuStack_2c0,&plStack_308);
              }
              else {
              ...
              if (uVar17 == 3) {
                ...
                func_0x000108921f70(&pppppppuStack_2c0,&pppppppuStack_220,&uStack_180,&UNK_10b29cbd0
                                   );
              }
              else {
                ...
                func_0x00010892fa6c(&pppppppuStack_2c0,&uStack_170);
              }
            }
            else if (uVar17 == 5) {
...
joined_r0x00010367f194:
                ...
                lVar21 = *plVar25;
                plVar30 = plVar28;
                if (lVar21 == -0x7ffffffffffffffa) goto LAB_10367f154;
...
LAB_10367f3b8:
                    uStack_107 = uVar8;
                    uStack_108 = uVar16;
                    func_0x0001089223ec(&pppppppuStack_118,1,&UNK_10b2bde78,&UNK_10b29b520);
                    goto LAB_10367f170;
                  }
                  ...
                  plVar28 = plVar30;
                  plStack_258 = plVar30;
                  if (lVar21 == -0x7ffffffffffffffa) goto LAB_10367f3b8;
                  uStack_170 = (int)lVar21;
                  uStack_16c = (int)((ulong)lVar21 >> 0x20);
                  ...
                  if (uVar24 == 0x8000000000000000) goto LAB_10367f3b8;
                  uVar18 = CONCAT71(uStack_107,uStack_108);
...
LAB_10367f1e8:
                ...
                bVar19 = bStack_110;
                if (pppppppuStack_118 == (undefined8 *******)0x2) goto LAB_10367f20c;
LAB_10367f264:
...
joined_r0x00010367f6e4:
                ...
                plVar25 = plStack_1b0;
                plVar30 = plStack_1a0;
                if (pppppppuVar15 != (undefined8 *******)0x2) goto LAB_10367f4c8;
              }
              else {
                lVar21 = *plVar30;
                uVar24 = 2;
...
LAB_10367f6b4:
                      ...
                      uStack_140 = uStack_c7;
                      uVar6 = uVar17;
                      goto joined_r0x00010367f6e4;
                    }
                    func_0x0001034a6e50(&pppppppuStack_118,&pppppppuStack_220);
                    uVar24 = (ulong)bStack_110;
                    uVar18 = uStack_390;
                    uVar20 = uStack_388;
                    if (pppppppuStack_118 != (undefined8 *******)0x2) goto LAB_10367f264;
                  }
                  else if (iVar11 == 1) {
                  ...
                  plVar25 = plStack_1a0;
                  plVar30 = plStack_1a0;
                  if (plStack_1b0 == plStack_1a0) goto joined_r0x00010367f148;
                  lVar21 = *plStack_1b0;
                  plVar30 = plStack_1b0;
                }
                plVar25 = plVar30 + 0xe;
                plVar30 = plStack_1a0;
joined_r0x00010367f148:
                plStack_1a0 = plVar30;
                if (iVar11 == 2) goto LAB_10367f1e8;
LAB_10367f20c:
                uVar18 = uStack_390;
                if (uVar17 == 0x8000000000000000) {
...
LAB_10367fa20:
      ...
      pcVar9 = (code *)SoftwareBreakpoint(1,0x10367fa24);
      (*pcVar9)();
    }
    uVar20 = param_2[6];
    uVar17 = param_2[1];
    ...
    uStack_1a8 = uVar23;
    func_0x000108921f70(&pppppppuStack_118,&pppppppuStack_2c0,&uStack_180,&UNK_10b29b230);
...
SUB_108931100:
      ...
      *(undefined8 *******)(puVar10 + -0x40) = ppppppuVar3;
      puVar10[-0x50] = 5;
      func_0x000108921f70(param_1,puVar10 + -0x50,puVar10 + -0x31,&UNK_10b29b230);
      if (*pppppppuVar15 != (undefined8 ******)0x0) {
        _free(ppppppuVar2);
      }
      return;
...
LAB_10367ec60:
  func_0x000108921f70(param_1,&pppppppuStack_220,&uStack_180,&UNK_10b29b230);
  return;
}
