...
void FUN_100caaf08(ulong *param_1)

{
  ...
  if (3 < bVar1) {
    if (bVar1 == 4) {
      ...
      FUN_100d4e420(param_1 + 0x70);
    }
LAB_100caaf80:
    if (((*(byte *)((long)param_1 + 0x379) & 1) != 0) && (param_1[0x3a] != 0x8000000000000002)) {
      FUN_100df5b9c(param_1 + 0x3a);
    }
    *(undefined1 *)((long)param_1 + 0x379) = 0;
    return;
  }
  if (bVar1 != 0) {
    if (bVar1 != 3) {
    ...
    func_0x000100cbca80(param_1 + 0x70);
    goto LAB_100caaf80;
  }
