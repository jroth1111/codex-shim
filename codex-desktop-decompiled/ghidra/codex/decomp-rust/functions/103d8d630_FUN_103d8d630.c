...
void FUN_103d8d630(long param_1)

{
  ...
  **(long **)(param_1 + 0x20) = lVar1 + -1;
  ...
  if (*(int *)(param_1 + 0x30) == 1) {
    ...
    func_0x000103dbe4a0(param_1 + 0x38);
  }
  if (*(long *)(param_1 + 0x750) != 0) {
    (**(code **)(*(long *)(param_1 + 0x750) + 0x18))(*(undefined8 *)(param_1 + 0x758));
  }
  plVar4 = *(long **)(param_1 + 0x760);
  if (plVar4 != (long *)0x0) {
    lVar1 = *plVar4;
    *plVar4 = lVar1 + -1;
    LORelease();
    if (lVar1 == 1) {
      DataMemoryBarrier(2,1);
      lVar1 = *(long *)(param_1 + 0x760);
      puVar5 = *(undefined8 **)(param_1 + 0x768);
      uVar6 = puVar5[2];
