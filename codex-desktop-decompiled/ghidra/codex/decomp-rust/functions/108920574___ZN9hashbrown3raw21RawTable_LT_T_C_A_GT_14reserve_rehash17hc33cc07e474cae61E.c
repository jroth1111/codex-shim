...
ulong __ZN9hashbrown3raw21RawTable_LT_T_C_A_GT_14reserve_rehash17hc33cc07e474cae61E
...

{
  ...
  if (CARRY8(uVar15,param_2)) {
    ...
    if (uStack_c0 >> 1 < uVar18) {
      if (uVar18 < uStack_c0 + 1) {
        uVar18 = uStack_c0 + 1;
      }
      FUN_102c58734(&plStack_80,0x288,uVar18);
      if (plStack_80 != (long *)0x0) {
        ...
        if (uVar15 != 0) {
          ...
          do {
            ...
            uVar6 = FUN_102c48024(uVar1,uVar2,plVar9[uVar7 * -0x51 + -0x50],
                                  plVar9[uVar7 * -0x51 + -0x4f]);
            ...
            *(byte *)((long)plStack_80 + (uVar10 - 8 & uStack_78) + 8) = bVar4 >> 1;
            _memcpy(plStack_80 + ~uVar10 * 0x51,plVar9 + ~uVar7 * 0x51,0x288);
          } while (uVar12 != 0);
        }
        *param_1 = (long)plStack_80;
        param_1[1] = uStack_78;
        param_1[2] = lStack_70 - uVar15;
        if ((unaff_x26 != 0) && (lVar17 = unaff_x26 * 0x288 + 0x288, unaff_x26 + lVar17 != -9)) {
...
LAB_108920778:
  ...
  do {
    if (*(char *)((long)unaff_x25 + uVar18) == -0x80) {
      puVar16 = unaff_x25 + ~uVar18 * 0x51;
      while( true ) {
        uVar7 = FUN_102c48024(uVar1,uVar2,unaff_x25[uVar18 * -0x51 + -0x50],
                              unaff_x25[uVar18 * -0x51 + -0x4f]);
        uVar6 = unaff_x26 & uVar7;
        ...
        if (uVar10 == 0) {
          lVar17 = 8;
          do {
            uVar12 = uVar12 + lVar17 & unaff_x26;
        ...
        uVar10 = (uVar10 & 0xff00ff00ff00ff00) >> 8 | (uVar10 & 0xff00ff00ff00ff) << 8;
        uVar10 = (uVar10 & 0xffff0000ffff0000) >> 0x10 | (uVar10 & 0xffff0000ffff) << 0x10;
        uVar12 = uVar12 + ((ulong)LZCOUNT(uVar10 >> 0x20 | uVar10 << 0x20) >> 3) & unaff_x26;
        ...
        if ((uVar7 & unaff_x26) < 8) {
          *(byte *)((long)unaff_x25 + uVar18) = bVar4 >> 1;
          *(byte *)((long)unaff_x25 + (unaff_x26 & uVar18 - 8) + 8) = bVar4 >> 1;
          goto LAB_108920a24;
        }
        puVar8 = unaff_x25 + ~uVar12 * 0x51;
        cVar3 = *(char *)((long)unaff_x25 + uVar12);
        *(byte *)((long)unaff_x25 + uVar12) = bVar4 >> 1;
        *(byte *)((long)unaff_x25 + (uVar12 - 8 & unaff_x26) + 8) = bVar4 >> 1;
        if (cVar3 == -1) break;
        puVar11 = unaff_x25 + uVar12 * -0x51;
        if (unaff_x25 + uVar18 * -0x51 + -0x51 < puVar11 && puVar8 < unaff_x25 + uVar18 * -0x51) {
          lVar17 = 0;
        }
        else {
          uVar7 = puVar16[1];
      ...
      *(undefined1 *)((long)unaff_x25 + (unaff_x26 & uVar18 - 8) + 8) = 0xff;
      _memcpy(puVar8,puVar16,0x288);
    }
LAB_108920a24:
    puVar13 = puVar13 + -0x51;
    uVar18 = uVar18 + 1;
    param_1 = plStack_b8;
    if (unaff_x20 <= uVar15) goto LAB_108920af8;
    uVar15 = uVar15 + 1;
  } while( true );
}
