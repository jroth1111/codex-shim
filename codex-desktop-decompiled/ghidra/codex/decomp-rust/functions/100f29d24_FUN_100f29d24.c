...
void FUN_100f29d24(undefined8 *param_1,long param_2)
...
LAB_100f29d58:
  ...
  *(char **)(param_2 + 8) = pcVar3 + 0x20;
  if (cStack_60 == '\x16') goto LAB_100f29d58;
...
LAB_100f29d98:
    ...
    if ((uStack_98 & 1) == 0) goto LAB_100f29de0;
  }
  else {
    if (cStack_60 == '\x11') {
      ...
      uStack_28 = puVar1[3];
      uStack_30 = puVar1[2];
      func_0x000101434930(&uStack_98,&uStack_40);
      _free(puVar1);
    }
    else {
      if (cStack_60 == '\x12') goto LAB_100f29d98;
      func_0x000101434930(&uStack_98,&cStack_60);
    }
