...
void FUN_1006245e4(ulong *param_1,ulong *param_2)

{
  ...
  *param_2 = 0x8000000000000001;
  if (uVar14 != 0x8000000000000001) {
    ...
    uStack_c0 = uVar7;
    uStack_b8 = uVar3;
    FUN_100613d44(&uStack_a8,&uStack_110);
    if (uStack_a8 == 2) {
      param_1[2] = uStack_98;
      param_1[1] = uStack_a0;
      param_1[4] = uStack_88;
        ...
        if (uVar14 == 0x8000000000000000) {
          if (uVar12 == 0) {
            ...
            if (uVar7 == 0) {
              ...
              pcVar5 = (code *)SoftwareBreakpoint(1,0x100624760);
              (*pcVar5)();
            }
          }
...
LAB_100624a88:
                    /* WARNING: Does not return */
    pcVar5 = (code *)SoftwareBreakpoint(1,0x100624a8c);
    (*pcVar5)();
  }
  ...
  uStack_190 = uVar7;
  uStack_188 = uVar3;
  func_0x000101540afc(puVar9,&uStack_210,&uStack_1e0);
  if (*puVar9 == 2) {
    if ((uVar14 & 0x7fffffffffffffff) != 0) {
      _free(uVar2);
    }
