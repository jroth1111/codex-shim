...
/* WARNING: Removing unreachable block (ram,0x0001013bf86c) */

void FUN_1013bf2f0(undefined1 *param_1,char *param_2)
...
LAB_1013bf790:
    ...
    if ((byte)uStack_e0 == 4) {
      if (plStack_118 != (long *)0x0) {
        if (plStack_118 == (long *)0x1) goto LAB_1013bf648;
    ...
    if ((byte)uStack_e0 == 0xc) {
      if (lStack_108 == 7) {
        if ((int)*plStack_110 != 0x64657263 || *(int *)((long)plStack_110 + 3) != 0x73746964)
        goto LAB_1013bf460;
        uStack_140 = (char *)((ulong)uStack_140._2_6_ << 0x10);
      }
      else if ((lStack_108 == 0xb) &&
              (*plStack_110 == 0x696c5f6567617375 &&
               *(long *)((long)plStack_110 + 3) == 0x74696d696c5f6567)) {
        uStack_140 = (char *)CONCAT62(uStack_140._2_6_,0x100);
      }
      else {
LAB_1013bf460:
        pcStack_138 = (char *)FUN_1087e4494(plStack_110,lStack_108,&UNK_10b232520,2);
        uStack_140 = (char *)CONCAT71(uStack_140._1_7_,1);
      }
joined_r0x0001013bf604:
      if (plVar5 == (long *)0x0) goto LAB_1013bf79c;
      _free(plVar6);
      pcVar8 = uStack_140;
      lVar9 = lStack_88;
      lStack_88 = lStack_68;
      goto joined_r0x0001013bf6d8;
    }
LAB_1013bf840:
    pcStack_138 = (char *)FUN_108855b04(&uStack_e0,&uStack_51,&UNK_10b210720);
    uStack_140 = (char *)CONCAT71(uStack_140._1_7_,1);
    lVar9 = lStack_88;
LAB_1013bf7a8:
    lStack_88 = lVar9;
    ...
    if ((byte)uStack_e0 == 0xd) {
      if (plStack_110 == (long *)0x7) {
        if ((int)*plStack_118 == 0x64657263 && *(int *)((long)plStack_118 + 3) == 0x73746964)
        goto LAB_1013bf78c;
      }
      else if ((plStack_110 == (long *)0xb) &&
              (*plStack_118 == 0x696c5f6567617375 &&
               *(long *)((long)plStack_118 + 3) == 0x74696d696c5f6567)) goto LAB_1013bf648;
      pcStack_138 = (char *)FUN_1087e4494(plStack_118,plStack_110,&UNK_10b232520,2);
LAB_1013bf57c:
      uVar10 = 1;
      goto LAB_1013bf790;
    }
    if ((byte)uStack_e0 == 0xe) {
      FUN_100bb70d4(&uStack_140,plStack_110,lStack_108);
      goto joined_r0x0001013bf604;
    }
    if ((byte)uStack_e0 != 0xf) goto LAB_1013bf840;
    FUN_100bb70d4(&uStack_140,plStack_118,plStack_110);
LAB_1013bf794:
    FUN_100e077ec(&uStack_e0);
LAB_1013bf79c:
    pcVar8 = uStack_140;
    lVar9 = lStack_88;
    lStack_88 = lStack_68;
joined_r0x0001013bf6d8:
    bVar4 = (char)uStack_140 == '\x01';
    uStack_140 = pcVar8;
    lStack_68 = lStack_88;
    if (bVar4) goto LAB_1013bf7a8;
