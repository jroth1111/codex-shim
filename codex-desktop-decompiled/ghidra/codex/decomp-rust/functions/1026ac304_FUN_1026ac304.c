...
void FUN_1026ac304(ulong *param_1)
      ...
      do {
        ...
        if (bVar1 < 2) {
          if (bVar1 == 0) {
            ...
            if (*(long *)(pbVar10 + 0x20) != 0) goto code_r0x0001026a20e4;
          }
          else {
            if (bVar1 == 1) goto code_r0x0001026a2150;
            lVar5 = *(long *)(pbVar10 + 8);
joined_r0x0001026a2148:
            if (lVar5 != 0) {
              _free(*(undefined8 *)(pbVar10 + 0x10));
            }
            if (*(long *)(pbVar10 + 0x20) != 0) {
              lVar5 = *(long *)(pbVar10 + 0x28);
              goto code_r0x0001026a20e4;
            }
          }
        }
        else {
          if (bVar1 != 2) {
            lVar5 = *(long *)(pbVar10 + 8);
            goto joined_r0x0001026a2148;
          }
code_r0x0001026a2150:
          if (*(long *)(pbVar10 + 8) == 0) goto code_r0x0001026a20ec;
          lVar5 = *(long *)(pbVar10 + 0x10);
code_r0x0001026a20e4:
          _free(lVar5);
        }
code_r0x0001026a20ec:
        uVar11 = uVar11 + 1;
      } while (uVar11 != uVar6);
    }
    if (param_1[4] == 0) {
  ...
  case 5:
    ...
    func_0x0001026a2cd8(param_1 + 0xc);
  ...
  case 6:
    ...
    if (uVar6 != 0) {
      ...
      do {
        ...
        if (puVar8[2] + 0x7fffffffffffffff < 2 || (puVar8[2] & 0x7fffffffffffffff) == 0) {
          lVar5 = puVar8[-1];
        }
        else {
          _free(puVar8[3]);
  ...
  case 7:
    ...
    func_0x0001026a9020(param_1 + 0x14);
    ...
    func_0x0001026a5e5c(param_1[0x1d]);
  ...
  case 8:
    ...
    func_0x0001026a9020(param_1 + 0xf);
    uVar6 = param_1[0xc];
