...
void FUN_1012d7710(undefined8 param_1,long param_2,undefined *param_3)
...
code_r0x0001012d7710:
  plVar5 = (long *)FUN_108856088(s_duplicate_field_____108ac2973,param_2);
LAB_1012d6bf0:
  bVar3 = true;
  bVar16 = true;
  ...
  if (plVar12 == (long *)0x2) {
    ...
    while( true ) {
      ...
      *(undefined8 *)(unaff_x24 + 0x70) = *(undefined8 *)(unaff_x24 + 0x1e0);
      ...
      uVar4 = *(undefined8 *)(unaff_x24 + 0xf0);
      ...
      puVar7[7] = uVar24;
      puVar7[6] = uVar23;
      uVar4 = *(undefined8 *)(unaff_x24 + 0xd0);
      ...
      puVar7[0xb] = uVar24;
      puVar7[10] = uVar23;
      uVar4 = *(undefined8 *)(unaff_x24 + 0x90);
...
code_r0x0001012d65f4:
      ...
      case (long *)0xb:
                    /* WARNING: This code block may not be properly labeled as switch case */
        FUN_1087f49f4(&stack0x000002f0,in_stack_000002d4);
...
code_r0x0001012d7200:
            ...
            if (bVar9 != 0x10) {
              ...
              if (plVar5 != in_stack_00000090) {
                ...
                *(undefined8 *)(unaff_x24 + 0x300) = uVar4;
                ...
                *(undefined8 *)(unaff_x24 + 800) = uVar4;
...
joined_r0x0001012d68c8:
          if ((lVar13 != 8) || (*plVar5 != 0x65707954656d696d)) goto code_r0x0001012d6920;
          *(undefined1 *)(unaff_x29 + -0xaf) = 1;
          *(undefined1 *)(unaff_x29 + -0xb0) = 0;
        }
      ...
      if (bVar9 != 0xe) {
        ...
        FUN_100a8c388(unaff_x29 + -0xb0,
                      *(undefined8 *)((undefined *)((long)in_stack_00000078 + (long)plVar18) + 8));
        if ((*(byte *)(unaff_x29 + -0xb0) & 1) != 0) goto code_r0x0001012d6b38;
        goto code_r0x0001012d6934;
      }
      param_3 = *(undefined **)((undefined *)((long)in_stack_00000078 + (long)plVar18) + 0x18);
      FUN_100a8c388(unaff_x29 + -0xb0,
                    *(undefined8 *)((undefined *)((long)in_stack_00000078 + (long)plVar18) + 0x10));
...
code_r0x0001012d6788:
      if ((lVar13 != 4) || ((int)*plVar5 != 0x626f6c62)) goto code_r0x0001012d6920;
      *(undefined1 *)(unaff_x29 + -0xaf) = 2;
      *(undefined1 *)(unaff_x29 + -0xb0) = 0;
    }
