...
void FUN_103da6208(int *param_1)
  ...
  if (*param_1 == 0) {
    ...
    if (cVar2 == '\0') {
      ...
      **(long **)(param_1 + 0x38) = lVar6 + -1;
      ...
      lVar6 = **(long **)(param_1 + 0x3c);
      **(long **)(param_1 + 0x3c) = lVar6 + -1;
      LORelease();
      if (lVar6 == 1) {
        DataMemoryBarrier(2,1);
      ...
      *(long *)*plVar10 = lVar6 + -1;
      ...
      if (cVar2 == '\x03') {
        func_0x000103da39a8(param_1 + 0x56);
      }
      else {
        if (cVar2 != '\x04') {
          return;
        }
        func_0x000103dae9fc(param_1 + 0x56);
      }
      ...
      **(long **)(param_1 + 0x34) = lVar6 + -1;
      ...
      if ((*(byte *)((long)param_1 + 0x155) & 1) != 0) {
        lVar6 = **(long **)(param_1 + 0x38);
        **(long **)(param_1 + 0x38) = lVar6 + -1;
        LORelease();
        if (lVar6 == 1) {
      ...
      if ((((*(byte *)(param_1 + 0x55) & 1) != 0) &&
          (*(long *)(param_1 + 0x2a) != -0x8000000000000000)) && (*(long *)(param_1 + 0x2a) != 0)) {
        _free(*(undefined8 *)(param_1 + 0x2c));
      }
      if ((*(byte *)((long)param_1 + 0x153) & 1) != 0) {
        lVar6 = **(long **)(param_1 + 0x3c);
        **(long **)(param_1 + 0x3c) = lVar6 + -1;
        LORelease();
        if (lVar6 == 1) {
      ...
      if ((*(byte *)((long)param_1 + 0x152) & 1) != 0) {
        plVar10 = (long *)(param_1 + 0x40);
        lVar14 = *plVar10;
        LOAcquire();
        lVar6 = *(long *)(lVar14 + 0x1f0);
