...
void FUN_1011a3da4(long *param_1,long *param_2,ulong ***param_3)

{
  ...
  if (param_1[2] != 0) {
    ...
    while( true ) {
      ...
      if ((ulong ***)param_2[5] < pppuVar7) goto LAB_1011a41b8;
      lVar6 = *param_2;
      if (lVar6 != 2) {
        if (lVar6 != 1) {
          pppuVar9 = (ulong ***)param_2[3];
...
LAB_1011a4210:
    ...
    pcVar3 = (code *)SoftwareBreakpoint(1,0x1011a4220);
    (*pcVar3)();
  }
  if (lVar6 == 2) {
    param_3 = (ulong ***)0x0;
  ...
  FUN_100f30848(&pppuStack_80,&plStack_b8,param_3);
  ...
  if (((ulong)plVar5 & 1) == 0) {
    ...
    plVar5[4] = lVar6 + -1;
    LORelease();
    if (lVar6 != 1) goto LAB_1011a4188;
    if (*plVar5 != 0) {
      _free(plVar5[1]);
    }
  }
  else {
    if (param_1[2] + ((ulong)plVar5 >> 5) == 0) goto LAB_1011a4188;
