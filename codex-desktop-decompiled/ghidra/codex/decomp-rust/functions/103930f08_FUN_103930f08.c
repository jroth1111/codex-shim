...
void FUN_103930f08(long *param_1)
  ...
  if (lVar3 != 0) {
    ...
    if (lVar4 != 0) {
      ...
      do {
        ...
        if (plVar5[(long)-iVar2 * 0xf + -0xf] != 0) {
          _free(plVar5[(long)-iVar2 * 0xf + -0xe]);
        }
        uVar7 = uVar7 - 1 & uVar7;
        lVar4 = lVar4 + -1;
        FUN_1039415f0(plVar5 + (long)-iVar2 * 0xf + -0xc);
      } while (lVar4 != 0);
    }
    if (lVar3 * 0x79 != -0x81) {
                    /* WARNING: Could not recover jumptable at 0x000108aa97cc. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      (*(code *)PTR__free_10b61b0a8)(*param_1 + lVar3 * -0x78 + -0x78);
      return;
    }
  }
  return;
