...
LAB_1013985e0:
    ...
    do {
      ...
      *puVar17 = uVar12;
      ...
      if (0xc < bVar4) {
        if (bVar4 == 0xd) {
          func_0x000100bb3cf4(&bStack_98,uVar3,uVar12);
          goto LAB_1013981b8;
        }
        if (bVar4 != 0xe) {
          if (bVar4 != 0xf) goto LAB_101398444;
          func_0x000100bb3a24(&bStack_98,uVar3,uVar12);
          goto LAB_1013981b8;
        }
        func_0x000100bb3a24(&bStack_98,uVar12,uStack_c8);
...
LAB_101398444:
      ...
      func_0x000100bb3cf4(&bStack_98,uVar12);
