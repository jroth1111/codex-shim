...
void FUN_103dafebc(long param_1)

{
  ...
  **(long **)(param_1 + 0x20) = lVar1 + -1;
  ...
  if (*(int *)(param_1 + 0x30) == 1) {
    ...
    func_0x000103da8a48(param_1 + 0x38);
  }
LAB_103daff68:
  if (*(long *)(param_1 + 0x278) != 0) {
    (**(code **)(*(long *)(param_1 + 0x278) + 0x18))(*(undefined8 *)(param_1 + 0x280));
  }
  plVar3 = *(long **)(param_1 + 0x288);
  if (plVar3 != (long *)0x0) {
    lVar1 = *plVar3;
    *plVar3 = lVar1 + -1;
    LORelease();
    if (lVar1 == 1) {
      ...
      puVar4 = *(undefined8 **)(param_1 + 0x290);
      uVar5 = puVar4[2];
      if ((code *)*puVar4 != (code *)0x0) {
