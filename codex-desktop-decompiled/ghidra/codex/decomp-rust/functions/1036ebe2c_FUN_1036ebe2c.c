...
void FUN_1036ebe2c(long *param_1,ulong *param_2)
...
LAB_1036ebfbc:
        func_0x000108922654(&lStack_238,plVar2,uVar14,&UNK_10b2b77a0,2);
      }
    }
    else {
  ...
  if (uVar9 != 6) {
    ...
    FUN_108921f70(&lStack_238,&lStack_c8,&UNK_10b2c9b38,&UNK_10b29b520);
    ...
    *param_1 = lStack_238;
    ...
    FUN_10337b6e4(param_2);
    return;
  }
  if (param_2[6] == 0) {
    uVar12 = 0x2a;
    puVar8 = (undefined8 *)_malloc(0x2a);
    if (puVar8 != (undefined8 *)0x0) {
      puVar8[1] = 0x3120796c74636178;
      *puVar8 = 0x65206465746e6177;
      puVar8[3] = 0x20646e756f66202c;
      puVar8[2] = 0x746e656d656c6520;
      *(undefined8 *)((long)puVar8 + 0x22) = 0x73746e656d656c65;
      *(undefined8 *)((long)puVar8 + 0x1a) = 0x203020646e756f66;
      lVar15 = 0x2a;
LAB_1036ec0f0:
      *param_1 = 0;
      param_1[3] = lVar15;
    ...
    if (param_2[6] == 1) {
      ...
      if (uVar9 != 0) {
        ...
        if (uVar14 != 0x8000000000000000) {
          ...
          if (uVar9 == 9) {
            if (*plVar2 != 0x6f7463656e6e6f63 || (char)plVar2[1] != 'r') goto LAB_1036ec1c0;
            bStack_c0 = 0;
LAB_1036ec210:
            lStack_c8 = 2;
          }
...
LAB_1036ec1c0:
            func_0x000108922654(&lStack_c8,plVar2,uVar9,&UNK_10b2b77a0,2);
          }
          if (uVar14 != 0) {
            _free(plVar2);
          }
          ...
          if (lStack_c8 == 2) {
            ...
            if ((bVar13 & 1) == 0) {
              ...
              if (lStack_c8 != 2) goto LAB_1036ec314;
              bStack_230 = 0;
            }
            else {
              func_0x000106128f78(&lStack_c8,&uStack_170);
...
LAB_1036ebf30:
    ...
    uVar12 = 0x2d;
    puVar8 = (undefined8 *)_malloc(0x2d);
    if (puVar8 != (undefined8 *)0x0) {
      puVar8[1] = 0x3120796c74636178;
      *puVar8 = 0x65206465746e6177;
      puVar8[3] = 0x742065726f6d202c;
      puVar8[2] = 0x746e656d656c6520;
      *(undefined8 *)((long)puVar8 + 0x25) = 0x746e656d656c6520;
      *(undefined8 *)((long)puVar8 + 0x1d) = 0x31206e6168742065;
      lVar15 = 0x2d;
      goto LAB_1036ec0f0;
    }
  }
...
LAB_1036ec3b8:
  ...
  pcVar7 = (code *)SoftwareBreakpoint(1,0x1036ec3bc);
  (*pcVar7)();
}
