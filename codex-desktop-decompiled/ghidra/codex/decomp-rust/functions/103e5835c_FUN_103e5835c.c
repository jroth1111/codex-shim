...
void FUN_103e5835c(long param_1,undefined8 param_2)
...
joined_r0x000103e58428:
  if (iVar1 == 1) {
    ...
    func_0x000103da4e28(param_1 + 0x18);
  }
  _memcpy(param_1 + 0x10,param_2,0x508);
  if (*(char *)(lVar2 + 0x48) != '\x01') {
    if (*(char *)(lVar2 + 0x48) == '\x02') {
      return;
    }
