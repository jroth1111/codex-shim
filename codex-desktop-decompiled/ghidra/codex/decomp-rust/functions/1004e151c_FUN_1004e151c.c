...

{
  ...
  lVar2 = thunk_FUN_108856088(s_duplicate_field_____108ac2973,&stack0x00000020);
  *unaff_x19 = -0x7fffffffffffffff;
  ...
  if (*unaff_x19 != -0x7fffffffffffffff) {
    ...
    uVar1 = unaff_x22 - (unaff_x21 + 0x40);
    if (uVar1 == 0) {
      ...
      *unaff_x19 = in_stack_00000020;
      ...
      lVar2 = thunk_FUN_1087e422c(unaff_x23 + 1 + (uVar1 >> 6),&stack0x000000b8,&UNK_10b23a190);
      *unaff_x19 = -0x7fffffffffffffff;
      unaff_x19[1] = lVar2;
      if (in_stack_00000088 != (long *)0x0) {
        lVar2 = *in_stack_00000088;
        *in_stack_00000088 = lVar2 + -1;
        LORelease();
        if (lVar2 == 1) {
          DataMemoryBarrier(2,1);
