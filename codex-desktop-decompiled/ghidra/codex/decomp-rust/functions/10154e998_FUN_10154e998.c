...
void FUN_10154e998(ulong *param_1,long *param_2,ulong *param_3)
  ...
  if (lVar8 < 4) {
    if (lVar8 < 2) {
      ...
      if (lVar1 == 0) {
        ...
        if (unaff_x22 == 0) goto LAB_10154ec8c;
      }
...
LAB_10154ec8c:
        ...
        pcVar3 = (code *)SoftwareBreakpoint(1,0x10154ec9c);
        (*pcVar3)();
      }
    }
    _memcpy(unaff_x22,lVar9,lVar1);
...
LAB_10154eaa8:
  ...
  uStack_138 = uVar7;
  lStack_120 = lVar2;
  func_0x000100615ab4(&uStack_b8,&uStack_1b0);
  if (uStack_b8 == 2) {
    param_1[2] = uStack_b0;
    param_1[1] = 1;
    *param_1 = 2;
