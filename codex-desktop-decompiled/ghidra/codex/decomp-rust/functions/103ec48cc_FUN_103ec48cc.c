...
ulong * FUN_103ec48cc(ulong *param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
                     undefined8 param_5)
    ...
    if (*puVar16 == 0) {
      if (*(ulong **)(uVar25 + 0x28) == puVar10) {
        ...
        *(ulong *)(uVar25 + 0x28) = uVar20;
        goto joined_r0x000103ec4984;
      }
LAB_103ec4a80:
      func_0x000108a07a20(&UNK_10b300260);
LAB_103ec4a8c:
                    /* WARNING: Does not return */
      pcVar8 = (code *)SoftwareBreakpoint(1,0x103ec4a90);
      (*pcVar8)();
    }
    uVar20 = param_1[4];
    *(ulong *)(*puVar16 + 0x10) = uVar20;
joined_r0x000103ec4984:
    if (uVar20 == 0) {
      if (*(ulong **)(uVar25 + 0x30) != puVar10) goto LAB_103ec4a80;
    ...
    if (puVar16 == puVar10) {
      func_0x00010897c0b4(1,uVar25 + 0x18,&stack0xffffffffffffffc8,0,param_5,&UNK_10b2fbba0);
      goto LAB_103ec4a8c;
    }
    param_1[3] = 0;
      ...
      if (*pcVar1 == '\x01') {
        *pcVar1 = in_wzr;
        ...
        __ZN11parking_lot9raw_mutex8RawMutex11unlock_slow17h37f4fcce25a32539E(pcVar1,0);
                    ...
                    /* WARNING: Could not recover jumptable at 0x000103ec4a08. Too many branches */
