...
LAB_10136f4c8:
            ...
            if (cVar7 == '\x11') {
              ...
              uStack_78 = puVar9[3];
              uStack_80 = puVar9[2];
              func_0x00010143cf68(&uStack_1e0,&puStack_90);
              _free(puVar9);
              ppuVar32 = uStack_1e0;
            }
            else {
              ...
              cStack_b0 = cVar7;
              func_0x00010143cf68(&uStack_1e0,&cStack_b0);
              ppuVar32 = uStack_1e0;
            }
            uStack_1e0 = ppuVar32;
            if (ppuVar32 == (undefined **)0x8000000000000003) {
...
LAB_10136f950:
      ...
      if (cVar7 == '\x11') {
        ...
        uStack_78 = puVar27[3];
        uStack_80 = puVar27[2];
        func_0x00010143cf68(&cStack_138,&puStack_90);
        _free(puVar27);
      }
      else {
        if (cVar7 == '\x12') goto LAB_10136f940;
        func_0x00010143cf68(&cStack_138,&cStack_b0);
      }
