...
void FUN_100bb3654(undefined1 *param_1,long *param_2,long param_3)

{
  if (param_3 < 8) {
      ...
      if ((int)*param_2 == 0x696d696c && *(char *)((long)param_2 + 4) == 't') {
        ...
        *param_1 = 0;
        return;
            ...
            ((int)*param_2 == 0x73727563 && *(short *)((long)param_2 + 4) == 0x726f)) {
      param_1[1] = 1;
      *param_1 = 0;
      return;
    }
    ...
    if (*param_2 == 0x656956736d657469 && (char)param_2[1] == 'w') {
      param_1[1] = 4;
      *param_1 = 0;
      return;
    }
