...

{
  ...
  ulong in_stack_0000ca50;
  
  __ZN7tracing15__macro_support13__tracing_log17h72768b16bee39960E();
  if ((in_stack_0000ca50 & 3) == 1) {
    uVar4 = *(undefined8 *)(in_stack_0000ca50 - 1);
    puVar2 = *(undefined8 **)(in_stack_0000ca50 + 7);
    pcVar1 = (code *)*puVar2;
    if (pcVar1 != (code *)0x0) {
      (*pcVar1)(uVar4);
    }
    ...
    _free((undefined8 *)(in_stack_0000ca50 - 1));
  }
  if (unaff_x28 != 0) {
    _free();
  }
