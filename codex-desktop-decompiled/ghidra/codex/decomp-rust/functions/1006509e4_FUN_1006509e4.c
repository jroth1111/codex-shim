...

{
  ...
  auVar10 = thunk_FUN_108856088(s_duplicate_field_____108ac2973,&stack0x00000128);
  uVar7 = auVar10._0_8_;
    ...
    if ((bStack0000000000000100 & 1) == 0) {
      *(undefined1 *)(unaff_x29 + -0x80) = 0;
      while( true ) {
        ...
        auVar10._0_8_ = in_stack_00000198;
        if (*piVar4 != 4) {
          plVar6 = (long *)func_0x000107c05db8((long)*piVar4 << 0x20 | 2);
          auVar10._8_4_ = uStack00000000000001a8;
          auVar10._0_8_ = in_stack_00000198;
          goto LAB_10064fecc;
        }
      ...
      if (lVar3 == 0) {
        *(undefined8 *)(unaff_x29 + -0x80) = 3;
        plVar6 = (long *)FUN_107c05dbc(unaff_x29 + -0x80,in_stack_000000e0,in_stack_000000e8);
        auVar10._8_4_ = uStack00000000000001a8;
        auVar10._0_8_ = in_stack_00000198;
        goto LAB_10064fecc;
      }
...
LAB_10064fecc:
  ...
  *(ulong *)(unaff_x29 + -0x70) = CONCAT44(uStack00000000000001ac,uStack00000000000001a8);
  ...
  uStack00000000000001a8 = auVar10._8_4_;
  in_stack_00000198 = auVar10._0_8_;
  uVar5 = thunk_FUN_108832e54(uVar7,in_stack_000000e0,in_stack_000000e8);
