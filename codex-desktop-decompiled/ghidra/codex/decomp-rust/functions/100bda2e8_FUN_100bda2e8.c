...
void FUN_100bda2e8(undefined2 *param_1,byte *param_2)
...
LAB_100bda6ec:
      pbStack_d8 = pbVar17;
      uVar12 = FUN_1087e422c(0,&UNK_10b231e98,&UNK_10b20a590);
    }
    else {
      pbVar17 = pbVar2 + 0x20;
      if (*pbVar2 == 0x16) goto LAB_100bda6ec;
      ...
      if ((short)uStack_78 != 1) {
        ...
        uVar12 = FUN_1087e422c(1,&UNK_10b231e98,&UNK_10b20a590);
      }
    }
LAB_100bda82c:
    ...
    *param_1 = 1;
    ...
    goto joined_r0x000100bda900;
  }
  if (bVar4 != 0x15) {
    uVar12 = FUN_108855b04(param_2,&uStack_78,&UNK_10b20c3e0);
    *(undefined8 *)(param_1 + 4) = uVar12;
    *param_1 = 1;
    return;
  }
        ...
        if (bVar3 == 1) {
          ...
          if (bVar3 != 4) {
            if (bVar3 == 0xc) {
              ...
              goto joined_r0x000100bda54c;
            }
LAB_100bdaa74:
            lStack_a0 = lVar20 + 1;
            pbStack_b8 = pbVar16;
            uVar12 = FUN_108855b04(&bStack_98,&uStack_78,&UNK_10b210e40);
            goto LAB_100bda8d0;
          }
          iVar14 = 1;
          if (piVar5 != (int *)0x1) {
...
LAB_100bda5d4:
        ...
        if (bVar3 == 0xd) {
          if (piVar6 != (int *)0x4) goto LAB_100bda5d0;
...
LAB_100bda554:
        ...
        if (bVar3 != 0xe) {
          if (bVar3 != 0xf) goto LAB_100bdaa74;
          if (piVar6 == (int *)0x4) {
            if ((char)*piVar5 == 'c') {
        ...
        if (lStack_80 == 4) {
          if ((char)*piVar6 == 'c') {
            if (((*(char *)((long)piVar6 + 1) != 'o') || (*(char *)((long)piVar6 + 2) != 'l')) ||
               (*(char *)((long)piVar6 + 3) != 's')) goto LAB_100bda594;
            iVar13 = 1;
          }
          else {
...
joined_r0x000100bda54c:
      ...
      if (iVar13 == 0) {
        ...
        pbStack_e0 = (byte *)CONCAT71(pbStack_e0._1_7_,0x16);
        if (bVar3 == 0x16) goto LAB_100bda9a4;
        uVar12 = *puVar18;
        puVar19[1] = puVar18[1];
        *puVar19 = uVar12;
...
LAB_100bda87c:
        ...
        *(undefined8 *)((long)puVar19 + 0xf) = uVar12;
        bStack_98 = bVar3;
        FUN_100615630(&uStack_78,&bStack_98);
        if (((ulong)uStack_78 & 1) != 0) goto LAB_100bda87c;
        bVar7 = true;
...
LAB_100bda9a4:
          ...
          pcVar11 = (code *)SoftwareBreakpoint(1,0x100bda9d4);
          (*pcVar11)();
        }
        uVar12 = *puVar18;
        puVar19[1] = puVar18[1];
