...
/* WARNING: Removing unreachable block (ram,0x000101cb48b0) */
/* WARNING: Removing unreachable block (ram,0x000101cb48c0) */

void FUN_101cb4f20(void)

{
  ...
  *in_stack_00000088 = -0x8000000000000000;
  ...
  if (((in_stack_000000a8 != 0x8000000000000001) && ((unaff_x25 & 1) != 0)) &&
     ((in_stack_000000a8 & 0x7fffffffffffffff) != 0)) {
    _free(in_stack_00000030);
  }
  uVar1 = 0;
