...
void FUN_103db2d80(long param_1)

{
  ...
  **(long **)(param_1 + 0x20) = lVar1 + -1;
  ...
  if (*(int *)(param_1 + 0x30) == 1) {
    ...
    func_0x000103dad308(param_1 + 0x38);
  }
  if (*(long *)(param_1 + 0xdd8) != 0) {
    (**(code **)(*(long *)(param_1 + 0xdd8) + 0x18))(*(undefined8 *)(param_1 + 0xde0));
  }
  plVar4 = *(long **)(param_1 + 0xde8);
  if (plVar4 != (long *)0x0) {
    lVar1 = *plVar4;
    *plVar4 = lVar1 + -1;
    LORelease();
    if (lVar1 == 1) {
      ...
      puVar5 = *(undefined8 **)(param_1 + 0xdf0);
      uVar6 = puVar5[2];
