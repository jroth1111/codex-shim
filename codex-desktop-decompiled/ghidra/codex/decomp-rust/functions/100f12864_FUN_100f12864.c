...
void FUN_100f12864(undefined8 param_1)

{
  ...
  long in_stack_00005bc0;
  
  __ZN12tracing_core5event5Event8dispatch17h50a390618bcffa4fE(param_1,&stack0x00003d10);
  if ((*unaff_x26 == '\0') && (___ZN3log20MAX_LOG_LEVEL_FILTER17h2019f7c33388e688E != 0)) {
    uVar5 = *unaff_x21;
    ...
    iVar4 = (**(code **)(puVar1 + 0x18))(puVar2,&stack0x00005b78);
    if (iVar4 != 0) {
      __ZN7tracing15__macro_support13__tracing_log17h72768b16bee39960E
                (uVar5,puVar2,puVar1,&stack0x00005b78,&stack0x00003d10);
    }
  }
  ...
  if (in_stack_00005bc0 == unaff_x27) {
    if ((___ZN12tracing_core8metadata9MAX_LEVEL17h02c7742de62f64c3E < 2) &&
      ...
      if ((*unaff_x26 == '\0') && (3 < ___ZN3log20MAX_LOG_LEVEL_FILTER17h2019f7c33388e688E)) {
        ...
        iVar4 = (**(code **)(puVar1 + 0x18))(puVar2,&stack0x00003d10);
        if (iVar4 != 0) {
          __ZN7tracing15__macro_support13__tracing_log17h72768b16bee39960E
                    (uVar5,puVar2,puVar1,&stack0x00003d10,&stack0x00001eb0);
        }
      }
    }
      ...
      if (iVar4 != 0) {
        ...
        *(undefined1 *)(unaff_x25 + 0x30) = 1;
        (**(code **)(puVar1 + 0x20))(puVar2,&stack0x00001eb0);
      }
    }
  }
  else {
    register0x00000008 = (BADSPACEBASE *)((ulong)&stack0x00005bc0 | 8);
    unaff_x27 = in_stack_00005bc0;
  }
  ...
  *(undefined8 *)(unaff_x29 + -0xd0) = uVar5;
  if ((*(long *)(unaff_x19 + 0xd0) != -0x8000000000000000) && (*(long *)(unaff_x19 + 0xd0) != 0)) {
