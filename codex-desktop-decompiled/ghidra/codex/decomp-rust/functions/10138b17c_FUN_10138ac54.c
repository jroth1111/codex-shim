...
void FUN_10138ac54(undefined8 *param_1,byte *param_2)
...
LAB_10138af70:
      pbStack_e8 = pbVar14;
      pbVar9 = (byte *)FUN_1087e422c(0,&UNK_10b22fdb8,&UNK_10b20a590);
    }
    else {
      pbVar14 = unaff_x21 + 0x20;
      if (*unaff_x21 == 0x16) goto LAB_10138af70;
      ...
      if (puStack_a0 != (undefined *)0x8000000000000000) {
        *param_1 = puStack_a0;
        ...
        if (lVar12 == 0) goto LAB_10138b0d8;
        *param_1 = 0x8000000000000000;
        param_1[1] = lVar12;
        unaff_x21 = pbVar9;
        puVar13 = puVar6;
        goto joined_r0x00010138b028;
      }
    }
    *param_1 = 0x8000000000000000;
    param_1[1] = pbVar9;
...
joined_r0x00010138b028:
    ...
    if (bVar3 != 0x15) {
      uVar11 = FUN_108855b04(param_2,&puStack_a0,&UNK_10b20a780);
      *param_1 = 0x8000000000000000;
      param_1[1] = uVar11;
      return;
    }
          ...
          if (bVar2 != 1) {
            ...
            if (bVar2 == 0xc) {
              if (lStack_70 == 4) {
                ...
                if (iVar1 == 0x68746170) goto LAB_10138aedc;
              }
...
LAB_10138b1e0:
            lStack_b0 = lVar17 + 1;
            pbStack_c8 = pbVar19;
            uVar11 = FUN_108855b04(&bStack_88,&puStack_a0,&UNK_10b210940);
            *param_1 = 0x8000000000000000;
            param_1[1] = uVar11;
            puVar13 = (undefined *)((ulong)puVar13 & 0x7fffffffffffffff);
            goto joined_r0x00010138b218;
          }
          bVar8 = cStack_87 == '\0';
LAB_10138ae60:
          bVar8 = !bVar8;
...
LAB_10138ae68:
          ...
          if (bVar2 != 0xe) {
            if (bVar2 != 0xf) goto LAB_10138b1e0;
            if ((((piVar5 != (int *)0x4) || ((char)*piVar4 != 'p')) ||
                (*(char *)((long)piVar4 + 1) != 'a')) || (*(char *)((long)piVar4 + 2) != 't'))
            goto LAB_10138ae68;
            bVar8 = *(char *)((long)piVar4 + 3) == 'h';
            goto LAB_10138ae60;
          }
          if (((lStack_70 == 4) && ((char)*piVar5 == 'p')) &&
             ((*(char *)((long)piVar5 + 1) == 'a' && (*(char *)((long)piVar5 + 2) == 't')))) {
            bVar8 = *(char *)((long)piVar5 + 3) != 'h';
          }
          else {
            bVar8 = true;
          }
          if (piVar4 == (int *)0x0) goto LAB_10138ae74;
          _free();
          if (bVar8) goto LAB_10138ae78;
LAB_10138aedc:
...
LAB_10138b1dc:
            ...
            pcVar7 = (code *)SoftwareBreakpoint(1,0x10138b1e0);
            (*pcVar7)();
          }
          uVar11 = *puVar16;
          puVar15[1] = puVar16[1];
      ...
      if (puVar13 != (undefined *)0x8000000000000000) {
        *param_1 = puVar13;
        ...
        if (pbVar10 == pbVar9) goto LAB_10138b0d8;
