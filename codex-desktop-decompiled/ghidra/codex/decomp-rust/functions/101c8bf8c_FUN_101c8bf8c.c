...

{
  ...
  __ZN5alloc3fmt6format12format_inner17h63985d1d6aa0fe33E
            (unaff_x29 + -0x58,s_Array<_>_108ae5df7,&stack0x00000030);
  if (in_stack_00000000 != 0) {
    _free(in_stack_00000008);
  }
  __ZN5alloc3fmt6format12format_inner17h63985d1d6aa0fe33E(&stack0x00000050,s_roots_____108ae24b5);
