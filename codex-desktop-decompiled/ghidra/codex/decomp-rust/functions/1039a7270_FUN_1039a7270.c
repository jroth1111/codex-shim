...
void FUN_1039a7270(ulong *param_1,undefined8 *param_2,char *param_3,ulong param_4)
  ...
  *puVar11 = uVar14;
  ...
  do {
    while( true ) {
      ...
      iVar16 = iVar16 + -1;
      if (iVar16 == 0) goto LAB_1039a7514;
    }
    iVar16 = iVar16 + -1;
  } while (iVar16 != 0);
LAB_1039a7514:
  ...
  if (param_4 == 0) {
    ...
    if (pcVar13 == (char *)0x0) {
      ...
      pcVar7 = (code *)SoftwareBreakpoint(1,0x1039a755c);
      (*pcVar7)();
    }
  }
