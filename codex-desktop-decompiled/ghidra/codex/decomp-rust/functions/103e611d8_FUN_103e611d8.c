...
void FUN_103e611d8(ulong *param_1)
...
LAB_103e612e0:
    uStack_78 = uVar7;
    FUN_103da6208(param_1 + 6);
    _memcpy(param_1 + 6,auStack_b98,0xb20);
...
LAB_103e6132c:
    ...
    *param_1 = uStack_68 + uStack_70 * -0x40;
    ...
    if ((uVar6 >> 1 & 1) != 0) goto LAB_103e612a8;
    if ((uVar6 >> 3 & 1) == 0) {
      auStack_b98[0] = 2;
      unaff_x22 = param_1[5];
      unaff_x20 = (*
      ...
      if (*(char *)(unaff_x20 + 0x48) == '\x01') goto LAB_103e612d8;
      if (*(char *)(unaff_x20 + 0x48) != '\x02') goto LAB_103e612c0;
      uVar7 = 0;
      goto LAB_103e612e0;
    }
    if ((uVar6 >> 4 & 1) == 0) goto LAB_103e6132c;
    if (param_1[0x16c] != 0) {
      (**(code **)(param_1[0x16c] + 0x10))(param_1[0x16d]);
      LOAcquire();
      uVar2 = *param_1;
      *param_1 = uVar2 & 0xffffffffffffffef;
      ...
      if ((uVar6 >> 1 & 1) == 0) {
        ...
        if ((uVar6 >> 4 & 1) != 0) {
          if ((uVar6 >> 3 & 1) == 0) {
            if (param_1[0x16c] != 0) {
              (**(code **)(param_1[0x16c] + 0x18))(param_1[0x16d]);
            }
            param_1[0x16c] = 0;
          }
          goto LAB_103e6132c;
...
LAB_103e61410:
  ...
  pcVar1 = (code *)SoftwareBreakpoint(1,0x103e61414);
  (*pcVar1)();
}
