...
void FUN_1006291d8(ulong *param_1,ulong *param_2)

{
  ...
  *param_2 = 0x8000000000000001;
  if (uVar12 != 0x8000000000000001) {
    ...
    uStack_60 = uVar5;
    uStack_58 = uVar2;
    func_0x0001013d48d0(param_1,&uStack_b0);
    if (*param_1 == 2) {
      ...
      if (uVar12 == 0x8000000000000000) {
        if (uVar10 == 0) {
          ...
          if (uVar5 == 0) {
            ...
            pcVar4 = (code *)SoftwareBreakpoint(1,0x1006292d4);
            (*pcVar4)();
          }
        }
  ...
  *plVar8 = -0x8000000000000000;
  ...
  if (uVar12 != 0x8000000000000001) {
    ...
    uStack_130 = uVar5;
    uStack_128 = uVar2;
    func_0x00010154e998(puVar7,&uStack_1b0,&uStack_180);
    if (*puVar7 == 2) {
      if ((uVar12 & 0x7fffffffffffffff) != 0) {
        _free(uVar1);
      }
...
LAB_1006295f8:
                    /* WARNING: Does not return */
  pcVar4 = (code *)SoftwareBreakpoint(1,0x1006295fc);
  (*pcVar4)();
}
