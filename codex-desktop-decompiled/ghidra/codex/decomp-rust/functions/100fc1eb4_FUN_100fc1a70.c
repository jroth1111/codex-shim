...
void FUN_100fc1a70(undefined8 *param_1,undefined8 *param_2,undefined8 *param_3)
...
LAB_100fc1b48:
      ...
      if ((auStack_210 & 1) == 0) {
        ...
        *plVar15 = lVar10 + 1;
        ...
        plVar17 = plStack_1d0;
        plVar8 = plStack_1c8;
        if (lVar10 < 0) goto LAB_100fc1f04;
...
LAB_100fc1d10:
    ...
    func_0x000108a07af4(&UNK_10b23a400);
LAB_100fc1edc:
    func_0x000108a07b10(&UNK_10b23a400);
  }
  else {
    if (bVar3 != 3) goto LAB_100fc1edc;
...
LAB_100fc1f04:
  ...
  pcVar9 = (code *)SoftwareBreakpoint(1,0x100fc1f08);
  (*pcVar9)();
}
