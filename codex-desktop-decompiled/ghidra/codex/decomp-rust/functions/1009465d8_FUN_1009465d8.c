...

{
  ...
  if (lVar5 == -0x8000000000000000) {
    ...
    *(undefined8 *)(unaff_x19 + 0x130) = *(undefined8 *)(unaff_x19 + 0xd8);
    *(long *)(unaff_x19 + 0x138) = lVar3;
    *(long *)(unaff_x19 + 0x140) = lVar4;
    *(undefined8 *)(unaff_x19 + 0x148) = 0x8000000000000005;
    *(undefined1 *)(unaff_x19 + 0x150) = *(undefined1 *)(unaff_x19 + 0x110);
    *(undefined8 *)(unaff_x19 + 0x158) = unaff_x27;
    *(undefined1 *)(unaff_x19 + 0x198) = 0;
    FUN_100882728(unaff_x29 + -0xf0,unaff_x19 + 0x118);
    lVar5 = *(long *)(unaff_x29 + -0xf0);
    if (lVar5 != -0x7fffffffffffffff) {
      ...
      FUN_100cd1518(unaff_x19 + 0x118);
      if (lVar5 != -0x8000000000000000) {
        bVar1 = *(byte *)(unaff_x19 + 0x291);
        ...
        goto joined_r0x00010094677c;
      }
      *(undefined2 *)(unaff_x19 + 0x291) = 0;
...
LAB_10094680c:
  ...
  *unaff_x21 = unaff_x24 + 0x6c;
  uVar2 = 3;
LAB_100946878:
  *(undefined1 *)(unaff_x19 + 0x298) = uVar2;
  return;
}
