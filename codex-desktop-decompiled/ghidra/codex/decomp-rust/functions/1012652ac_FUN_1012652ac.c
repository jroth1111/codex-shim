...
/* WARNING: Removing unreachable block (ram,0x000101265864) */

void FUN_1012652ac(ulong *param_1,char *param_2)
...
LAB_101265bac:
        ...
        pcVar8 = (code *)SoftwareBreakpoint(1,0x101265bb0);
        (*pcVar8)();
      }
      uStack_118 = 0;
      uStack_128 = uVar21;
                  ...
                  if (bVar4 != 1) {
                    ...
                    if (bVar4 == 0xc) {
                      if (lStack_70 == 4) {
                        ...
                        if (iVar3 == 0x656d616e) goto LAB_1012655f0;
                      }
...
LAB_101265928:
                    ...
                    pbStack_c8 = pbVar27;
                    pbVar12 = (byte *)FUN_108855b04(&uStack_88,&puStack_a0,&UNK_10b20f420);
                    puVar26 = (undefined *)((ulong)puVar26 & 0x7fffffffffffffff);
                    goto joined_r0x000101265954;
                  }
...
LAB_101265580:
                  ...
                  if (bVar4 != 0xe) {
                    if (bVar4 != 0xf) goto LAB_101265928;
                    if ((((piStack_78 != (int *)0x4) || ((char)*piStack_80 != 'n')) ||
                        (*(char *)((long)piStack_80 + 1) != 'a')) ||
                       (*(char *)((long)piStack_80 + 2) != 'm')) goto LAB_101265580;
                  ...
                  if (piStack_80 == (int *)0x0) goto LAB_10126558c;
                  _free();
                  if (bVar9) goto LAB_101265590;
LAB_1012655f0:
...
LAB_1012657d8:
          ...
          pcStack_148 = pcVar24;
          pbStack_130 = pbVar20;
          uVar21 = FUN_108855b04(acStack_110,&puStack_a0,&UNK_10b20c4a0);
          *param_1 = 0x8000000000000000;
          param_1[1] = uVar21;
          uVar14 = uStack_120;
          uVar21 = uStack_118;
joined_r0x0001012659bc:
          uStack_120 = uVar14;
          uStack_118 = uVar21;
          if (uVar21 != 0) {
...
LAB_101265690:
          pbStack_e8 = pbVar31;
          pbVar11 = (byte *)FUN_1087e422c(0,&UNK_10b231928,&UNK_10b20a590);
LAB_1012656ac:
...
LAB_1012656dc:
          ...
          bVar4 = *pbStack_100;
          if (bVar4 == 0x16) goto LAB_101265690;
          ...
          *(undefined8 *)((long)puVar22 + 0xf) = uVar32;
          ...
          puVar26 = puStack_a0;
          pbVar11 = pbStack_98;
          if (puStack_a0 == (undefined *)0x8000000000000000) goto LAB_1012656ac;
...
LAB_10126586c:
        ...
        *puVar15 = puVar26;
        ...
        if (pcVar24 != pcVar25) goto code_r0x0001012658bc;
        goto LAB_1012659fc;
      }
      pcVar16 = pcVar17 + 0x20;
      pbVar1 = (byte *)0x0;
...
LAB_101265a20:
    ...
    uVar21 = FUN_108855b04(param_2,&puStack_a0,&UNK_10b20a0e0);
    *param_1 = 0x8000000000000000;
    param_1[1] = uVar21;
  }
  return;
code_r0x0001012658bc:
  pcVar16 = pcVar24 + 0x20;
  pcVar23 = pcVar24;
  unaff_x24 = pbVar27;
  pbVar1 = pbVar20;
  cVar7 = *pcVar24;
  if (*pcVar24 == '\x16') goto LAB_1012659fc;
  goto LAB_101265394;
}
