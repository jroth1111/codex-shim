...

{
  ...
  long in_stack_000071c8;
  undefined8 in_stack_000071d0;
  undefined8 *in_stack_00007200;
  
  __ZN5alloc3fmt6format12format_inner17h63985d1d6aa0fe33E
            (&stack0x00000010,s_Failed_to_resume_session_from___108adb1e6,&stack0x00007220);
  __ZN9codex_tui10chatwidget10ChatWidget17add_error_message17hc02ae70319960b9eE();
  if (in_stack_000071c8 != 0) {
    _free(in_stack_000071d0);
  }
  (**(code **)*in_stack_00007200)();
