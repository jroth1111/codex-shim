...

{
  ...
  func_0x000108a07a3c(&UNK_108ce3081,0x1a,&stack0x00000050,&UNK_10b259ed8,&UNK_10b259548);
                    /* WARNING: Does not return */
  pcVar7 = (code *)SoftwareBreakpoint(1,0x10177d0e4);
  (*pcVar7)();
}
