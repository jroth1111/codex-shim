...
/* WARNING: Removing unreachable block (ram,0x00010065de5c) */

void FUN_10065cd2c(void)
  ...
  *in_stack_00000100 = -0x8000000000000000;
  ...
  if ((in_stack_000000a8 != -0x7ffffffffffffffd) && (-0x7ffffffffffffffe < in_stack_000000a8)) {
    if (in_stack_00000698 != 0) {
      puVar3 = (undefined8 *)(in_stack_00000090 + 8);
      do {
        if (puVar3[-1] != 0) {
          _free(*puVar3);
        }
  ...
  if (in_stack_00000670 != -0x8000000000000000) {
    if (in_stack_00000680 != 0) {
      puVar3 = (undefined8 *)(in_stack_00000678 + 8);
      do {
        if (puVar3[-1] != 0) {
          _free(*puVar3);
        }
  ...
  if (in_stack_00000658 != -0x8000000000000000) {
    if (in_stack_00000668 != 0) {
      puVar3 = (undefined8 *)(in_stack_00000660 + 8);
      do {
        if (puVar3[-1] != 0) {
          _free(*puVar3);
        }
  ...
  if (*in_stack_00000100 == -0x8000000000000000) {
    ...
    if (in_stack_00000108 != unaff_x25) {
      lVar2 = thunk_FUN_1087e422c(in_stack_00000078,&UNK_10b21cb90,&UNK_10b20a590);
      *in_stack_00000100 = -0x8000000000000000;
      in_stack_00000100[1] = lVar2;
