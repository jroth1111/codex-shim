...
void FUN_101291ac4(undefined8 *param_1,byte *param_2)
...
LAB_101291ff0:
      pbStack_e8 = pbVar14;
      pbVar17 = (byte *)FUN_1087e422c(0,&UNK_10b232250,&UNK_10b20a590);
LAB_10129200c:
...
LAB_101292014:
      ...
      if (*pbVar18 == 0x16) goto LAB_101291ff0;
      ...
      pbVar17 = pbStack_98;
      puVar15 = puStack_a0;
      if (puStack_a0 == (undefined *)0x8000000000000000) goto LAB_10129200c;
      if (lVar12 == 1) {
LAB_1012920b4:
        pbVar8 = (byte *)FUN_1087e422c(1,&UNK_10b232250,&UNK_10b20a590);
LAB_1012920cc:
        *param_1 = 0x8000000000000000;
        param_1[1] = pbVar8;
      ...
      pbStack_e8 = pbVar14;
      if (pbVar18[0x20] == 0x16) goto LAB_1012920b4;
      ...
      pbVar8 = pbStack_98;
      puVar6 = puStack_a0;
      if (puStack_a0 == (undefined *)0x8000000000000000) goto LAB_1012920cc;
      *param_1 = puVar15;
      param_1[1] = pbVar17;
      param_1[2] = uVar9;
      ...
      if (lVar12 == 0) goto LAB_1012922b0;
      *param_1 = 0x8000000000000000;
      param_1[1] = lVar12;
      if (puVar15 != (undefined *)0x0) {
        _free(pbVar17);
  ...
  if (bVar3 != 0x15) {
    uVar9 = FUN_108855b04(param_2,&puStack_a0,&UNK_10b20c220);
    *param_1 = 0x8000000000000000;
    param_1[1] = uVar9;
    return;
  }
        ...
        if (bVar2 == 1) {
          ...
          if (bVar2 != 4) {
            if (bVar2 == 0xc) {
              if (lStack_70 == 7) {
                iVar10 = 1;
                if ((int)*plVar5 != 0x6d6d6f63 || *(int *)((long)plVar5 + 3) != 0x646e616d) {
                  iVar10 = 2;
                }
              }
              else if (lStack_70 == 8) {
              ...
              goto joined_r0x000101291e18;
            }
LAB_1012924a0:
            lStack_b0 = lVar20 + 1;
            pbStack_c8 = pbVar17;
            uVar9 = FUN_108855b04(&bStack_88,&puStack_a0,&UNK_10b211980);
            goto LAB_101292144;
          }
          iVar11 = 1;
          if (plVar4 != (long *)0x1) {
...
LAB_101291eb4:
        ...
        if (bVar2 == 0xd) {
          if (plVar5 == (long *)0x7) {
            iVar10 = 1;
            if ((int)*plVar4 != 0x6d6d6f63 || *(int *)((long)plVar4 + 3) != 0x646e616d) {
              iVar10 = 2;
            }
          }
          else {
            if (plVar5 != (long *)0x8) goto LAB_101291e7c;
            iVar10 = 2;
        ...
        if (bVar2 != 0xe) {
          if (bVar2 != 0xf) goto LAB_1012924a0;
          if (plVar5 == (long *)0x7) {
            if (((((char)*plVar4 != 'c') || (*(char *)((long)plVar4 + 1) != 'o')) ||
                (*(char *)((long)plVar4 + 2) != 'm')) ||
               (((*(char *)((long)plVar4 + 3) != 'm' || (*(char *)((long)plVar4 + 4) != 'a')) ||
                ((*(char *)((long)plVar4 + 5) != 'n' || (*(char *)((long)plVar4 + 6) != 'd'))))))
            goto LAB_101291e7c;
            iVar10 = 1;
          }
...
LAB_101291e7c:
        ...
        if (lStack_70 == 7) {
          if ((((char)*plVar5 != 'c') || (*(char *)((long)plVar5 + 1) != 'o')) ||
             ((*(char *)((long)plVar5 + 2) != 'm' ||
              ((((*(char *)((long)plVar5 + 3) != 'm' || (*(char *)((long)plVar5 + 4) != 'a')) ||
                (*(char *)((long)plVar5 + 5) != 'n')) || (*(char *)((long)plVar5 + 6) != 'd'))))))
          goto LAB_101291ddc;
          iVar10 = 1;
        }
...
LAB_10129249c:
          ...
          pcVar7 = (code *)SoftwareBreakpoint(1,0x1012924a0);
          (*pcVar7)();
        }
        uVar9 = *puVar13;
        puVar16[1] = puVar13[1];
    ...
    pbStack_c8 = pbVar18;
    lStack_b0 = lVar21;
    if (puVar15 == (undefined *)0x8000000000000000) goto LAB_101292110;
    if (puVar19 != (undefined *)0x8000000000000000) {
      *param_1 = puVar15;
