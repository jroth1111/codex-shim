...
long FUN_103b92524(long *param_1,long *param_2,long param_3)

{
  ...
  lVar13 = param_2[1];
  lVar10 = param_2[2];
  uVar6 = FUN_103b1b21c(param_1[4],param_1[5],lVar13,lVar10);
  if (param_1[2] == 0) {
    func_0x00010896680c(param_1,1,param_1 + 4,1);
  }
  bVar4 = false;
  lVar8 = 0;
  plVar1 = (long *)*param_1;
...
LAB_103b92628:
      bVar11 = NEON_umaxv(CONCAT17(-((char)((ulong)lVar14 >> 0x38) == -1),
                                   CONCAT16(-(cVar20 == -1),
                                            CONCAT15(-(cVar19 == -1),
                                                  ...
                                                  char)lVar14 == -1)))))))),1);
      if ((bVar11 & 1) != 0) {
        uVar6 = (ulong)*(char *)((long)plVar1 + uStack_98);
        if (-1 < *(char *)((long)plVar1 + uStack_98)) {
          lVar13 = *plVar1;
          ...
          uStack_98 = (ulong)LZCOUNT(uVar6 >> 0x20 | uVar6 << 0x20) >> 3;
          uVar6 = (ulong)*(byte *)((long)plVar1 + uStack_98);
        }
        bVar3 = bVar3 >> 1;
        *(byte *)((long)plVar1 + uStack_98) = bVar3;
        *(byte *)((long)plVar1 + (uStack_98 - 8 & uVar2) + 8) = bVar3;
        param_1[3] = param_1[3] + 1;
        param_1[2] = param_1[2] - (uVar6 & 1);
        lVar13 = *param_2;
        plVar1[uStack_98 * -4 + -3] = param_2[1];
        plVar1[uStack_98 * -4 + -4] = lVar13;
        plVar1[uStack_98 * -4 + -2] = param_2[2];
        plVar1[uStack_98 * -4 + -1] = param_3;
        return 0;
      }
      bVar4 = true;
    }
      ...
      if (uVar12 != 0) {
        ...
        uStack_98 = uVar6 + ((ulong)LZCOUNT(uVar12 >> 0x20 | uVar12 << 0x20) >> 3) & uVar2;
        goto LAB_103b92628;
      }
      bVar4 = false;
    }
