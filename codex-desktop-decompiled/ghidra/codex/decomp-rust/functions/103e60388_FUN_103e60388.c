...
void FUN_103e60388(ulong *param_1)
...
LAB_103e604a8:
    ...
    if ((uVar7 >> 1 & 1) != 0) goto LAB_103e60490;
    if ((uVar7 >> 3 & 1) == 0) {
      auStack_2a8[0] = 2;
      FUN_103e57ff4(param_1 + 4,auStack_2a8);
LAB_103e60414:
      puStack_60 = param_1;
    ...
    if ((uVar7 >> 4 & 1) == 0) goto LAB_103e60414;
    if (param_1[0x4f] != 0) {
      (**(code **)(param_1[0x4f] + 0x10))(param_1[0x50]);
      LOAcquire();
      uVar2 = *param_1;
      *param_1 = uVar2 & 0xffffffffffffffef;
      ...
      if ((uVar7 >> 1 & 1) == 0) {
        ...
        if ((uVar7 >> 4 & 1) != 0) {
          if ((uVar7 >> 3 & 1) == 0) {
            if (param_1[0x4f] != 0) {
              (**(code **)(param_1[0x4f] + 0x18))(param_1[0x50]);
            }
            param_1[0x4f] = 0;
          }
          goto LAB_103e60414;
...
LAB_103e60528:
  ...
  pcVar1 = (code *)SoftwareBreakpoint(1,0x103e6052c);
  (*pcVar1)();
}
