...
/* WARNING: Removing unreachable block (ram,0x000101410d44) */
/* WARNING: Type propagation algorithm not settling */

void FUN_1014107e4(undefined1 *param_1,char *param_2)
...
LAB_101410c5c:
      ...
      if ((byte)uStack_e0 == 4) {
        if (plStack_118 != (long *)0x0) {
          if (plStack_118 == (long *)0x1) goto LAB_101410afc;
      ...
      if ((byte)uStack_e0 == 0xc) {
        if (lStack_108 == 6) {
          if ((int)*plStack_110 != 0x696c6e69 || *(short *)((long)plStack_110 + 4) != 0x656e)
          goto LAB_101410950;
          uStack_140 = (long *)((ulong)uStack_140._2_6_ << 0x10);
        }
        else if ((lStack_108 == 8) && (*plStack_110 == 0x6465686361746564)) {
          uStack_140 = (long *)CONCAT62(uStack_140._2_6_,0x100);
        }
        else {
LAB_101410950:
          plStack_138 = (long *)FUN_1087e4494(plStack_110,lStack_108,&UNK_10b231c18,2);
          uStack_140 = (long *)CONCAT71(uStack_140._1_7_,1);
        }
joined_r0x000101410b70:
        plVar10 = plVar7;
        if (plVar5 == (long *)0x0) goto LAB_101410c68;
        _free(plVar7);
        plVar10 = uStack_140;
        lVar9 = lStack_88;
        lStack_88 = lStack_68;
        goto joined_r0x000101410c70;
      }
LAB_101410d18:
      plStack_138 = (long *)FUN_108855b04(&uStack_e0,&uStack_51,&UNK_10b210b20);
      uStack_140 = (long *)CONCAT71(uStack_140._1_7_,1);
      lVar9 = lStack_88;
LAB_101410c74:
      lStack_88 = lVar9;
...
joined_r0x000101410d88:
      bVar4 = true;
    }
    else {
      if ((byte)uStack_e0 == 0xd) {
        if (plStack_110 == (long *)0x6) {
          if ((int)*plStack_118 == 0x696c6e69 && *(short *)((long)plStack_118 + 4) == 0x656e)
          goto LAB_101410c58;
        }
        else if ((plStack_110 == (long *)0x8) && (*plStack_118 == 0x6465686361746564))
        goto LAB_101410afc;
        plStack_138 = (long *)FUN_1087e4494(plStack_118,plStack_110,&UNK_10b231c18,2);
LAB_101410a68:
        uVar8 = 1;
        goto LAB_101410c5c;
      }
      if ((byte)uStack_e0 == 0xe) {
        func_0x000100ba9ddc(&uStack_140,plStack_110,lStack_108);
        goto joined_r0x000101410b70;
      }
      if ((byte)uStack_e0 != 0xf) goto LAB_101410d18;
      func_0x000100ba9ddc(&uStack_140,plStack_118,plStack_110);
LAB_101410c60:
...
LAB_101410c68:
      ...
      lVar9 = lStack_88;
      lStack_88 = lStack_68;
joined_r0x000101410c70:
      bVar4 = (char)uStack_140 == '\x01';
      uStack_140 = plVar10;
      lStack_68 = lStack_88;
      if (bVar4) goto LAB_101410c74;
...
LAB_101410a74:
      ...
      plStack_138 = plVar10;
      if (cVar2 == '\x16') goto LAB_101410a74;
...
LAB_10141089c:
      ...
      if ((byte)uStack_e0 == '\x16') goto LAB_10141089c;
      FUN_100e077ec(&uStack_e0);
