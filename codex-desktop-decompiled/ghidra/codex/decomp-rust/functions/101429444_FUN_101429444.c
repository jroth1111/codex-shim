...
/* WARNING: Removing unreachable block (ram,0x00010142998c) */
/* WARNING: Type propagation algorithm not settling */

void FUN_101429444(undefined1 *param_1,char *param_2)
...
LAB_1014298a4:
      ...
      if ((byte)uStack_e0 == 4) {
        if (plStack_118 != (long *)0x0) {
          if (plStack_118 == (long *)0x1) goto LAB_101429744;
      ...
      if ((byte)uStack_e0 == 0xc) {
        if (lStack_108 == 4) {
          if ((int)*plStack_110 != 0x68676968) goto LAB_1014295a4;
          uStack_140 = (long *)((ulong)uStack_140._2_6_ << 0x10);
        }
...
LAB_1014295a4:
          plStack_138 = (long *)FUN_1087e4494(plStack_110,lStack_108,&UNK_10b2225d8,2);
          uStack_140 = (long *)CONCAT71(uStack_140._1_7_,1);
        }
joined_r0x0001014297b8:
        plVar10 = plVar7;
        if (plVar5 == (long *)0x0) goto LAB_1014298b0;
        _free(plVar7);
        plVar10 = uStack_140;
        lVar9 = lStack_88;
        lStack_88 = lStack_68;
        goto joined_r0x0001014298b8;
      }
LAB_101429960:
      plStack_138 = (long *)FUN_108855b04(&uStack_e0,&uStack_51,&UNK_10b2100e0);
      uStack_140 = (long *)CONCAT71(uStack_140._1_7_,1);
      lVar9 = lStack_88;
LAB_1014298bc:
      lStack_88 = lVar9;
...
joined_r0x0001014299d0:
      bVar4 = true;
    }
    else {
      if ((byte)uStack_e0 == 0xd) {
        if (plStack_110 == (long *)0x4) {
          if ((int)*plStack_118 == 0x68676968) goto LAB_1014298a0;
        }
        else if ((plStack_110 == (long *)0x8) && (*plStack_118 == 0x6c616e696769726f))
        goto LAB_101429744;
        plStack_138 = (long *)FUN_1087e4494(plStack_118,plStack_110,&UNK_10b2225d8,2);
LAB_1014296b0:
        uVar8 = 1;
        goto LAB_1014298a4;
      }
      if ((byte)uStack_e0 == 0xe) {
        func_0x000100ac2adc(&uStack_140,plStack_110,lStack_108);
        goto joined_r0x0001014297b8;
      }
      if ((byte)uStack_e0 != 0xf) goto LAB_101429960;
      func_0x000100ac2adc(&uStack_140,plStack_118,plStack_110);
LAB_1014298a8:
...
LAB_1014298b0:
      ...
      lVar9 = lStack_88;
      lStack_88 = lStack_68;
joined_r0x0001014298b8:
      bVar4 = (char)uStack_140 == '\x01';
      uStack_140 = plVar10;
      lStack_68 = lStack_88;
      if (bVar4) goto LAB_1014298bc;
...
LAB_1014296bc:
      ...
      plStack_138 = plVar10;
      if (cVar2 == '\x16') goto LAB_1014296bc;
...
LAB_1014294fc:
      ...
      if ((byte)uStack_e0 == '\x16') goto LAB_1014294fc;
      FUN_100e077ec(&uStack_e0);
