...
void FUN_103e2f6cc(long *param_1,long param_2)
...
LAB_103e2f708:
  ...
  *(char **)(param_2 + 8) = pcVar2 + 0x20;
  if (cStack_a0 == '\x16') goto LAB_103e2f708;
...
LAB_103e2f74c:
    ...
    if (cStack_a0 == '\x11') {
      ...
      lStack_68 = plVar1[3];
      lStack_70 = plVar1[2];
      FUN_103d20208(&lStack_58,&lStack_80);
      ...
      if (cStack_a0 == '\x12') goto LAB_103e2f74c;
      FUN_103d20208(&lStack_80,&cStack_a0);
      unaff_x21 = lStack_78;
      unaff_x22 = lStack_70;
