...

{
  ...
  *(char **)(unaff_x29 + -0x80) = s__state_db_returned_rollout_path_f_108ac6b83;
  *(undefined1 **)(unaff_x29 + -0x78) = &stack0x00000570;
  ...
  if (((*unaff_x26 < 4) &&
    ...
    in_stack_00000220 = (int)&stack0x00000310;
    in_stack_00000228 = &UNK_10b208fd0;
    ...
    if ((*unaff_x25 == '\0') && (1 < ___ZN3log20MAX_LOG_LEVEL_FILTER17h2019f7c33388e688E)) {
      ...
      if (iVar13 != 0) {
        in_stack_00000220 = 0x8cad1e0;
        in_stack_00000228 = (undefined *)0xa9;
        __ZN7tracing15__macro_support13__tracing_log17h72768b16bee39960E
...
LAB_10076ad50:
  ...
  if (uVar15 < 0x180) {
    ...
    if (in_stack_00000220 == 1) {
      puVar27 = &UNK_10b4add80;
      goto LAB_10076a248;
    }
    iVar13 = _stat(in_stack_00000228,&stack0x00000310);
    if (iVar13 == -1) {
