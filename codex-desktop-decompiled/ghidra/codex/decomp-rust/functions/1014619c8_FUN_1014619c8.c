...
void FUN_1014619c8(long *param_1,byte *param_2)
...
LAB_101461b58:
        ...
        if (bVar1 != 4) {
          if (bVar1 == 0xc) {
            ...
            if (lVar3 != 7) goto LAB_101461ba8;
            goto LAB_101461a1c;
          }
LAB_101461cc4:
          FUN_108855bf0(&uStack_80,param_2,&uStack_21,&UNK_10b214928);
          goto LAB_101461ac8;
        }
        uVar4 = *(ulong *)(param_2 + 8);
        if (uVar4 != 0) {
          if (uVar4 != 1) goto LAB_101461b58;
          goto LAB_101461bc4;
        }
      }
LAB_101461b84:
      ...
      if (bVar1 == 0xd) {
        ...
        if (lVar3 == 7) {
LAB_101461a1c:
          if (*piVar6 == 0x696d696c && *(int *)((long)piVar6 + 3) == 0x64657469) goto LAB_101461b84;
        }
        else {
LAB_101461ba8:
          if ((lVar3 == 4) && (*piVar6 == 0x6c6c7566)) goto LAB_101461bc4;
        }
        ...
        if (bVar1 == 0xe) {
          ...
          if (bVar1 != 0xf) goto LAB_101461cc4;
          uVar5 = *(undefined8 *)(param_2 + 8);
          uVar2 = *(undefined8 *)(param_2 + 0x10);
        }
        FUN_100b20d24(&uStack_80,uVar5,uVar2);
      }
LAB_101461ac8:
      ...
      if ((uStack_78 & 1) == 0) goto LAB_101461b84;
LAB_101461bc4:
      if (((pbVar7 == (byte *)0x0) || (*pbVar7 == 0x12)) ||
         (FUN_108855bf0(&uStack_80,pbVar7,&uStack_21,&UNK_10b20a5c0),
         CONCAT71(uStack_7f,uStack_80) == 2)) {
