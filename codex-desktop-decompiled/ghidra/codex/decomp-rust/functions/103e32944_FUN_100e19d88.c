...
LAB_1060f6a78:
    ...
    if (lVar5 == 1) {
      if (*param_1 == 0x8000000000000000) {
        func_0x000105cb0f24(param_1 + 0xe);
        uVar9 = param_1[0xe];
        if (uVar9 != 0) {
        ...
        func_0x000100d6d9b4(param_1 + 1);
      }
      else {
        func_0x000104a92388(param_1);
      ...
      *plVar7 = lVar5 + -1;
      ...
      DataMemoryBarrier(2,1);
      uVar9 = param_1[0x13];
      func_0x000104ad8eb8(uVar9 + 0x10);
      if (uVar9 == 0xffffffffffffffff) {
        return;
      }
      lVar5 = *(long *)(uVar9 + 8);
  ...
  **(long **)(uVar9 + 0x40) = lVar5 + -1;
  ...
  if (*(long *)(uVar9 + 0x70) != 2) {
    ...
    func_0x000103d95cc0((long *)(uVar9 + 0x70));
  }
  if (uVar9 != 0xffffffffffffffff) {
    lVar5 = *(long *)(uVar9 + 8);
    *(long *)(uVar9 + 8) = lVar5 + -1;
