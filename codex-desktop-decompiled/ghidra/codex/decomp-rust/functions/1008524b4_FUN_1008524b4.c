...
void FUN_1008524b4(undefined8 param_1,undefined8 param_2)

{
  ...
  *(char **)(unaff_x29 + -0xe0) = s__MCP_server_cancelled_request__r_108ac4e98;
  *(undefined1 **)(unaff_x29 + -0xd8) = &stack0x00000350;
  ...
  *(undefined8 *)(unaff_x29 + -0x98) = param_1;
  ...
  if (in_stack_000003b8 != (long *)0x0) {
    lVar6 = *in_stack_000003b8;
    *in_stack_000003b8 = lVar6 + -1;
    LORelease();
    if (lVar6 == 1) {
      DataMemoryBarrier(2,1);
      __ZN5alloc4sync16Arc_LT_T_C_A_GT_9drop_slow17h2a633a52a46b1fedE(&stack0x000003b8);
    }
  }
  if ((in_stack_000003a0 != -0x8000000000000000) && (in_stack_000003a0 != 0)) {
    _free(in_stack_000003a8);
  }
  *(undefined1 *)(unaff_x19 + 0x318) = 1;
  FUN_100d82d84();
  func_0x000100dccb50(*(undefined8 *)(unaff_x20 + 0x250));
