...
void FUN_101618ffc(undefined8 *param_1,long *param_2)

{
  ...
  if (lVar3 == -0x8000000000000000) {
    if (lStack_80 == 9) {
      if (*plVar1 != 0x6f7463656e6e6f63 || (char)plVar1[1] != 'r') {
code_r0x0001087e44e4:
        puStack_78 = &UNK_10b2207d8;
        uStack_70 = 2;
      ...
      *(undefined1 *)(param_1 + 1) = 0;
      ...
      if ((lStack_80 != 6) || ((int)*plVar1 != 0x67756c70 || *(short *)((long)plVar1 + 4) != 0x6e69)
...
LAB_101619084:
    FUN_1087e44e4(param_1,plVar1,lStack_80,&UNK_10b2207d8,2);
  }
  else {
    if ((lStack_80 != 6) || ((int)*plVar1 != 0x67756c70 || *(short *)((long)plVar1 + 4) != 0x6e69))
    goto LAB_101619084;
