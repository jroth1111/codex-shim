...

{
  ...
  *(char **)(unaff_x29 + -0x70) = s__Failed_to_submit_initial_prompt_108accf3c;
  *(undefined1 **)(unaff_x29 + -0x68) = &stack0x00004ae0;
  *(long *)(unaff_x29 + -0x80) = unaff_x29 + -0x70;
  *(undefined **)(unaff_x29 + -0x78) = &UNK_10b208fd0;
  FUN_1009b8c0c(&stack0x00002580);
