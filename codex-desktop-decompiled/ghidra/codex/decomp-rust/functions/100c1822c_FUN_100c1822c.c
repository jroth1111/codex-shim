...
/* WARNING: Removing unreachable block (ram,0x000100c185ac) */
/* WARNING: Removing unreachable block (ram,0x000100c185c4) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_100c1822c(undefined8 param_1)

{
  ...
  uVar15 = 1;
  uVar16 = 0;
  __ZN12tracing_core5event5Event8dispatch17h50a390618bcffa4fE(*unaff_x23,&stack0x00000820);
  if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
    ...
    if (iVar6 != 0) {
      __ZN7tracing15__macro_support13__tracing_log17h72768b16bee39960E
                (uVar10,puVar3,puVar2,&stack0x000007f0,&stack0x00000820);
    }
  }
  ...
  if (bVar1 < 3) {
    if ((bVar1 != 0) && (bVar1 != 2)) goto LAB_100c18374;
LAB_100c184c0:
    ...
    func_0x000100c257d4(in_stack_000007c0 + 0xa0,&stack0x00000960,in_stack_000007c8,&stack0x00000690
    ...
    if (bVar1 == 3) {
      ...
      if (bVar1 != 4) goto LAB_100c18374;
      lVar8 = 0x51;
    }
    if (*(char *)(lVar7 + lVar8) != '\x01') goto LAB_100c184c0;
LAB_100c18374:
  ...
  FUN_100c2a794(&stack0x00000820,in_stack_000007c0,in_stack_000007c8,&stack0x00000690,unaff_x21 + 2,
                &stack0x000007f0);
LAB_100c18604:
  ...
  *(undefined8 *)(unaff_x25 + 0x24) = param_1;
  ...
  if (cVar5 == '\x03') {
    ...
    *(ulong *)((long)in_stack_00000038 + 0x1c) = CONCAT44((int)param_1,uVar16);
