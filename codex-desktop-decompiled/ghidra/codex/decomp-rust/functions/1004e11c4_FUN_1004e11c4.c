...

{
  ...
  *unaff_x19 = -0x7fffffffffffffff;
  ...
  if (plVar2 != (long *)0x0) {
    ...
    *plVar2 = lVar1 + -1;
    ...
    if (lVar1 == 1) {
      ...
      __ZN5alloc4sync16Arc_LT_T_C_A_GT_9drop_slow17h2a633a52a46b1fedE(unaff_x29 + -0x80);
    }
  }
  ...
  if (((unaff_w28 != 1) && ((in_stack_000000a0 & 1) != 0)) && (in_stack_000000a8 != (long *)0x0)) {
  ...
  if (*unaff_x19 != -0x7fffffffffffffff) {
    ...
    if (unaff_x22 - in_stack_00000010 == 0) {
      ...
      *unaff_x19 = in_stack_00000020;
      ...
      in_stack_000000b8 = unaff_x23 + 1;
      lVar1 = thunk_FUN_1087e422c(unaff_x23 + 1 + ((ulong)(unaff_x22 - in_stack_00000010) >> 6),
                                  &stack0x000000b8,&UNK_10b23a190);
      *unaff_x19 = -0x7fffffffffffffff;
      unaff_x19[1] = lVar1;
