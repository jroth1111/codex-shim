...
void FUN_103ea83a4(char *param_1)

{
  ...
  if (*param_1 == '\x01') {
    __ZN4core9panicking5panic17h30f5ec71e3af4326E(&UNK_108dc1167,0x28,&UNK_10b2fff80);
  }
  else {
    if (param_1[1] == '\0') {
      return;
    ...
    if (*unaff_x19 != unaff_x20) goto LAB_103ea847c;
  }
  FUN_10897c4d0(unaff_x19,unaff_x20,1,1,1);
  unaff_x20 = unaff_x19[2];
LAB_103ea847c:
  *(undefined1 *)(unaff_x19[1] + unaff_x20) = 0x5d;
