...
void FUN_105dc3cf8(long *param_1,long *param_2)

{
  ...
  uStack_c0 = 0;
  uStack_88 = 0x80;
  func_0x000105dc9e60(param_1,&lStack_d0);
    ...
    if (uStack_a8 < uStack_b0) {
      do {
        if (0x20 < *(byte *)(lStack_b8 + uStack_a8) ||
          ...
          auStack_38[0] = 0x16;
          lVar1 = func_0x000108a492a4(&lStack_d0,auStack_38);
          *param_1 = -0x7ffffffffffffffb;
          param_1[1] = lVar1;
          FUN_105dc6c20(&lStack_80);
          break;
        }
