...
void FUN_10140a0b8(undefined8 *param_1,char *param_2)
...
LAB_10140a320:
                if (ppppuVar7 != (undefined8 ****)0x8000000000000001) {
                  ppppuStack_140 = (undefined ****)&UNK_108cba47a;
                  lStack_138 = 6;
...
LAB_10140a520:
                ...
                if (bVar2 != 0x10) {
                  if (bVar2 == 0x11) {
                    ...
                    if (bVar2 == 0x12) goto LAB_10140a1c4;
                  ...
                  if ((ppppuVar7 == (undefined8 ****)0x8000000000000000) ||
                     ...
                     ppppuVar7 == (undefined8 ****)0x8000000000000001)) goto LAB_10140a4a8;
                }
LAB_10140a1c4:
              ...
              if (*(long *)(lVar8 + lVar9 + 8) == 0) goto LAB_10140a320;
            }
            else {
              if (bVar2 != 0xc) {
LAB_10140a4f8:
                ppppuStack_190 = ppppuVar7;
                unaff_x20 = (undefined *)FUN_108855c40(lVar8 + lVar9,&ppppuStack_b8,&UNK_10b20ebe0);
                if (ppppuVar7 != (undefined8 ****)0x8000000000000001) goto LAB_10140a520;
                goto LAB_10140a4a8;
              }
              if ((*(long *)(lVar8 + lVar9 + 0x18) == 6) &&
                 (piVar5 = *(int **)(lVar8 + lVar9 + 0x10),
                 *piVar5 == 0x61657263 && (short)piVar5[1] == 0x6574)) goto LAB_10140a320;
            }
          }
          else if (bVar2 == 0xd) {
            if ((*(long *)(lVar8 + lVar9 + 0x10) == 6) &&
               (piVar5 = *(int **)(lVar8 + lVar9 + 8),
               *piVar5 == 0x61657263 && (short)piVar5[1] == 0x6574)) goto LAB_10140a320;
          }
          else if (bVar2 == 0xe) {
            if (*(long *)(lVar8 + lVar9 + 0x18) == 6) {
              ...
              cVar3 = *pcVar6;
joined_r0x00010140a2a4:
              if (((((cVar3 == 'c') && (pcVar6[1] == 'r')) && (pcVar6[2] == 'e')) &&
                  ((pcVar6[3] == 'a' && (pcVar6[4] == 't')))) && (pcVar6[5] == 'e'))
              goto LAB_10140a320;
            }
          }
          else {
            if (bVar2 != 0xf) goto LAB_10140a4f8;
            if (*(long *)(lVar8 + lVar9 + 0x10) == 6) {
              pcVar6 = *(char **)(lVar8 + lVar9 + 8);
              cVar3 = *pcVar6;
              goto joined_r0x00010140a2a4;
            }
          }
          lVar9 = lVar9 + 0x40;
    ...
    unaff_x20 = (undefined *)FUN_108855c40(param_2,&ppppuStack_b8,&UNK_10b20b380);
    goto LAB_10140a4a8;
  }
  lVar8 = *(long *)(param_2 + 0x18);
  if (lVar8 == 0) {
    unaff_x20 = (undefined *)FUN_1087e422c(0,&UNK_10b22e778,&UNK_10b20a590);
    goto LAB_10140a4a8;
  }
  ...
  if (cVar3 != '\x10') {
    if (cVar3 == '\x11') {
      ...
      if (cVar3 == '\x12') goto LAB_10140a430;
      FUN_1004de164(&ppppuStack_b8);
      ppppuVar7 = ppppuStack_b8;
      unaff_x20 = puStack_b0;
      ppppuStack_190 = (undefined8 ****)ppppuStack_a8;
