...
void FUN_105dc42c8(undefined8 *param_1,long param_2,int param_3,ulong param_4,int param_5)
...
LAB_105dc431c:
  if (uVar2 <= uVar11) {
    uStack_38 = 5;
LAB_105dc44dc:
    uVar9 = FUN_108a499a0(param_2,&uStack_38);
    *param_1 = 1;
    param_1[1] = uVar9;
    return;
  }
  ...
  *(ulong *)(param_2 + 0x28) = uVar11;
      ...
      *(ulong *)(param_2 + 0x28) = uVar11;
      if ((0xccccccb < (int)uVar10) && ((uVar10 != 0xccccccc || (7 < (uVar6 & 0xff))))) {
        if ((param_4 != 0) && (bVar7)) {
          uStack_28 = 0xe;
          puStack_30 = param_1;
          uVar9 = FUN_108a499a0(param_2,&uStack_28);
          puStack_30[1] = uVar9;
          uVar9 = 1;
          param_1 = puStack_30;
          goto LAB_108a49970;
        ...
        if (*(ulong *)(param_2 + 0x20) <= uVar11) goto LAB_108a49954;
        goto LAB_108a49934;
      }
  ...
  while (0x134 < uVar10) {
    if (dVar12 == 0.0) goto LAB_105dc44b0;
    if (-1 < (int)uVar6) goto LAB_105dc447c;
    uVar1 = uVar6 + 0x134;
    uVar10 = uVar1;
    if ((int)uVar1 < 0) {
      uVar10 = -uVar6 - 0x134;
