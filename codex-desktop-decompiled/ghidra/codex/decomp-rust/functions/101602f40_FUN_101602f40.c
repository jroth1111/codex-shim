...
void FUN_101602f40(undefined8 *param_1,ulong *param_2)

{
  ...
  if ((long)uVar5 < 2) {
    if (uVar5 == 0) {
      ...
      if ((auVar8._0_8_ & 1) == 0) {
        ...
        if ((auVar8._0_8_ & 1) == 0) {
          ...
          if ((auStack_e0[0] & 1) == 0) {
            ...
            func_0x00010880a030(&uStack_160,uStack_b0,uStack_a8);
          }
          else {
            func_0x0001087fa470(&uStack_160,uStack_d0,uStack_c8);
          }
        }
        else {
          uStack_a0 = CONCAT71(uStack_a0._1_7_,1);
          uStack_98 = auVar8._8_8_;
          FUN_1087e3db0(&uStack_160,&uStack_a0,auStack_e0,&UNK_10b20a620);
        }
      }
      else {
      ...
      uVar5 = uStack_160;
      if ((uStack_100 & 0x7fffffffffffffff) == 0) goto joined_r0x0001016032b8;
      _free(uStack_f8);
      uStack_a0 = uStack_160;
      if (uStack_160 != 2) goto LAB_1016032bc;
    }
LAB_10160326c:
    ...
    if ((bool)uVar4 || cVar3 != cVar2) {
      ...
      *puStack_140 = 0x676e6974616f6c66;
      ...
      if ((long)uVar5 < 5) {
        ...
        uStack_98 = uStack_a0;
        func_0x00010882f65c(&uStack_160,&uStack_a0);
        uVar5 = uStack_160;
      }
      else {
        uStack_78 = param_2[5];
        ...
        uStack_50 = uVar6;
        uStack_48 = uVar7;
        func_0x000108872ecc(&uStack_160,&uStack_a0);
        uVar5 = uStack_160;
      }
joined_r0x0001016032b8:
      uStack_a0 = uVar5;
      if (uStack_a0 == 2) goto LAB_10160326c;
    }
LAB_1016032bc:
