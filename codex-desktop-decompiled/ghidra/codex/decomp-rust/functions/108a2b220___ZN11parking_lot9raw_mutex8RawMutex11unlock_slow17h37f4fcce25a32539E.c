...
ulong * __ZN11parking_lot9raw_mutex8RawMutex11unlock_slow17h37f4fcce25a32539E
...

{
  ...
  uVar23 = (long)param_1 * -0x61c8864680b583eb;
  do {
    if (___ZN16parking_lot_core11parking_lot9HASHTABLE17h738ba5664d7e2164E == (long *)0x0) {
      ...
      puVar9 = (ulong *)(uVar23 >> ((ulong)(uint)-(int)plVar11[3] & 0x3f));
    ...
    if (___ZN16parking_lot_core11parking_lot9HASHTABLE17h738ba5664d7e2164E == plVar11) {
      ...
      if (*(undefined4 **)(uVar8 + 0x78) != param_1) goto LAB_108a2a480;
      uVar16 = 0;
  ...
  while (*(undefined4 **)(uVar8 + 0x78) != param_1) {
LAB_108a2a480:
    uVar16 = uVar8;
...
LAB_108a2a4cc:
    iVar14 = (int)uVar23;
    if (auVar26._8_4_ <= (uint)puVar13[4]) goto LAB_108a2a4d8;
LAB_108a2a540:
    uVar16 = auVar26._0_8_;
    iVar14 = (int)uVar23;
    ...
    *(uint *)(puVar13 + 5) = uVar15;
    uVar15 = uVar15 % 1000000 + auVar26._8_4_;
    if (999999999 < uVar15) {
...
LAB_108a2a63c:
        iVar14 = 0xb3df510;
        auVar25 = func_0x000108a07bdc();
        uStack_220 = auVar25._8_8_;
        pbVar10 = auVar25._0_8_;
        ...
        unaff_x20 = (undefined4 *)&__ZN16parking_lot_core11parking_lot9HASHTABLE17h738ba5664d7e2164E
        ;
...
LAB_108a2a460:
    if (uVar21 != 0) {
      do {
        bVar7 = *(undefined4 **)(uVar21 + 0x78) == param_1;
        uVar23 = (ulong)bVar7;
        if (bVar7) break;
...
LAB_108a2a4d8:
    if ((param_2 & 1) != 0) goto LAB_108a2a5a0;
    uVar17 = 0;
    if (iVar14 == 0) {
      *param_1 = 0;
    }
...
__ZN16parking_lot_core9word_lock8WordLock11unlock_slow17hf23effa208de0cd0E:
  ...
  *puVar13 = uVar16 | 2;
  do {
    ...
    uVar23 = uVar21;
    while (uVar8 == 0) {
      uVar22 = *(ulong *)(uVar23 + 0x88);
      *(ulong *)(uVar22 + 0x80) = uVar23;
      uVar23 = uVar22;
    ...
    if ((uVar16 & 1) == 0) {
      ...
      if (*(long *)(uVar8 + 0x80) != 0) {
        *(long *)(uVar21 + 0x78) = *(long *)(uVar8 + 0x80);
        uVar23 = *puVar13;
        *puVar13 = uVar23 & 0xfffffffffffffffd;
        LORelease();
LAB_108a2b2e4:
        _pthread_mutex_lock(uVar23,uVar8);
        *(undefined1 *)(uVar8 + 0x70) = 0;
        _pthread_cond_signal(uVar8 + 0x40);
      ...
      uVar23 = uVar16 & 0xfffffffffffffffd;
...
LAB_108a2a718:
  ...
  *(undefined1 *)(puVar12 + 0xe) = 1;
  ...
  if (puVar13[1] == 0) {
    ...
    *puVar13 = uVar23 - 1;
    LORelease();
    if (3 < uVar23 && (uVar23 & 2) == 0) goto LAB_108a2a8cc;
  }
  else {
...
LAB_108a2a8cc:
  ...
  if (iStack_214 == 1000000000) {
    ...
    uVar23 = FUN_1059dd990(puVar12,uStack_220);
    if ((uVar23 & 1) == 0) {
      do {
        plVar11 = ___ZN16parking_lot_core11parking_lot9HASHTABLE17h738ba5664d7e2164E;
        if (___ZN16parking_lot_core11parking_lot9HASHTABLE17h738ba5664d7e2164E == (long *)0x0) {
        ...
        uVar23 = puVar12[0xf];
        uVar8 = uVar23 * -0x61c8864680b583eb >> ((ulong)(uint)-(int)plVar11[3] & 0x3f);
        uVar16 = plVar11[1];
        if (uVar16 <= uVar8) {
...
LAB_108a2abac:
        ...
        if ((___ZN16parking_lot_core11parking_lot9HASHTABLE17h738ba5664d7e2164E == plVar11) &&
           (puVar12[0xf] == uVar23)) goto LAB_108a2a994;
        uVar23 = *puVar13;
        *puVar13 = uVar23 - 1;
        LORelease();
        if (3 < uVar23 && (uVar23 & 2) == 0) {
...
LAB_108a2aac4:
        *pbVar10 = *pbVar10 & 0xfd;
        ...
        do {
          ...
          bVar7 = (bool)(puVar20[0xf] != uVar23 & bVar7);
...
joined_r0x000108a2aaa0:
          for (; uVar8 != 0; uVar8 = *(ulong *)(uVar8 + 0x80)) {
            if (*(ulong *)(uVar8 + 0x78) == uVar23) goto LAB_108a2aacc;
          }
          if (bVar7) goto LAB_108a2aac4;
        }
      }
