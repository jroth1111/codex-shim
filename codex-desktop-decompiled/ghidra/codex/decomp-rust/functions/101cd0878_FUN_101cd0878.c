...
/* WARNING: Removing unreachable block (ram,0x000101cd1b1c) */
/* WARNING: Removing unreachable block (ram,0x000101cd1ad8) */
/* WARNING: Removing unreachable block (ram,0x000101cd1b24) */
/* WARNING: Type propagation algorithm not settling */

void FUN_101cd0878(void)

{
  ...
  uVar1 = FUN_1088dc508(s_missing_field_____108ac28f7,&stack0x00000520);
  *unaff_x22 = unaff_x26;
  unaff_x22[1] = uVar1;
  ...
  if (in_stack_00000460 != unaff_x24 + 8) {
    lVar2 = unaff_x24 + in_stack_00000460 + -0xb;
