...
void FUN_10123d3a8(undefined8 *param_1,byte *param_2)
...
LAB_10123d72c:
      pbStack_e8 = pbVar13;
      pbVar8 = (byte *)FUN_1087e422c(0,&UNK_10b232178,&UNK_10b20a590);
    }
    else {
      pbVar13 = unaff_x21 + 0x20;
      if (*unaff_x21 == 0x16) goto LAB_10123d72c;
      ...
      if (puStack_a0 != (undefined *)0x8000000000000000) {
        *param_1 = puStack_a0;
        ...
        if (lVar11 == 0) goto LAB_10123d894;
        *param_1 = 0x8000000000000000;
        param_1[1] = lVar11;
        unaff_x21 = pbVar8;
        puVar12 = puVar5;
        goto joined_r0x00010123d7e4;
      }
    }
    *param_1 = 0x8000000000000000;
    param_1[1] = pbVar8;
...
joined_r0x00010123d7e4:
    ...
    if (bVar2 != 0x15) {
      uVar10 = FUN_108855b04(param_2,&puStack_a0,&UNK_10b20c580);
      *param_1 = 0x8000000000000000;
      param_1[1] = uVar10;
      return;
    }
...
LAB_10123d61c:
          ...
          if (bVar1 != 0xc) goto LAB_10123d99c;
          if (lStack_70 == 8) {
            lVar18 = *plVar4;
            if (plVar3 != (long *)0x0) {
              _free();
            }
            if (lVar18 != 0x6449646165726874) goto LAB_10123d634;
            goto LAB_10123d698;
          }
          if (plVar3 != (long *)0x0) {
            _free();
...
LAB_10123d998:
            ...
            pcVar6 = (code *)SoftwareBreakpoint(1,0x10123d99c);
            (*pcVar6)();
          }
          uVar10 = *puVar15;
          puVar14[1] = puVar15[1];
...
LAB_10123d99c:
            lStack_b0 = lVar16 + 1;
            pbStack_c8 = pbVar17;
            uVar10 = FUN_108855b04(&bStack_88,&puStack_a0,&UNK_10b2111a0);
            *param_1 = 0x8000000000000000;
            param_1[1] = uVar10;
            puVar12 = (undefined *)((ulong)puVar12 & 0x7fffffffffffffff);
joined_r0x00010123d9d4:
            if (puVar12 != (undefined *)0x0) {
              _free(unaff_x21);
            }
            goto LAB_10123d854;
...
LAB_10123d628:
          FUN_100e077ec(&bStack_88);
joined_r0x00010123d674:
          if (bVar7) goto LAB_10123d634;
LAB_10123d698:
      ...
      if (puVar12 != (undefined *)0x8000000000000000) {
        *param_1 = puVar12;
        ...
        if (pbVar9 == pbVar8) goto LAB_10123d894;
