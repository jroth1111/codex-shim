...
void FUN_1002913f0(undefined8 param_1)

{
  ...
  __ZN12tracing_core5event5Event8dispatch17h50a390618bcffa4fE(param_1,&stack0x00000820);
  if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
    ...
    iVar3 = (**(code **)(puVar1 + 0x18))(puVar2,&stack0x00000400);
    if (iVar3 != 0) {
      __ZN7tracing15__macro_support13__tracing_log17h72768b16bee39960E
                (uVar5,puVar2,puVar1,&stack0x00000400,&stack0x00000820);
    }
  }
