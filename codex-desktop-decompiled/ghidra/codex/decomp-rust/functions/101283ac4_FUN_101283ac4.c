...
void FUN_101283ac4(undefined1 *param_1,char *param_2)
...
LAB_101283e68:
        ...
        if (uStack_e0._1_1_ != 3) goto LAB_101283fd0;
LAB_101283e54:
        uVar11 = 3;
      }
      uVar8 = 0;
...
LAB_101283e74:
    ...
    if ((byte)uStack_e0 == 4) {
      if (lStack_118 < 2) {
        if (lStack_118 == 0) goto LAB_101283e60;
        if (lStack_118 == 1) goto LAB_101283d44;
      }
      else {
        if (lStack_118 == 2) goto LAB_101283e68;
        if (lStack_118 == 3) goto LAB_101283e54;
      }
...
LAB_101283ff4:
    ...
    if ((byte)uStack_e0 == 0xc) {
      func_0x000100b62100(&uStack_140,uStack_110,lStack_108);
      goto LAB_101283c70;
    }
LAB_101283f84:
    pcStack_138 = (char *)FUN_108855b04(&uStack_e0,&uStack_51,&UNK_10b20d2c0);
...
LAB_101283e8c:
    ...
    if ((byte)uStack_e0 == 0xd) {
      func_0x000100b62100(&uStack_140,lStack_118,uStack_110);
LAB_101283e78:
      FUN_100e077ec(&uStack_e0);
LAB_101283e80:
      pcVar9 = uStack_140;
      ...
      if ((byte)uStack_e0 != 0xe) {
        if ((byte)uStack_e0 != 0xf) goto LAB_101283f84;
        func_0x000100b61edc(&uStack_140,lStack_118,uStack_110);
        goto LAB_101283e78;
      }
      func_0x000100b61edc(&uStack_140,uStack_110,lStack_108);
LAB_101283c70:
      if (lVar10 == 0) goto LAB_101283e80;
      _free(uVar7);
      pcVar9 = uStack_140;
      lVar10 = lStack_88;
      lStack_88 = lStack_68;
...
LAB_101283de4:
        ...
        if ((uVar1 == 0x12) || ((uVar1 == 0x15 && (lStack_88 == 0)))) goto LAB_101283de4;
        pcVar9 = (char *)FUN_108855b04(&cStack_a0,&uStack_51,&UNK_10b20a5c0);
        goto LAB_101283ea4;
      }
LAB_101283dec:
    ...
    if (uStack_140._1_1_ == 0) {
      if (uVar1 == 0x16) goto LAB_101283dec;
      if ((uVar1 == 0x12) || ((uVar1 == 0x15 && (lStack_88 == 0)))) goto LAB_101283de4;
      pcVar9 = (char *)FUN_108855b04(&cStack_a0,&uStack_51,&UNK_10b20a5c0);
    }
    else {
