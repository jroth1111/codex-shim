...

{
  ...
  lVar4 = thunk_FUN_108856088(s_missing_field_____108ac28f7,unaff_x29 + -0xc0);
  *in_stack_00000100 = -0x8000000000000000;
  ...
  if ((unaff_x22 != -0x7ffffffffffffffd) && (-0x7ffffffffffffffe < unaff_x22)) {
