...

{
  ...
  __ZN5alloc3fmt6format12format_inner17h63985d1d6aa0fe33E
            (&stack0x00000718,s__invalid_result__expected_Assume_108ab843c,&stack0x00000880);
  ...
  if (in_stack_000006c0 != 0) {
    puVar2 = (undefined8 *)(in_stack_000006b8 + 8);
    do {
      if ((puVar2[-1] & 0x7fffffffffffffff) != 0) {
        _free(*puVar2);
      }
      puVar2 = puVar2 + 7;
      in_stack_000006c0 = in_stack_000006c0 + -1;
    } while (in_stack_000006c0 != 0);
  }
  if (in_stack_000006b0 != 0) {
    _free(in_stack_000006b8);
  }
  __ZN79__LT_aws_smithy_xml__decode__ScopedDecoder_u20_as_u20_core__ops__drop__Drop_GT_4drop17h2b111c3882e0d66eE
            (&stack0x000005d0);
