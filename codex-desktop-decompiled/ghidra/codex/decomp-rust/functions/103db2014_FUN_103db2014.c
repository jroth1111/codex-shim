...
void FUN_103db2014(long param_1)

{
  ...
  **(long **)(param_1 + 0x20) = lVar1 + -1;
  ...
  if (*(int *)(param_1 + 0x30) == 1) {
    ...
    func_0x000103daad40(param_1 + 0x38);
  }
LAB_103db20c0:
  if (*(long *)(param_1 + 0x2b8) != 0) {
    (**(code **)(*(long *)(param_1 + 0x2b8) + 0x18))(*(undefined8 *)(param_1 + 0x2c0));
  }
  ...
  if (plVar3 != (long *)0x0) {
    ...
    *plVar3 = lVar1 + -1;
    ...
    if (lVar1 == 1) {
      ...
      puVar4 = *(undefined8 **)(param_1 + 0x2d0);
      uVar5 = puVar4[2];
      if ((code *)*puVar4 != (code *)0x0) {
