...
ulong FUN_1039cf2e0(ulong param_1,ulong param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  uStack_40 = param_1;
  uStack_38 = param_2;
  func_0x0001039d40ec(&uStack_60,param_3,param_4);
  uStack_11 = 0xff;
  func_0x0001039d40ec(&uStack_60,&uStack_11,1);
