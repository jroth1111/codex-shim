...

{
  ...
  undefined8 in_stack_00002f30;
  undefined8 in_stack_00002f38;
  undefined8 in_stack_00002f40;
  
  FUN_100f3f484(&stack0x00002f30,s_failed_to_read_thread_after_roll_108acc522,&stack0x00000af0);
  unaff_x22[1] = in_stack_00002f38;
  *unaff_x22 = in_stack_00002f30;
  unaff_x22[2] = in_stack_00002f40;
  *(undefined8 *)(unaff_x20 + 0x19c0) = 0x8000000000000005;
  *(undefined8 *)(unaff_x20 + 0x1a08) = 0xffffffffffff80a5;
  *(undefined8 *)(unaff_x20 + 0x1a10) = unaff_x24;
  *(undefined8 *)(unaff_x20 + 0x1a18) = unaff_x23;
  *(undefined8 *)(unaff_x20 + 0x1a20) = unaff_x21;
  *(undefined8 *)(unaff_x20 + 0x1a28) = unaff_x19;
  *(long *)(unaff_x20 + 0x1a30) = unaff_x20 + 0x290;
  *in_stack_00000058 = 0;
  iVar2 = func_0x000100899140(unaff_x20 + 0x19a8);
  if (iVar2 == 0) {
    FUN_100d8fbc8(unaff_x20 + 0x19a8);
    FUN_100e19e94(unaff_x20 + 0x2480);
    *(undefined1 *)(unaff_x25 + 0x9ed) = 0;
    if (*(long *)(unaff_x20 + 0x15a8) != 0) {
      _free(*(undefined8 *)(unaff_x20 + 0x15b0));
    }
