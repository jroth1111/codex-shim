...
void FUN_1012e09c8(undefined8 *param_1,char *param_2)

{
  ...
  if (*param_2 != '\x15') {
    uVar15 = FUN_108855c40(param_2,&ppppppiStack_98,&UNK_10b213428);
    ...
    if ((byte)uStack_2f0 == '\x16') {
      ...
      if (cVar3 != '\x10') {
        if (cVar3 == '\x11') {
          ...
          if (cVar3 == '\x12') goto LAB_1012e0bc4;
...
LAB_1012e1544:
        ...
        pcVar7 = (code *)SoftwareBreakpoint(1,0x1012e1548);
        (*pcVar7)();
      }
      ...
      if (bVar6 < 0xd) {
        ...
        if (bVar6 == 0xc) {
          if (piStack_2d8 == (int *)0x6) {
            ...
            if (piStack_2d8 != (int *)0x5) goto LAB_1012e0f18;
            iVar10 = 2;
          ...
          goto joined_r0x0001012e0f10;
        }
LAB_1012e164c:
        piStack_d8 = piStack_330;
        pppppppiStack_e0 = pppppppiVar17;
        piVar9 = (int *)FUN_108855b04(&uStack_2f0,&ppppppiStack_98,&UNK_10b2126e0);
LAB_1012e1488:
...
LAB_1012e14b0:
        ...
        if (bVar6 == 0xd) {
          if (pppppppiStack_2e0 == (int *******)0x6) {
            ...
            if (pppppppiStack_2e0 != (int *******)0x5) goto LAB_1012e0fac;
            iVar10 = 2;
          ...
          if (piStack_2d8 == (int *)0x6) {
            if (((*(char *)pppppppiStack_2e0 != 't') ||
               ...
               (((*(char *)((long)pppppppiStack_2e0 + 2) != 's' ||
                ...
                (*(char *)((long)pppppppiStack_2e0 + 5) != 'd')))) goto LAB_1012e0f18;
            iVar10 = 1;
          }
...
LAB_1012e10ec:
        ...
        pppppppiStack_e0 = pppppppiVar17;
        piVar9 = (int *)FUN_108856088(s_duplicate_field_____108ac2973,&uStack_2f0);
        if (ppppppiVar18 == (int ******)0x0) goto LAB_1012e1204;
      }
      _free(piStack_338);
      uVar15 = 1;
...
LAB_1012e1170:
    ...
    pppppppiVar17 = (int *******)0x8000000000000001;
    uVar15 = 1;
    if (ppppppiVar18 == (int ******)0x8000000000000000) goto LAB_1012e118c;
LAB_1012e1138:
    ...
    piStack_158 = piStack_2d8;
    pppppppiStack_160 = pppppppiStack_2e0;
    if ((char)pppppppiStack_120 == '\x16') goto LAB_1012e1350;
LAB_1012e1278:
    FUN_100e077ec(&pppppppiStack_120);
    piVar9 = piStack_338;
    if (ppppppiVar18 != (int ******)0x8000000000000000) {
LAB_1012e1350:
    ...
    if (ppppppiVar18 != (int ******)0x8000000000000000) goto LAB_1012e1138;
LAB_1012e118c:
