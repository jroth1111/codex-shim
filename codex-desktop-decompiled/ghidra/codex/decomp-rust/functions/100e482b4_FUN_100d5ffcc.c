...
/* WARNING: Possible PIC construction at 0x000100d60024: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x000100d60028) */

void FUN_100d5ffcc(long *param_1)

{
  ...
  *(undefined8 *)((long)register0x00000008 + -8) = unaff_x30;
  if (*plVar4 == 6) {
    ...
    do {
      uVar5 = uVar7;
      if (((uint)uVar5 >> 2 & 1) != 0) goto LAB_100e482fc;
      uVar7 = plVar6[10];
    } while (uVar7 != uVar5);
    plVar6[10] = uVar5 | 2;
LAB_100e482fc:
    ...
    do {
      uVar5 = uVar7;
      if (((uint)uVar5 >> 2 & 1) != 0) goto LAB_100e4836c;
      uVar7 = plVar6[10];
    } while (uVar7 != uVar5);
    plVar6[10] = uVar5 | 2;
LAB_100e4836c:
