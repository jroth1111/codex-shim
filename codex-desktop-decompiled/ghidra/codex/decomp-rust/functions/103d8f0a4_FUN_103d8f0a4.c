...
void FUN_103d8f0a4(long param_1)
...
joined_r0x000103d8f18c:
  ...
  if (iVar1 == 1) {
    ...
    func_0x000103dbc954(param_1 + 0x18);
  }
  _memcpy(param_1 + 0x10,auStack_b40,0xaf8);
  if (*(char *)(lVar2 + 0x48) != '\x01') {
    if (*(char *)(lVar2 + 0x48) == '\x02') {
      return;
    }
