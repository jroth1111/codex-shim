...
void FUN_101383024(ulong *param_1,char *param_2)
  ...
  if (*param_2 == '\x14') {
    ...
    if (uVar11 == 0) {
      ...
      if (uStack_108 == 0) {
        ...
        pcVar7 = (code *)SoftwareBreakpoint(1,0x101383310);
        (*pcVar7)();
      }
      uStack_100 = 0;
      cVar3 = *pcVar2;
...
LAB_1013830fc:
        ...
        *(undefined8 *)((long)puVar15 + 0xf) = uVar16;
        acStack_88[0] = cVar3;
        func_0x000100bd47e8(acStack_c0,acStack_88);
        uVar5 = uStack_100;
        uVar4 = uStack_108;
        if (acStack_c0[0] == '\x05') {
          lStack_118 = lVar13 + 1;
        ...
        *(undefined4 *)((long)((ulong)&cStack_f8 | 1) + 3) =
        ...
        if (uStack_100 == uStack_110) {
          func_0x0001088db290(&uStack_110);
        }
        ...
        *puVar12 = CONCAT71(uStack_f7,cStack_f8);
        ...
        pcVar8 = pcVar1;
        lVar6 = uVar14 + 1;
        if (uVar11 != 0) goto code_r0x0001013831a4;
        goto LAB_101383234;
      }
      pcVar8 = pcVar2 + 0x20;
      lVar6 = 0;
...
LAB_101383254:
    ...
    uVar14 = FUN_108855b04(param_2,acStack_c0,&UNK_10b20a140);
    *param_1 = 0x8000000000000000;
    param_1[1] = uVar14;
  }
  return;
code_r0x0001013831a4:
  pcVar8 = pcVar9 + 0x20;
  cVar3 = *pcVar9;
  uVar11 = uVar11 - 0x20;
  lVar13 = lVar13 + 1;
  pcVar9 = pcVar8;
  lVar6 = lVar13;
  if (cVar3 == '\x16') goto LAB_101383234;
  goto LAB_1013830fc;
}
