...
void FUN_103db1994(long param_1)

{
  ...
  **(long **)(param_1 + 0x20) = lVar1 + -1;
  ...
  if (*(int *)(param_1 + 0x30) == 1) {
    ...
    func_0x000103daa834(param_1 + 0x38);
  }
  if (*(long *)(param_1 + 0x15a8) != 0) {
    (**(code **)(*(long *)(param_1 + 0x15a8) + 0x18))(*(undefined8 *)(param_1 + 0x15b0));
  }
  plVar4 = *(long **)(param_1 + 0x15b8);
  if (plVar4 != (long *)0x0) {
    lVar1 = *plVar4;
    *plVar4 = lVar1 + -1;
    LORelease();
    if (lVar1 == 1) {
      DataMemoryBarrier(2,1);
      lVar1 = *(long *)(param_1 + 0x15b8);
      puVar5 = *(undefined8 **)(param_1 + 0x15c0);
      uVar6 = puVar5[2];
