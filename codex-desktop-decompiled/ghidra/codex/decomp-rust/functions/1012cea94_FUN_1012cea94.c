...
void FUN_1012cea94(undefined8 *param_1,byte *param_2)
...
LAB_1012cee18:
      pbStack_e8 = pbVar13;
      pbVar8 = (byte *)FUN_1087e422c(0,&UNK_10b232230,&UNK_10b20a590);
    }
    else {
      pbVar13 = unaff_x21 + 0x20;
      if (*unaff_x21 == 0x16) goto LAB_1012cee18;
      ...
      if (puStack_a0 != (undefined *)0x8000000000000000) {
        *param_1 = puStack_a0;
        ...
        if (lVar11 == 0) goto LAB_1012cef80;
...
joined_r0x0001012ceed0:
    ...
    if (bVar2 != 0x15) {
      uVar10 = FUN_108855b04(param_2,&puStack_a0,&UNK_10b20bfe0);
      *param_1 = 0x8000000000000000;
      param_1[1] = uVar10;
      return;
    }
...
LAB_1012ced08:
          ...
          if (bVar1 != 0xc) goto LAB_1012cf088;
          if (lStack_70 == 8) {
            lVar18 = *plVar4;
            if (plVar3 != (long *)0x0) {
              _free();
            }
            if (lVar18 != 0x6449646165726874) goto LAB_1012ced20;
            goto LAB_1012ced84;
          }
          if (plVar3 != (long *)0x0) {
            _free();
...
LAB_1012cf084:
            ...
            pcVar6 = (code *)SoftwareBreakpoint(1,0x1012cf088);
            (*pcVar6)();
          }
          uVar10 = *puVar15;
          puVar14[1] = puVar15[1];
...
LAB_1012cf088:
            lStack_b0 = lVar16 + 1;
            pbStack_c8 = pbVar17;
            uVar10 = FUN_108855b04(&bStack_88,&puStack_a0,&UNK_10b211ee0);
            *param_1 = 0x8000000000000000;
            param_1[1] = uVar10;
...
LAB_1012ced84:
      ...
      if (puVar12 != (undefined *)0x8000000000000000) {
        *param_1 = puVar12;
        ...
        if (pbVar9 == pbVar8) goto LAB_1012cef80;
