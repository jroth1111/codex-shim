...
/* WARNING: Removing unreachable block (ram,0x000100919658) */
...

{
  ...
  plVar3 = (long *)FUN_108856088(s_missing_field_____108ac28f7,&stack0x00000670);
  if (unaff_x25 != 0) {
    _free();
  }
  ...
  if (in_stack_000000e0 != -0x7ffffffffffffffa) {
  ...
  if (in_stack_00000490 != -0x7ffffffffffffffb) {
  ...
  if (*plVar3 == 1) {
    uVar8 = plVar3[1];
    if ((uVar8 & 3) != 1) goto LAB_100919bb4;
    puVar7 = (undefined8 *)(uVar8 - 1);
    uVar9 = *puVar7;
    puVar6 = *(undefined8 **)(uVar8 + 7);
    pcVar5 = (code *)*puVar6;
    if (pcVar5 != (code *)0x0) {
      (*pcVar5)(uVar9);
    }
    ...
    if ((*plVar3 != 0) || (plVar3[2] == 0)) goto LAB_100919bb4;
  ...
  *in_stack_000000f8 = 1;
  if (in_stack_00000500 == -0x7fffffffffffffff) {
    ...
    *in_stack_000000f0 = uVar9;
    ...
    uVar4 = 1;
    in_stack_000000f0[0xd] = 0xffffffffffff80a8;
  }
  *(undefined1 *)(unaff_x19 + 0xe38) = uVar4;
  return;
}
