...
void FUN_100f283ec(undefined2 *param_1,long param_2)
...
LAB_100f28420:
  ...
  *(char **)(param_2 + 8) = pcVar3 + 0x20;
  if (cStack_60 == '\x16') goto LAB_100f28420;
  ...
  *(long *)(param_2 + 0x20) = *(long *)(param_2 + 0x20) + 1;
  if (cStack_60 != '\x10') {
    if (cStack_60 == '\x11') {
      ...
      uStack_28 = puVar1[3];
      uStack_30 = puVar1[2];
      func_0x0001014548f8(&uStack_70,&uStack_40);
      _free(puVar1);
      goto joined_r0x000100f2847c;
    }
    if (cStack_60 != '\x12') {
      func_0x0001014548f8(&uStack_70,&cStack_60);
      goto joined_r0x000100f2847c;
    }
  }
  uStack_70 = 0x200;
  FUN_100e077ec(&cStack_60);
joined_r0x000100f2847c:
  bVar2 = (uStack_70 & 1) == 0;
  if (bVar2) {
