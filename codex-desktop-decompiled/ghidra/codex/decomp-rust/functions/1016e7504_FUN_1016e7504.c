...
void FUN_1016e7504(undefined8 *param_1,long *param_2,long *param_3,undefined8 param_4)

{
  ...
  long lStack_388;
  long lStack_380;
  undefined1 auStack_378 [776];
  
  lVar7 = param_3[1];
  lVar11 = param_3[2];
  uVar6 = FUN_100e8dd9c(param_2[4],param_2[5],lVar7,lVar11);
  if (param_2[2] == 0) {
    func_0x00010891c484(param_2,1,param_2 + 4,1);
  }
  bVar4 = false;
  lVar9 = 0;
  plVar1 = (long *)*param_2;
  ...
  do {
    for (; uVar13 != 0; uVar13 = uVar13 - 1 & uVar13) {
      ...
      if ((lVar11 == plVar1[uVar8 * -0x62 + -0x60]) &&
         (iVar5 = _memcmp(lVar7,plVar1[uVar8 * -0x62 + -0x61],lVar11), iVar5 == 0)) {
        _memcpy(param_1,plVar1 + uVar8 * -0x62 + -0x5f,0x2f8);
        _memcpy(plVar1 + uVar8 * -0x62 + -0x5f,param_4,0x2f8);
        if (*param_3 == 0) {
          return;
        }
...
LAB_1016e7630:
      bVar12 = NEON_umaxv(CONCAT17(-((char)((ulong)lVar14 >> 0x38) == -1),
                                   CONCAT16(-(cVar20 == -1),
                                            CONCAT15(-(cVar19 == -1),
                                                  ...
                                                  char)lVar14 == -1)))))))),1);
      if ((bVar12 & 1) != 0) {
        uVar6 = (ulong)*(char *)((long)plVar1 + uStack_3b8);
        if (-1 < *(char *)((long)plVar1 + uStack_3b8)) {
          lVar7 = *plVar1;
          ...
          uStack_3b8 = (ulong)LZCOUNT(uVar6 >> 0x20 | uVar6 << 0x20) >> 3;
          uVar6 = (ulong)*(byte *)((long)plVar1 + uStack_3b8);
        }
        lStack_388 = param_3[1];
        lStack_390 = *param_3;
        lStack_380 = param_3[2];
        _memcpy(auStack_378,param_4,0x2f8);
        bVar3 = bVar3 >> 1;
        *(byte *)((long)plVar1 + uStack_3b8) = bVar3;
        *(byte *)((long)plVar1 + (uStack_3b8 - 8 & uVar2) + 8) = bVar3;
        param_2[3] = param_2[3] + 1;
        param_2[2] = param_2[2] - (uVar6 & 1);
        _memcpy(plVar1 + uStack_3b8 * -0x62 + -0x62,&lStack_390,0x310);
        *param_1 = 5;
        return;
      }
      bVar4 = true;
      ...
      if (uVar13 != 0) {
        ...
        uStack_3b8 = uVar6 + ((ulong)LZCOUNT(uVar13 >> 0x20 | uVar13 << 0x20) >> 3) & uVar2;
        goto LAB_1016e7630;
      }
      bVar4 = false;
    }
