...
void FUN_1087dc190(undefined8 *param_1,long param_2,undefined8 param_3,ulong param_4,ulong param_5,
                  long param_6)
  ...
  if (param_2 == 0) {
    ...
    if (uVar6 != 0) {
      if (uVar6 < param_5) {
        ...
        if (iVar3 != 0) goto LAB_1087dc2ac;
      }
      else {
        uStack_48 = _malloc(uVar6);
      }
      goto joined_r0x0001087dc274;
    }
LAB_1087dc294:
    uVar4 = 0;
    param_1[1] = uStack_48;
...
joined_r0x0001087dc274:
      if (uStack_48 != 0) goto LAB_1087dc294;
    }
LAB_1087dc2ac:
    param_1[1] = param_5;
    uVar4 = 1;
