...
void FUN_1013e8820(undefined8 *param_1,byte *param_2)
...
LAB_1013e8b3c:
      pbStack_e8 = pbVar14;
      pbVar9 = (byte *)FUN_1087e422c(0,&UNK_10b230898,&UNK_10b20a590);
    }
    else {
      pbVar14 = unaff_x21 + 0x20;
      if (*unaff_x21 == 0x16) goto LAB_1013e8b3c;
      ...
      if (puStack_a0 != (undefined *)0x8000000000000000) {
        *param_1 = puStack_a0;
        ...
        if (lVar12 == 0) goto LAB_1013e8ca4;
        *param_1 = 0x8000000000000000;
        param_1[1] = lVar12;
        unaff_x21 = pbVar9;
        puVar13 = puVar6;
        goto joined_r0x0001013e8bf4;
      }
    }
    *param_1 = 0x8000000000000000;
    param_1[1] = pbVar9;
...
joined_r0x0001013e8bf4:
    ...
    if (bVar3 != 0x15) {
      uVar11 = FUN_108855b04(param_2,&puStack_a0,&UNK_10b20c900);
      *param_1 = 0x8000000000000000;
      param_1[1] = uVar11;
      return;
    }
          ...
          if (bVar2 != 1) {
            ...
            if (bVar2 == 0xc) {
              if (lStack_70 == 4) {
                ...
                if (iVar1 == 0x68746170) goto LAB_1013e8aa8;
              }
...
LAB_1013e8dac:
            lStack_b0 = lVar17 + 1;
            pbStack_c8 = pbVar19;
            uVar11 = FUN_108855b04(&bStack_88,&puStack_a0,&UNK_10b211960);
            *param_1 = 0x8000000000000000;
            param_1[1] = uVar11;
            puVar13 = (undefined *)((ulong)puVar13 & 0x7fffffffffffffff);
            goto joined_r0x0001013e8de4;
          }
          bVar8 = cStack_87 == '\0';
LAB_1013e8a2c:
          bVar8 = !bVar8;
...
LAB_1013e8a34:
          ...
          if (bVar2 != 0xe) {
            if (bVar2 != 0xf) goto LAB_1013e8dac;
          ...
          if (piVar4 == (int *)0x0) goto LAB_1013e8a40;
          _free();
          if (bVar8) goto LAB_1013e8a44;
LAB_1013e8aa8:
...
LAB_1013e8da8:
            ...
            pcVar7 = (code *)SoftwareBreakpoint(1,0x1013e8dac);
            (*pcVar7)();
          }
          uVar11 = *puVar16;
          puVar15[1] = puVar16[1];
      ...
      if (puVar13 != (undefined *)0x8000000000000000) {
        *param_1 = puVar13;
        ...
        if (pbVar10 == pbVar9) goto LAB_1013e8ca4;
