...
void FUN_1015612ac(long *param_1,long *param_2,undefined8 *param_3)
  ...
  if (lVar4 < 4) {
    if (lVar4 < 2) {
      ...
      if (lVar1 == 0) {
        ...
        if (unaff_x23 == 0) goto LAB_10156147c;
      }
...
LAB_10156147c:
        ...
        pcVar3 = (code *)SoftwareBreakpoint(1,0x10156148c);
        (*pcVar3)();
      }
    }
    _memcpy(unaff_x23,lVar5,lVar1);
...
LAB_1015613c0:
  ...
  lStack_c8 = lVar2;
  func_0x00010150b630(param_1,&lStack_158);
  if (*param_1 != 2) {
    lStack_98 = param_1[5];
    lStack_a0 = param_1[4];
    lStack_88 = param_1[7];
