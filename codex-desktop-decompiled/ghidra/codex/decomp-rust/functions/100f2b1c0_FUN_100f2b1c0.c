...
void FUN_100f2b1c0(long *param_1,long param_2)
...
LAB_100f2b1f8:
  ...
  *(char **)(param_2 + 8) = pcVar3 + 0x20;
  if (cStack_70 == '\x16') goto LAB_100f2b1f8;
...
LAB_100f2b23c:
    ...
    if (cStack_70 == '\x11') {
      ...
      uStack_38 = puVar1[3];
      uStack_40 = puVar1[2];
      auVar4 = FUN_100617a90(&uStack_50);
      _free(puVar1);
    }
    else {
      if (cStack_70 == '\x12') goto LAB_100f2b23c;
      auVar4 = FUN_100617a90(&cStack_70);
    }
