...

{
  ...
  lVar3 = thunk_FUN_108856088(s_missing_field_____108ac28f7,unaff_x29 + -0x100);
  *unaff_x20 = 2;
  unaff_x20[1] = lVar3;
  ...
  iVar2 = 0;
  if (in_stack_000000a8 != 0x8000000000000001) {
    iVar2 = unaff_w19;
  }
  if ((iVar2 == 1) && ((in_stack_000000a8 & 0x7fffffffffffffff) != 0)) {
    _free(in_stack_00000028);
  }
  uVar1 = 0;
  ...
  if (*unaff_x20 == 2) {
    ...
    lVar7 = unaff_x20[0x1a];
    lVar6 = unaff_x20[0x1d];
    ...
    if (in_stack_000000c8 == unaff_x25) {
      ...
      *(long *)(unaff_x29 + -0x100) = unaff_x22;
      lVar4 = FUN_1087e422c(((ulong)(in_stack_000000c8 - unaff_x25) >> 6) + unaff_x22,
    ...
    if (lVar4 == 0) {
      ...
      unaff_x20[0x1b] = lVar8;
      unaff_x20[0x1a] = lVar7;
      unaff_x20[0x1d] = lVar6;
