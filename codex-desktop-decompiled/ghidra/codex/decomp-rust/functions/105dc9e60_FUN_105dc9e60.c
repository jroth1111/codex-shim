...
long * FUN_105dc9e60(long *param_1,long param_2,ulong param_3)

{
  ...
  if (*(ulong *)(param_2 + 0x28) < uVar9) {
    plVar15 = (long *)(param_2 + 0x18);
    lVar12 = *plVar15;
    lVar17 = *(ulong *)(param_2 + 0x28) + 5;
    while (bVar1 = *(byte *)(lVar12 + lVar17 + -5),
          bVar1 < 0x21 && (1L << ((ulong)bVar1 & 0x3f) & 0x100002600U) != 0) {
      *(long *)(param_2 + 0x28) = lVar17 + -4;
      lVar17 = lVar17 + 1;
      if (lVar17 - uVar9 == 5) goto LAB_105dc9ee8;
    }
    uVar13 = (uint)bVar1;
    if (bVar1 < 0x66) {
      if (bVar1 != 0x22) {
        if (bVar1 != 0x2d) {
          if (uVar13 != 0x5b) goto LAB_105dca204;
          cVar2 = *(char *)(param_2 + 0x48) + -1;
          *(char *)(param_2 + 0x48) = cVar2;
          if (cVar2 == '\0') {
            uStack_190 = (long *)0x18;
            plVar15 = (long *)func_0x000108a492a4(param_2,&uStack_190);
          ...
          *(ulong *)(param_2 + 0x28) = uVar10;
          ...
          if (uVar9 <= uVar10) goto LAB_105dca130;
          plVar16 = (long *)0x8;
          bVar11 = true;
          plVar8 = param_1;
          goto LAB_105dca018;
        ...
        *(long *)(param_2 + 0x28) = lVar17 + -4;
        plVar6 = (long *)func_0x000105dc4078(&uStack_c0,param_2,0);
        if (uStack_c0 == (long *)0x3) {
          *param_1 = -0x7ffffffffffffffb;
          param_1[1] = (long)plStack_b8;
          return plVar6;
        }
        plVar16 = (long *)0x8000000000000002;
        if (uStack_c0 == (long *)0x0) {
          if ((long *)((ulong)plStack_b8 & 0x7fffffffffffffff) < (long *)0x7ff0000000000000) {
            ...
            plVar6 = (long *)FUN_105dc6c20(&uStack_190);
            plVar15 = extraout_x8;
            plVar8 = (long *)0x2;
          }
          else {
            plVar15 = (long *)((ulong)plStack_b8 & 0x7fffffffffffffff);
            plVar8 = (long *)0x3;
          ...
          if (uStack_c0 != (long *)0x1) {
            plVar8 = (long *)((ulong)plStack_b8 >> 0x3f);
          }
        }
LAB_105dca658:
        uVar9 = 0;
      ...
      *(undefined8 *)(param_2 + 0x10) = 0;
      plVar8 = (long *)__ZN68__LT_serde_json__read__StrRead_u20_as_u20_serde_json__read__Read_GT_9parse_str17ha2d4764bf8c46c27E
                                 (&uStack_190,plVar15,param_2);
      plVar15 = plStack_180;
      plVar16 = plStack_188;
      ...
      if (plStack_180 == (long *)0x0) {
        ...
        plVar4 = (long *)__RNvCshXwFllX56pT_7___rustc12___rust_alloc(plStack_180,1);
        if (plVar4 == (long *)0x0) {
...
LAB_105dcae0c:
      ...
      plVar6 = (long *)_memcpy(plVar4,plVar16,plVar15);
      uVar9 = (ulong)plVar15 & 0xffffffffffffff00;
      plVar16 = (long *)0x8000000000000003;
      plVar8 = plVar15;
      goto LAB_105dcaccc;
    }
    plVar6 = param_1;
    plVar4 = unaff_x22;
    if (uVar13 == 0x73 || bVar1 < 0x73) {
      if (uVar13 == 0x66) {
        uVar14 = lVar17 - 4;
        *(ulong *)(param_2 + 0x28) = uVar14;
        ...
        if (uVar9 <= uVar14) goto LAB_105dca45c;
        cVar2 = *(char *)(lVar12 + lVar17 + -4);
        *(ulong *)(param_2 + 0x28) = lVar17 - 3U;
        if (cVar2 == 'a') {
          if (lVar17 - 3U == uVar10) goto LAB_105dca45c;
          cVar2 = *(char *)(lVar12 + lVar17 + -3);
          *(ulong *)(param_2 + 0x28) = lVar17 - 2U;
          if (cVar2 == 'l') {
            if (lVar17 - 2U == uVar10) goto LAB_105dca45c;
            cVar2 = *(char *)(lVar12 + lVar17 + -2);
            *(ulong *)(param_2 + 0x28) = lVar17 - 1U;
            if (cVar2 == 's') {
              if (lVar17 - 1U == uVar10) goto LAB_105dca45c;
              cVar2 = *(char *)(lVar12 + lVar17 + -1);
...
LAB_105dca204:
          if (uVar13 - 0x30 < 10) {
            plVar6 = (long *)func_0x000105dc4078(&uStack_c0,param_2,1);
            if (uStack_c0 == (long *)0x3) {
              *param_1 = -0x7ffffffffffffffb;
              param_1[1] = (long)plStack_b8;
              return plVar6;
          ...
          uStack_190 = (long *)0xa;
          plVar8 = (long *)func_0x000108a492a4(param_2,&uStack_190);
          goto LAB_105dcac20;
        }
        uVar14 = lVar17 - 4;
        *(ulong *)(param_2 + 0x28) = uVar14;
      ...
      if (uVar13 != 0x74) {
        if (uVar13 != 0x7b) goto LAB_105dca204;
        cVar2 = *(char *)(param_2 + 0x48) + -1;
        *(char *)(param_2 + 0x48) = cVar2;
        if (cVar2 == '\0') {
          uStack_190 = (long *)0x18;
        ...
        *(long *)(param_2 + 0x28) = lVar17 + -4;
        uStack_1e0 = 1;
        lStack_1e8 = param_2;
        uVar5 = func_0x000105dc8cc8(&uStack_190,&lStack_1e8);
        lVar17 = lStack_1e8;
        plVar16 = plStack_188;
        if ((char)uStack_190 == '\x01') {
LAB_105dca1c4:
          auVar19._8_8_ = plStack_1f0;
          auVar19._0_8_ = uVar5;
        ...
        if (uStack_190._1_1_ == '\x01') {
          ...
          *(undefined8 *)(lStack_1e8 + 0x10) = 0;
          uVar5 = __ZN68__LT_serde_json__read__StrRead_u20_as_u20_serde_json__read__Read_GT_9parse_str17ha2d4764bf8c46c27E
          ...
          if (plStack_180 == (long *)0x0) {
            ...
            if (((*plStack_188 == 0x6a5f656472657324 && plStack_188[1] == 0x6972703a3a6e6f73) &&
              ...
              if (unaff_x23 == (long *)0x0) {
                uVar5 = func_0x0001087c9084(1,0x1e);
                ...
                lVar17 = *(long *)((long)plVar15 + param_3);
                ...
                if (uVar10 == 0) {
                  lVar17 = 8;
                  do {
                    param_3 = param_3 + lVar17 & uVar9;
                    lVar12 = *(long *)((long)plVar15 + param_3);
                    uVar10 = CONCAT17(-(lVar12 < 0),
                                      CONCAT16(-((char)((ulong)lVar12 >> 0x30) < '\0'),
                                               CONCAT15(-((char)((ulong)lVar12 >> 0x28) < '\0'),
                                                        CONCAT14(-((char)((ulong)lVar12 >> 0x20) <
                                                                  '\0'),CONCAT13(-((char)((ulong)
                                                  lVar12 >> 0x18) < '\0'),
                                                  CONCAT12(-((char)((ulong)lVar12 >> 0x10) < '\0'),
                                                           CONCAT11(-((char)((ulong)lVar12 >> 8) <
                                                                     '\0'),-((char)lVar12 < '\0'))))
                                                  ))));
                    lVar17 = lVar17 + 8;
                  } while (uVar10 == 0);
                ...
                plVar16 = (long *)(param_3 + ((ulong)LZCOUNT(uVar10 >> 0x20 | uVar10 << 0x20) >> 3)
                                  & uVar9);
                if (-1 < *(char *)((long)plVar15 + (long)plVar16)) {
                  lVar17 = *plVar15;
                  ...
                  return (long *)((ulong)LZCOUNT(uVar9 >> 0x20 | uVar9 << 0x20) >> 3);
                }
                return plVar16;
              }
              lVar18 = plVar16[1];
              lVar12 = *plVar16;
              uVar5 = *(undefined8 *)((long)plVar16 + 0xe);
              *(undefined8 *)((long)unaff_x23 + 0x16) = *(undefined8 *)((long)plVar16 + 0x16);
              *(undefined8 *)((long)unaff_x23 + 0xe) = uVar5;
              unaff_x23[1] = lVar18;
              *unaff_x23 = lVar12;
              plVar8 = (long *)0x1e;
            }
          ...
          if (plVar8 == (long *)0x8000000000000000) {
            ...
            if (uStack_190 == (long *)0x0) {
              ...
              plVar6 = (long *)FUN_105dc3cf8(&uStack_190,&uStack_c0);
              if (uStack_190 == (long *)0x8000000000000005) {
                plVar6 = (long *)func_0x000108a4a5c4(plStack_188);
                plStack_230 = (long *)0x8000000000000005;
                plStack_228 = plVar6;
              }
              else {
          ...
          if (plVar8 != (long *)0x8000000000000001) {
            ...
            func_0x000105dc3c40(&plStack_230,&lStack_1e8);
        ...
        plStack_1f8 = auVar19._0_8_;
        *(long *)*pauVar7 = (long)plStack_1f8 + 1;
...
LAB_105dcab14:
    uStack_190 = (long *)0x9;
LAB_105dca460:
    plVar15 = (long *)func_0x000108a499a0(param_2,&uStack_190);
    goto LAB_105dc9efc;
  }
LAB_105dc9ee8:
  uStack_190 = (long *)0x5;
...
LAB_105dca018:
  do {
    plVar6 = plStack_1c8;
    while (bVar1 = *(byte *)(*plVar15 + uVar10),
          bVar1 < 0x21 && (1L << ((ulong)bVar1 & 0x3f) & 0x100002600U) != 0) {
      uVar10 = uVar10 + 1;
      *(ulong *)(param_2 + 0x28) = uVar10;
      if (uVar9 == uVar10) goto LAB_105dca130;
    ...
    if (!bVar11) {
      if (bVar1 != 0x2c) {
        uStack_190 = (long *)0x7;
        plVar4 = (long *)func_0x000108a492a4(param_2,&uStack_190);
        goto LAB_105dca148;
      }
      uVar10 = uVar10 + 1;
      *(ulong *)(param_2 + 0x28) = uVar10;
...
LAB_105dcaacc:
      ...
      while (bVar1 = *(byte *)(*plVar15 + uVar10),
        ...
        uVar10 = uVar10 + 1;
        *(ulong *)(param_2 + 0x28) = uVar10;
        if (uVar9 == uVar10) goto LAB_105dcaacc;
      }
      if (bVar1 == 0x5d) {
    ...
    plVar8 = (long *)FUN_105dc9e60(&uStack_190,param_2);
    plVar4 = plStack_188;
    ...
    uStack_c0 = uStack_190;
    plStack_b8 = plStack_188;
    if (plVar6 == plStack_1d8) {
      plVar8 = (long *)__ZN5alloc7raw_vec19RawVec_LT_T_C_A_GT_8grow_one17hd86cb4541401251eE
                                 (&plStack_1d8);
      plVar16 = plStack_1d0;
    }
    bVar11 = false;
    plVar4 = plVar16 + (long)plVar6 * 9;
    plVar4[1] = (long)plStack_b8;
    *plVar4 = (long)uStack_c0;
    plVar4[8] = (long)plStack_80;
    plVar4[5] = (long)plStack_98;
    plVar4[4] = (long)plStack_a0;
    plVar4[7] = (long)plStack_88;
    plVar4[6] = (long)plStack_90;
    plVar4[3] = (long)plStack_a8;
    plVar4[2] = (long)plStack_b0;
    plStack_1c8 = (long *)((long)plVar6 + 1);
    uVar9 = *(ulong *)(param_2 + 0x20);
...
LAB_105dca130:
  ...
  plVar4 = (long *)func_0x000108a492a4(param_2,&uStack_190);
LAB_105dca148:
  lVar17 = (long)plVar6 + 1;
  plVar8 = plVar16;
  while (lVar17 = lVar17 + -1, lVar17 != 0) {
    FUN_105dc6c20(plVar8);
    plVar8 = plVar8 + 9;
  }
  if (plStack_1d8 != (long *)0x0) {
    plVar8 = (long *)_free(plVar16);
  }
  uVar9 = *(ulong *)(param_2 + 0x20);
  uVar10 = *(ulong *)(param_2 + 0x28);
...
LAB_105dca3a8:
  ...
  *(char *)(param_2 + 0x48) = *(char *)(param_2 + 0x48) + '\x01';
  ...
  if (uVar10 < uVar9) {
    do {
      bVar1 = *(byte *)(*plVar15 + uVar10);
      if (0x2c < bVar1) {
LAB_105dcac80:
        if (bVar1 != 0x5d) {
          plStack_1d8 = (long *)0x16;
          plVar8 = (long *)func_0x000108a492a4(param_2,&plStack_1d8);
          goto LAB_105dca424;
        }
      ...
      if ((1L << ((ulong)bVar1 & 0x3f) & 0x100002600U) == 0) {
        ...
        uVar10 = uVar10 + 1;
        *(ulong *)(param_2 + 0x28) = uVar10;
        if (uVar10 < uVar9) goto LAB_105dcac54;
        goto LAB_105dcada0;
      }
      uVar10 = uVar10 + 1;
      *(ulong *)(param_2 + 0x28) = uVar10;
  ...
  goto LAB_105dca424;
LAB_105dca8d0:
  uVar5 = func_0x000105dc8cc8(&uStack_c0,&lStack_1e8);
  lVar17 = lStack_1e8;
...
LAB_105dcab1c:
      ...
      auVar19._8_8_ = auStack_1a0._8_8_;
      auVar19._0_8_ = uVar5;
    ...
    *(undefined8 *)(lStack_1e8 + 0x10) = 0;
    ...
    if (plStack_b0 == (long *)0x0) {
      ...
      plVar8 = (long *)__RNvCshXwFllX56pT_7___rustc12___rust_alloc(plStack_b0,1);
      if (plVar8 == (long *)0x0) {
LAB_105dcae18:
        func_0x0001087c9084(1,unaff_x22);
      ...
      _memcpy(plVar8,plVar16,unaff_x22);
      plStack_228 = plVar8;
      if ((unaff_x22 == (long *)0x8000000000000001) || (unaff_x22 == (long *)0x8000000000000000))
      goto LAB_105dcab70;
    }
    uVar9 = *(ulong *)(lVar17 + 0x28);
    if (*(ulong *)(lVar17 + 0x20) <= uVar9) {
LAB_105dcaae4:
      plStack_110 = (long *)0x3;
      plStack_188 = (long *)func_0x000108a492a4(lVar17,&plStack_110);
...
LAB_105dcade8:
    ...
    *(ulong *)(lVar17 + 0x28) = uVar9 + 1;
    uVar5 = FUN_105dc9e60(&uStack_c0,lVar17);
...
LAB_105dcab70:
  plStack_230 = (long *)0x8000000000000005;
LAB_105dcab74:
  uVar5 = FUN_105dc704c(&plStack_1d8);
  auVar19._8_8_ = plStack_1f0;
  auVar19._0_8_ = uVar5;
LAB_105dca714:
  plStack_1f0 = auVar19._8_8_;
  *(char *)(param_2 + 0x48) = *(char *)(param_2 + 0x48) + '\x01';
  uVar9 = *(ulong *)(param_2 + 0x28);
  if (uVar9 < *(ulong *)(param_2 + 0x20)) {
LAB_105dca73c:
    bVar1 = *(byte *)(*plVar15 + uVar9);
    if (bVar1 < 0x2d) {
      if ((1L << ((ulong)bVar1 & 0x3f) & 0x100002600U) != 0) goto code_r0x000105dca754;
      if ((ulong)bVar1 != 0x2c) goto LAB_105dcabc4;
      uStack_c0 = (long *)0x15;
      plVar8 = (long *)func_0x000108a492a4(param_2,&uStack_c0);
    }
    else {
LAB_105dcabc4:
      if (bVar1 == 0x7d) {
        *(ulong *)(param_2 + 0x28) = uVar9 + 1;
        plVar16 = plStack_230;
        plVar8 = plStack_228;
...
joined_r0x000105dcacb0:
        ...
        if (plVar16 != (long *)0x8000000000000005) {
          plStack_1f0 = auVar19._8_8_;
          if (plVar16 != (long *)0x8000000000000005) {
            uVar9 = (ulong)plVar8 & 0xffffffffffffff00;
            plVar6 = auVar19._0_8_;
            plVar4 = plStack_180;
LAB_105dcaccc:
            *param_1 = (long)plVar16;
            param_1[1] = (ulong)plVar8 & 0xff | uVar9;
...
code_r0x000105dca754:
  ...
  *(ulong *)(param_2 + 0x28) = uVar9;
  if (*(ulong *)(param_2 + 0x20) == uVar9) goto LAB_105dca764;
  goto LAB_105dca73c;
  while( true ) {
    uVar10 = uVar10 + 1;
    *(ulong *)(param_2 + 0x28) = uVar10;
...
LAB_105dcac20:
  plVar15 = (long *)func_0x000108a4a02c(plVar8,param_2);
LAB_105dc9efc:
  *param_1 = -0x7ffffffffffffffb;
  param_1[1] = (long)plVar15;
  return plVar15;
