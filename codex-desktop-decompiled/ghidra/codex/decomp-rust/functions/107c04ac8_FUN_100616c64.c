...
/* WARNING: Possible PIC construction at 0x000100616f1c: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x000100616f20) */

void FUN_100616c64(ulong *param_1,ulong *param_2)

{
  ...
  if ((long)uVar3 < 4) {
    if ((long)uVar3 < 3) {
      ...
      thunk_FUN_1087e3db0(param_1,&uStack_158,&uStack_51,&UNK_10b20a560);
    }
    else {
    ...
    auStack_70[0] = 10;
    uStack_d0 = uVar8;
    thunk_FUN_1087e3db0(&uStack_158,auStack_70,&uStack_51,&UNK_10b20a560);
    if (uStack_158 == 2) {
      if (uVar7 == 0) {
        ...
        *param_1 = 2;
        ...
        thunk_FUN_1087e427c(&uStack_158,uVar7,&UNK_10b21cb80,&UNK_10b20a590);
...
SUB_107c04ac8:
      ...
      *(undefined1 *)((long)register0x00000008 + -0x50) = 5;
      FUN_1087e3db0(param_1,(undefined1 *)((long)register0x00000008 + -0x50),
                    (undefined1 *)((long)register0x00000008 + -0x31),&UNK_10b20a560);
      if (*param_2 != 0) {
        _free(uVar3);
      }
      return;
    ...
    uStack_e8 = uVar3;
    uStack_e0 = uVar8;
    thunk_FUN_1087e3db0(&uStack_d0,auStack_70,&uStack_51,&UNK_10b20a560);
    if (uStack_d0 == 2) {
      if (uVar7 == 0) {
        ...
        *param_1 = 2;
        ...
        thunk_FUN_1087e427c(&uStack_d0,uVar6,&UNK_10b21cb90,&UNK_10b20a590);
