...
void FUN_1014a83ac(undefined8 *param_1)

{
  ...
  func_0x000101602f40(&pcStack_98);
  pcStack_a8 = pcStack_88;
  pcStack_b0 = pcStack_90;
  pcStack_a0 = pcStack_80;
  if (pcStack_98 != (char *)0x2) goto LAB_1014a8444;
...
LAB_1014a8620:
    ...
    pcVar2 = (code *)SoftwareBreakpoint(1,0x1014a8624);
    (*pcVar2)();
  }
  *puVar3 = uVar4 + 1;
  if (puVar3[1] == 0x8000000000000000) {
    ...
    if (pcStack_b0 == (char *)0x8000000000000000) {
      ...
      *puVar3 = *puVar3 - 1;
      ...
      if (pcStack_98 != (char *)0x3) goto LAB_1014a85b8;
      goto LAB_1014a8438;
    }
