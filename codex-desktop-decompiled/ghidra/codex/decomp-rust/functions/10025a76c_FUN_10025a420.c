...
bool FUN_10025a420(long *param_1,undefined8 param_2,long *param_3,long *param_4)
  ...
  if (*param_1 != 1) {
    ...
    if (uVar8 == 0) {
      *(undefined2 *)(param_1 + 0xb) = 7;
      ...
      FUN_107c03c64(8,0x270);
      param_1[3] = 6;
      param_1[4] = (long)unaff_x20;
      param_1[5] = 0;
      Var27 = __Unwind_Resume();
      lVar13 = (long)Var27;
      ...
      if (uVar8 >> 0xf == 0) {
        ...
        if (uVar8 == *(ulong *)(lVar13 + 0x18)) {
          __ZN5alloc7raw_vec19RawVec_LT_T_C_A_GT_8grow_one17h329ea332e617019cE();
        }
        ...
        puVar7[1] = uStack_f0;
        *puVar7 = 0;
        puVar7[0xc] = CONCAT62(uStack_96,(short)((unkuint10)Var27 >> 0x40));
        puVar7[9] = lVar21;
        puVar7[8] = lVar19;
        puVar7[0xb] = lVar25;
        puVar7[10] = lVar23;
    ...
    uVar8 = FUN_10025a894(param_1,uVar15 << 1);
joined_r0x00010025a4f8:
    if ((uVar8 & 1) == 0) {
      return false;
    }
    return true;
  ...
  if (pauVar6[1][0] == '\x01') {
    ...
    *(long *)(*pauVar6 + 8) = auVar28._8_8_;
    pauVar6[1][0] = 1;
  }
  *(long *)*pauVar6 = auVar28._0_8_ + 1;
  *param_1 = 2;
  *(undefined1 (*) [16])(param_1 + 1) = auVar28;
  puVar14 = (undefined4 *)param_1[9];
  if (uVar15 == 0) goto LAB_10025a5f8;
  uVar8 = uVar15 * 4 - 4;
  puVar10 = puVar14;
  if (0xb < uVar8) {
    uVar9 = (uVar8 >> 2) + 1;
    if (uVar8 < 0x7c) {
      ...
      if (uVar9 == uVar12) goto LAB_10025a5f8;
      if ((uVar9 & 0x1c) == 0) {
    ...
    if (uVar9 == uVar8) goto LAB_10025a5f8;
  }
LAB_10025a5e4:
  do {
    puVar11 = puVar10 + 1;
...
LAB_10025a5f8:
  ...
  do {
    lVar19 = lVar13 + 0x68;
    uVar5 = FUN_1002599cc(param_1,lVar13 + 0x40);
    uVar8 = 0;
