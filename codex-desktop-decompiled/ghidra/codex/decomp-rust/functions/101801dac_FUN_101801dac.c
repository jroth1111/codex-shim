...

{
  ...
  if (puVar2 == (undefined8 *)0x0) {
    ...
    *puVar2 = in_stack_00014e20;
    puVar2[1] = in_stack_00014e28;
    puVar2[2] = in_stack_00014e30;
    plVar3 = (long *)_malloc(0x18);
    if (plVar3 != (long *)0x0) {
      *plVar3 = (long)puVar2;
      plVar3[1] = (long)&UNK_10b25d268;
      *(undefined1 *)(plVar3 + 2) = 0x28;
      uVar9 = *(ulong *)(unaff_x26 + 0x1a00);
      if ((uVar9 & 3) == 1) {
        uVar10 = *(undefined8 *)(uVar9 - 1);
        puVar2 = *(undefined8 **)(uVar9 + 7);
        pcVar4 = (code *)*puVar2;
        if (pcVar4 != (code *)0x0) {
          (*pcVar4)(uVar10);
        }
      ...
      *(undefined1 *)(unaff_x20 + 0x24d) = 0;
      ...
      if ((*(byte *)(unaff_x20 + 0x24e) & 1) != 0) {
        uVar9 = *(ulong *)(unaff_x19 + 0x4c8);
        if (uVar9 != 0x8000000000000003) {
          bVar1 = uVar9 != 0x8000000000000000;
          if (uVar9 < 0x8000000000000001) {
            uVar9 = 0;
          }
          if (((bVar1) && ((uVar9 & 0x7fffffffffffffff) == 0)) &&
...
LAB_101805be4:
  ...
  pcVar4 = (code *)SoftwareBreakpoint(1,0x1018061c4);
  (*pcVar4)();
}
