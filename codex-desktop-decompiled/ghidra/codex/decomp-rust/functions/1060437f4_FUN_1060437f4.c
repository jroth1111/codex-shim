...
void FUN_1060437f4(long param_1,ulong param_2,undefined8 *param_3,ulong param_4,uint param_5,
                  undefined8 param_6)

{
  ...
  uVar20 = 1;
  uVar11 = param_2;
  if (param_2 == 0) goto LAB_10604391c;
LAB_1060438c8:
...
LAB_1060438dc:
    if ((param_5 & 1) == 0) {
      ...
      func_0x000106046158(lVar10,uVar11,param_3,param_4,0,0,param_6);
      uVar11 = uVar11 << 1 | 1;
    }
    goto LAB_106043a3c;
  }
...
LAB_106043958:
        ...
        uVar17 = 2;
        puVar13 = (ulong *)(param_1 + 0x48 + uVar15 * 0x20);
        uVar18 = uVar8;
        do {
          uVar19 = *puVar13;
          uVar21 = uVar17;
...
LAB_106043a0c:
        if (uVar21 < uVar5) goto LAB_1060438dc;
        if (uVar8 < *(ulong *)(lVar10 + 8)) {
          if (1 < uVar21) {
            uVar11 = uVar21 >> 1;
            goto LAB_106043958;
  ...
  do {
    ...
    if (1 < uVar16) {
      do {
        while( true ) {
          uVar11 = uVar16 - 1;
          if ((uint)abStack_ab[uVar16] < (uint)lVar10) goto LAB_106043c5c;
          ...
          if ((uVar17 & 1) == 0) {
            func_0x000106046158(puVar9,uVar18,param_3,param_4,(int)LZCOUNT(uVar18 | 1) << 1 ^ 0x7e,0
                                ,param_6);
          }
          if ((uVar21 & 1) == 0) {
            func_0x000106046158(puVar9 + uVar18 * 4,uVar19,param_3,param_4,
          ...
          if ((1 < uVar17) && (1 < uVar21)) {
            ...
            if (uVar21 <= param_4) {
              ...
              if (uVar19 < uVar18) {
                do {
                  bVar3 = (ulong)puVar12[-3] <= (ulong)puVar6[-3];
                  puVar14 = puVar12 + -4;
                  if (bVar3) {
                    puVar14 = puVar6 + -4;
                  }
                ...
                do {
                  bVar3 = (ulong)puVar4[1] <= (ulong)puVar12[1];
                  puVar7 = puVar12;
                  if (bVar3) {
                    puVar7 = puVar4;
                  }
          ...
          uVar21 = uVar8 * 2 | 1;
          if (uVar11 < 2) goto LAB_106043c4c;
        }
        uVar21 = uVar8 * 2;
      } while (1 < uVar11);
LAB_106043c4c:
...
LAB_106043c5c:
    ...
    if (param_2 <= uVar15) {
      ...
      func_0x000106046158(param_1,param_2,param_3,param_4,(int)LZCOUNT(param_2 | 1) << 1 ^ 0x7e,0,
                          param_6);
      return;
    }
    uVar16 = uVar16 + 1;
    ...
    if (uVar15 <= param_2 && uVar11 != 0) goto LAB_1060438c8;
LAB_10604391c:
    lVar10 = 0;
    uVar11 = 1;
    uVar21 = uVar20;
