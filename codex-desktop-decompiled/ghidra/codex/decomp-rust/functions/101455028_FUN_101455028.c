...
void FUN_101455028(undefined1 *param_1,char *param_2)

{
  ...
  if (*param_2 == '\x14') {
    if (*(long *)(param_2 + 0x18) == 0) {
      ppuVar4 = (undefined1 **)&UNK_10b22d960;
      ...
      if (cVar6 != '\x10') {
        ...
        else if (cVar6 == '\x12') goto LAB_1014552b4;
        if (cVar6 != '\0') {
LAB_1014553a0:
...
LAB_101455204:
                ...
                if (bVar1 != 0x10) {
                  if (bVar1 == 0x11) {
                    ...
                    if (*pcVar8 != '\0') goto LAB_1014553a0;
                    cVar6 = pcVar8[1];
                  }
                  else if (bVar1 != 0x12) {
                    if (bVar1 != 0) {
              ...
              if (*(long *)(lVar11 + lVar9 + 8) == 0) goto LAB_101455204;
            }
            else {
              if (bVar1 != 0xc) {
LAB_101455340:
                puVar5 = &UNK_10b2149c8;
              ...
              if ((*(long *)(lVar11 + lVar9 + 0x18) == 0xb) &&
                 ...
                 *(long *)((long)plVar12 + 3) == 0x6465676e61684374)) goto LAB_101455204;
            }
          }
          else if (bVar1 == 0xd) {
...
joined_r0x00010145514c:
            ...
            if (bVar1 != 0xf) goto LAB_101455340;
            if (*(long *)(lVar11 + lVar9 + 0x10) == 0xb) {
