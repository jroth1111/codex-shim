...

{
  ...
  __ZN5alloc3fmt6format12format_inner17h63985d1d6aa0fe33E
            (&stack0x000002e0,s__failed_to_serialize_stop_hook_i_108ac3281,unaff_x29 + -0x80);
  ...
  if (*in_stack_000000c0 == 1) {
    ...
    if ((uVar7 & 3) != 1) goto LAB_1006d0f98;
    ...
    if ((*in_stack_000000c0 != 0) || (in_stack_000000c0[2] == 0)) goto LAB_1006d0f98;
    puVar6 = (undefined8 *)in_stack_000000c0[1];
  }
  _free(puVar6);
LAB_1006d0f98:
  _free(in_stack_000000c0);
  FUN_100e05f20(&stack0x000008a0);
  uVar9 = extraout_x10;
