...
void FUN_103da5bf0(int *param_1)

{
  ...
  if (*param_1 == 0) {
    if ((char)param_1[0x7da] == '\0') {
      func_0x000103d9c234(param_1 + 2);
      func_0x000103d9c4c8(param_1 + 0x3c);
    }
    else {
      if ((char)param_1[0x7da] != '\x03') {
        return;
      }
      func_0x000103da555c(param_1 + 0x42);
    }
