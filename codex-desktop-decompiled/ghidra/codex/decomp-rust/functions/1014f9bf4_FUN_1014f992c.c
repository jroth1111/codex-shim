...
undefined8 FUN_1014f992c(long param_1)

{
  ...
  lStack0000000000000118 = unaff_x29 + -0x80;
  pcStack0000000000000110 = s_send_response_error__108ac8efd;
  _uStack0000000000000100 = (undefined1 *)&stack0x00000110;
  puStack0000000000000108 = &UNK_10b208fd0;
  puStack0000000000000198 = (undefined8 *)&stack0x00000100;
  _uStack0000000000000190 = (long *)0x1;
  uStack00000000000001a0 = 1;
  puStack0000000000000128 = in_stack_000000f0;
  _uStack0000000000000120 = (undefined8 *)in_stack_000000e8;
  uStack0000000000000130 = in_stack_000000f8;
  ...
  if (cVar4 != '\x04') {
    ...
    _uStack0000000000000100 = CONCAT43(*(undefined4 *)((long)puVar10 + 3),(int3)*puVar10);
    ...
    *(undefined8 *)(unaff_x29 + -0x70) = *(undefined8 *)(unaff_x29 + -0x90);
    if (cVar4 != '\x05') {
      ...
      puStack0000000000000128 = puVar12;
      plVar6 = (long *)FUN_100f410dc(0x18,8);
      *plVar6 = 0;
      *(undefined1 *)(plVar6 + 2) = 0xb;
      _uStack0000000000000190 = CONCAT41(uStack0000000000000100,cVar4);
      _uStack0000000000000190 = (long *)CONCAT44(stack0x00000103,uStack0000000000000190);
      ...
      pcStack0000000000000110 = (char *)plVar6;
...
LAB_1014f9af0:
      ...
      if ((*unaff_x28 == '\0') && (3 < ___ZN3log20MAX_LOG_LEVEL_FILTER17h2019f7c33388e688E)) {
        ...
        if (iVar5 != 0) {
          ...
          *(undefined8 ***)(unaff_x29 + -0x78) = &stack0x00000098;
          in_stack_000000e8 = unaff_x29 + -0x80;
          in_stack_000000f0 = (undefined8 *)&UNK_10b208fd0;
          in_stack_00000018 = &stack0x000000e8;
          in_stack_00000010 = 1;
          in_stack_00000020 = 1;
  ...
  if ((*unaff_x28 == '\0') && (lVar7 = *(long *)(unaff_x19 + 0x12f8), lVar7 != 0)) {
    ...
    in_stack_00000018 = *(undefined8 **)(lVar7 + 0x18);
