            ...
            if (lStack_128 != 0) {
              ...
              do {
                ...
                *puVar24 = uVar8;
                ...
                if (0xc < bVar6) {
                  if (bVar6 == 0xd) {
                    FUN_100ae7360(&uStack_c0,puStack_98,uStack_90);
                    goto LAB_10124a00c;
                  }
                  if (bVar6 == 0xe) {
                    FUN_100ae70a8(&uStack_c0,uStack_90,uStack_88);
joined_r0x000101249f70:
                  ...
                  if (bVar6 == 0xf) {
                    FUN_100ae70a8(&uStack_c0,puStack_98,uStack_90);
                    goto LAB_10124a00c;
                  }
LAB_10124a33c:
...
LAB_10124a374:
                ...
                if (bVar6 == 1) {
                  ...
                  if (bVar6 != 4) {
                    ...
                    FUN_100ae7360(&uStack_c0,uStack_90);
...
joined_r0x000101249fd8:
                ...
                if (uStack_c0._1_1_ < 3) {
                  ...
                  *(long *)((long)puVar24 + 0xf) = auVar7._0_8_;
                  uStack_a0 = (undefined8 *)CONCAT71(uStack_a0._1_7_,cVar11);
                  FUN_1013833b8(&uStack_c0,&uStack_a0);
