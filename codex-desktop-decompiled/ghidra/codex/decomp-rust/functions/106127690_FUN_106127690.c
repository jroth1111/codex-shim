    ...
    if (uVar35 != 1) {
      ...
      if ((long)ppppppuStack_40 < 0) {
        if (NAN((double)ppppppuStack_40)) {
          uVar28 = 9;
          ppppppuVar20 = (undefined8 ******)func_0x00010611f954(param_3,&UNK_109becdf0);
...
LAB_106128928:
        ...
        *(undefined4 *)((long)param_3[1] + (long)pppppuVar26) = 0x302e302d;
        ...
        if (NAN((double)ppppppuStack_40)) {
          uVar28 = 7;
          uStack_38 = (ulong ******)&ppppppuStack_40;
          ppppppuVar20 = (undefined8 ******)func_0x00010611f954(param_3,&UNK_109becbc8);
...
LAB_1061279e8:
      ...
      do {
        ...
        if ((pppppppuStack_50 != (undefined8 *******)0x8000000000000004) ||
           (pppppuVar18 = (ulong *****)
                          func_0x000106129654(&pppppppuStack_50,&pppppppuStack_78,ppppppuVar20),
