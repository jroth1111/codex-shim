...
void FUN_10061a998(undefined8 *param_1,ulong *param_2)
  ...
  if ((long)uVar11 < 3) {
    if (uVar11 == 0) {
      if (param_2[1] == 0x8000000000000000) {
        ...
        thunk_FUN_1087e3db0(&uStack_1d0,&uStack_d0,&puStack_150,&UNK_10b20a3c0);
        uVar11 = uStack_1d0;
      }
      else {
        func_0x000107c04d58(&uStack_1d0);
        uVar11 = uStack_1d0;
      }
    }
    else if (uVar11 == 1) {
      ...
      if ((auVar17._0_8_ & 1) == 0) {
        ...
        if ((auVar17._0_8_ & 1) == 0) {
          ...
          if (((uint)puStack_150 & 1) == 0) {
            ...
            func_0x000107c04a10(&uStack_1d0,uStack_120,uStack_118);
          }
          else {
            func_0x000107c0461c(&uStack_1d0,uStack_140,puStack_138);
          }
        }
        else {
      ...
      if ((uVar11 & 1) == 0) {
        ...
        if (puStack_1b0 == (undefined8 *)0x0) {
          ...
          pcVar8 = (code *)SoftwareBreakpoint(1,0x10061af80);
          (*pcVar8)();
        }
...
LAB_10061aae8:
      ...
      if (*puVar16 == 0x8000000000000006) {
        ...
        uStack_70 = 0;
        uStack_d0 = *puVar16;
        FUN_10160334c(&uStack_130,&uStack_d0);
        uVar7 = uStack_118;
        uVar6 = uStack_120;
        uVar5 = uStack_128;
        uVar13 = uStack_160;
        ...
        puVar10 = puVar9;
        if (uStack_128 != 0x8000000000000000) goto code_r0x00010061ab60;
      }
    }
LAB_10061adf8:
    puVar9 = puVar10;
...
LAB_10061ae10:
    ...
    uStack_80 = uVar1;
    uStack_78 = uVar3;
    func_0x000107c059dc(&uStack_1d0,&uStack_d0);
    uVar11 = uStack_1d0;
  }
  uStack_d0 = uVar11;
  if (uStack_d0 == 2) {
...
LAB_10061af14:
  ...
  *param_1 = 1;
  ...
  param_1[2] = uStack_1c0;
  return;
code_r0x00010061ab60:
  if (uStack_160 == uStack_170) {
    __ZN5alloc7raw_vec19RawVec_LT_T_C_A_GT_8grow_one17h04f561b8f2dea13fE(&uStack_170);
  }
  ...
  *puVar10 = uVar5;
  ...
  puVar10 = puVar12;
  puVar16 = puVar9;
  if (puVar9 == puVar12) goto LAB_10061adf8;
  goto LAB_10061aae8;
}
