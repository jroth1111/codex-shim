...
/* WARNING: Removing unreachable block (ram,0x00010098c0cc) */
/* WARNING: Removing unreachable block (ram,0x00010098c0d0) */
/* WARNING: Removing unreachable block (ram,0x00010098c054) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined8 FUN_10098c244(void)

{
  ...
  *(char **)(unaff_x29 + -0xb0) = s__request_failed_with_client_erro_108ac9cbd;
  ...
  *(undefined8 *)(unaff_x19 + 0x270) = 0x800000000000000d;
  *(undefined8 *)(unaff_x19 + 0x280) = *(undefined8 *)(unaff_x19 + 0x128);
  *(undefined8 *)(unaff_x19 + 0x278) = *(undefined8 *)(unaff_x19 + 0x120);
  *(undefined8 *)(unaff_x19 + 0x288) = *(undefined8 *)(unaff_x19 + 0x130);
  *(undefined8 *)(unaff_x19 + 0x298) = 0;
  *(undefined **)(unaff_x19 + 0x290) = &UNK_108c56c70;
  *(undefined8 *)(unaff_x19 + 0x2a8) = 0;
  *(undefined8 *)(unaff_x19 + 0x2a0) = 0;
  *(undefined1 (*) [16])(unaff_x19 + 0x2b0) = auVar24;
  *(long *)(unaff_x19 + 0x458) = *(long *)(unaff_x19 + 0x138) + 0x10;
  *(undefined1 *)(unaff_x19 + 0xf48) = 0;
  lVar3 = unaff_x19 + 0x270;
  ...
  if (*(char *)(unaff_x19 + 0xf48) != '\0') {
    if (*(char *)(unaff_x19 + 0xf48) != '\x03') goto LAB_10098c0c0;
    if (*(char *)(unaff_x19 + 0xf40) == '\x03') {
      FUN_100e7ab5c(unaff_x19 + 0x650);
      goto LAB_10098c0c0;
    }
    if (*(char *)(unaff_x19 + 0xf40) != '\0') goto LAB_10098c0c0;
    lVar3 = unaff_x19 + 0x460;
  }
  FUN_100def028(lVar3);
LAB_10098c0c0:
  ...
  *(undefined8 *)(unaff_x28 + 0x48) = uVar19;
  if ((___ZN12tracing_core8metadata9MAX_LEVEL17h02c7742de62f64c3E < 5) &&
     (((bRam000000010b627fc0 - 1 < 2 ||
       ((bRam000000010b627fc0 != 0 &&
        (cVar4 = __ZN12tracing_core8callsite15DefaultCallsite8register17hd8a0d35d4a8f8e8bE
                           (&
                            __ZN16codex_app_server22bespoke_event_handling30on_request_user_input_response28__u7b__u7b_closure_u7d__u7d_10__CALLSITE17hd7473591684d2b90E
                           ), cVar4 != '\0')))) &&
      (uVar7 = __ZN7tracing15__macro_support12__is_enabled17h508af3f20e7344eeE
                         (
                         ___ZN16codex_app_server22bespoke_event_handling30on_request_user_input_response28__u7b__u7b_closure_u7d__u7d_10__CALLSITE17hd7473591684d2b90E
                         ), (uVar7 & 1) != 0)))) {
    ...
    *(long *)(unaff_x29 + -0xd8) = unaff_x29 + -0xb0;
    ...
    if ((__ZN12tracing_core10dispatcher6EXISTS17h9b1f5f531bc653aaE == '\0') &&
      ...
      iVar5 = (**(code **)(puVar1 + 0x18))(puVar2,&stack0x000001a0);
      if (iVar5 != 0) {
        ...
        *(undefined8 *)(unaff_x29 + -0xa8) = in_stack_000001a8;
        *(undefined8 *)(unaff_x29 + -0xb0) = in_stack_000001a0;
        *(undefined8 *)(unaff_x29 + -0xa0) = in_stack_000001b0;
        __ZN7tracing15__macro_support13__tracing_log17h72768b16bee39960E
  ...
  *(undefined1 *)(unaff_x19 + 0x201) = 0;
  if (*(long *)(unaff_x19 + 0x220) != -0x7ffffffffffffffb) {
