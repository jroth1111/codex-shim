...
void FUN_100f2aa40(undefined2 *param_1,long param_2)
...
LAB_100f2aac0:
        ...
        uStack_48 = puVar1[3];
        uStack_50 = puVar1[2];
        func_0x000100bda2e8(&sStack_40,&uStack_60);
        if (sStack_40 == 1) {
          _free(puVar1);
LAB_100f2ab48:
        ...
        if (cStack_80 == '\x12') goto LAB_100f2aac0;
        func_0x000100bda2e8(&uStack_60,&cStack_80);
        uStack_38 = uStack_58;
        if ((short)uStack_60 == 1) goto LAB_100f2ab48;
        uVar3 = 1;
