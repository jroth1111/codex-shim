...
void FUN_100fca4a4(long *param_1,ulong param_2,undefined8 param_3)

{
  ...
  undefined1 auStack_980 [496];
  
  uVar14 = param_2 & 0xffffffffffffffe0;
  lVar3 = *param_1;
  uVar4 = uVar14 - *(long *)(lVar3 + 0x3f00);
  if (uVar4 != 0) {
    plVar16 = (long *)(lVar3 + 0x3f00);
    bVar2 = (param_2 & 0x1f) < uVar4 >> 5;
    do {
      while( true ) {
        lVar17 = *(long *)(lVar3 + 0x3f08);
        if (*(long *)(lVar3 + 0x3f08) == 0) {
          lVar17 = *plVar16;
          lVar6 = _malloc(0x3f20);
          if (lVar6 == 0) {
            auVar18 = __ZN5alloc5alloc18handle_alloc_error17h77990a064974ed31E(8,0x3f20);
            plVar16 = auVar18._0_8_;
            uVar14 = auVar18._8_8_ & 0xffffffffffffffe0;
            uVar4 = uVar14 - *(long *)(*plVar16 + 0x1100);
            if (uVar4 == 0) {
              return;
            }
          ...
          *(long *)(lVar6 + 0x3f00) = lVar17 + 0x20;
          *(undefined8 *)(lVar6 + 0x3f08) = 0;
          *(undefined8 *)(lVar6 + 0x3f18) = 0;
          *(undefined8 *)(lVar6 + 0x3f10) = 0;
          lVar17 = *(long *)(lVar3 + 0x3f08);
          if (lVar17 == 0) {
            *(long *)(lVar3 + 0x3f08) = lVar6;
            lVar17 = lVar6;
          }
          else {
            *(long *)(lVar6 + 0x3f00) = *(long *)(lVar17 + 0x3f00) + 0x20;
            lVar12 = *(long *)(lVar17 + 0x3f08);
            if (lVar12 == 0) {
              *(long *)(lVar17 + 0x3f08) = lVar6;
            }
            else {
              do {
                InstructionSynchronizationBarrier();
                *(long *)(lVar6 + 0x3f00) = *(long *)(lVar12 + 0x3f00) + 0x20;
                plVar16 = (long *)(lVar12 + 0x3f08);
                lVar12 = *plVar16;
              } while (lVar12 != 0);
              *plVar16 = lVar6;
            }
        ...
        if (((bool)(bVar2 & (int)*(undefined8 *)(lVar3 + 0x3f10) == -1)) && (*param_1 == lVar3))
        break;
        bVar2 = false;
        InstructionSynchronizationBarrier();
        plVar16 = (long *)(lVar17 + 0x3f00);
        lVar3 = lVar17;
        if (*(ulong *)(lVar17 + 0x3f00) == uVar14) {
          return;
        }
      }
      *param_1 = lVar17;
      ...
      LORelease();
      *(ulong *)(lVar3 + 0x3f18) = uVar4;
      *(ulong *)(lVar3 + 0x3f10) = *(ulong *)(lVar3 + 0x3f10) | 0x100000000;
      LORelease();
      bVar2 = true;
      InstructionSynchronizationBarrier();
      plVar16 = (long *)(lVar17 + 0x3f00);
      lVar3 = lVar17;
    } while (*(ulong *)(lVar17 + 0x3f00) != uVar14);
  }
  return;
LAB_100fca6b8:
  lVar17 = *(long *)(lVar3 + 0x1108);
  if (*(long *)(lVar3 + 0x1108) == 0) {
    lVar17 = *(long *)(lVar3 + 0x1100);
    lVar6 = _malloc(0x1120);
    if (lVar6 == 0) {
      auVar18 = __ZN5alloc5alloc18handle_alloc_error17h77990a064974ed31E(8,0x1120);
      plVar16 = auVar18._0_8_;
      uVar14 = auVar18._8_8_ & 0xffffffffffffffe0;
      uVar4 = uVar14 - *(long *)(*plVar16 + 0x100);
      if (uVar4 == 0) {
        return;
      }
      bVar2 = (auVar18._8_8_ & 0x1f) < uVar4 >> 5;
    ...
    *(long *)(lVar6 + 0x1100) = lVar17 + 0x20;
    *(undefined8 *)(lVar6 + 0x1108) = 0;
    *(undefined8 *)(lVar6 + 0x1118) = 0;
    *(undefined8 *)(lVar6 + 0x1110) = 0;
    lVar17 = *(long *)(lVar3 + 0x1108);
    if (lVar17 == 0) {
      *(long *)(lVar3 + 0x1108) = lVar6;
      lVar17 = lVar6;
    }
    else {
      *(long *)(lVar6 + 0x1100) = *(long *)(lVar17 + 0x1100) + 0x20;
      lVar12 = *(long *)(lVar17 + 0x1108);
      if (lVar12 == 0) {
        *(long *)(lVar17 + 0x1108) = lVar6;
      }
      else {
        do {
          InstructionSynchronizationBarrier();
          *(long *)(lVar6 + 0x1100) = *(long *)(lVar12 + 0x1100) + 0x20;
          plVar13 = (long *)(lVar12 + 0x1108);
          lVar12 = *plVar13;
        } while (lVar12 != 0);
        *plVar13 = lVar6;
      }
  ...
  if (((bool)(bVar2 & (int)*(undefined8 *)(lVar3 + 0x1110) == -1)) && (*plVar16 == lVar3)) {
    *plVar16 = lVar17;
    uVar4 = plVar16[1];
    plVar16[1] = uVar4 | in_xzr;
    LORelease();
    *(ulong *)(lVar3 + 0x1118) = uVar4;
    *(ulong *)(lVar3 + 0x1110) = *(ulong *)(lVar3 + 0x1110) | 0x100000000;
    LORelease();
    bVar2 = true;
    InstructionSynchronizationBarrier();
    uVar4 = *(ulong *)(lVar17 + 0x1100);
  }
  else {
    bVar2 = false;
    InstructionSynchronizationBarrier();
  ...
  goto LAB_100fca6b8;
LAB_100fca81c:
  lVar17 = *(long *)(lVar3 + 0x108);
  if (*(long *)(lVar3 + 0x108) == 0) {
    lVar17 = *(long *)(lVar3 + 0x100);
    lVar6 = _malloc(0x120);
    if (lVar6 == 0) {
      auVar18 = __ZN5alloc5alloc18handle_alloc_error17h77990a064974ed31E(8,0x120);
      plVar16 = auVar18._0_8_;
      uVar14 = auVar18._8_8_ & 0xffffffffffffffe0;
      uVar4 = uVar14 - *(long *)(*plVar16 + 0x2400);
      if (uVar4 == 0) {
        return;
      }
      bVar2 = (auVar18._8_8_ & 0x1f) < uVar4 >> 5;
    ...
    *(long *)(lVar6 + 0x100) = lVar17 + 0x20;
    *(undefined8 *)(lVar6 + 0x108) = 0;
    *(undefined8 *)(lVar6 + 0x110) = 0;
    *(undefined8 *)(lVar6 + 0x118) = 0;
    lVar17 = *(long *)(lVar3 + 0x108);
    if (lVar17 == 0) {
      *(long *)(lVar3 + 0x108) = lVar6;
      lVar17 = lVar6;
    }
    else {
      *(long *)(lVar6 + 0x100) = *(long *)(lVar17 + 0x100) + 0x20;
      lVar12 = *(long *)(lVar17 + 0x108);
      if (lVar12 == 0) {
        *(long *)(lVar17 + 0x108) = lVar6;
      }
      else {
        do {
          InstructionSynchronizationBarrier();
          *(long *)(lVar6 + 0x100) = *(long *)(lVar12 + 0x100) + 0x20;
          plVar13 = (long *)(lVar12 + 0x108);
          lVar12 = *plVar13;
        } while (lVar12 != 0);
        *plVar13 = lVar6;
      }
  ...
  if (((bool)(bVar2 & (int)*(undefined8 *)(lVar3 + 0x110) == -1)) && (*plVar16 == lVar3)) {
    *plVar16 = lVar17;
    uVar4 = plVar16[1];
    plVar16[1] = uVar4 | in_xzr;
    LORelease();
    *(ulong *)(lVar3 + 0x118) = uVar4;
    *(ulong *)(lVar3 + 0x110) = *(ulong *)(lVar3 + 0x110) | 0x100000000;
    LORelease();
    bVar2 = true;
    InstructionSynchronizationBarrier();
    uVar4 = *(ulong *)(lVar17 + 0x100);
  }
  else {
    bVar2 = false;
    InstructionSynchronizationBarrier();
...
LAB_100fca998:
  ...
  if (((bool)(bVar2 & (int)*(undefined8 *)(lVar3 + 0x2410) == -1)) && (*plVar16 == lVar3)) {
    *plVar16 = lVar17;
    uVar4 = plVar16[1];
    plVar16[1] = uVar4 | in_xzr;
    LORelease();
...
LAB_100fcc784:
            ...
            *(undefined1 *)(lVar3 + 0x479) = 0;
            ...
            _memcpy(auStack_980,lVar3 + 0x208,0x1f0);
          }
          else {
LAB_100fcc6f8:
            uStack_b70 = 0;
            ...
            *(undefined8 *)(lVar3 + 0x440) = uStack_b78;
...
LAB_100fcc720:
            ...
            *(undefined1 *)(lVar3 + 0x470) = 1;
            *(undefined1 *)(lVar3 + 0x479) = 0;
            _memcpy(&uStack_b78,lVar3 + 0x200,0x1f8);
            lVar6 = *plVar16;
            LOAcquire();
            uVar4 = *(ulong *)(lVar6 + 0x88);
            *(ulong *)(lVar6 + 0x88) = uVar4 + 1;
            lVar17 = FUN_100fca4a4(lVar6 + 0x80,uVar4);
            _memcpy(lVar17 + (uVar4 & 0x1f) * 0x1f8,&uStack_b78,0x1f8);
          ...
          *(undefined1 *)(lVar3 + 0x479) = 0;
          *puVar7 = uVar15;
          _memcpy(puVar7 + 1,auStack_980,0x1f0);
          uVar11 = 1;
LAB_100fcc7c0:
