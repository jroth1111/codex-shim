...
void FUN_103da6be4(long param_1)

{
  ...
  **(long **)(param_1 + 0x20) = lVar2 + -1;
  ...
  func_0x000103da21f4(param_1 + 0x30);
  if (*(long *)(param_1 + 0x1be0) != 0) {
    (**(code **)(*(long *)(param_1 + 0x1be0) + 0x18))(*(undefined8 *)(param_1 + 0x1be8));
  }
  ...
  if (plVar4 != (long *)0x0) {
    ...
    *plVar4 = lVar2 + -1;
    ...
    if (lVar2 == 1) {
      ...
      puVar1 = *(undefined8 **)(param_1 + 0x1bf8);
      uVar5 = puVar1[2];
