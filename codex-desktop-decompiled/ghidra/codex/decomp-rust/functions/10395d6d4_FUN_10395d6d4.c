...
void FUN_10395d6d4(char *param_1,ulong param_2,undefined8 param_3)

{
  ...
  uVar5 = 0;
  uVar6 = 0;
  if (param_2 == 0) goto LAB_10395d8e8;
  lVar7 = param_2 - 1;
  if (lVar7 == 0) {
    uVar6 = 0;
    if (*param_1 != '/') {
    ...
    do {
      if (param_1[uVar8] == '/') {
        if (uVar5 <= uVar8 && uVar8 - uVar5 != 0) {
          ...
          FUN_10397a8ac(param_3,param_1 + uVar5,uVar8 - uVar5);
        }
        uVar4 = 0;
        if (param_1[uVar8 + 1] == '.') {
...
LAB_10395d85c:
  ...
  if (cVar2 != '/') goto LAB_10395d8e8;
  uVar9 = uVar8 + 2;
  if (uVar5 <= uVar8) {
    uVar6 = (lVar7 - uVar5) + uVar6;
    uVar6 = uVar6 >> 2 | uVar6 << 0x3e;
    FUN_10397a8ac(param_3,param_1 + uVar5);
  }
...
LAB_10395d8e8:
  ...
  uStack_58 = uVar6;
  FUN_10397a8ac(param_3,&uStack_58,8);
  return;
}
