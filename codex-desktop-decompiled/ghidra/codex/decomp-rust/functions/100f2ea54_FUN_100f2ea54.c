...
void FUN_100f2ea54(long *param_1,long param_2)
...
LAB_100f2ea90:
  ...
  *(char **)(param_2 + 8) = pcVar2 + 0x20;
  if (cStack_a0 == '\x16') goto LAB_100f2ea90;
...
LAB_100f2ead4:
    ...
    if (cStack_a0 == '\x11') {
      ...
      lStack_68 = plVar1[3];
      lStack_70 = plVar1[2];
      FUN_10061cfd8(&lStack_58,&lStack_80);
      ...
      if (cStack_a0 == '\x12') goto LAB_100f2ead4;
      FUN_10061cfd8(&lStack_80,&cStack_a0);
      unaff_x21 = lStack_78;
      unaff_x22 = lStack_70;
