...
void FUN_1017a32bc(long param_1)

{
  ...
  **(long **)(param_1 + 0x20) = lVar1 + -1;
  ...
  if (*(int *)(param_1 + 0x30) == 1) {
    ...
    FUN_1017a97a4(param_1 + 0x38);
  }
  if (*(long *)(param_1 + 0x860) != 0) {
    (**(code **)(*(long *)(param_1 + 0x860) + 0x18))(*(undefined8 *)(param_1 + 0x868));
  }
  plVar4 = *(long **)(param_1 + 0x870);
  if (plVar4 != (long *)0x0) {
    lVar1 = *plVar4;
    *plVar4 = lVar1 + -1;
    LORelease();
    if (lVar1 == 1) {
      ...
      puVar5 = *(undefined8 **)(param_1 + 0x878);
      uVar6 = puVar5[2];
