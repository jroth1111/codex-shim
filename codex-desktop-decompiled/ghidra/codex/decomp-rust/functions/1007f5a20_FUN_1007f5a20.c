...

{
  ...
  func_0x000105a96624(&stack0x00000ba0,pcVar8 + 0x1f0,uVar5);
  in_stack_00000020 = 1;
  in_stack_00000028 = &stack0x00000580;
  if (*pcVar9 == '\0') {
    *pcVar9 = '\x01';
  }
  else {
  ...
  if (((((ulong)in_stack_00000028 & 0xffffffff) < *(ulong *)(in_stack_00000020 + 0x10)) &&
    ...
    if (cVar2 == '\0') {
      func_0x000105a8dbb0(pcVar1,uVar4,&stack0x000006f0);
    }
    ...
    __ZN14rama_http_core2h25proto7streams6counts6Counts16transition_after17ha1da6b7002dcf5f5E
              (pcVar8 + 8,&stack0x000006f0,(int)lVar3 != 1000000000);
    if (*pcVar9 == '\x01') {
      *pcVar9 = in_wzr;
    }
    else {
    ...
    *(undefined1 *)(in_stack_00000018 + 2) = 0xfc;
    *(undefined1 *)((long)in_stack_00000018 + 9) = 0x7a;
    *(undefined2 *)((long)in_stack_00000018 + 10) = 0x8ac;
    in_stack_00000018[3] = 1;
    *(undefined1 **)(in_stack_00000018 + 4) = &stack0x00000a40;
  ...
  pcVar6 = (code *)SoftwareBreakpoint(1,0x1007fa264);
  (*pcVar6)();
}
