...

{
  ...
  uVar3 = FUN_108876314(s_missing_field_____108ac28f7,unaff_x29 + -0xe0);
...
LAB_1017422b8:
            ...
            lVar5 = *(long *)(in_stack_00000228 + lVar14 + 0x18);
            if (lVar5 == 1) goto LAB_10174091c;
LAB_101740818:
            if ((lVar5 != 3) || (*psVar9 != 0x746b || (char)psVar9[1] != 'y')) goto LAB_1017407d4;
LAB_10174105c:
            lVar5 = func_0x000101769f44(in_stack_00000228 + lVar14 + 0x20);
            if (lVar5 != 0) goto LAB_1017409c0;
            goto joined_r0x000101741078;
          }
          lVar5 = *(long *)(in_stack_00000228 + lVar14 + 8);
          if (lVar5 != 1) {
            if (lVar5 != 2) {
              if (lVar5 == 0) goto LAB_10174105c;
              goto LAB_1017407d4;
            }
LAB_101740958:
...
LAB_101740930:
        ...
        if (bVar1 == 0xd) {
          ...
          lVar5 = *(long *)(in_stack_00000228 + lVar14 + 0x10);
          if (lVar5 != 1) goto LAB_101740818;
LAB_10174091c:
        ...
        else if ((((lVar5 == 3) && (*pcVar11 == 'k')) && (pcVar11[1] == 't')) && (pcVar11[2] == 'y')
                ) goto LAB_10174105c;
      }
LAB_1017407d4:
      lVar14 = lVar14 + 0x40;
  ...
  *(undefined **)(unaff_x29 + -0xd8) = &DAT_101744cb8;
  lVar5 = FUN_108876314(s_missing_field_____108ac28f7,unaff_x29 + -0xe0);
LAB_1017409c0:
...
LAB_101741040:
            ...
            if (bVar1 - 0xc < 2) {
              ...
              if (bVar1 != 0x15) {
                ...
                lVar5 = func_0x000108a4a50c(unaff_x29 + -0xe0,&UNK_10b2564e8,&UNK_10b2564c8);
                goto LAB_101740ba0;
              }
              lVar5 = *(long *)(in_stack_00000228 + lVar14 + 0x38);
              if (lVar5 != 1) {
                if (lVar5 == 0) {
            ...
            if (bVar1 < 0xd) {
              ...
              if (bVar1 == 0xd) {
                ...
                lVar5 = *(long *)(pbVar6 + 0x10);
LAB_10174141c:
                if (lVar5 == 3) {
                  if (*psVar9 == 0x636f && (char)psVar9[1] == 't') goto LAB_101741440;
                  lVar5 = 3;
                }
                lVar5 = FUN_1088755e4(psVar9,lVar5,&UNK_10b256ba8,1);
                goto LAB_101740ba0;
              }
              if (bVar1 == 0xe) {
                lVar5 = 0x18;
              ...
              if (((*(long *)(pbVar6 + lVar5) != 3) || (*pcVar11 != 'o')) ||
                 ((pcVar11[1] != 'c' || (pcVar11[2] != 't')))) {
                __ZN5alloc6string6String15from_utf8_lossy17hfb27054e23a2c9beE
                          (unaff_x29 + -0xe0,pcVar11,*(long *)(pbVar6 + lVar5),&UNK_10b2565d8);
                uVar13 = *(ulong *)(unaff_x29 + -0xe0);
                uVar3 = *(undefined8 *)(unaff_x29 + -0xd8);
                lVar5 = FUN_1088755e4(uVar3,*(undefined8 *)(unaff_x29 + -0xd0),&UNK_10b256ba8,1);
...
LAB_101741440:
              if ((pbVar4 == (byte *)0x0) || (*pbVar4 == 0x12)) {
...
LAB_101742780:
            lVar5 = FUN_108876268(pbVar6,unaff_x29 + -0xa0,puVar7);
            goto LAB_101740ba0;
          }
        }
        else {
...
LAB_101740b38:
        ...
        else if ((lVar5 == 3) && (*psVar9 == 0x746b && (char)psVar9[1] == 'y')) goto LAB_101741040;
      }
      else {
        if (bVar1 == 0xe) {
          psVar9 = *(short **)(in_stack_00000228 + lVar14 + 0x10);
        ...
        if (lVar5 == 1) goto LAB_101740b38;
        if ((((lVar5 == 3) && ((char)*psVar9 == 'k')) && (*(char *)((long)psVar9 + 1) == 't')) &&
...
joined_r0x000101741078:
  ...
  lVar5 = in_stack_00000228 + lVar14;
...
LAB_1017412d4:
        ...
        *(undefined ***)(unaff_x29 + -0xe0) = &stack0x000001c0;
        *(undefined **)(unaff_x29 + -0xd8) = &DAT_101744cb8;
        lVar5 = FUN_108876314(s_duplicate_field_____108ac2973,unaff_x29 + -0xe0);
        goto LAB_1017409c0;
      }
    }
    else {
...
LAB_1017422bc:
    lVar5 = FUN_108876268(lVar14,unaff_x29 + -0xa0,&UNK_10b256638);
    goto LAB_1017409c0;
  }
...
LAB_101741254:
    if (uVar12 != 0x8000000000000000) goto LAB_101742214;
    FUN_10176936c(unaff_x29 + -0xe0,lVar5 + 0x60);
    uVar12 = *(ulong *)(unaff_x29 + -0xe0);
    if (uVar12 == 0x8000000000000000) goto LAB_101741308;
    unaff_x21 = *(long *)(unaff_x29 + -0xd8);
    unaff_x25 = *(ulong *)(unaff_x29 + -0xd0);
...
joined_r0x000101741458:
  ...
  if (0xc < bVar1) {
    if (bVar1 == 0xd) {
      psVar9 = *(short **)(in_stack_00000228 + lVar14 + 0x48);
      lVar5 = *(long *)(in_stack_00000228 + lVar14 + 0x50);
LAB_101741564:
      if (lVar5 != 3) {
LAB_10174156c:
        if ((lVar5 != 1) || ((char)*psVar9 != 'k')) goto LAB_101741484;
        goto LAB_101741580;
      }
      ...
      if (bVar1 == 0xe) {
        psVar9 = *(short **)(in_stack_00000228 + lVar14 + 0x50);
        lVar5 = *(long *)(in_stack_00000228 + lVar14 + 0x58);
      }
      else {
  ...
  if (bVar1 != 1) {
    if (bVar1 == 4) {
      lVar5 = *(long *)(in_stack_00000228 + lVar14 + 0x48);
      iVar8 = 1;
      if (lVar5 != 1) {
        iVar8 = 2;
      }
      if (lVar5 == 0) goto LAB_101741654;
      goto LAB_10174154c;
    }
    if (bVar1 == 0xc) {
      psVar9 = *(short **)(in_stack_00000228 + lVar14 + 0x50);
...
LAB_1017423bc:
    lVar14 = in_stack_00000228 + lVar14 + 0x40;
LAB_101742304:
    lVar5 = FUN_108876268(lVar14,unaff_x29 + -0xa0,&UNK_10b256618);
    goto LAB_101740ba0;
  }
  cVar2 = *(char *)(in_stack_00000228 + lVar14 + 0x41);
  iVar8 = 1;
...
joined_r0x0001017410a0:
  ...
  if (0xc < bVar1) {
    if (bVar1 == 0xd) {
      ...
      lVar5 = *(long *)(in_stack_00000228 + in_stack_000000c8 + 0x50);
LAB_1017417b8:
      if (lVar5 == 3) {
...
LAB_1017417c0:
        if ((lVar5 == 1) && ((char)*psVar9 == 'x')) goto LAB_1017417d4;
      }
    }
    else {
      if (bVar1 == 0xe) {
        psVar9 = *(short **)(in_stack_00000228 + in_stack_000000c8 + 0x50);
        lVar5 = *(long *)(in_stack_00000228 + in_stack_000000c8 + 0x58);
      }
      else {
  ...
  if (bVar1 != 1) {
    if (bVar1 == 4) {
      lVar5 = *(long *)(in_stack_00000228 + in_stack_000000c8 + 0x48);
      if (lVar5 != 1) {
        if (lVar5 != 2) {
          if (lVar5 == 0) goto LAB_101741870;
          goto LAB_1017416d0;
        }
        goto LAB_1017417d4;
      }
