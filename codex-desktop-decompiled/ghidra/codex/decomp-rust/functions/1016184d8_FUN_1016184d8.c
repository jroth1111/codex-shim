...
void FUN_1016184d8(undefined8 *param_1,long *param_2)

{
  ...
  if (lVar3 == -0x8000000000000000) {
    if (lStack_80 == 6) {
      if ((int)*plVar1 != 0x72626577 || *(short *)((long)plVar1 + 4) != 0x6374) {
code_r0x0001087e44e4:
        puStack_78 = &UNK_10b220000;
        uStack_70 = 2;
      ...
      *(undefined1 *)(param_1 + 1) = 0;
      ...
      if ((lStack_80 != 9) || (*plVar1 != 0x656b636f73626577 || (char)plVar1[1] != 't'))
...
LAB_101618550:
    FUN_1087e44e4(param_1,plVar1,lStack_80,&UNK_10b220000,2);
  }
  else {
    if ((lStack_80 != 9) || (*plVar1 != 0x656b636f73626577 || (char)plVar1[1] != 't'))
    goto LAB_101618550;
