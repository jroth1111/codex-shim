...
void FUN_10392b2fc(long *param_1)
  ...
  if (lVar3 != 0) {
    ...
    if (lVar4 != 0) {
      ...
      do {
        ...
        if (plVar5[(long)-iVar2 * 10 + -10] != 0) {
          _free(plVar5[(long)-iVar2 * 10 + -9]);
        }
        uVar7 = uVar7 - 1 & uVar7;
        lVar4 = lVar4 + -1;
        FUN_10392e9f0(plVar5 + (long)-iVar2 * 10 + -7);
      } while (lVar4 != 0);
    }
    if (lVar3 * 0x51 != -0x59) {
                    /* WARNING: Could not recover jumptable at 0x000108aa97cc. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      (*(code *)PTR__free_10b61b0a8)(*param_1 + lVar3 * -0x50 + -0x50);
      return;
    }
  }
  return;
