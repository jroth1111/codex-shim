...
void FUN_100cf5a30(long param_1)
...
code_r0x0001047f2050:
    ...
    if (cVar2 == '\x03') {
      ...
      if (*(char *)(param_1 + 0x24f) == '\0') {
        ...
        **(long **)(param_1 + 0x240) = lVar3 + -1;
        LORelease();
        if (lVar3 == 1) {
          DataMemoryBarrier(2,1);
          __ZN5alloc4sync16Arc_LT_T_C_A_GT_9drop_slow17h10f445fb86fd931aE(param_1 + 0x240);
        }
        _close(*(undefined4 *)(param_1 + 0x248));
        plVar6 = (long *)*plVar5;
        if (plVar6 != (long *)0x0) {
          lVar3 = *plVar6;
          *plVar6 = lVar3 + -1;
      ...
      else if (*(char *)(param_1 + 0x24f) == '\x03') {
        FUN_100cc8e40(param_1 + 0x50);
