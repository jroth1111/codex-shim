...

{
  ...
  uVar5 = FUN_108856088(s_missing_field_____108ac28f7,unaff_x29 + -0x90);
  *unaff_x23 = 0x8000000000000000;
  unaff_x23[1] = uVar5;
  FUN_100cfb250(unaff_x29 + -0x100);
  ...
  if (((in_stack_000000b0 & 0x7fffffffffffffff) != 0) && ((unaff_x19 & 1) != 0)) {
    _free(in_stack_00000030);
  }
  uVar1 = 0;
  if (in_stack_00000250 != -0x7fffffffffffffff) {
    uVar1 = unaff_w22;
  }
  if (((uVar1 & 1) != 0) && (in_stack_00000250 != -0x8000000000000000)) {
  ...
  if (*in_stack_000000a0 == -0x8000000000000000) {
    ...
    if (lVar3 == lVar7) {
      ...
      *(long *)(unaff_x29 + -0x100) = in_stack_00000110;
      lVar7 = FUN_1087e422c(in_stack_00000110 + ((ulong)(lVar3 - lVar7) >> 6),unaff_x29 + -0x100,
                            &UNK_10b23a190);
    }
    if (in_stack_000000d0 != '\x16') {
      FUN_100e077ec(&stack0x000000d0);
