...
/* WARNING: Removing unreachable block (ram,0x000101c27134) */
/* WARNING: Removing unreachable block (ram,0x000101c27140) */
/* WARNING: Removing unreachable block (ram,0x000101c27180) */

void FUN_101c27470(void)

{
  ...
  lVar3 = FUN_1088dc508(s_missing_field_____108ac28f7,unaff_x29 + -0x90);
  *unaff_x19 = 0x12;
  unaff_x19[1] = lVar3;
  ...
  if (((in_stack_00000098 != 0x8000000000000001) && ((unaff_x21 & 1) != 0)) &&
     ((in_stack_00000098 & 0x7fffffffffffffff) != 0)) {
    _free(in_stack_00000028);
  }
  uVar1 = 0;
  ...
  if (*unaff_x19 == 0x12) {
    ...
    if (lVar2 == lVar3) {
      ...
      *(long *)(unaff_x29 + -0xc0) = in_stack_000000e0;
      lVar3 = FUN_1088c7110(in_stack_000000e0 + ((ulong)(lVar2 - lVar3) >> 6),unaff_x29 + -0xc0,
                            &UNK_10b276c98);
    }
    if (in_stack_000000a0 != '\x16') {
      FUN_1020378e0(&stack0x000000a0);
