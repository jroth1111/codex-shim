...
undefined8 FUN_1006f36bc(undefined8 param_1)

{
  ...
  *(char **)(unaff_x29 + -0x90) = s_>write_socks5_server_reply_w___s_108ac4429;
  ...
  *puVar6 = 0;
  *(undefined8 *)(unaff_x19 + 0x3f) = 0;
  *(undefined8 *)(unaff_x19 + 0x38) = 0;
  *(undefined8 *)(unaff_x19 + 0x30) = 0;
  lStack0000000000000098 = 0x27;
  puStack0000000000000090 = puVar6;
  FUN_1006f32a4();
  uVar5 = *unaff_x26;
  if (0x27 < uVar5) {
    __ZN4core5slice5index16slice_index_fail17h29aa2edd8429fa12E(0,uVar5,0x27,&UNK_10b21eba0);
LAB_1006f431c:
                    /* WARNING: Does not return */
    pcVar3 = (code *)SoftwareBreakpoint(1,0x1006f4320);
    (*pcVar3)();
  }
  *(undefined8 *)(unaff_x19 + 0x48) = unaff_x25;
  *(undefined8 **)(unaff_x19 + 0x50) = puVar6;
  *(ulong *)(unaff_x19 + 0x58) = uVar5;
  do {
    if (uVar5 == 0) break;
    auVar7 = func_0x0001060f8f1c(*(undefined8 *)(unaff_x19 + 0x48));
    uVar4 = auVar7._8_8_;
    if (auVar7._0_8_ == 2) {
      *(undefined1 *)(unaff_x19 + 0x18) = 4;
      return 1;
    }
    if ((auVar7._0_8_ & 1) != 0) break;
    lVar1 = *(long *)(unaff_x19 + 0x50);
    uVar2 = *(ulong *)(unaff_x19 + 0x58);
    ...
    *(ulong *)(unaff_x19 + 0x50) = lVar1 + uVar4;
    *(ulong *)(unaff_x19 + 0x58) = uVar5;
  } while (uVar4 != 0);
