...
void FUN_103e5c5c8(ulong *param_1)
...
LAB_103e5c71c:
    ...
    *param_1 = uStack_68 + uStack_70 * -0x40;
    ...
    if ((uVar6 >> 1 & 1) != 0) goto LAB_103e5c698;
    if ((uVar6 >> 3 & 1) == 0) {
      auStack_b98[0] = 2;
      unaff_x22 = param_1[5];
      unaff_x20 = (*
      ...
      if (*(char *)(unaff_x20 + 0x48) == '\x01') goto LAB_103e5c6c8;
      if (*(char *)(unaff_x20 + 0x48) != '\x02') goto LAB_103e5c6b0;
      uVar7 = 0;
      goto LAB_103e5c6d0;
    }
    if ((uVar6 >> 4 & 1) == 0) goto LAB_103e5c71c;
    if (param_1[0x16c] != 0) {
...
LAB_103e5c800:
  ...
  pcVar1 = (code *)SoftwareBreakpoint(1,0x103e5c804);
  (*pcVar1)();
}
