...

{
  ...
  uVar9 = FUN_108856088(s_missing_field_____108ac28f7,&stack0x000000b0);
  ...
  *(undefined1 *)(unaff_x29 + -0xa0) = 0x16;
  ...
  if (bVar3 != 0x14) {
    if (bVar3 != 0x15) {
      uVar9 = FUN_108855b04(&stack0x00000090,unaff_x29 + -0xa0,&UNK_10b20c520);
      goto LAB_101275538;
    }
...
LAB_101274d0c:
      ...
      *(undefined8 *)((long)puVar17 + 0xf) = uVar9;
      ...
      *puVar17 = uVar9;
      ...
      uVar9 = CONCAT71(uStack00000000000000c1,uStack00000000000000c0);
      lVar16 = lVar15;
      if (0xc < bStack00000000000000b0) {
        if (bStack00000000000000b0 == 0xd) {
          FUN_100b1df10(unaff_x29 + -0x80,uVar1,uVar9);
          goto LAB_101274e08;
        }
        if (bStack00000000000000b0 == 0xe) {
          FUN_100b1dc94(unaff_x29 + -0x80,uVar9,in_stack_000000c8);
...
LAB_101274dc8:
        ...
        if (bStack00000000000000b0 == 0xf) {
          FUN_100b1dc94(unaff_x29 + -0x80,uVar1,uVar9);
          goto LAB_101274e08;
        }
LAB_101275138:
        uVar9 = FUN_108855b04(&stack0x000000b0,unaff_x29 + -0xa0,&UNK_10b20fb40);
...
LAB_101274e08:
        ...
        FUN_100b1df10(unaff_x29 + -0x80,uVar9);
        ...
        *(byte *)(unaff_x29 + -0x80) = bVar5;
        if (bVar5 != 0x10) {
          if (bVar5 == 0x11) {
            ...
            bStack00000000000000b0 = (byte)uVar9;
            bStack00000000000000b1 = (byte)((ulong)uVar9 >> 8);
            uStack00000000000000b2 = (undefined2)((ulong)uVar9 >> 0x10);
            uStack00000000000000b4 = (undefined4)((ulong)uVar9 >> 0x20);
...
LAB_101274e80:
        ...
        *(undefined8 *)((long)puVar14 + 0xf) = uVar9;
...
LAB_101274fd4:
        ...
        if (uStack0000000000000080 != 0x8000000000000001) {
          ...
          *(undefined8 *)(unaff_x29 + -0x78) = 4;
          ...
          uStack00000000000000b9 = 0x100c7b3;
          in_stack_00000168 = pbVar25;
          uVar9 = FUN_108856088(s_duplicate_field_____108ac2973,&stack0x000000b0);
...
LAB_101274c68:
    ...
    *(long *)(unaff_x29 + -0x90) = lVar16;
    if (lVar10 == 1) {
LAB_101274bf4:
      uVar9 = FUN_1087e422c(1,&UNK_10b22d500,&UNK_10b20a590);
LAB_101274c0c:
      bStack00000000000000b0 = 2;
      bStack00000000000000b1 = 0;
      uStack00000000000000b2 = 0;
...
LAB_1012755dc:
    uVar9 = FUN_100e077ec(&stack0x00000140);
    lVar21 = 0;
LAB_10127574c:
    if (lVar10 == 2) {
LAB_101275768:
...
LAB_1012758bc:
      uVar8 = FUN_1087e422c(4,&UNK_10b22d500,&UNK_10b20a590);
LAB_1012758d4:
      bStack00000000000000b0 = 2;
      bStack00000000000000b1 = 0;
      uStack00000000000000b2 = 0;
...
LAB_1012753c0:
  ...
  uVar9 = CONCAT71(uStack00000000000000b9,bStack00000000000000b8);
LAB_101275538:
  *in_stack_00000070 = 2;
  in_stack_00000070[1] = uVar9;
  return;
LAB_1012751ac:
...
LAB_10127524c:
    ...
    FUN_100d34830(&stack0x00000160);
    if (pbVar20 != pbVar18) {
      uVar9 = FUN_1087e422c(((ulong)((long)pbVar20 - (long)pbVar18) >> 6) + lVar16,&stack0x00000230,
                            &UNK_10b23a190);
      bStack00000000000000b0 = 2;
      bStack00000000000000b1 = 0;
      uStack00000000000000b2 = 0;
