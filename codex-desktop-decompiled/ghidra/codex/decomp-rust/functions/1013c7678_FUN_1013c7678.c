...
/* WARNING: Removing unreachable block (ram,0x0001013c782c) */
/* WARNING: Removing unreachable block (ram,0x0001013c77a0) */
/* WARNING: Removing unreachable block (ram,0x0001013c7798) */

void FUN_1013c7678(void)

{
  ...
  lStack0000000000000128 = FUN_108856088(s_missing_field_____108ac28f7,&stack0x00000690);
  ...
  if (in_stack_00000120 == -0x8000000000000000) {
    *in_stack_000000f0 = 0x800000000000000b;
    in_stack_000000f0[1] = lStack0000000000000128;
  }
  else {
