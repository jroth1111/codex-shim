...
/* WARNING: Removing unreachable block (ram,0x00010133d3c8) */

void FUN_10133cd80(undefined1 *param_1,char *param_2)
...
LAB_10133d2ec:
    ...
    if ((byte)uStack_e0 == 4) {
      if (plStack_118 != (long *)0x0) {
        if (plStack_118 == (long *)0x1) goto LAB_10133d02c;
        if (plStack_118 == (long *)0x2) goto LAB_10133d1cc;
    ...
    if ((byte)uStack_e0 == 0xc) {
      if (lStack_108 == 7) {
        if ((int)*plStack_110 != 0x646e6570 || *(int *)((long)plStack_110 + 3) != 0x676e6964)
        goto LAB_10133d0ec;
        uStack_140 = (char *)((ulong)uStack_140._2_6_ << 0x10);
      }
      else if (lStack_108 == 0xb) {
        if (*plStack_110 != 0x72676f72705f6e69 ||
            *(long *)((long)plStack_110 + 3) != 0x73736572676f7270) goto LAB_10133d0ec;
        uStack_140 = (char *)CONCAT62(uStack_140._2_6_,0x100);
      }
      else if ((lStack_108 == 9) &&
              (*plStack_110 == 0x6574656c706d6f63 && (char)plStack_110[1] == 'd')) {
        uStack_140 = (char *)CONCAT62(uStack_140._2_6_,0x200);
      }
      else {
LAB_10133d0ec:
        pcStack_138 = (char *)FUN_1087e4494(plStack_110,lStack_108,&UNK_10b223198,3);
        uStack_140 = (char *)CONCAT71(uStack_140._1_7_,1);
      }
joined_r0x00010133d1e8:
      if (plVar5 == (long *)0x0) goto LAB_10133d2f8;
      _free(plVar6);
      pcVar9 = uStack_140;
      lVar10 = lStack_88;
      lStack_88 = lStack_68;
      goto joined_r0x00010133d300;
    }
LAB_10133d39c:
    pcStack_138 = (char *)FUN_108855b04(&uStack_e0,&uStack_51,&UNK_10b2119e0);
    uStack_140 = (char *)CONCAT71(uStack_140._1_7_,1);
    lVar10 = lStack_88;
LAB_10133d304:
    lStack_88 = lVar10;
    ...
    if ((byte)uStack_e0 == 0xd) {
      if (plStack_110 == (long *)0x7) {
        if ((int)*plStack_118 == 0x646e6570 && *(int *)((long)plStack_118 + 3) == 0x676e6964)
        goto LAB_10133d2e8;
      }
      else if (plStack_110 == (long *)0xb) {
        if (*plStack_118 == 0x72676f72705f6e69 &&
            *(long *)((long)plStack_118 + 3) == 0x73736572676f7270) goto LAB_10133d02c;
      }
      else if ((plStack_110 == (long *)0x9) &&
              (*plStack_118 == 0x6574656c706d6f63 && (char)plStack_118[1] == 'd'))
      goto LAB_10133d1cc;
      pcStack_138 = (char *)FUN_1087e4494(plStack_118,plStack_110,&UNK_10b223198,3);
LAB_10133d148:
      uVar8 = 1;
      goto LAB_10133d2ec;
    }
    if ((byte)uStack_e0 == 0xe) {
      func_0x000100ae2b9c(&uStack_140,plStack_110,lStack_108);
      goto joined_r0x00010133d1e8;
    }
    if ((byte)uStack_e0 != 0xf) goto LAB_10133d39c;
    func_0x000100ae2b9c(&uStack_140,plStack_118,plStack_110);
LAB_10133d2f0:
    FUN_100e077ec(&uStack_e0);
LAB_10133d2f8:
    pcVar9 = uStack_140;
    lVar10 = lStack_88;
    lStack_88 = lStack_68;
joined_r0x00010133d300:
    bVar4 = (char)uStack_140 == '\x01';
    uStack_140 = pcVar9;
    lStack_68 = lStack_88;
    if (bVar4) goto LAB_10133d304;
...
LAB_10133d2bc:
        ...
        if ((uVar1 == 0x12) || ((uVar1 == 0x15 && (lStack_88 == 0)))) goto LAB_10133d2bc;
        pcVar9 = (char *)FUN_108855b04(&cStack_a0,&uStack_51,&UNK_10b20a5c0);
        goto LAB_10133d31c;
      }
LAB_10133d2c4:
    ...
    if (uVar1 == 0x16) goto LAB_10133d2c4;
    if ((uVar1 == 0x12) || ((uVar1 == 0x15 && (lStack_88 == 0)))) goto LAB_10133d2bc;
    pcVar9 = (char *)FUN_108855b04(&cStack_a0,&uStack_51,&UNK_10b20a5c0);
  }
LAB_10133d31c:
