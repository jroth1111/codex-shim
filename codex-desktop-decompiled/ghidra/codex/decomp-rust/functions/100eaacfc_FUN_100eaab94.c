...
bool FUN_100eaab94(char *param_1)
...
LAB_100eaac4c:
        do {
          ...
          if (uStack_30._1_1_ == '\x02') {
            if (bVar2) {
              if (lStack_58 - lStack_60 == 0) goto LAB_100eaaca0;
...
LAB_100eaad28:
          ...
          if (bVar2) goto LAB_100eaad28;
          lStack_50 = 0;
          if (lVar6 == 0) goto LAB_100eaad10;
          puVar3 = (undefined *)FUN_10129cdf4();
      ...
      puVar3 = (undefined *)FUN_108855c40(param_1,&lStack_60,&UNK_10b2140c8);
    }
    goto LAB_100eaacc4;
  }
  ...
  if (lVar6 == 0) {
    ...
    puVar3 = (undefined *)FUN_10129cdf4(*(undefined8 *)(param_1 + 0x10));
    if (puVar3 != (undefined *)0x0) goto LAB_100eaacc4;
    uVar1 = lVar6 - 1;
    if (uVar1 == 0) {
LAB_100eaaca0:
      puVar3 = (undefined *)0;
