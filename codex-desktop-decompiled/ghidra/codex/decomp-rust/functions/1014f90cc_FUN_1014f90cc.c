...
undefined8 FUN_1014f90cc(long param_1)

{
  ...
  puStack00000000000000d8 = &stack0x000000e8;
  pcStack00000000000000d0 = s_send_response_error__108ac8efd;
  puStack00000000000000b8 = (undefined1 *)&stack0x000000d0;
  puStack00000000000000c0 = &UNK_10b208fd0;
  plStack0000000000000198 = (long *)&stack0x000000b8;
  _uStack0000000000000190 = (long *)0x1;
  uStack00000000000001a0 = 1;
  plStack0000000000000128 = in_stack_000000a0;
...
LAB_1014f943c:
        *plVar6 = (long)pbVar7;
        ...
        if (plVar6 != (long *)0x0) {
          pcStack00000000000000d0 = (char *)plVar6;
            ...
            if ((*unaff_x28 == '\0') && (3 < ___ZN3log20MAX_LOG_LEVEL_FILTER17h2019f7c33388e688E)) {
              ...
              if (iVar5 != 0) {
                ...
                *(long ***)(unaff_x29 + -0x78) = &stack0x00000098;
                in_stack_000000e8 = (long *)(unaff_x29 + -0x80);
                ...
                *(undefined **)(unaff_x29 + -0xa8) = &DAT_1061c2098;
                ...
                in_stack_000001c8 = plStack0000000000000128;
          ...
          plVar9 = (long *)pcStack00000000000000d0;
          lVar10 = *(long *)pcStack00000000000000d0;
          if (lVar10 != 0) {
            puVar12 = *(undefined8 **)((long)pcStack00000000000000d0 + 8);
            pcVar3 = (code *)*puVar12;
            if (pcVar3 != (code *)0x0) {
              (*pcVar3)(lVar10);
            }
        ...
        if ((*unaff_x28 == '\0') && (lVar10 = *(long *)(unaff_x19 + 0x12f8), lVar10 != 0)) {
          ...
          in_stack_00000018 = *(undefined8 **)(lVar10 + 0x18);
    ...
    plStack0000000000000128 = plVar9;
    plVar6 = (long *)_malloc(0x18);
    if (plVar6 == (long *)0x0) {
      __ZN5alloc5alloc18handle_alloc_error17h77990a064974ed31E(8,0x18);
    }
