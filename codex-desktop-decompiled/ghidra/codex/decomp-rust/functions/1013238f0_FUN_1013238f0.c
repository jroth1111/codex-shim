...
void FUN_1013238f0(undefined8 *param_1,byte *param_2)
...
LAB_101323c74:
      pbStack_e8 = pbVar13;
      pbVar8 = (byte *)FUN_1087e422c(0,&UNK_10b231e88,&UNK_10b20a590);
    }
    else {
      pbVar13 = unaff_x21 + 0x20;
      if (*unaff_x21 == 0x16) goto LAB_101323c74;
      ...
      if (puStack_a0 != (undefined *)0x8000000000000000) {
        *param_1 = puStack_a0;
        ...
        if (lVar11 == 0) goto LAB_101323ddc;
        *param_1 = 0x8000000000000000;
        param_1[1] = lVar11;
        unaff_x21 = pbVar8;
        puVar12 = puVar5;
        goto joined_r0x000101323d2c;
      }
    }
    *param_1 = 0x8000000000000000;
    param_1[1] = pbVar8;
...
joined_r0x000101323d2c:
    ...
    if (bVar2 != 0x15) {
      uVar10 = FUN_108855b04(param_2,&puStack_a0,&UNK_10b20c860);
      *param_1 = 0x8000000000000000;
      param_1[1] = uVar10;
      return;
    }
...
LAB_101323b64:
          ...
          if (bVar1 != 0xc) goto LAB_101323ee4;
          if (lStack_70 == 8) {
            lVar18 = *plVar4;
            if (plVar3 != (long *)0x0) {
              _free();
            }
            if (lVar18 != 0x64496e6967756c70) goto LAB_101323b7c;
            goto LAB_101323be0;
          }
          if (plVar3 != (long *)0x0) {
            _free();
...
LAB_101323ee0:
            ...
            pcVar6 = (code *)SoftwareBreakpoint(1,0x101323ee4);
            (*pcVar6)();
          }
          uVar10 = *puVar15;
          puVar14[1] = puVar15[1];
          ...
          *(undefined8 *)((long)puVar14 + 0xf) = uVar10;
          ...
          if (bVar1 != 0xd) {
            if (bVar1 == 0xe) {
              if (((((lStack_70 == 8) && ((char)*plVar4 == 'p')) &&
                   (*(char *)((long)plVar4 + 1) == 'l')) &&
                  ((*(char *)((long)plVar4 + 2) == 'u' && (*(char *)((long)plVar4 + 3) == 'g')))) &&
                 ((*(char *)((long)plVar4 + 4) == 'i' &&
                  ((*(char *)((long)plVar4 + 5) == 'n' && (*(char *)((long)plVar4 + 6) == 'I'))))))
              {
              ...
              goto joined_r0x000101323bbc;
            }
            if (bVar1 == 0xf) {
              if ((((plVar4 == (long *)0x8) && ((char)*plVar3 == 'p')) &&
                  (*(char *)((long)plVar3 + 1) == 'l')) &&
                 (((*(char *)((long)plVar3 + 2) == 'u' && (*(char *)((long)plVar3 + 3) == 'g')) &&
                  ((*(char *)((long)plVar3 + 4) == 'i' &&
                   ((*(char *)((long)plVar3 + 5) == 'n' && (*(char *)((long)plVar3 + 6) == 'I'))))))
                 )) {
...
LAB_101323ee4:
            lStack_b0 = lVar16 + 1;
            pbStack_c8 = pbVar17;
            uVar10 = FUN_108855b04(&bStack_88,&puStack_a0,&UNK_10b212420);
            *param_1 = 0x8000000000000000;
            param_1[1] = uVar10;
            puVar12 = (undefined *)((ulong)puVar12 & 0x7fffffffffffffff);
joined_r0x000101323f1c:
            if (puVar12 != (undefined *)0x0) {
              _free(unaff_x21);
            }
            goto LAB_101323d9c;
          ...
          if (plVar4 == (long *)0x8) {
            bVar7 = *plVar3 == 0x64496e6967756c70;
            goto LAB_101323b64;
          }
LAB_101323b6c:
          bVar7 = true;
LAB_101323b70:
          FUN_100e077ec(&bStack_88);
joined_r0x000101323bbc:
          if (bVar7) goto LAB_101323b7c;
LAB_101323be0:
          if (puVar12 != (undefined *)0x8000000000000000) {
            lStack_b0 = lVar16 + 1;
            puStack_a0 = &UNK_108c982a8;
            pbStack_98 = (byte *)0x8;
      ...
      if (puVar12 != (undefined *)0x8000000000000000) {
        *param_1 = puVar12;
        ...
        if (pbVar9 == pbVar8) goto LAB_101323ddc;
