...
/* WARNING: Removing unreachable block (ram,0x000101439608) */
/* WARNING: Type propagation algorithm not settling */

void FUN_101439078(undefined1 *param_1,char *param_2)
...
LAB_101439520:
      ...
      if ((byte)uStack_e0 == 4) {
        if (plStack_118 != (long *)0x0) {
          if (plStack_118 == (long *)0x1) goto LAB_1014393c0;
...
LAB_1014391ec:
            plStack_138 = (long *)FUN_1087e4494(plStack_110,lStack_108,&UNK_10b2225f8,2);
...
joined_r0x000101439434:
        plVar10 = plVar6;
        if (plVar5 == (long *)0x0) goto LAB_10143952c;
        _free(plVar6);
        plVar5 = uStack_140;
        lVar9 = lStack_88;
        lStack_88 = lStack_68;
        goto joined_r0x000101439448;
      }
LAB_1014395dc:
      plStack_138 = (long *)FUN_108855b04(&uStack_e0,&uStack_51,&UNK_10b20f7c0);
      uStack_140 = (long *)CONCAT71(uStack_140._1_7_,1);
      lVar9 = lStack_88;
LAB_101439538:
      lStack_88 = lVar9;
...
joined_r0x00010143964c:
      ...
      if ((byte)uStack_e0 == 0xd) {
        ...
        goto LAB_1014393c0;
        plStack_138 = (long *)FUN_1087e4494(plStack_118,plStack_110,&UNK_10b2225f8,2);
LAB_10143930c:
        uVar8 = 1;
        goto LAB_101439520;
      }
      if ((byte)uStack_e0 == 0xe) {
        func_0x000100ac3a3c(&uStack_140,plStack_110,lStack_108);
        goto joined_r0x000101439434;
      }
      if ((byte)uStack_e0 != 0xf) goto LAB_1014395dc;
      func_0x000100ac3a3c(&uStack_140,plStack_118,plStack_110);
LAB_101439524:
...
LAB_10143952c:
      ...
      lVar9 = lStack_88;
      lStack_88 = lStack_68;
joined_r0x000101439448:
      bVar4 = (char)uStack_140 == '\x01';
      uStack_140 = plVar5;
      lStack_68 = lStack_88;
      if (bVar4) goto LAB_101439538;
...
LAB_101439318:
      ...
      plStack_138 = plVar10;
      if (cVar2 == '\x16') goto LAB_101439318;
...
LAB_101439130:
      ...
      if ((byte)uStack_e0 == '\x16') goto LAB_101439130;
      FUN_100e077ec(&uStack_e0);
