...
void FUN_10128b9f4(undefined8 *param_1,byte *param_2)
...
LAB_10128be2c:
      pbStack_e8 = pbVar15;
      pbVar8 = (byte *)FUN_1087e422c(0,&UNK_10b2320f8,&UNK_10b20a590);
    }
    else {
      pbVar15 = unaff_x21 + 0x20;
      if (*unaff_x21 == 0x16) goto LAB_10128be2c;
      ...
      if (puStack_a0 != (undefined *)0x8000000000000000) {
        *param_1 = puStack_a0;
        ...
        if (lVar11 == 0) goto LAB_10128bfa4;
        *param_1 = 0x8000000000000000;
        param_1[1] = lVar11;
        unaff_x21 = pbVar8;
        puVar14 = puVar5;
        goto joined_r0x00010128bee4;
      }
    }
    *param_1 = 0x8000000000000000;
    param_1[1] = pbVar8;
...
joined_r0x00010128bee4:
    ...
    if (bVar2 != 0x15) {
      uVar10 = FUN_108855b04(param_2,&puStack_a0,&UNK_10b20a6e0);
      *param_1 = 0x8000000000000000;
      param_1[1] = uVar10;
      return;
    }
        ...
        if (bVar1 < 0xd) {
          if (bVar1 != 1) {
            ...
            if (bVar1 == 0xc) {
              if (lStack_70 == 0xf) {
                uVar12 = *puVar4;
                uVar13 = *(ulong *)((long)puVar4 + 7) ^ 0x656d614e6563616c;
                bVar7 = (uVar12 ^ 0x6c7074656b72616d) != 0 || uVar13 != 0;
                if (plVar3 == (long *)0x0) goto LAB_10128bd44;
                _free();
                if ((uVar12 ^ 0x6c7074656b72616d) == 0 && uVar13 == 0) goto LAB_10128bd8c;
              }
...
LAB_10128c0c0:
            lStack_b0 = lVar18 + 1;
            pbStack_c8 = pbVar20;
            uVar10 = FUN_108855b04(&bStack_88,&puStack_a0,&UNK_10b2129e0);
            *param_1 = 0x8000000000000000;
            param_1[1] = uVar10;
            puVar14 = (undefined *)((ulong)puVar14 & 0x7fffffffffffffff);
            goto joined_r0x00010128c0fc;
          }
          bVar7 = cStack_87 == '\0';
LAB_10128bd30:
          bVar7 = !bVar7;
...
LAB_10128bd48:
          ...
          *(undefined8 *)((long)puVar16 + 0xf) = uVar10;
          ...
          if (bVar1 == 0xd) {
            if (puVar4 == (ulong *)0xf) {
              bVar7 = false;
              if (*plVar3 == 0x6c7074656b72616d) {
                bVar7 = *(long *)((long)plVar3 + 7) == 0x656d614e6563616c;
              }
              goto LAB_10128bd30;
            }
LAB_10128bd38:
          ...
          if (bVar1 != 0xe) {
            if (bVar1 != 0xf) goto LAB_10128c0c0;
            if ((((((puVar4 != (ulong *)0xf) || ((char)*plVar3 != 'm')) ||
                  (*(char *)((long)plVar3 + 1) != 'a')) ||
                 (((*(char *)((long)plVar3 + 2) != 'r' || (*(char *)((long)plVar3 + 3) != 'k')) ||
                  ((*(char *)((long)plVar3 + 4) != 'e' ||
                   ((*(char *)((long)plVar3 + 5) != 't' || (*(char *)((long)plVar3 + 6) != 'p'))))))
                 )) || ((*(char *)((long)plVar3 + 7) != 'l' ||
                        ((((char)plVar3[1] != 'a' || (*(char *)((long)plVar3 + 9) != 'c')) ||
                         (*(char *)((long)plVar3 + 10) != 'e')))))) ||
               (((*(char *)((long)plVar3 + 0xb) != 'N' || (*(char *)((long)plVar3 + 0xc) != 'a')) ||
                (*(char *)((long)plVar3 + 0xd) != 'm')))) goto LAB_10128bd38;
            bVar7 = *(char *)((long)plVar3 + 0xe) == 'e';
            goto LAB_10128bd30;
          }
          if (((((lStack_70 == 0xf) && ((char)*puVar4 == 'm')) &&
               ((*(char *)((long)puVar4 + 1) == 'a' &&
                ((((*(char *)((long)puVar4 + 2) == 'r' && (*(char *)((long)puVar4 + 3) == 'k')) &&
                  (*(char *)((long)puVar4 + 4) == 'e')) &&
                 ((*(char *)((long)puVar4 + 5) == 't' && (*(char *)((long)puVar4 + 6) == 'p'))))))))
              && (*(char *)((long)puVar4 + 7) == 'l')) &&
             ((((char)puVar4[1] == 'a' && (*(char *)((long)puVar4 + 9) == 'c')) &&
              ((*(char *)((long)puVar4 + 10) == 'e' &&
               (((*(char *)((long)puVar4 + 0xb) == 'N' && (*(char *)((long)puVar4 + 0xc) == 'a')) &&
                (*(char *)((long)puVar4 + 0xd) == 'm')))))))) {
            bVar7 = *(char *)((long)puVar4 + 0xe) != 'e';
          }
          else {
            bVar7 = true;
          }
...
LAB_10128c0bc:
            ...
            pcVar6 = (code *)SoftwareBreakpoint(1,0x10128c0c0);
            (*pcVar6)();
          }
          uVar10 = *puVar17;
          puVar16[1] = puVar17[1];
      ...
      if (puVar14 != (undefined *)0x8000000000000000) {
        *param_1 = puVar14;
        ...
        if (pbVar9 == pbVar8) goto LAB_10128bfa4;
