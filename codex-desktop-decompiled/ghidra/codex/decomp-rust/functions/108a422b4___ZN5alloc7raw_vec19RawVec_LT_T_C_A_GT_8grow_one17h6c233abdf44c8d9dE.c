...
void __ZN5alloc7raw_vec19RawVec_LT_T_C_A_GT_8grow_one17h6c233abdf44c8d9dE(long *param_1)

{
  ...
  lVar6 = 8;
  uVar7 = 0;
  if ((SUB168(ZEXT816(0x118) * auVar3,8) == 0) &&
     (uVar5 = uVar5 * 0x118, uVar5 < 0x7ffffffffffffff9)) {
    if (lVar1 == 0) {
      if (uVar5 != 0) {
        if (uVar5 < 8) {
          lStack_88 = 0;
      ...
      if (iVar4 == 0 && lStack_88 != 0) {
        _memcpy(lStack_88,lVar2,lVar1 * 0x118);
        _free(lVar2);
      }
    }
    else {
