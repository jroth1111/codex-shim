...
LAB_1014281f0:
              ...
              if (bStack_2e0 == 0x16) {
                ...
                lStack_228 = lVar12 + 1;
                FUN_1012232c8(&pbStack_220,&bStack_2e0);
                pbVar26 = pbStack_220;
                pbVar15 = pbStack_218;
...
LAB_101427cb8:
            ...
            lVar12 = lVar12 + 1;
            lStack_228 = lVar12;
            FUN_1012652ac(&pbStack_220,&bStack_2e0);
            in_x9 = pbStack_218;
            in_x10 = pbStack_220;
            pbVar27 = pbStack_210;
...
LAB_1014282b8:
            ...
            lVar12 = lVar12 + 1;
            lStack_228 = lVar12;
            FUN_1013a7e30(&pbStack_220,&bStack_2e0);
            pbVar14 = pbStack_218;
            pbVar16 = pbStack_220;
            pbVar18 = pbStack_210;
          ...
          lVar12 = lVar12 + 1;
          lStack_228 = lVar12;
          FUN_10127dd40(&pbStack_220,&bStack_2e0);
          if (pbStack_220 != (byte *)0x8000000000000000) {
        ...
        lVar12 = lVar12 + 1;
        lStack_228 = lVar12;
        FUN_1012527b8(&pbStack_220,&bStack_2e0);
        if (pbStack_220 != (byte *)0x8000000000000000) {
...
LAB_101427cb0:
      ...
      lStack_228 = 1;
      FUN_1013407f0(&pbStack_220,&bStack_2e0);
      if (pbStack_220 != (byte *)0x8000000000000000) {
        lVar12 = 1;
        in_x10 = extraout_x10;
        in_x9 = extraout_x9;
    ...
    if (*(long *)(param_2 + 0x18) == 0) {
      ...
      do {
        ...
        *puVar28 = uVar11;
        ...
        if (0xc < bStack_2e0) {
          if (bStack_2e0 == 0xd) {
            FUN_100baa718(&uStack_248,uVar1,uVar11);
            goto LAB_1014275dc;
          }
          if (bStack_2e0 == 0xe) {
            FUN_100baa448(&uStack_248,uVar11,pbStack_2c8);
joined_r0x000101427540:
          ...
          if (bStack_2e0 == 0xf) {
            FUN_100baa448(&uStack_248,uVar1,uVar11);
            goto LAB_1014275dc;
          }
LAB_1014278f4:
...
LAB_1014285b8:
        ...
        if (bStack_2e0 == 1) {
          ...
          if (bStack_2e0 != 4) {
            ...
            FUN_100baa718(&uStack_248,uVar11);
          ...
          if (uStack_248._1_1_ < 5) {
            if (uStack_248._1_1_ == 3) {
              if (pbStack_2f8 == (byte *)0x8000000000000000) {
                ...
                *(undefined8 *)((long)puVar28 + 0xf) = uVar11;
                bStack_2e0 = bVar13;
                FUN_1013a7e30(&uStack_248,&bStack_2e0);
...
LAB_101427fe8:
              ...
              if (pbStack_300 == (byte *)0x8000000000000000) {
                ...
                *(undefined8 *)((long)puVar28 + 0xf) = uVar11;
                bStack_2e0 = bVar13;
                FUN_1012652ac(&uStack_248,&bStack_2e0);
...
LAB_101428f14:
          ...
          *(undefined8 *)((long)puVar28 + 0xf) = uVar11;
          bStack_2e0 = bVar13;
          FUN_1012232c8(&uStack_248,&bStack_2e0);
        ...
        if (uStack_248._1_1_ != 0) {
          if (uStack_248._1_1_ != 1) {
            ...
            *(undefined8 *)((long)puVar28 + 0xf) = uVar11;
            bStack_2e0 = bVar13;
            FUN_10127dd40(&uStack_248,&bStack_2e0);
          ...
          if (pbStack_318 == (byte *)0x8000000000000000) {
            ...
            *(undefined8 *)((long)puVar28 + 0xf) = uVar11;
            bStack_2e0 = bVar13;
            FUN_1012527b8(&uStack_248,&bStack_2e0);
        ...
        *(undefined8 *)((long)puVar28 + 0xf) = uVar11;
        bStack_2e0 = bVar13;
        FUN_1013407f0(&uStack_248,&bStack_2e0);
        if (uStack_248 == (byte *)0x8000000000000000) {
          pbStack_310 = (byte *)0x8000000000000000;
          goto LAB_10142798c;
        }
