...
/* WARNING: Removing unreachable block (ram,0x00010090d9c0) */
/* WARNING: Removing unreachable block (ram,0x00010090d150) */
...

{
  ...
  ulong in_stack_00001200;
  
  __ZN5alloc3fmt6format12format_inner17h63985d1d6aa0fe33E
            (unaff_x29 + -0x78,s_failed_to_load_thread_history___108acf985,&stack0x00000d20);
  if ((in_stack_00001200 & 3) == 1) {
    uVar1 = *(undefined8 *)(in_stack_00001200 - 1);
    puVar3 = *(undefined8 **)(in_stack_00001200 + 7);
    pcVar2 = (code *)*puVar3;
    if (pcVar2 != (code *)0x0) {
      (*pcVar2)(uVar1);
    }
    ...
    _free((undefined8 *)(in_stack_00001200 - 1));
  }
  ...
  *in_stack_00000128 = 1;
  FUN_100cdbd08(in_stack_00000108);
  ...
  *in_stack_00000150 = 0x8000000000000070;
  in_stack_00000150[1] = CONCAT44(in_stack_00000444,in_stack_00000440);
