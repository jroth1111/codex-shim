...
/* WARNING: Removing unreachable block (ram,0x000101cb48d4) */
/* WARNING: Removing unreachable block (ram,0x000101cb4998) */
/* WARNING: Removing unreachable block (ram,0x000101cb48dc) */

void FUN_101cb4810(void)

{
  ...
  lVar1 = FUN_1088dc508(s_missing_field_____108ac28f7,&stack0x000002c0);
  *in_stack_00000088 = unaff_x22;
  in_stack_00000088[1] = lVar1;
  ...
  if (*in_stack_00000088 == -0x8000000000000000) {
    ...
    if (in_stack_00000120 != in_stack_00000110) {
      lVar1 = FUN_1088c7110(in_stack_00000048,&UNK_10b271520,&UNK_10b26ca30);
