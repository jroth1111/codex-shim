...

{
  ...
  if (unaff_x19 != -0x7ffffffffffffffb) {
    FUN_100de6690(unaff_x29 + -0xf8);
  }
  if (((unaff_w22 != 0) && (in_stack_00000228 != 7)) &&
     (FUN_100e5d1e8(&stack0x00000228), in_stack_00000260 != 0)) {
    _free(in_stack_00000268);
  }
  FUN_100de8910(unaff_x27 + 0x48);
  if (in_stack_00000100 != -0x7ffffffffffffffb) {
