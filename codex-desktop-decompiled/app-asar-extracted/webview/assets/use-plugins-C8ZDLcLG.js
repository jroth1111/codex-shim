import{s as e}from"./chunk-Bj-mKKzh.js";import{Gn as t,Hn as n,P as r,Qn as i,Un as a,Vn as o,Yn as s,Zn as c,rt as l}from"./src-BLHmAhbF.js";import{Ca as u,X as d,Xi as f,ts as p}from"./app-server-manager-signals-7MlBpIlX.js";import{C as m,L as ee,T as te,X as ne,_ as h,l as re,u as g,xt as _}from"./setting-storage-kJblH-wH.js";import{t as ie}from"./invalidate-queries-and-broadcast-CPrIeBVQ.js";import{u as ae}from"./thread-context-inputs-D4zJFWk0.js";import{t as oe}from"./use-codex-home-B1p9XqNi.js";import{a as se,i as ce,n as le,t as ue}from"./use-is-plugins-enabled-M47TXC7m.js";import{t as de}from"./get-build-flavor-DDOtCsji.js";var v=[`<svg
...
`].map(e=>`data:image/svg+xml,${encodeURIComponent(e)}`);function y(e){let t=0;for(let n=0;n<e.length;n+=1)t=(t*31+e.charCodeAt(n))%v.length;return v[t]??``}var b=e(r(),1),x={".svg":`image/svg+xml`,".png":`image/png`,".jpg":`image/jpeg`,".jpeg":`image/jpeg`,".webp":`image/webp`,".gif":`image/gif`,".avif":`image/avif`};async function S(e,t,n){let r=C(e);if(r==null)return null;try{let e={path:r,hostId:t},i=await n.fetchQuery({queryFn:({signal:t})=>re(`read-file-binary`,{params:e,signal:t}),queryKey:g(`read-file-binary`,e),retry:!1,gcTime:1/0,staleTime:h.INFINITE});return i.contentsBase64?`data:${w(r)};base64,${i.contentsBase64}`:null}catch(e){return m.warning(`Failed to inline local image`,{safe:{},sensitive:{error:e,resolvedImagePath:r}}),null}}function C(e){if(e==null)return null;let n=e.trim();if(n.length===0)return null;let r=n.toLowerCase();if(r.startsWith(`data:`)||r.startsWith(`http:`)||r.startsWith(`https:`)||r.startsWith(`file:`)||r.startsWith(`vscode-resource:`)||r.startsWith(`vscode-webview:`)||r.startsWith(`vscode-file:`))return null;let i=t(n);return o(i)?i:null}function w(e){return x[b.default.extname(e).toLowerCase()]??`application/octet-stream`}var fe=_(),T=[`plugins`],E=4,D=[],pe=[],O=[],me=[],k=[],A=`computer-use`,j=`.tmp/marketplaces/openai-internal-testing`,M=new Set([`codex-official`,...s,`openai-curated`,`openai-primary-runtime`].map(J));function N(e){return{...Q(e.summary),description:e.summary.interface?.shortDescription??e.description??null,displayName:e.summary.interface?.displayName??null,marketplaceDisplayName:null,marketplaceName:e.marketplaceName,plugin:e.summary,keywords:e.summary.keywords,...B({marketplaceName:e.marketplaceName,marketplacePath:e.marketplacePath})}}function P({marketplacePath:e,remoteMarketplaceName:t}){if(e!=null&&t!=null)throw Error(`plugin marketplace request requires one marketplace source`);if(e!=null)return{marketplacePath:e};if(t!=null)return{remoteMarketplaceName:t};throw Error(`plugin marketplace request requires a marketplace source`)}function F(e){return e.marketplacePath??`remote:${e.remoteMarketplaceName}`}function I(e){return e.marketplacePath==null?R(e.plugin):e.plugin.name}function L(e){return e.marketplacePath==null?R(e.plugin):e.plugin.id}function R(e){if(e.remotePluginId==null)throw Error(`remote plugin ${e.id} is missing remotePluginId`);return e.remotePluginId}function z(e){return{...P(e),pluginName:I(e)}}function B({marketplaceName:e,marketplacePath:t}){return t==null?{marketplacePath:null,remoteMarketplaceName:e}:{marketplacePath:t,remoteMarketplaceName:null}}function V(e,t,n){let r=(0,fe.c)(54),i;r[0]===e?i=r[1]:(i={hostId:e},r[0]=e,r[1]=i);let a=ue(i)&&(n?.enabled??!0),o=n?.additionalMarketplaceKinds??O,s=n?.installSuggestionPluginNames??null,c=ve({additionalMarketplaceKinds:o,includeRemoteCatalog:n?.includeRemoteCatalog??!0}),l=ie(),f=ee(),m=ne(ae),re=oe(e),g=u(e).kind===`local`,_=ne(d),v;r[2]!==e||r[3]!==_?(v=_.includes(e),r[2]=e,r[3]=_,r[4]=v):v=r[4];let y=v,b=a&&y,x;r[5]!==e||r[6]!==b?(x={enabled:b,hostId:e},r[5]=e,r[6]=b,r[7]=x):x=r[7];let S=se(x),C;r[8]===e?C=r[9]:(C={hostId:e},r[8]=e,r[9]=C);let w=le(C),E;r[10]!==e||r[11]!==g?(E={hostId:e,isHostLocal:g},r[10]=e,r[11]=g,r[12]=E):E=r[12];let A=ce(E),j=t===void 0,M=De({codexHome:re,hostId:e,rootsOverrideCwd:t,workspaceRoots:m.data?.roots}),N=a&&y&&(t!==void 0||m.isFetched),P;r[13]===Symbol.for(`react.memo_cache_sentinel`)?(P=de(),r[13]=P):P=r[13];let F=P,I=s==null?ye(e,M,c):_e(e,M,O,s),L;r[14]!==F||r[15]!==e||r[16]!==s||r[17]!==c||r[18]!==f||r[19]!==M?(L=async()=>{let t=s==null?await p(`list-plugins`,c==null?{hostId:e,...M.length>0?{cwds:M}:{}}:{hostId:e,...M.length>0?{cwds:M}:{},marketplaceKinds:c}):await p(`send-cli-request-for-host`,{hostId:e,method:`plugin/installed`,params:{...M.length>0?{cwds:M}:{},installSuggestionPluginNames:s}}),n=Oe(t.marketplaces),r=F==null?n:we({buildFlavor:F,plugins:n});return{featuredPluginIds:s==null?F==null?t.featuredPluginIds:Ce({buildFlavor:F,featuredPluginIds:t.featuredPluginIds}):D,marketplaceLoadErrors:t.marketplaceLoadErrors,marketplaces:Te(t.marketplaces),plugins:await Ee({hostId:e,plugins:r,queryClient:f})}},r[14]=F,r[15]=e,r[16]=s,r[17]=c,r[18]=f,r[19]=M,r[20]=L):L=r[20];let R;r[21]!==N||r[22]!==I||r[23]!==L?(R={queryKey:I,queryFn:L,enabled:N,staleTime:h.FIVE_MINUTES,gcTime:1/0},r[21]=N,r[22]=I,r[23]=L,r[24]=R):R=r[24];let z=te(R),B;r[25]!==l||r[26]!==z?(B=async function(){await l(T),await z.refetch()},r[25]=l,r[26]=z,r[27]=B):B=r[27];let V=B;if(!a||!y){let e;return r[28]===Symbol.for(`react.memo_cache_sentinel`)?(e={availablePlugins:k,featuredPluginIds:D,installedPlugins:k,marketplaceLoadErrors:pe,marketplaces:me,errorMessage:null,isLoading:!1,isFetching:!1,refetch:ge,forceReload:he},r[28]=e):e=r[28],e}let H,U,W,G;r[29]!==S.available||r[30]!==A.available||r[31]!==w.available||r[32]!==z.data?.featuredPluginIds||r[33]!==z.data?.plugins?(H={isComputerUseAvailable:S.available,isExternalBrowserUseAvailable:A.available,isInAppBrowserUseAvailable:w.available},U=z.data?.plugins??k,W=xe({plugins:U,...H}),G=be({featuredPluginIds:z.data?.featuredPluginIds??D,...H}),r[29]=S.available,r[30]=A.available,r[31]=w.available,r[32]=z.data?.featuredPluginIds,r[33]=z.data?.plugins,r[34]=H,r[35]=U,r[36]=W,r[37]=G):(H=r[34],U=r[35],W=r[36],G=r[37]);let K;r[38]===U?K=r[39]:(K=Se(U),r[38]=U,r[39]=K);let q=z.data?.marketplaceLoadErrors??pe,J=z.data?.marketplaces??me,Y=z.error?String(z.error.message):null,X=j&&m.isLoading||z.isLoading||w.isLoading||A.isLoading||S.isLoading,Z=j&&m.isFetching||z.isFetching||S.isFetching,Q;r[40]!==H||r[41]!==z?(Q=async()=>{let e=(await z.refetch()).data?.plugins??k;return{availablePlugins:xe({plugins:e,...H}),installedPlugins:Se(e)}},r[40]=H,r[41]=z,r[42]=Q):Q=r[42];let $;return r[43]!==V||r[44]!==W||r[45]!==G||r[46]!==K||r[47]!==q||r[48]!==J||r[49]!==Y||r[50]!==X||r[51]!==Z||r[52]!==Q?($={availablePlugins:W,featuredPluginIds:G,installedPlugins:K,marketplaceLoadErrors:q,marketplaces:J,errorMessage:Y,isLoading:X,isFetching:Z,refetch:Q,forceReload:V},r[43]=V,r[44]=W,r[45]=G,r[46]=K,r[47]=q,r[48]=J,r[49]=Y,r[50]=X,r[51]=Z,r[52]=Q,r[53]=$):$=r[53],$}async function he(){}async function ge(){return{availablePlugins:k,installedPlugins:k}}function H(e){let t=(0,fe.c)(10),{enabled:n,hostId:r,marketplaceKind:i}=e,a=n===void 0?!0:n,o;t[0]===r?o=t[1]:(o={hostId:r},t[0]=r,t[1]=o);let s=ue(o),c,l;t[2]!==r||t[3]!==i?(c=[...T,`marketplace-kind`,r,i],l=async()=>Oe((await p(`list-plugins`,{hostId:r,marketplaceKinds:[i]})).marketplaces),t[2]=r,t[3]=i,t[4]=c,t[5]=l):(c=t[4],l=t[5]);let u=a&&s,d;return t[6]!==c||t[7]!==l||t[8]!==u?(d={queryKey:c,queryFn:l,enabled:u,staleTime:h.FIVE_MINUTES},t[6]=c,t[7]=l,t[8]=u,t[9]=d):d=t[9],te(d)}function _e(e,t,n=O,r=null){return r==null?ye(e,t,ve({additionalMarketplaceKinds:n,includeRemoteCatalog:!0})):[...T,e,t,`installed`,r]}function ve({additionalMarketplaceKinds:e,includeRemoteCatalog:t}){return t&&e.length===0?null:[`local`,...e]}function ye(e,t,n){return n==null?[...T,e,t]:[...T,e,t,`marketplace-kinds`,n]}function be({featuredPluginIds:e,...t}){return e.filter(e=>U(e,t))}function xe({plugins:e,...t}){return e.filter(e=>U(e.plugin.id,t))}function Se(e){return e.filter(e=>e.plugin.installed)}function U(e,{isComputerUseAvailable:t,isExternalBrowserUseAvailable:n,isInAppBrowserUseAvailable:r}){return!(!r&&W(e)||!n&&G(e)||!t&&K(e))}function W(e){let t=q(e);return t===`browser`||t===`browser-use`}function G(e){let t=q(e);return t===`chrome`||t===`chrome-dev`||t===`chrome-internal`}function K(e){return q(e)===A}function q(e){return e.split(`@`)[0]}function Ce({buildFlavor:e,featuredPluginIds:t}){let n=c(e);return t.filter(e=>{let t=l(e);return t==null?!0:!i(t)||t===n})}function we({buildFlavor:e,plugins:t}){let n=c(e);return t.filter(e=>!i(e.marketplaceName)||e.marketplaceName===n)}function J(e){return e.trim().toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)}function Y(e){return M.has(J(e))}function Te(e){let t=new Map;for(let n of e){let e=`${n.name}\u0000${n.path??``}`;if(t.has(e))continue;let r=Y(n.name);t.set(e,{displayName:n.interface?.displayName??null,isBuiltIn:r,name:n.name,path:n.path,pluginCount:n.plugins.length})}return Array.from(t.values()).sort((e,t)=>{let n=e.displayName?.trim()||e.name,r=t.displayName?.trim()||t.name;return n.localeCompare(r)})}async function Ee({hostId:e,plugins:t,queryClient:n}){let r=[...t];async function i(a){let o=t[a];if(o==null)return;let[s,c]=await Promise.all([S(o.composerIconPath,e,n),S(o.logoPath,e,n)]);(s!=null||c!=null)&&(r[a]={...o,composerIconPath:s??o.composerIconPath,logoPath:c??o.logoPath,plugin:o.plugin.interface?{...o.plugin,interface:{...o.plugin.interface,...s==null?{}:{composerIcon:s},...c==null?{}:{logo:c}}}:o.plugin}),await i(a+E)}return await Promise.all(Array.from({length:Math.min(E,t.length)},(e,t)=>i(t))),r}function De({codexHome:e,hostId:t,rootsOverrideCwd:n,workspaceRoots:r}){let i=t===`local`&&e!=null?f(e,j):null;return X([...typeof n==`string`?[n]:n??r??[],...i==null?[]:[i]],e)}function X(e,t){return Array.from(new Set(e.map(e=>e.trim()).filter(e=>o(e)&&Z(e,t))))}function Z(e,t){return t==null?!0:n(t)||a(t)?n(e)||a(e):e.startsWith(`/`)&&!e.startsWith(`//`)}function Oe(e){let t=new Map;for(let n of e)for(let e of n.plugins)t.has(e.id)||t.set(e.id,{...Q(e),description:e.interface?.shortDescription??null,displayName:e.interface?.displayName??null,marketplaceDisplayName:n.interface?.displayName??null,marketplaceName:n.name,plugin:e,keywords:e.keywords,...B({marketplaceName:n.name,marketplacePath:n.path})});return Array.from(t.values())}function Q(e){let t=e.interface?.composerIcon??e.interface?.composerIconUrl??null,n=e.interface?.logo??e.interface?.logoUrl??null;if(t!=null||n!=null)return{composerIconPath:t,logoPath:n};let r=y(e.id);return{composerIconPath:r,logoPath:r}}export{S as _,P as a,L as c,K as d,G as f,C as g,H as h,F as i,R as l,V as m,N as n,z as o,W as p,Q as r,I as s,T as t,Y as u};
//# sourceMappingURL=use-plugins-C8ZDLcLG.js.map