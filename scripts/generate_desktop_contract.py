...
def _render_contract() -> str:
    ...
    workspace_request_keys = tuple(sorted(DESKTOP_WORKSPACE_REQUEST_KEYS))
...
{_render_tuple(workspace_request_keys)}
))

WORKSPACE_METADATA_KEYS = (
{_render_tuple(WORKSPACE_METADATA_KEYS)}
)

WORKSPACE_HEADER_KEYS = (
{_render_tuple(WORKSPACE_HEADER_KEYS)}
)
'''
